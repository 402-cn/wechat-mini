...
function demo_product_catalog(): array {
    return [
        [1, 1, '安居置业精选款A', './assets/images/real_estate_10.jpg', 39.00],
        [2, 1, '安居置业精选款B', './assets/images/real_estate_11.jpg', 88.00],
        [3, 1, '安居置业精选款C', './assets/images/real_estate_12.jpg', 137.00],
        [4, 1, '安居置业精选款D', './assets/images/real_estate_13.jpg', 186.00],
        [5, 1, '安居置业精选款E', './assets/images/real_estate_14.jpg', 235.00],
        [6, 1, '安居置业精选款F', './assets/images/real_estate_15.jpg', 284.00],
        [7, 2, '热销单品1', './assets/images/real_estate_16.jpg', 39.00],
        [8, 2, '热销单品2', './assets/images/real_estate_17.jpg', 88.00],
        [9, 2, '热销单品3', './assets/images/real_estate_18.jpg', 137.00],
        [10, 2, '热销单品4', './assets/images/real_estate_19.jpg', 186.00],
        [11, 2, '热销单品5', './assets/images/real_estate_20.jpg', 235.00],
        [12, 2, '热销单品6', './assets/images/real_estate_21.jpg', 284.00],
        [13, 3, '新品推荐1', './assets/images/real_estate_22.jpg', 39.00],
        [14, 3, '新品推荐2', './assets/images/real_estate_23.jpg', 88.00],
        [15, 3, '新品推荐3', './assets/images/real_estate_24.jpg', 137.00],
        [16, 3, '新品推荐4', './assets/images/real_estate_25.jpg', 186.00],
        [17, 3, '新品推荐5', './assets/images/real_estate_26.jpg', 235.00],
        [18, 3, '新品推荐6', './assets/images/real_estate_27.jpg', 284.00],
        [19, 4, '套餐服务1', './assets/images/real_estate_28.jpg', 39.00],
        [20, 4, '套餐服务2', './assets/images/real_estate_29.jpg', 88.00],
        [21, 4, '套餐服务3', './assets/images/real_estate_30.jpg', 137.00],
        [22, 4, '套餐服务4', './assets/images/real_estate_31.jpg', 186.00],
        [23, 4, '套餐服务5', './assets/images/real_estate_32.jpg', 235.00],
        [24, 4, '套餐服务6', './assets/images/real_estate_33.jpg', 284.00],
        [25, 5, '会员专享1', './assets/images/real_estate_34.jpg', 39.00],
        [26, 5, '会员专享2', './assets/images/real_estate_35.jpg', 88.00],
        [27, 5, '会员专享3', './assets/images/real_estate_36.jpg', 137.00],
        [28, 5, '会员专享4', './assets/images/real_estate_37.jpg', 186.00],
        [29, 5, '会员专享5', './assets/images/real_estate_38.jpg', 235.00],
        [30, 5, '会员专享6', './assets/images/real_estate_39.jpg', 284.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'新房',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'二手房',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'租房',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'商铺',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'资讯',5,1)");
