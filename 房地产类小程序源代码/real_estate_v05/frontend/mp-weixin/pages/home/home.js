...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_real_estate_v05_home_04: [{"id":1,"image":"/uploads/stock/real_estate_10.jpg","imageSrc":"","name":"安居置业精选款A","price":39},{"id":2,"image":"/uploads/stock/real_estate_11.jpg","imageSrc":"","name":"安居置业精选款B","price":88},{"id":3,"image":"/uploads/stock/real_estate_12.jpg","imageSrc":"","name":"安居置业精选款C","price":137},{"id":4,"image":"/uploads/stock/real_estate_13.jpg","imageSrc":"","name":"安居置业精选款D","price":186},{"id":5,"image":"/uploads/stock/real_estate_14.jpg","imageSrc":"","name":"安居置业精选款E","price":235},{"id":6,"image":"/uploads/stock/real_estate_15.jpg","imageSrc":"","name":"安居置业精选款F","price":284},{"id":7,"image":"/uploads/stock/real_estate_16.jpg","imageSrc":"","name":"热销单品1","price":39},{"id":8,"image":"/uploads/stock/real_estate_17.jpg","imageSrc":"","name":"热销单品2","price":88}], products_real_estate_v05_home_06: [{"id":9,"image":"/uploads/stock/real_estate_18.jpg","imageSrc":"","name":"热销单品3","price":137},{"id":10,"image":"/uploads/stock/real_estate_19.jpg","imageSrc":"","name":"热销单品4","price":186},{"id":11,"image":"/uploads/stock/real_estate_20.jpg","imageSrc":"","name":"热销单品5","price":235},{"id":12,"image":"/uploads/stock/real_estate_21.jpg","imageSrc":"","name":"热销单品6","price":284}], productWidgets: [{"key":"products_real_estate_v05_home_04","cid":"real_estate_v05_home_04","limit":8},{"key":"products_real_estate_v05_home_06","cid":"real_estate_v05_home_06","limit":4}], swiper_real_estate_v05_home_02: { height: 360, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/real_estate_49.jpg","imageSrc":"","link":"","title":"房地产"}] }, swiperWidgets: [{"key":"swiper_real_estate_v05_home_02","cid":"real_estate_v05_home_02","height":360,"interval":3000}], notice_real_estate_v05_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购房地产好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_real_estate_v05_home_03","cid":"real_estate_v05_home_03"}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_real_estate_v05_home_04();
    await this._mpLoadProducts_products_real_estate_v05_home_06()
  },
  async _mpLoadProducts_products_real_estate_v05_home_04() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("real_estate_v05_home_04");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_real_estate_v05_home_04 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_real_estate_v05_home_04: list });
    } catch (e) { this.mpDevWarn('product', "real_estate_v05_home_04", e); }
  },

  async _mpLoadProducts_products_real_estate_v05_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("real_estate_v05_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_real_estate_v05_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_real_estate_v05_home_06: list });
    } catch (e) { this.mpDevWarn('product', "real_estate_v05_home_06", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_real_estate_v05_home_02()
  },
  async _mpLoadSwiper_swiper_real_estate_v05_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("real_estate_v05_home_02"));
      ...
      var cur = this.data.swiper_real_estate_v05_home_02 || {};
      this.setData({
        swiper_real_estate_v05_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "real_estate_v05_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_real_estate_v05_home_03()
  },
  async _mpLoadNotice_notice_real_estate_v05_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("real_estate_v05_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_real_estate_v05_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "real_estate_v05_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_real_estate_v05_home_04, 'image'); if (list.length) this.setData({ products_real_estate_v05_home_04: list }); }
    { var list = withSrc(this.data.products_real_estate_v05_home_06, 'image'); if (list.length) this.setData({ products_real_estate_v05_home_06: list }); }
    { var wgt = this.data.swiper_real_estate_v05_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_real_estate_v05_home_02: next }); } }
  },
onShow() {
