...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_real_estate_v06_home_05: [{"id":7,"image":"/uploads/stock/real_estate_16.jpg","imageSrc":"","name":"热销单品1","price":39},{"id":8,"image":"/uploads/stock/real_estate_17.jpg","imageSrc":"","name":"热销单品2","price":88},{"id":9,"image":"/uploads/stock/real_estate_18.jpg","imageSrc":"","name":"热销单品3","price":137},{"id":10,"image":"/uploads/stock/real_estate_19.jpg","imageSrc":"","name":"热销单品4","price":186}], productWidgets: [{"key":"products_real_estate_v06_home_05","cid":"real_estate_v06_home_05","limit":4}], swiper_real_estate_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/real_estate_50.jpg","imageSrc":"","link":"","title":"房地产"},{"image":"/uploads/stock/real_estate_51.jpg","imageSrc":"","link":"","title":"热销楼盘"},{"image":"/uploads/stock/real_estate_52.jpg","imageSrc":"","link":"","title":"限时优惠"}] }, swiperWidgets: [{"key":"swiper_real_estate_v06_home_02","cid":"real_estate_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_real_estate_v06_home_05()
  },
  async _mpLoadProducts_products_real_estate_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("real_estate_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_real_estate_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_real_estate_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "real_estate_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_real_estate_v06_home_02()
  },
  async _mpLoadSwiper_swiper_real_estate_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("real_estate_v06_home_02"));
      ...
      var cur = this.data.swiper_real_estate_v06_home_02 || {};
      this.setData({
        swiper_real_estate_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "real_estate_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_real_estate_v06_home_05, 'image'); if (list.length) this.setData({ products_real_estate_v06_home_05: list }); }
    { var wgt = this.data.swiper_real_estate_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_real_estate_v06_home_02: next }); } }
  },
onShow() {
