...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_software_it_v06_home_05: [{"id":7,"image":"/uploads/stock/software_it_16.jpg","imageSrc":"","name":"热销单品1","price":39},{"id":8,"image":"/uploads/stock/software_it_17.jpg","imageSrc":"","name":"热销单品2","price":88},{"id":9,"image":"/uploads/stock/software_it_18.jpg","imageSrc":"","name":"热销单品3","price":137},{"id":10,"image":"/uploads/stock/software_it_19.jpg","imageSrc":"","name":"热销单品4","price":186}], productWidgets: [{"key":"products_software_it_v06_home_05","cid":"software_it_v06_home_05","limit":4}], swiper_software_it_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/software_it_50.jpg","imageSrc":"","link":"","title":"软件互联网"},{"image":"/uploads/stock/software_it_51.jpg","imageSrc":"","link":"","title":"免费评估"},{"image":"/uploads/stock/software_it_52.jpg","imageSrc":"","link":"","title":"方案咨询"}] }, swiperWidgets: [{"key":"swiper_software_it_v06_home_02","cid":"software_it_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_software_it_v06_home_05()
  },
  async _mpLoadProducts_products_software_it_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("software_it_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_software_it_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_software_it_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "software_it_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_software_it_v06_home_02()
  },
  async _mpLoadSwiper_swiper_software_it_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("software_it_v06_home_02"));
      ...
      var cur = this.data.swiper_software_it_v06_home_02 || {};
      this.setData({
        swiper_software_it_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "software_it_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_software_it_v06_home_05, 'image'); if (list.length) this.setData({ products_software_it_v06_home_05: list }); }
    { var wgt = this.data.swiper_software_it_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_software_it_v06_home_02: next }); } }
  },
onShow() {
