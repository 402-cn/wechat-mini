...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_fashion_v03_home_08: [{"id":1,"image":"/uploads/stock/fashion_10.jpg","imageSrc":"","name":"春季连衣裙","price":99},{"id":2,"image":"/uploads/stock/fashion_11.jpg","imageSrc":"","name":"针织开衫","price":228},{"id":3,"image":"/uploads/stock/fashion_12.jpg","imageSrc":"","name":"休闲西装","price":357},{"id":4,"image":"/uploads/stock/fashion_13.jpg","imageSrc":"","name":"牛仔外套","price":486},{"id":5,"image":"/uploads/stock/fashion_14.jpg","imageSrc":"","name":"半身裙","price":615},{"id":6,"image":"/uploads/stock/fashion_15.jpg","imageSrc":"","name":"雪纺衬衫","price":744}], productWidgets: [{"key":"products_fashion_v03_home_08","cid":"fashion_v03_home_08","limit":6}], swiper_fashion_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/fashion_9.jpg","imageSrc":"","link":"","title":"服装鞋包"},{"image":"/uploads/stock/fashion_48.jpg","imageSrc":"","link":"","title":"春季上新"},{"image":"/uploads/stock/fashion_49.jpg","imageSrc":"","link":"","title":"清仓特卖"}] }, swiperWidgets: [{"key":"swiper_fashion_v03_home_02","cid":"fashion_v03_home_02","height":340,"interval":3000}], promoPair_fashion_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/fashion_42.jpg","imageSrc":"","navUrl":"","title":"春季上新"},{"bgColor":"#fff3e0","image":"/uploads/stock/fashion_43.jpg","imageSrc":"","navUrl":"","title":"清仓特卖"}]}, promoPair_fashion_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/fashion_44.jpg","imageSrc":"","navUrl":"","title":"会员折扣"},{"bgColor":"#fff3e0","image":"/uploads/stock/fashion_45.jpg","imageSrc":"","navUrl":"","title":"限时秒杀"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_fashion_v03_home_08()
  },
  async _mpLoadProducts_products_fashion_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("fashion_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_fashion_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_fashion_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "fashion_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_fashion_v03_home_02()
  },
  async _mpLoadSwiper_swiper_fashion_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("fashion_v03_home_02"));
      ...
      var cur = this.data.swiper_fashion_v03_home_02 || {};
      this.setData({
        swiper_fashion_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "fashion_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_fashion_v03_home_08, 'image'); if (list.length) this.setData({ products_fashion_v03_home_08: list }); }
    { var wgt = this.data.swiper_fashion_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_fashion_v03_home_02: next }); } }
  },
onShow() {
