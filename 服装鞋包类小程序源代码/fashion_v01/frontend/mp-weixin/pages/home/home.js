...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_fashion_v01_home_11: [{"id":1,"image":"/uploads/stock/fashion_10.jpg","imageSrc":"","name":"春季连衣裙","price":99},{"id":2,"image":"/uploads/stock/fashion_11.jpg","imageSrc":"","name":"针织开衫","price":228},{"id":3,"image":"/uploads/stock/fashion_12.jpg","imageSrc":"","name":"休闲西装","price":357}], products_fashion_v01_home_13: [{"id":7,"image":"/uploads/stock/fashion_16.jpg","imageSrc":"","name":"男士POLO","price":99},{"id":8,"image":"/uploads/stock/fashion_17.jpg","imageSrc":"","name":"休闲裤","price":228},{"id":9,"image":"/uploads/stock/fashion_18.jpg","imageSrc":"","name":"商务衬衫","price":357},{"id":10,"image":"/uploads/stock/fashion_19.jpg","imageSrc":"","name":"夹克外套","price":486},{"id":11,"image":"/uploads/stock/fashion_20.jpg","imageSrc":"","name":"卫衣","price":615},{"id":12,"image":"/uploads/stock/fashion_21.jpg","imageSrc":"","name":"牛仔裤","price":744}], productWidgets: [{"key":"products_fashion_v01_home_11","cid":"fashion_v01_home_11","limit":3},{"key":"products_fashion_v01_home_13","cid":"fashion_v01_home_13","limit":6}], swiper_fashion_v01_home_03: { height: 320, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/fashion_7.jpg","imageSrc":"","link":"","title":"服装鞋包"},{"image":"/uploads/stock/fashion_8.jpg","imageSrc":"","link":"","title":"春季上新"},{"image":"/uploads/stock/fashion_9.jpg","imageSrc":"","link":"","title":"清仓特卖"}] }, swiperWidgets: [{"key":"swiper_fashion_v01_home_03","cid":"fashion_v01_home_03","height":320,"interval":3000}], notice_fashion_v01_home_04: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购服装鞋包好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_fashion_v01_home_04","cid":"fashion_v01_home_04"}], gridNav_fashion_v01_home_02: {"items":[{"icon":"/uploads/stock/fashion_1.jpg","iconSrc":"","navUrl":"","text":"再买一单"},{"icon":"/uploads/stock/fashion_2.jpg","iconSrc":"","navUrl":"","text":"会员中心"},{"icon":"/uploads/stock/fashion_3.jpg","iconSrc":"","navUrl":"","text":"优惠券"},{"icon":"/uploads/stock/fashion_4.jpg","iconSrc":"","navUrl":"","text":"我的订单"}]}, gridNav_fashion_v01_home_05: {"items":[{"icon":"/uploads/stock/fashion_1.jpg","iconSrc":"","navUrl":"","text":"极速达"},{"icon":"/uploads/stock/fashion_2.jpg","iconSrc":"","navUrl":"","text":"品质保障"},{"icon":"/uploads/stock/fashion_3.jpg","iconSrc":"","navUrl":"","text":"售后无忧"}]}, gridNav_fashion_v01_home_06: {"items":[{"icon":"/uploads/stock/fashion_1.jpg","iconSrc":"","navUrl":"","text":"女装"},{"icon":"/uploads/stock/fashion_2.jpg","iconSrc":"","navUrl":"","text":"男装"},{"icon":"/uploads/stock/fashion_3.jpg","iconSrc":"","navUrl":"","text":"童装"},{"icon":"/uploads/stock/fashion_4.jpg","iconSrc":"","navUrl":"","text":"鞋靴"},{"icon":"/uploads/stock/fashion_5.jpg","iconSrc":"","navUrl":"","text":"箱包"},{"icon":"/uploads/stock/fashion_6.jpg","iconSrc":"","navUrl":"","text":"配饰"},{"icon":"/uploads/stock/fashion_55.jpg","iconSrc":"","navUrl":"","text":"内衣"},{"icon":"/uploads/stock/fashion_56.jpg","iconSrc":"","navUrl":"","text":"运动"},{"icon":"/uploads/stock/fashion_57.jpg","iconSrc":"","navUrl":"","text":"新品"},{"icon":"/uploads/stock/fashion_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]}, promoPair_fashion_v01_home_07: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/fashion_40.jpg","imageSrc":"","navUrl":"","title":"春季上新"},{"bgColor":"#fff3e0","image":"/uploads/stock/fashion_41.jpg","imageSrc":"","navUrl":"","title":"清仓特卖"}]}, promoPair_fashion_v01_home_08: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/fashion_42.jpg","imageSrc":"","navUrl":"","title":"会员折扣"},{"bgColor":"#fff3e0","image":"/uploads/stock/fashion_43.jpg","imageSrc":"","navUrl":"","title":"限时秒杀"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_fashion_v01_home_11();
    await this._mpLoadProducts_products_fashion_v01_home_13()
  },
  async _mpLoadProducts_products_fashion_v01_home_11() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("fashion_v01_home_11");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_fashion_v01_home_11 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_fashion_v01_home_11: list });
    } catch (e) { this.mpDevWarn('product', "fashion_v01_home_11", e); }
  },

  async _mpLoadProducts_products_fashion_v01_home_13() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("fashion_v01_home_13");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_fashion_v01_home_13 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_fashion_v01_home_13: list });
    } catch (e) { this.mpDevWarn('product', "fashion_v01_home_13", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_fashion_v01_home_03()
  },
  async _mpLoadSwiper_swiper_fashion_v01_home_03() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("fashion_v01_home_03"));
      ...
      var cur = this.data.swiper_fashion_v01_home_03 || {};
      this.setData({
        swiper_fashion_v01_home_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "fashion_v01_home_03", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_fashion_v01_home_04()
  },
  async _mpLoadNotice_notice_fashion_v01_home_04() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("fashion_v01_home_04"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_fashion_v01_home_04: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "fashion_v01_home_04", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_fashion_v01_home_11, 'image'); if (list.length) this.setData({ products_fashion_v01_home_11: list }); }
    { var list = withSrc(this.data.products_fashion_v01_home_13, 'image'); if (list.length) this.setData({ products_fashion_v01_home_13: list }); }
    { var wgt = this.data.swiper_fashion_v01_home_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_fashion_v01_home_03: next }); } }
  },
onShow() {
