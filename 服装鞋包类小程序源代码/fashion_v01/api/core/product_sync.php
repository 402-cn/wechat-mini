...
function demo_product_catalog(): array {
    return [
        [1, 1, '春季连衣裙', './assets/images/fashion_10.jpg', 99.00],
        [2, 1, '针织开衫', './assets/images/fashion_11.jpg', 228.00],
        [3, 1, '休闲西装', './assets/images/fashion_12.jpg', 357.00],
        [4, 1, '牛仔外套', './assets/images/fashion_13.jpg', 486.00],
        [5, 1, '半身裙', './assets/images/fashion_14.jpg', 615.00],
        [6, 1, '雪纺衬衫', './assets/images/fashion_15.jpg', 744.00],
        [7, 2, '男士POLO', './assets/images/fashion_16.jpg', 99.00],
        [8, 2, '休闲裤', './assets/images/fashion_17.jpg', 228.00],
        [9, 2, '商务衬衫', './assets/images/fashion_18.jpg', 357.00],
        [10, 2, '夹克外套', './assets/images/fashion_19.jpg', 486.00],
        [11, 2, '卫衣', './assets/images/fashion_20.jpg', 615.00],
        [12, 2, '牛仔裤', './assets/images/fashion_21.jpg', 744.00],
        [13, 3, '小白鞋', './assets/images/fashion_22.jpg', 99.00],
        [14, 3, '高跟鞋', './assets/images/fashion_23.jpg', 228.00],
        [15, 3, '运动鞋', './assets/images/fashion_24.jpg', 357.00],
        [16, 3, '马丁靴', './assets/images/fashion_25.jpg', 486.00],
        [17, 3, '凉鞋', './assets/images/fashion_26.jpg', 615.00],
        [18, 3, '乐福鞋', './assets/images/fashion_27.jpg', 744.00],
        [19, 4, '托特包', './assets/images/fashion_28.jpg', 99.00],
        [20, 4, '双肩包', './assets/images/fashion_29.jpg', 228.00],
        [21, 4, '斜挎包', './assets/images/fashion_30.jpg', 357.00],
        [22, 4, '手拿包', './assets/images/fashion_31.jpg', 486.00],
        [23, 4, '旅行箱', './assets/images/fashion_32.jpg', 615.00],
        [24, 4, '腰包', './assets/images/fashion_33.jpg', 744.00],
        [25, 5, '丝巾', './assets/images/fashion_34.jpg', 99.00],
        [26, 5, '腰带', './assets/images/fashion_35.jpg', 228.00],
        [27, 5, '太阳镜', './assets/images/fashion_36.jpg', 357.00],
        [28, 5, '棒球帽', './assets/images/fashion_37.jpg', 486.00],
        [29, 5, '围巾', './assets/images/fashion_38.jpg', 615.00],
        [30, 5, '手表', './assets/images/fashion_39.jpg', 744.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'女装',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'男装',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'鞋靴',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'箱包',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'配饰',5,1)");
