...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_fashion_v06_home_05: [{"id":7,"image":"/uploads/stock/fashion_16.jpg","imageSrc":"","name":"男士POLO","price":99},{"id":8,"image":"/uploads/stock/fashion_17.jpg","imageSrc":"","name":"休闲裤","price":228},{"id":9,"image":"/uploads/stock/fashion_18.jpg","imageSrc":"","name":"商务衬衫","price":357},{"id":10,"image":"/uploads/stock/fashion_19.jpg","imageSrc":"","name":"夹克外套","price":486}], productWidgets: [{"key":"products_fashion_v06_home_05","cid":"fashion_v06_home_05","limit":4}], swiper_fashion_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/fashion_50.jpg","imageSrc":"","link":"","title":"服装鞋包"},{"image":"/uploads/stock/fashion_51.jpg","imageSrc":"","link":"","title":"春季上新"},{"image":"/uploads/stock/fashion_52.jpg","imageSrc":"","link":"","title":"清仓特卖"}] }, swiperWidgets: [{"key":"swiper_fashion_v06_home_02","cid":"fashion_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_fashion_v06_home_05()
  },
  async _mpLoadProducts_products_fashion_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("fashion_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_fashion_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_fashion_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "fashion_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_fashion_v06_home_02()
  },
  async _mpLoadSwiper_swiper_fashion_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("fashion_v06_home_02"));
      ...
      var cur = this.data.swiper_fashion_v06_home_02 || {};
      this.setData({
        swiper_fashion_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "fashion_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_fashion_v06_home_05, 'image'); if (list.length) this.setData({ products_fashion_v06_home_05: list }); }
    { var wgt = this.data.swiper_fashion_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_fashion_v06_home_02: next }); } }
  },
onShow() {
