...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_fashion_v02_home_06: [{"id":1,"image":"/uploads/stock/fashion_10.jpg","imageSrc":"","name":"春季连衣裙","price":99},{"id":2,"image":"/uploads/stock/fashion_11.jpg","imageSrc":"","name":"针织开衫","price":228},{"id":3,"image":"/uploads/stock/fashion_12.jpg","imageSrc":"","name":"休闲西装","price":357},{"id":4,"image":"/uploads/stock/fashion_13.jpg","imageSrc":"","name":"牛仔外套","price":486},{"id":5,"image":"/uploads/stock/fashion_14.jpg","imageSrc":"","name":"半身裙","price":615},{"id":6,"image":"/uploads/stock/fashion_15.jpg","imageSrc":"","name":"雪纺衬衫","price":744},{"id":7,"image":"/uploads/stock/fashion_16.jpg","imageSrc":"","name":"男士POLO","price":99},{"id":8,"image":"/uploads/stock/fashion_17.jpg","imageSrc":"","name":"休闲裤","price":228}], products_fashion_v02_home_07: [{"id":13,"image":"/uploads/stock/fashion_22.jpg","imageSrc":"","name":"小白鞋","price":99},{"id":14,"image":"/uploads/stock/fashion_23.jpg","imageSrc":"","name":"高跟鞋","price":228},{"id":15,"image":"/uploads/stock/fashion_24.jpg","imageSrc":"","name":"运动鞋","price":357}], productWidgets: [{"key":"products_fashion_v02_home_06","cid":"fashion_v02_home_06","limit":8},{"key":"products_fashion_v02_home_07","cid":"fashion_v02_home_07","limit":3}], swiper_fashion_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/fashion_8.jpg","imageSrc":"","link":"","title":"服装鞋包"},{"image":"/uploads/stock/fashion_9.jpg","imageSrc":"","link":"","title":"春季上新"}] }, swiperWidgets: [{"key":"swiper_fashion_v02_home_02","cid":"fashion_v02_home_02","height":280,"interval":3000}], notice_fashion_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购服装鞋包好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_fashion_v02_home_03","cid":"fashion_v02_home_03"}], gridNav_fashion_v02_home_04: {"items":[{"icon":"/uploads/stock/fashion_1.jpg","iconSrc":"","navUrl":"","text":"女装"},{"icon":"/uploads/stock/fashion_2.jpg","iconSrc":"","navUrl":"","text":"男装"},{"icon":"/uploads/stock/fashion_3.jpg","iconSrc":"","navUrl":"","text":"童装"},{"icon":"/uploads/stock/fashion_4.jpg","iconSrc":"","navUrl":"","text":"鞋靴"},{"icon":"/uploads/stock/fashion_5.jpg","iconSrc":"","navUrl":"","text":"箱包"},{"icon":"/uploads/stock/fashion_6.jpg","iconSrc":"","navUrl":"","text":"配饰"},{"icon":"/uploads/stock/fashion_55.jpg","iconSrc":"","navUrl":"","text":"内衣"},{"icon":"/uploads/stock/fashion_56.jpg","iconSrc":"","navUrl":"","text":"运动"},{"icon":"/uploads/stock/fashion_57.jpg","iconSrc":"","navUrl":"","text":"新品"},{"icon":"/uploads/stock/fashion_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_fashion_v02_home_06();
    await this._mpLoadProducts_products_fashion_v02_home_07()
  },
  async _mpLoadProducts_products_fashion_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("fashion_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_fashion_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_fashion_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "fashion_v02_home_06", e); }
  },

  async _mpLoadProducts_products_fashion_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("fashion_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_fashion_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_fashion_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "fashion_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_fashion_v02_home_02()
  },
  async _mpLoadSwiper_swiper_fashion_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("fashion_v02_home_02"));
      ...
      var cur = this.data.swiper_fashion_v02_home_02 || {};
      this.setData({
        swiper_fashion_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "fashion_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_fashion_v02_home_03()
  },
  async _mpLoadNotice_notice_fashion_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("fashion_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_fashion_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "fashion_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_fashion_v02_home_06, 'image'); if (list.length) this.setData({ products_fashion_v02_home_06: list }); }
    { var list = withSrc(this.data.products_fashion_v02_home_07, 'image'); if (list.length) this.setData({ products_fashion_v02_home_07: list }); }
    { var wgt = this.data.swiper_fashion_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_fashion_v02_home_02: next }); } }
  },
onShow() {
