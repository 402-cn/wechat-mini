...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_auto_v06_home_05: [{"id":7,"image":"/uploads/stock/auto_16.jpg","imageSrc":"","name":"发动机维修","price":99},{"id":8,"image":"/uploads/stock/auto_17.jpg","imageSrc":"","name":"变速箱养护","price":298},{"id":9,"image":"/uploads/stock/auto_18.jpg","imageSrc":"","name":"电路检测","price":497},{"id":10,"image":"/uploads/stock/auto_19.jpg","imageSrc":"","name":"钣金喷漆","price":696}], productWidgets: [{"key":"products_auto_v06_home_05","cid":"auto_v06_home_05","limit":4}], swiper_auto_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/auto_50.jpg","imageSrc":"","link":"","title":"汽车服务"},{"image":"/uploads/stock/auto_51.jpg","imageSrc":"","link":"","title":"保养套餐"},{"image":"/uploads/stock/auto_52.jpg","imageSrc":"","link":"","title":"洗车优惠"}] }, swiperWidgets: [{"key":"swiper_auto_v06_home_02","cid":"auto_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_auto_v06_home_05()
  },
  async _mpLoadProducts_products_auto_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("auto_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_auto_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_auto_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "auto_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_auto_v06_home_02()
  },
  async _mpLoadSwiper_swiper_auto_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("auto_v06_home_02"));
      ...
      var cur = this.data.swiper_auto_v06_home_02 || {};
      this.setData({
        swiper_auto_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "auto_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_auto_v06_home_05, 'image'); if (list.length) this.setData({ products_auto_v06_home_05: list }); }
    { var wgt = this.data.swiper_auto_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_auto_v06_home_02: next }); } }
  },
onShow() {
