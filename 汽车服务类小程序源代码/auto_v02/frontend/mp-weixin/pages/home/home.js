...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_auto_v02_home_06: [{"id":1,"image":"/uploads/stock/auto_10.jpg","imageSrc":"","name":"小保养套餐","price":99},{"id":2,"image":"/uploads/stock/auto_11.jpg","imageSrc":"","name":"大保养套餐","price":298},{"id":3,"image":"/uploads/stock/auto_12.jpg","imageSrc":"","name":"机油更换","price":497},{"id":4,"image":"/uploads/stock/auto_13.jpg","imageSrc":"","name":"机滤更换","price":696},{"id":5,"image":"/uploads/stock/auto_14.jpg","imageSrc":"","name":"空调滤芯","price":895},{"id":6,"image":"/uploads/stock/auto_15.jpg","imageSrc":"","name":"刹车片","price":1094},{"id":7,"image":"/uploads/stock/auto_16.jpg","imageSrc":"","name":"发动机维修","price":99},{"id":8,"image":"/uploads/stock/auto_17.jpg","imageSrc":"","name":"变速箱养护","price":298}], products_auto_v02_home_07: [{"id":13,"image":"/uploads/stock/auto_22.jpg","imageSrc":"","name":"精洗打蜡","price":99},{"id":14,"image":"/uploads/stock/auto_23.jpg","imageSrc":"","name":"内饰清洗","price":298},{"id":15,"image":"/uploads/stock/auto_24.jpg","imageSrc":"","name":"镀晶","price":497}], productWidgets: [{"key":"products_auto_v02_home_06","cid":"auto_v02_home_06","limit":8},{"key":"products_auto_v02_home_07","cid":"auto_v02_home_07","limit":3}], swiper_auto_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/auto_8.jpg","imageSrc":"","link":"","title":"汽车服务"},{"image":"/uploads/stock/auto_9.jpg","imageSrc":"","link":"","title":"保养套餐"}] }, swiperWidgets: [{"key":"swiper_auto_v02_home_02","cid":"auto_v02_home_02","height":280,"interval":3000}], notice_auto_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购汽车服务好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_auto_v02_home_03","cid":"auto_v02_home_03"}], gridNav_auto_v02_home_04: {"items":[{"icon":"/uploads/stock/auto_1.jpg","iconSrc":"","navUrl":"","text":"保养"},{"icon":"/uploads/stock/auto_2.jpg","iconSrc":"","navUrl":"","text":"维修"},{"icon":"/uploads/stock/auto_3.jpg","iconSrc":"","navUrl":"","text":"洗车"},{"icon":"/uploads/stock/auto_4.jpg","iconSrc":"","navUrl":"","text":"美容"},{"icon":"/uploads/stock/auto_5.jpg","iconSrc":"","navUrl":"","text":"轮胎"},{"icon":"/uploads/stock/auto_6.jpg","iconSrc":"","navUrl":"","text":"机油"},{"icon":"/uploads/stock/auto_55.jpg","iconSrc":"","navUrl":"","text":"配件"},{"icon":"/uploads/stock/auto_56.jpg","iconSrc":"","navUrl":"","text":"保险"},{"icon":"/uploads/stock/auto_57.jpg","iconSrc":"","navUrl":"","text":"年检"},{"icon":"/uploads/stock/auto_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_auto_v02_home_06();
    await this._mpLoadProducts_products_auto_v02_home_07()
  },
  async _mpLoadProducts_products_auto_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("auto_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_auto_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_auto_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "auto_v02_home_06", e); }
  },

  async _mpLoadProducts_products_auto_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("auto_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_auto_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_auto_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "auto_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_auto_v02_home_02()
  },
  async _mpLoadSwiper_swiper_auto_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("auto_v02_home_02"));
      ...
      var cur = this.data.swiper_auto_v02_home_02 || {};
      this.setData({
        swiper_auto_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "auto_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_auto_v02_home_03()
  },
  async _mpLoadNotice_notice_auto_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("auto_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_auto_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "auto_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_auto_v02_home_06, 'image'); if (list.length) this.setData({ products_auto_v02_home_06: list }); }
    { var list = withSrc(this.data.products_auto_v02_home_07, 'image'); if (list.length) this.setData({ products_auto_v02_home_07: list }); }
    { var wgt = this.data.swiper_auto_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_auto_v02_home_02: next }); } }
  },
onShow() {
