...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_auto_v01_home_11: [{"id":1,"image":"/uploads/stock/auto_10.jpg","imageSrc":"","name":"小保养套餐","price":99},{"id":2,"image":"/uploads/stock/auto_11.jpg","imageSrc":"","name":"大保养套餐","price":298},{"id":3,"image":"/uploads/stock/auto_12.jpg","imageSrc":"","name":"机油更换","price":497}], products_auto_v01_home_13: [{"id":7,"image":"/uploads/stock/auto_16.jpg","imageSrc":"","name":"发动机维修","price":99},{"id":8,"image":"/uploads/stock/auto_17.jpg","imageSrc":"","name":"变速箱养护","price":298},{"id":9,"image":"/uploads/stock/auto_18.jpg","imageSrc":"","name":"电路检测","price":497},{"id":10,"image":"/uploads/stock/auto_19.jpg","imageSrc":"","name":"钣金喷漆","price":696},{"id":11,"image":"/uploads/stock/auto_20.jpg","imageSrc":"","name":"玻璃修复","price":895},{"id":12,"image":"/uploads/stock/auto_21.jpg","imageSrc":"","name":"拖车服务","price":1094}], productWidgets: [{"key":"products_auto_v01_home_11","cid":"auto_v01_home_11","limit":3},{"key":"products_auto_v01_home_13","cid":"auto_v01_home_13","limit":6}], swiper_auto_v01_home_03: { height: 320, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/auto_7.jpg","imageSrc":"","link":"","title":"汽车服务"},{"image":"/uploads/stock/auto_8.jpg","imageSrc":"","link":"","title":"保养套餐"},{"image":"/uploads/stock/auto_9.jpg","imageSrc":"","link":"","title":"洗车优惠"}] }, swiperWidgets: [{"key":"swiper_auto_v01_home_03","cid":"auto_v01_home_03","height":320,"interval":3000}], notice_auto_v01_home_04: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购汽车服务好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_auto_v01_home_04","cid":"auto_v01_home_04"}], gridNav_auto_v01_home_02: {"items":[{"icon":"/uploads/stock/auto_1.jpg","iconSrc":"","navUrl":"","text":"再买一单"},{"icon":"/uploads/stock/auto_2.jpg","iconSrc":"","navUrl":"","text":"会员中心"},{"icon":"/uploads/stock/auto_3.jpg","iconSrc":"","navUrl":"","text":"优惠券"},{"icon":"/uploads/stock/auto_4.jpg","iconSrc":"","navUrl":"","text":"我的订单"}]}, gridNav_auto_v01_home_05: {"items":[{"icon":"/uploads/stock/auto_1.jpg","iconSrc":"","navUrl":"","text":"极速达"},{"icon":"/uploads/stock/auto_2.jpg","iconSrc":"","navUrl":"","text":"品质保障"},{"icon":"/uploads/stock/auto_3.jpg","iconSrc":"","navUrl":"","text":"售后无忧"}]}, gridNav_auto_v01_home_06: {"items":[{"icon":"/uploads/stock/auto_1.jpg","iconSrc":"","navUrl":"","text":"保养"},{"icon":"/uploads/stock/auto_2.jpg","iconSrc":"","navUrl":"","text":"维修"},{"icon":"/uploads/stock/auto_3.jpg","iconSrc":"","navUrl":"","text":"洗车"},{"icon":"/uploads/stock/auto_4.jpg","iconSrc":"","navUrl":"","text":"美容"},{"icon":"/uploads/stock/auto_5.jpg","iconSrc":"","navUrl":"","text":"轮胎"},{"icon":"/uploads/stock/auto_6.jpg","iconSrc":"","navUrl":"","text":"机油"},{"icon":"/uploads/stock/auto_55.jpg","iconSrc":"","navUrl":"","text":"配件"},{"icon":"/uploads/stock/auto_56.jpg","iconSrc":"","navUrl":"","text":"保险"},{"icon":"/uploads/stock/auto_57.jpg","iconSrc":"","navUrl":"","text":"年检"},{"icon":"/uploads/stock/auto_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]}, promoPair_auto_v01_home_07: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/auto_40.jpg","imageSrc":"","navUrl":"","title":"保养套餐"},{"bgColor":"#fff3e0","image":"/uploads/stock/auto_41.jpg","imageSrc":"","navUrl":"","title":"洗车优惠"}]}, promoPair_auto_v01_home_08: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/auto_42.jpg","imageSrc":"","navUrl":"","title":"会员特权"},{"bgColor":"#fff3e0","image":"/uploads/stock/auto_43.jpg","imageSrc":"","navUrl":"","title":"限时特惠"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_auto_v01_home_11();
    await this._mpLoadProducts_products_auto_v01_home_13()
  },
  async _mpLoadProducts_products_auto_v01_home_11() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("auto_v01_home_11");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_auto_v01_home_11 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_auto_v01_home_11: list });
    } catch (e) { this.mpDevWarn('product', "auto_v01_home_11", e); }
  },

  async _mpLoadProducts_products_auto_v01_home_13() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("auto_v01_home_13");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_auto_v01_home_13 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_auto_v01_home_13: list });
    } catch (e) { this.mpDevWarn('product', "auto_v01_home_13", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_auto_v01_home_03()
  },
  async _mpLoadSwiper_swiper_auto_v01_home_03() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("auto_v01_home_03"));
      ...
      var cur = this.data.swiper_auto_v01_home_03 || {};
      this.setData({
        swiper_auto_v01_home_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "auto_v01_home_03", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_auto_v01_home_04()
  },
  async _mpLoadNotice_notice_auto_v01_home_04() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("auto_v01_home_04"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_auto_v01_home_04: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "auto_v01_home_04", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_auto_v01_home_11, 'image'); if (list.length) this.setData({ products_auto_v01_home_11: list }); }
    { var list = withSrc(this.data.products_auto_v01_home_13, 'image'); if (list.length) this.setData({ products_auto_v01_home_13: list }); }
    { var wgt = this.data.swiper_auto_v01_home_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_auto_v01_home_03: next }); } }
  },
onShow() {
