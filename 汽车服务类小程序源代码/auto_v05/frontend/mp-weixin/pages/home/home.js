...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_auto_v05_home_04: [{"id":1,"image":"/uploads/stock/auto_10.jpg","imageSrc":"","name":"小保养套餐","price":99},{"id":2,"image":"/uploads/stock/auto_11.jpg","imageSrc":"","name":"大保养套餐","price":298},{"id":3,"image":"/uploads/stock/auto_12.jpg","imageSrc":"","name":"机油更换","price":497},{"id":4,"image":"/uploads/stock/auto_13.jpg","imageSrc":"","name":"机滤更换","price":696},{"id":5,"image":"/uploads/stock/auto_14.jpg","imageSrc":"","name":"空调滤芯","price":895},{"id":6,"image":"/uploads/stock/auto_15.jpg","imageSrc":"","name":"刹车片","price":1094},{"id":7,"image":"/uploads/stock/auto_16.jpg","imageSrc":"","name":"发动机维修","price":99},{"id":8,"image":"/uploads/stock/auto_17.jpg","imageSrc":"","name":"变速箱养护","price":298}], products_auto_v05_home_06: [{"id":9,"image":"/uploads/stock/auto_18.jpg","imageSrc":"","name":"电路检测","price":497},{"id":10,"image":"/uploads/stock/auto_19.jpg","imageSrc":"","name":"钣金喷漆","price":696},{"id":11,"image":"/uploads/stock/auto_20.jpg","imageSrc":"","name":"玻璃修复","price":895},{"id":12,"image":"/uploads/stock/auto_21.jpg","imageSrc":"","name":"拖车服务","price":1094}], productWidgets: [{"key":"products_auto_v05_home_04","cid":"auto_v05_home_04","limit":8},{"key":"products_auto_v05_home_06","cid":"auto_v05_home_06","limit":4}], swiper_auto_v05_home_02: { height: 360, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/auto_49.jpg","imageSrc":"","link":"","title":"汽车服务"}] }, swiperWidgets: [{"key":"swiper_auto_v05_home_02","cid":"auto_v05_home_02","height":360,"interval":3000}], notice_auto_v05_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购汽车服务好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_auto_v05_home_03","cid":"auto_v05_home_03"}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_auto_v05_home_04();
    await this._mpLoadProducts_products_auto_v05_home_06()
  },
  async _mpLoadProducts_products_auto_v05_home_04() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("auto_v05_home_04");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_auto_v05_home_04 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_auto_v05_home_04: list });
    } catch (e) { this.mpDevWarn('product', "auto_v05_home_04", e); }
  },

  async _mpLoadProducts_products_auto_v05_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("auto_v05_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_auto_v05_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_auto_v05_home_06: list });
    } catch (e) { this.mpDevWarn('product', "auto_v05_home_06", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_auto_v05_home_02()
  },
  async _mpLoadSwiper_swiper_auto_v05_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("auto_v05_home_02"));
      ...
      var cur = this.data.swiper_auto_v05_home_02 || {};
      this.setData({
        swiper_auto_v05_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "auto_v05_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_auto_v05_home_03()
  },
  async _mpLoadNotice_notice_auto_v05_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("auto_v05_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_auto_v05_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "auto_v05_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_auto_v05_home_04, 'image'); if (list.length) this.setData({ products_auto_v05_home_04: list }); }
    { var list = withSrc(this.data.products_auto_v05_home_06, 'image'); if (list.length) this.setData({ products_auto_v05_home_06: list }); }
    { var wgt = this.data.swiper_auto_v05_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_auto_v05_home_02: next }); } }
  },
onShow() {
