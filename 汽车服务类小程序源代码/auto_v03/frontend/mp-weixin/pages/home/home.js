...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_auto_v03_home_08: [{"id":1,"image":"/uploads/stock/auto_10.jpg","imageSrc":"","name":"小保养套餐","price":99},{"id":2,"image":"/uploads/stock/auto_11.jpg","imageSrc":"","name":"大保养套餐","price":298},{"id":3,"image":"/uploads/stock/auto_12.jpg","imageSrc":"","name":"机油更换","price":497},{"id":4,"image":"/uploads/stock/auto_13.jpg","imageSrc":"","name":"机滤更换","price":696},{"id":5,"image":"/uploads/stock/auto_14.jpg","imageSrc":"","name":"空调滤芯","price":895},{"id":6,"image":"/uploads/stock/auto_15.jpg","imageSrc":"","name":"刹车片","price":1094}], productWidgets: [{"key":"products_auto_v03_home_08","cid":"auto_v03_home_08","limit":6}], swiper_auto_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/auto_9.jpg","imageSrc":"","link":"","title":"汽车服务"},{"image":"/uploads/stock/auto_48.jpg","imageSrc":"","link":"","title":"保养套餐"},{"image":"/uploads/stock/auto_49.jpg","imageSrc":"","link":"","title":"洗车优惠"}] }, swiperWidgets: [{"key":"swiper_auto_v03_home_02","cid":"auto_v03_home_02","height":340,"interval":3000}], promoPair_auto_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/auto_42.jpg","imageSrc":"","navUrl":"","title":"保养套餐"},{"bgColor":"#fff3e0","image":"/uploads/stock/auto_43.jpg","imageSrc":"","navUrl":"","title":"洗车优惠"}]}, promoPair_auto_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/auto_44.jpg","imageSrc":"","navUrl":"","title":"会员特权"},{"bgColor":"#fff3e0","image":"/uploads/stock/auto_45.jpg","imageSrc":"","navUrl":"","title":"限时特惠"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_auto_v03_home_08()
  },
  async _mpLoadProducts_products_auto_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("auto_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_auto_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_auto_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "auto_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_auto_v03_home_02()
  },
  async _mpLoadSwiper_swiper_auto_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("auto_v03_home_02"));
      ...
      var cur = this.data.swiper_auto_v03_home_02 || {};
      this.setData({
        swiper_auto_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "auto_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_auto_v03_home_08, 'image'); if (list.length) this.setData({ products_auto_v03_home_08: list }); }
    { var wgt = this.data.swiper_auto_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_auto_v03_home_02: next }); } }
  },
onShow() {
