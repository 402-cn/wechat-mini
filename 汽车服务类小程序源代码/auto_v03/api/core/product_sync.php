...
function demo_product_catalog(): array {
    return [
        [1, 1, '小保养套餐', './assets/images/auto_10.jpg', 99.00],
        [2, 1, '大保养套餐', './assets/images/auto_11.jpg', 298.00],
        [3, 1, '机油更换', './assets/images/auto_12.jpg', 497.00],
        [4, 1, '机滤更换', './assets/images/auto_13.jpg', 696.00],
        [5, 1, '空调滤芯', './assets/images/auto_14.jpg', 895.00],
        [6, 1, '刹车片', './assets/images/auto_15.jpg', 1094.00],
        [7, 2, '发动机维修', './assets/images/auto_16.jpg', 99.00],
        [8, 2, '变速箱养护', './assets/images/auto_17.jpg', 298.00],
        [9, 2, '电路检测', './assets/images/auto_18.jpg', 497.00],
        [10, 2, '钣金喷漆', './assets/images/auto_19.jpg', 696.00],
        [11, 2, '玻璃修复', './assets/images/auto_20.jpg', 895.00],
        [12, 2, '拖车服务', './assets/images/auto_21.jpg', 1094.00],
        [13, 3, '精洗打蜡', './assets/images/auto_22.jpg', 99.00],
        [14, 3, '内饰清洗', './assets/images/auto_23.jpg', 298.00],
        [15, 3, '镀晶', './assets/images/auto_24.jpg', 497.00],
        [16, 3, '贴膜', './assets/images/auto_25.jpg', 696.00],
        [17, 3, '抛光', './assets/images/auto_26.jpg', 895.00],
        [18, 3, '消毒除味', './assets/images/auto_27.jpg', 1094.00],
        [19, 4, '轮胎更换', './assets/images/auto_28.jpg', 99.00],
        [20, 4, '四轮定位', './assets/images/auto_29.jpg', 298.00],
        [21, 4, '动平衡', './assets/images/auto_30.jpg', 497.00],
        [22, 4, '补胎', './assets/images/auto_31.jpg', 696.00],
        [23, 4, '雪地胎', './assets/images/auto_32.jpg', 895.00],
        [24, 4, '轮毂', './assets/images/auto_33.jpg', 1094.00],
        [25, 5, '行车记录仪', './assets/images/auto_34.jpg', 99.00],
        [26, 5, '车载充电器', './assets/images/auto_35.jpg', 298.00],
        [27, 5, '脚垫', './assets/images/auto_36.jpg', 497.00],
        [28, 5, '后备箱垫', './assets/images/auto_37.jpg', 696.00],
        [29, 5, '雨刮器', './assets/images/auto_38.jpg', 895.00],
        [30, 5, '灯泡', './assets/images/auto_39.jpg', 1094.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'保养',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'维修',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'美容',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'轮胎',4,1)");
