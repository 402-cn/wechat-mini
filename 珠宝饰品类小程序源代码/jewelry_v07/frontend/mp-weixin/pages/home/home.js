...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, articles_jewelry_v07_home_06: [{"cover":"/uploads/stock/corporate_7.jpg","coverSrc":"","created_at":"2026-01-01","id":"demo_1","summary":"部署后可在后台编辑","title":"欢迎来到集团官网"},{"cover":"/uploads/stock/corporate_8.jpg","coverSrc":"","created_at":"2026-01-02","id":"demo_2","summary":"演示文章仅供参考","title":"集团官网新品发布"},{"cover":"/uploads/stock/corporate_9.jpg","coverSrc":"","created_at":"2026-01-03","id":"demo_3","summary":"演示数据","title":"会员权益说明"},{"cover":"/uploads/stock/corporate_48.jpg","coverSrc":"","created_at":"2026-01-04","id":"demo_4","summary":"演示数据","title":"服务与配送说明"}], articleWidgets: [{"key":"articles_jewelry_v07_home_06","cid":"jewelry_v07_home_06","limit":4}], gridNav_jewelry_v07_home_04: {"items":[{"icon":"/uploads/stock/jewelry_1.jpg","iconSrc":"","navUrl":"/packageSys/pages/search-article/search-article","text":"公司概况"},{"icon":"/uploads/stock/jewelry_2.jpg","iconSrc":"","navUrl":"switchTab:/pages/category/category","text":"产品中心"},{"icon":"/uploads/stock/jewelry_3.jpg","iconSrc":"","navUrl":"/packageSys/pages/search-article/search-article","text":"新闻资讯"},{"icon":"/uploads/stock/jewelry_4.jpg","iconSrc":"","navUrl":"/packageSub/pages/contact/contact","text":"联系我们"}]} },
  onLoad(q) {
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.articles_jewelry_v07_home_06, 'cover'); if (list.length) this.setData({ articles_jewelry_v07_home_06: list }); }
  },
goArticle(e) {
...
async loadArticles() {
    ...
    try {
      await this._mpLoadArticles_articles_jewelry_v07_home_06()
    } finally {
      this._articleLoading = false;
    }
  },
  async _mpLoadArticles_articles_jewelry_v07_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/article/list.php?limit=4&component_id=' + encodeURIComponent("jewelry_v07_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.articles_jewelry_v07_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ articles_jewelry_v07_home_06: list });
    } catch (e) {
      this.mpDevWarn('article', "jewelry_v07_home_06", e);
      var cur = this.data.articles_jewelry_v07_home_06;
      if (cur && cur.length) {
        try {
          ...
          this.setData({ articles_jewelry_v07_home_06: patched });
        } catch (e2) {}
      }
    }
  },
