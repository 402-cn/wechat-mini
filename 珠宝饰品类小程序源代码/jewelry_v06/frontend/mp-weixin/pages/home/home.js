...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_jewelry_v06_home_05: [{"id":7,"image":"/uploads/stock/jewelry_16.jpg","imageSrc":"","name":"钻戒","price":299},{"id":8,"image":"/uploads/stock/jewelry_17.jpg","imageSrc":"","name":"对戒","price":898},{"id":9,"image":"/uploads/stock/jewelry_18.jpg","imageSrc":"","name":"素圈戒指","price":1497},{"id":10,"image":"/uploads/stock/jewelry_19.jpg","imageSrc":"","name":"排戒","price":2096}], productWidgets: [{"key":"products_jewelry_v06_home_05","cid":"jewelry_v06_home_05","limit":4}], swiper_jewelry_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/jewelry_50.jpg","imageSrc":"","link":"","title":"珠宝饰品"},{"image":"/uploads/stock/jewelry_51.jpg","imageSrc":"","link":"","title":"新品上市"},{"image":"/uploads/stock/jewelry_52.jpg","imageSrc":"","link":"","title":"节日礼盒"}] }, swiperWidgets: [{"key":"swiper_jewelry_v06_home_02","cid":"jewelry_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_jewelry_v06_home_05()
  },
  async _mpLoadProducts_products_jewelry_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("jewelry_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_jewelry_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_jewelry_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "jewelry_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_jewelry_v06_home_02()
  },
  async _mpLoadSwiper_swiper_jewelry_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("jewelry_v06_home_02"));
      ...
      var cur = this.data.swiper_jewelry_v06_home_02 || {};
      this.setData({
        swiper_jewelry_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "jewelry_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_jewelry_v06_home_05, 'image'); if (list.length) this.setData({ products_jewelry_v06_home_05: list }); }
    { var wgt = this.data.swiper_jewelry_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_jewelry_v06_home_02: next }); } }
  },
onShow() {
