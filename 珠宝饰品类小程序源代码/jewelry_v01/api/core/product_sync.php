...
function demo_product_catalog(): array {
    return [
        [1, 1, '钻石项链', './assets/images/jewelry_10.jpg', 299.00],
        [2, 1, '珍珠项链', './assets/images/jewelry_11.jpg', 898.00],
        [3, 1, '锁骨链', './assets/images/jewelry_12.jpg', 1497.00],
        [4, 1, '吊坠项链', './assets/images/jewelry_13.jpg', 2096.00],
        [5, 1, '毛衣链', './assets/images/jewelry_14.jpg', 2695.00],
        [6, 1, '情侣项链', './assets/images/jewelry_15.jpg', 3294.00],
        [7, 2, '钻戒', './assets/images/jewelry_16.jpg', 299.00],
        [8, 2, '对戒', './assets/images/jewelry_17.jpg', 898.00],
        [9, 2, '素圈戒指', './assets/images/jewelry_18.jpg', 1497.00],
        [10, 2, '排戒', './assets/images/jewelry_19.jpg', 2096.00],
        [11, 2, '开口戒指', './assets/images/jewelry_20.jpg', 2695.00],
        [12, 2, '尾戒', './assets/images/jewelry_21.jpg', 3294.00],
        [13, 3, '珍珠耳环', './assets/images/jewelry_22.jpg', 299.00],
        [14, 3, '钻石耳钉', './assets/images/jewelry_23.jpg', 898.00],
        [15, 3, '耳线', './assets/images/jewelry_24.jpg', 1497.00],
        [16, 3, '耳夹', './assets/images/jewelry_25.jpg', 2096.00],
        [17, 3, '流苏耳环', './assets/images/jewelry_26.jpg', 2695.00],
        [18, 3, '耳圈', './assets/images/jewelry_27.jpg', 3294.00],
        [19, 4, '黄金手链', './assets/images/jewelry_28.jpg', 299.00],
        [20, 4, '银手链', './assets/images/jewelry_29.jpg', 898.00],
        [21, 4, '串珠手链', './assets/images/jewelry_30.jpg', 1497.00],
        [22, 4, '转运珠', './assets/images/jewelry_31.jpg', 2096.00],
        [23, 4, '手镯', './assets/images/jewelry_32.jpg', 2695.00],
        [24, 4, '脚链', './assets/images/jewelry_33.jpg', 3294.00],
        [25, 5, '机械表', './assets/images/jewelry_34.jpg', 299.00],
        [26, 5, '石英表', './assets/images/jewelry_35.jpg', 898.00],
        [27, 5, '智能手表', './assets/images/jewelry_36.jpg', 1497.00],
        [28, 5, '情侣表', './assets/images/jewelry_37.jpg', 2096.00],
        [29, 5, '儿童表', './assets/images/jewelry_38.jpg', 2695.00],
        [30, 5, '复古表', './assets/images/jewelry_39.jpg', 3294.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'项链',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'戒指',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'耳环',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'手链',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'手表',5,1)");
