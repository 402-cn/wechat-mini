...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_jewelry_v01_home_11: [{"id":1,"image":"/uploads/stock/jewelry_10.jpg","imageSrc":"","name":"钻石项链","price":299},{"id":2,"image":"/uploads/stock/jewelry_11.jpg","imageSrc":"","name":"珍珠项链","price":898},{"id":3,"image":"/uploads/stock/jewelry_12.jpg","imageSrc":"","name":"锁骨链","price":1497}], products_jewelry_v01_home_13: [{"id":7,"image":"/uploads/stock/jewelry_16.jpg","imageSrc":"","name":"钻戒","price":299},{"id":8,"image":"/uploads/stock/jewelry_17.jpg","imageSrc":"","name":"对戒","price":898},{"id":9,"image":"/uploads/stock/jewelry_18.jpg","imageSrc":"","name":"素圈戒指","price":1497},{"id":10,"image":"/uploads/stock/jewelry_19.jpg","imageSrc":"","name":"排戒","price":2096},{"id":11,"image":"/uploads/stock/jewelry_20.jpg","imageSrc":"","name":"开口戒指","price":2695},{"id":12,"image":"/uploads/stock/jewelry_21.jpg","imageSrc":"","name":"尾戒","price":3294}], productWidgets: [{"key":"products_jewelry_v01_home_11","cid":"jewelry_v01_home_11","limit":3},{"key":"products_jewelry_v01_home_13","cid":"jewelry_v01_home_13","limit":6}], swiper_jewelry_v01_home_03: { height: 320, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/jewelry_7.jpg","imageSrc":"","link":"","title":"珠宝饰品"},{"image":"/uploads/stock/jewelry_8.jpg","imageSrc":"","link":"","title":"新品上市"},{"image":"/uploads/stock/jewelry_9.jpg","imageSrc":"","link":"","title":"节日礼盒"}] }, swiperWidgets: [{"key":"swiper_jewelry_v01_home_03","cid":"jewelry_v01_home_03","height":320,"interval":3000}], notice_jewelry_v01_home_04: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购珠宝饰品好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_jewelry_v01_home_04","cid":"jewelry_v01_home_04"}], gridNav_jewelry_v01_home_02: {"items":[{"icon":"/uploads/stock/jewelry_1.jpg","iconSrc":"","navUrl":"","text":"再买一单"},{"icon":"/uploads/stock/jewelry_2.jpg","iconSrc":"","navUrl":"","text":"会员中心"},{"icon":"/uploads/stock/jewelry_3.jpg","iconSrc":"","navUrl":"","text":"优惠券"},{"icon":"/uploads/stock/jewelry_4.jpg","iconSrc":"","navUrl":"","text":"我的订单"}]}, gridNav_jewelry_v01_home_05: {"items":[{"icon":"/uploads/stock/jewelry_1.jpg","iconSrc":"","navUrl":"","text":"极速达"},{"icon":"/uploads/stock/jewelry_2.jpg","iconSrc":"","navUrl":"","text":"品质保障"},{"icon":"/uploads/stock/jewelry_3.jpg","iconSrc":"","navUrl":"","text":"售后无忧"}]}, gridNav_jewelry_v01_home_06: {"items":[{"icon":"/uploads/stock/jewelry_1.jpg","iconSrc":"","navUrl":"","text":"项链"},{"icon":"/uploads/stock/jewelry_2.jpg","iconSrc":"","navUrl":"","text":"戒指"},{"icon":"/uploads/stock/jewelry_3.jpg","iconSrc":"","navUrl":"","text":"耳环"},{"icon":"/uploads/stock/jewelry_4.jpg","iconSrc":"","navUrl":"","text":"手链"},{"icon":"/uploads/stock/jewelry_5.jpg","iconSrc":"","navUrl":"","text":"手表"},{"icon":"/uploads/stock/jewelry_6.jpg","iconSrc":"","navUrl":"","text":"黄金"},{"icon":"/uploads/stock/jewelry_55.jpg","iconSrc":"","navUrl":"","text":"钻石"},{"icon":"/uploads/stock/jewelry_56.jpg","iconSrc":"","navUrl":"","text":"翡翠"},{"icon":"/uploads/stock/jewelry_57.jpg","iconSrc":"","navUrl":"","text":"定制"},{"icon":"/uploads/stock/jewelry_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]}, promoPair_jewelry_v01_home_07: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/jewelry_40.jpg","imageSrc":"","navUrl":"","title":"新品上市"},{"bgColor":"#fff3e0","image":"/uploads/stock/jewelry_41.jpg","imageSrc":"","navUrl":"","title":"节日礼盒"}]}, promoPair_jewelry_v01_home_08: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/jewelry_42.jpg","imageSrc":"","navUrl":"","title":"会员尊享"},{"bgColor":"#fff3e0","image":"/uploads/stock/jewelry_43.jpg","imageSrc":"","navUrl":"","title":"限时特惠"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_jewelry_v01_home_11();
    await this._mpLoadProducts_products_jewelry_v01_home_13()
  },
  async _mpLoadProducts_products_jewelry_v01_home_11() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("jewelry_v01_home_11");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_jewelry_v01_home_11 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_jewelry_v01_home_11: list });
    } catch (e) { this.mpDevWarn('product', "jewelry_v01_home_11", e); }
  },

  async _mpLoadProducts_products_jewelry_v01_home_13() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("jewelry_v01_home_13");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_jewelry_v01_home_13 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_jewelry_v01_home_13: list });
    } catch (e) { this.mpDevWarn('product', "jewelry_v01_home_13", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_jewelry_v01_home_03()
  },
  async _mpLoadSwiper_swiper_jewelry_v01_home_03() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("jewelry_v01_home_03"));
      ...
      var cur = this.data.swiper_jewelry_v01_home_03 || {};
      this.setData({
        swiper_jewelry_v01_home_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "jewelry_v01_home_03", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_jewelry_v01_home_04()
  },
  async _mpLoadNotice_notice_jewelry_v01_home_04() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("jewelry_v01_home_04"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_jewelry_v01_home_04: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "jewelry_v01_home_04", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_jewelry_v01_home_11, 'image'); if (list.length) this.setData({ products_jewelry_v01_home_11: list }); }
    { var list = withSrc(this.data.products_jewelry_v01_home_13, 'image'); if (list.length) this.setData({ products_jewelry_v01_home_13: list }); }
    { var wgt = this.data.swiper_jewelry_v01_home_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_jewelry_v01_home_03: next }); } }
  },
onShow() {
