...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, notice_jewelry_v05_coupon_02: {"bgColor":"#fff5f5","content":"新用户可领取专享优惠券，下单更优惠！","duration":"4.89s","fontSize":26,"prefixTitle":"","scrollDirection":"left","scrollSpeed":45,"showIcon":true,"textColor":"#e74c3c","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_jewelry_v05_coupon_02","cid":"jewelry_v05_coupon_02"}], promoPair_jewelry_v05_coupon_03: {"items":[{"bgColor":"#ffe0e0","image":"/uploads/stock/jewelry_40.jpg","imageSrc":"","navUrl":"","title":"满100减20"},{"bgColor":"#e8f8f0","image":"/uploads/stock/jewelry_41.jpg","imageSrc":"","navUrl":"","title":"新人立减"}]}, promoPair_jewelry_v05_coupon_04: {"items":[{"bgColor":"#f3e8ff","image":"/uploads/stock/jewelry_42.jpg","imageSrc":"","navUrl":"","title":"会员券"},{"bgColor":"#fff8e1","image":"/uploads/stock/jewelry_43.jpg","imageSrc":"","navUrl":"","title":"品类券"}]}, showMpTabBar: true, mpActiveTab: '', mpTabPrimary: "#2c3e50", mpTabItems: [{"icon":"/assets/tab/home.png","iconActive":"/assets/tab/home_active.png","page_key":"home","text":"首页"},{"icon":"/assets/tab/category.png","iconActive":"/assets/tab/category_active.png","page_key":"category","text":"分类"},{"icon":"/assets/tab/cart.png","iconActive":"/assets/tab/cart_active.png","page_key":"cart","text":"购物车"},{"icon":"/assets/tab/mine.png","iconActive":"/assets/tab/mine_active.png","page_key":"mine","text":"我的"}] },
  onLoad(q) {
...
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_jewelry_v05_coupon_02()
  },
  async _mpLoadNotice_notice_jewelry_v05_coupon_02() {
    const { req } = require('../../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("jewelry_v05_coupon_02"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_jewelry_v05_coupon_02: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "jewelry_v05_coupon_02", e); }
  },
