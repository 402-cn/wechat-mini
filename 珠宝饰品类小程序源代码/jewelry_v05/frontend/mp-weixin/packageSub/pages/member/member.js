...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, gridNav_jewelry_v05_member_03: {"items":[{"icon":"/uploads/stock/jewelry_1.jpg","iconSrc":"","navUrl":"","text":"会员折扣"},{"icon":"/uploads/stock/jewelry_2.jpg","iconSrc":"","navUrl":"","text":"积分翻倍"},{"icon":"/uploads/stock/jewelry_3.jpg","iconSrc":"","navUrl":"","text":"专属客服"}]}, showMpTabBar: true, mpActiveTab: '', mpTabPrimary: "#2c3e50", mpTabItems: [{"icon":"/assets/tab/home.png","iconActive":"/assets/tab/home_active.png","page_key":"home","text":"首页"},{"icon":"/assets/tab/category.png","iconActive":"/assets/tab/category_active.png","page_key":"category","text":"分类"},{"icon":"/assets/tab/cart.png","iconActive":"/assets/tab/cart_active.png","page_key":"cart","text":"购物车"},{"icon":"/assets/tab/mine.png","iconActive":"/assets/tab/mine_active.png","page_key":"mine","text":"我的"}] },
  onLoad(q) {
