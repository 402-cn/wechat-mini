...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_jewelry_v03_home_08: [{"id":1,"image":"/uploads/stock/jewelry_10.jpg","imageSrc":"","name":"钻石项链","price":299},{"id":2,"image":"/uploads/stock/jewelry_11.jpg","imageSrc":"","name":"珍珠项链","price":898},{"id":3,"image":"/uploads/stock/jewelry_12.jpg","imageSrc":"","name":"锁骨链","price":1497},{"id":4,"image":"/uploads/stock/jewelry_13.jpg","imageSrc":"","name":"吊坠项链","price":2096},{"id":5,"image":"/uploads/stock/jewelry_14.jpg","imageSrc":"","name":"毛衣链","price":2695},{"id":6,"image":"/uploads/stock/jewelry_15.jpg","imageSrc":"","name":"情侣项链","price":3294}], productWidgets: [{"key":"products_jewelry_v03_home_08","cid":"jewelry_v03_home_08","limit":6}], swiper_jewelry_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/jewelry_9.jpg","imageSrc":"","link":"","title":"珠宝饰品"},{"image":"/uploads/stock/jewelry_48.jpg","imageSrc":"","link":"","title":"新品上市"},{"image":"/uploads/stock/jewelry_49.jpg","imageSrc":"","link":"","title":"节日礼盒"}] }, swiperWidgets: [{"key":"swiper_jewelry_v03_home_02","cid":"jewelry_v03_home_02","height":340,"interval":3000}], promoPair_jewelry_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/jewelry_42.jpg","imageSrc":"","navUrl":"","title":"新品上市"},{"bgColor":"#fff3e0","image":"/uploads/stock/jewelry_43.jpg","imageSrc":"","navUrl":"","title":"节日礼盒"}]}, promoPair_jewelry_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/jewelry_44.jpg","imageSrc":"","navUrl":"","title":"会员尊享"},{"bgColor":"#fff3e0","image":"/uploads/stock/jewelry_45.jpg","imageSrc":"","navUrl":"","title":"限时特惠"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_jewelry_v03_home_08()
  },
  async _mpLoadProducts_products_jewelry_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("jewelry_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_jewelry_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_jewelry_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "jewelry_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_jewelry_v03_home_02()
  },
  async _mpLoadSwiper_swiper_jewelry_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("jewelry_v03_home_02"));
      ...
      var cur = this.data.swiper_jewelry_v03_home_02 || {};
      this.setData({
        swiper_jewelry_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "jewelry_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_jewelry_v03_home_08, 'image'); if (list.length) this.setData({ products_jewelry_v03_home_08: list }); }
    { var wgt = this.data.swiper_jewelry_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_jewelry_v03_home_02: next }); } }
  },
onShow() {
