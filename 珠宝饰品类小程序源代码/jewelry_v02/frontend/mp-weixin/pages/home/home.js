...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_jewelry_v02_home_06: [{"id":1,"image":"/uploads/stock/jewelry_10.jpg","imageSrc":"","name":"钻石项链","price":299},{"id":2,"image":"/uploads/stock/jewelry_11.jpg","imageSrc":"","name":"珍珠项链","price":898},{"id":3,"image":"/uploads/stock/jewelry_12.jpg","imageSrc":"","name":"锁骨链","price":1497},{"id":4,"image":"/uploads/stock/jewelry_13.jpg","imageSrc":"","name":"吊坠项链","price":2096},{"id":5,"image":"/uploads/stock/jewelry_14.jpg","imageSrc":"","name":"毛衣链","price":2695},{"id":6,"image":"/uploads/stock/jewelry_15.jpg","imageSrc":"","name":"情侣项链","price":3294},{"id":7,"image":"/uploads/stock/jewelry_16.jpg","imageSrc":"","name":"钻戒","price":299},{"id":8,"image":"/uploads/stock/jewelry_17.jpg","imageSrc":"","name":"对戒","price":898}], products_jewelry_v02_home_07: [{"id":13,"image":"/uploads/stock/jewelry_22.jpg","imageSrc":"","name":"珍珠耳环","price":299},{"id":14,"image":"/uploads/stock/jewelry_23.jpg","imageSrc":"","name":"钻石耳钉","price":898},{"id":15,"image":"/uploads/stock/jewelry_24.jpg","imageSrc":"","name":"耳线","price":1497}], productWidgets: [{"key":"products_jewelry_v02_home_06","cid":"jewelry_v02_home_06","limit":8},{"key":"products_jewelry_v02_home_07","cid":"jewelry_v02_home_07","limit":3}], swiper_jewelry_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/jewelry_8.jpg","imageSrc":"","link":"","title":"珠宝饰品"},{"image":"/uploads/stock/jewelry_9.jpg","imageSrc":"","link":"","title":"新品上市"}] }, swiperWidgets: [{"key":"swiper_jewelry_v02_home_02","cid":"jewelry_v02_home_02","height":280,"interval":3000}], notice_jewelry_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购珠宝饰品好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_jewelry_v02_home_03","cid":"jewelry_v02_home_03"}], gridNav_jewelry_v02_home_04: {"items":[{"icon":"/uploads/stock/jewelry_1.jpg","iconSrc":"","navUrl":"","text":"项链"},{"icon":"/uploads/stock/jewelry_2.jpg","iconSrc":"","navUrl":"","text":"戒指"},{"icon":"/uploads/stock/jewelry_3.jpg","iconSrc":"","navUrl":"","text":"耳环"},{"icon":"/uploads/stock/jewelry_4.jpg","iconSrc":"","navUrl":"","text":"手链"},{"icon":"/uploads/stock/jewelry_5.jpg","iconSrc":"","navUrl":"","text":"手表"},{"icon":"/uploads/stock/jewelry_6.jpg","iconSrc":"","navUrl":"","text":"黄金"},{"icon":"/uploads/stock/jewelry_55.jpg","iconSrc":"","navUrl":"","text":"钻石"},{"icon":"/uploads/stock/jewelry_56.jpg","iconSrc":"","navUrl":"","text":"翡翠"},{"icon":"/uploads/stock/jewelry_57.jpg","iconSrc":"","navUrl":"","text":"定制"},{"icon":"/uploads/stock/jewelry_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_jewelry_v02_home_06();
    await this._mpLoadProducts_products_jewelry_v02_home_07()
  },
  async _mpLoadProducts_products_jewelry_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("jewelry_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_jewelry_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_jewelry_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "jewelry_v02_home_06", e); }
  },

  async _mpLoadProducts_products_jewelry_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("jewelry_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_jewelry_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_jewelry_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "jewelry_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_jewelry_v02_home_02()
  },
  async _mpLoadSwiper_swiper_jewelry_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("jewelry_v02_home_02"));
      ...
      var cur = this.data.swiper_jewelry_v02_home_02 || {};
      this.setData({
        swiper_jewelry_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "jewelry_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_jewelry_v02_home_03()
  },
  async _mpLoadNotice_notice_jewelry_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("jewelry_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_jewelry_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "jewelry_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_jewelry_v02_home_06, 'image'); if (list.length) this.setData({ products_jewelry_v02_home_06: list }); }
    { var list = withSrc(this.data.products_jewelry_v02_home_07, 'image'); if (list.length) this.setData({ products_jewelry_v02_home_07: list }); }
    { var wgt = this.data.swiper_jewelry_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_jewelry_v02_home_02: next }); } }
  },
onShow() {
