...
function demo_product_catalog(): array {
    return [
        [1, 1, '智能手机A', './assets/images/digital_10.jpg', 199.00],
        [2, 1, '智能手机B', './assets/images/digital_11.jpg', 498.00],
        [3, 1, '手机壳', './assets/images/digital_12.jpg', 797.00],
        [4, 1, '钢化膜', './assets/images/digital_13.jpg', 1096.00],
        [5, 1, '快充头', './assets/images/digital_14.jpg', 1395.00],
        [6, 1, '数据线', './assets/images/digital_15.jpg', 1694.00],
        [7, 2, '轻薄笔记本', './assets/images/digital_16.jpg', 199.00],
        [8, 2, '游戏本', './assets/images/digital_17.jpg', 498.00],
        [9, 2, '平板电脑', './assets/images/digital_18.jpg', 797.00],
        [10, 2, '机械键盘', './assets/images/digital_19.jpg', 1096.00],
        [11, 2, '无线鼠标', './assets/images/digital_20.jpg', 1395.00],
        [12, 2, '显示器', './assets/images/digital_21.jpg', 1694.00],
        [13, 3, '降噪耳机', './assets/images/digital_22.jpg', 199.00],
        [14, 3, '真无线耳机', './assets/images/digital_23.jpg', 498.00],
        [15, 3, '头戴耳机', './assets/images/digital_24.jpg', 797.00],
        [16, 3, '运动耳机', './assets/images/digital_25.jpg', 1096.00],
        [17, 3, '耳放', './assets/images/digital_26.jpg', 1395.00],
        [18, 3, '麦克风', './assets/images/digital_27.jpg', 1694.00],
        [19, 4, '移动硬盘', './assets/images/digital_28.jpg', 199.00],
        [20, 4, 'U盘', './assets/images/digital_29.jpg', 498.00],
        [21, 4, '路由器', './assets/images/digital_30.jpg', 797.00],
        [22, 4, '摄像头', './assets/images/digital_31.jpg', 1096.00],
        [23, 4, '扩展坞', './assets/images/digital_32.jpg', 1395.00],
        [24, 4, '支架', './assets/images/digital_33.jpg', 1694.00],
        [25, 5, '智能手表', './assets/images/digital_34.jpg', 199.00],
        [26, 5, '手环', './assets/images/digital_35.jpg', 498.00],
        [27, 5, '智能音箱', './assets/images/digital_36.jpg', 797.00],
        [28, 5, '扫地机器人', './assets/images/digital_37.jpg', 1096.00],
        [29, 5, '智能门锁', './assets/images/digital_38.jpg', 1395.00],
        [30, 5, '摄像头套装', './assets/images/digital_39.jpg', 1694.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'手机',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'电脑',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'耳机',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'配件',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'智能',5,1)");
