...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_digital_v03_home_08: [{"id":1,"image":"/uploads/stock/digital_10.jpg","imageSrc":"","name":"智能手机A","price":199},{"id":2,"image":"/uploads/stock/digital_11.jpg","imageSrc":"","name":"智能手机B","price":498},{"id":3,"image":"/uploads/stock/digital_12.jpg","imageSrc":"","name":"手机壳","price":797},{"id":4,"image":"/uploads/stock/digital_13.jpg","imageSrc":"","name":"钢化膜","price":1096},{"id":5,"image":"/uploads/stock/digital_14.jpg","imageSrc":"","name":"快充头","price":1395},{"id":6,"image":"/uploads/stock/digital_15.jpg","imageSrc":"","name":"数据线","price":1694}], productWidgets: [{"key":"products_digital_v03_home_08","cid":"digital_v03_home_08","limit":6}], swiper_digital_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/digital_9.jpg","imageSrc":"","link":"","title":"数码家电"},{"image":"/uploads/stock/digital_48.jpg","imageSrc":"","link":"","title":"爆款直降"},{"image":"/uploads/stock/digital_49.jpg","imageSrc":"","link":"","title":"以旧换新"}] }, swiperWidgets: [{"key":"swiper_digital_v03_home_02","cid":"digital_v03_home_02","height":340,"interval":3000}], promoPair_digital_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/digital_42.jpg","imageSrc":"","navUrl":"","title":"爆款直降"},{"bgColor":"#fff3e0","image":"/uploads/stock/digital_43.jpg","imageSrc":"","navUrl":"","title":"以旧换新"}]}, promoPair_digital_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/digital_44.jpg","imageSrc":"","navUrl":"","title":"分期免息"},{"bgColor":"#fff3e0","image":"/uploads/stock/digital_45.jpg","imageSrc":"","navUrl":"","title":"限时特惠"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_digital_v03_home_08()
  },
  async _mpLoadProducts_products_digital_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("digital_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_digital_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_digital_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "digital_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_digital_v03_home_02()
  },
  async _mpLoadSwiper_swiper_digital_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("digital_v03_home_02"));
      ...
      var cur = this.data.swiper_digital_v03_home_02 || {};
      this.setData({
        swiper_digital_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "digital_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_digital_v03_home_08, 'image'); if (list.length) this.setData({ products_digital_v03_home_08: list }); }
    { var wgt = this.data.swiper_digital_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_digital_v03_home_02: next }); } }
  },
onShow() {
