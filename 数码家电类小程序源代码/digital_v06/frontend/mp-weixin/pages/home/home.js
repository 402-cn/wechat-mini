...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_digital_v06_home_05: [{"id":7,"image":"/uploads/stock/digital_16.jpg","imageSrc":"","name":"轻薄笔记本","price":199},{"id":8,"image":"/uploads/stock/digital_17.jpg","imageSrc":"","name":"游戏本","price":498},{"id":9,"image":"/uploads/stock/digital_18.jpg","imageSrc":"","name":"平板电脑","price":797},{"id":10,"image":"/uploads/stock/digital_19.jpg","imageSrc":"","name":"机械键盘","price":1096}], productWidgets: [{"key":"products_digital_v06_home_05","cid":"digital_v06_home_05","limit":4}], swiper_digital_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/digital_50.jpg","imageSrc":"","link":"","title":"数码家电"},{"image":"/uploads/stock/digital_51.jpg","imageSrc":"","link":"","title":"爆款直降"},{"image":"/uploads/stock/digital_52.jpg","imageSrc":"","link":"","title":"以旧换新"}] }, swiperWidgets: [{"key":"swiper_digital_v06_home_02","cid":"digital_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_digital_v06_home_05()
  },
  async _mpLoadProducts_products_digital_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("digital_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_digital_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_digital_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "digital_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_digital_v06_home_02()
  },
  async _mpLoadSwiper_swiper_digital_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("digital_v06_home_02"));
      ...
      var cur = this.data.swiper_digital_v06_home_02 || {};
      this.setData({
        swiper_digital_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "digital_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_digital_v06_home_05, 'image'); if (list.length) this.setData({ products_digital_v06_home_05: list }); }
    { var wgt = this.data.swiper_digital_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_digital_v06_home_02: next }); } }
  },
onShow() {
