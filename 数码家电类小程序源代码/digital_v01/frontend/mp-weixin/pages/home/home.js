...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_digital_v01_home_11: [{"id":1,"image":"/uploads/stock/digital_10.jpg","imageSrc":"","name":"智能手机A","price":199},{"id":2,"image":"/uploads/stock/digital_11.jpg","imageSrc":"","name":"智能手机B","price":498},{"id":3,"image":"/uploads/stock/digital_12.jpg","imageSrc":"","name":"手机壳","price":797}], products_digital_v01_home_13: [{"id":7,"image":"/uploads/stock/digital_16.jpg","imageSrc":"","name":"轻薄笔记本","price":199},{"id":8,"image":"/uploads/stock/digital_17.jpg","imageSrc":"","name":"游戏本","price":498},{"id":9,"image":"/uploads/stock/digital_18.jpg","imageSrc":"","name":"平板电脑","price":797},{"id":10,"image":"/uploads/stock/digital_19.jpg","imageSrc":"","name":"机械键盘","price":1096},{"id":11,"image":"/uploads/stock/digital_20.jpg","imageSrc":"","name":"无线鼠标","price":1395},{"id":12,"image":"/uploads/stock/digital_21.jpg","imageSrc":"","name":"显示器","price":1694}], productWidgets: [{"key":"products_digital_v01_home_11","cid":"digital_v01_home_11","limit":3},{"key":"products_digital_v01_home_13","cid":"digital_v01_home_13","limit":6}], swiper_digital_v01_home_03: { height: 320, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/digital_7.jpg","imageSrc":"","link":"","title":"数码家电"},{"image":"/uploads/stock/digital_8.jpg","imageSrc":"","link":"","title":"爆款直降"},{"image":"/uploads/stock/digital_9.jpg","imageSrc":"","link":"","title":"以旧换新"}] }, swiperWidgets: [{"key":"swiper_digital_v01_home_03","cid":"digital_v01_home_03","height":320,"interval":3000}], notice_digital_v01_home_04: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购数码家电好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_digital_v01_home_04","cid":"digital_v01_home_04"}], gridNav_digital_v01_home_02: {"items":[{"icon":"/uploads/stock/digital_1.jpg","iconSrc":"","navUrl":"","text":"再买一单"},{"icon":"/uploads/stock/digital_2.jpg","iconSrc":"","navUrl":"","text":"会员中心"},{"icon":"/uploads/stock/digital_3.jpg","iconSrc":"","navUrl":"","text":"优惠券"},{"icon":"/uploads/stock/digital_4.jpg","iconSrc":"","navUrl":"","text":"我的订单"}]}, gridNav_digital_v01_home_05: {"items":[{"icon":"/uploads/stock/digital_1.jpg","iconSrc":"","navUrl":"","text":"极速达"},{"icon":"/uploads/stock/digital_2.jpg","iconSrc":"","navUrl":"","text":"品质保障"},{"icon":"/uploads/stock/digital_3.jpg","iconSrc":"","navUrl":"","text":"售后无忧"}]}, gridNav_digital_v01_home_06: {"items":[{"icon":"/uploads/stock/digital_1.jpg","iconSrc":"","navUrl":"","text":"手机"},{"icon":"/uploads/stock/digital_2.jpg","iconSrc":"","navUrl":"","text":"电脑"},{"icon":"/uploads/stock/digital_3.jpg","iconSrc":"","navUrl":"","text":"平板"},{"icon":"/uploads/stock/digital_4.jpg","iconSrc":"","navUrl":"","text":"耳机"},{"icon":"/uploads/stock/digital_5.jpg","iconSrc":"","navUrl":"","text":"相机"},{"icon":"/uploads/stock/digital_6.jpg","iconSrc":"","navUrl":"","text":"家电"},{"icon":"/uploads/stock/digital_55.jpg","iconSrc":"","navUrl":"","text":"配件"},{"icon":"/uploads/stock/digital_56.jpg","iconSrc":"","navUrl":"","text":"智能"},{"icon":"/uploads/stock/digital_57.jpg","iconSrc":"","navUrl":"","text":"办公"},{"icon":"/uploads/stock/digital_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]}, promoPair_digital_v01_home_07: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/digital_40.jpg","imageSrc":"","navUrl":"","title":"爆款直降"},{"bgColor":"#fff3e0","image":"/uploads/stock/digital_41.jpg","imageSrc":"","navUrl":"","title":"以旧换新"}]}, promoPair_digital_v01_home_08: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/digital_42.jpg","imageSrc":"","navUrl":"","title":"分期免息"},{"bgColor":"#fff3e0","image":"/uploads/stock/digital_43.jpg","imageSrc":"","navUrl":"","title":"限时特惠"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_digital_v01_home_11();
    await this._mpLoadProducts_products_digital_v01_home_13()
  },
  async _mpLoadProducts_products_digital_v01_home_11() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("digital_v01_home_11");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_digital_v01_home_11 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_digital_v01_home_11: list });
    } catch (e) { this.mpDevWarn('product', "digital_v01_home_11", e); }
  },

  async _mpLoadProducts_products_digital_v01_home_13() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("digital_v01_home_13");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_digital_v01_home_13 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_digital_v01_home_13: list });
    } catch (e) { this.mpDevWarn('product', "digital_v01_home_13", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_digital_v01_home_03()
  },
  async _mpLoadSwiper_swiper_digital_v01_home_03() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("digital_v01_home_03"));
      ...
      var cur = this.data.swiper_digital_v01_home_03 || {};
      this.setData({
        swiper_digital_v01_home_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "digital_v01_home_03", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_digital_v01_home_04()
  },
  async _mpLoadNotice_notice_digital_v01_home_04() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("digital_v01_home_04"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_digital_v01_home_04: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "digital_v01_home_04", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_digital_v01_home_11, 'image'); if (list.length) this.setData({ products_digital_v01_home_11: list }); }
    { var list = withSrc(this.data.products_digital_v01_home_13, 'image'); if (list.length) this.setData({ products_digital_v01_home_13: list }); }
    { var wgt = this.data.swiper_digital_v01_home_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_digital_v01_home_03: next }); } }
  },
onShow() {
