...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_logistics_v01_home_11: [{"id":1,"image":"/uploads/stock/logistics_10.jpg","imageSrc":"","name":"速达物流精选款A","price":39},{"id":2,"image":"/uploads/stock/logistics_11.jpg","imageSrc":"","name":"速达物流精选款B","price":88},{"id":3,"image":"/uploads/stock/logistics_12.jpg","imageSrc":"","name":"速达物流精选款C","price":137}], products_logistics_v01_home_13: [{"id":7,"image":"/uploads/stock/logistics_16.jpg","imageSrc":"","name":"热销单品1","price":39},{"id":8,"image":"/uploads/stock/logistics_17.jpg","imageSrc":"","name":"热销单品2","price":88},{"id":9,"image":"/uploads/stock/logistics_18.jpg","imageSrc":"","name":"热销单品3","price":137},{"id":10,"image":"/uploads/stock/logistics_19.jpg","imageSrc":"","name":"热销单品4","price":186},{"id":11,"image":"/uploads/stock/logistics_20.jpg","imageSrc":"","name":"热销单品5","price":235},{"id":12,"image":"/uploads/stock/logistics_21.jpg","imageSrc":"","name":"热销单品6","price":284}], productWidgets: [{"key":"products_logistics_v01_home_11","cid":"logistics_v01_home_11","limit":3},{"key":"products_logistics_v01_home_13","cid":"logistics_v01_home_13","limit":6}], swiper_logistics_v01_home_03: { height: 320, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/logistics_7.jpg","imageSrc":"","link":"","title":"物流运输"},{"image":"/uploads/stock/logistics_8.jpg","imageSrc":"","link":"","title":"当日达"},{"image":"/uploads/stock/logistics_9.jpg","imageSrc":"","link":"","title":"企业专线"}] }, swiperWidgets: [{"key":"swiper_logistics_v01_home_03","cid":"logistics_v01_home_03","height":320,"interval":3000}], notice_logistics_v01_home_04: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购物流运输好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_logistics_v01_home_04","cid":"logistics_v01_home_04"}], gridNav_logistics_v01_home_02: {"items":[{"icon":"/uploads/stock/logistics_1.jpg","iconSrc":"","navUrl":"","text":"再买一单"},{"icon":"/uploads/stock/logistics_2.jpg","iconSrc":"","navUrl":"","text":"会员中心"},{"icon":"/uploads/stock/logistics_3.jpg","iconSrc":"","navUrl":"","text":"优惠券"},{"icon":"/uploads/stock/logistics_4.jpg","iconSrc":"","navUrl":"","text":"我的订单"}]}, gridNav_logistics_v01_home_05: {"items":[{"icon":"/uploads/stock/logistics_1.jpg","iconSrc":"","navUrl":"","text":"极速达"},{"icon":"/uploads/stock/logistics_2.jpg","iconSrc":"","navUrl":"","text":"品质保障"},{"icon":"/uploads/stock/logistics_3.jpg","iconSrc":"","navUrl":"","text":"售后无忧"}]}, gridNav_logistics_v01_home_06: {"items":[{"icon":"/uploads/stock/logistics_1.jpg","iconSrc":"","navUrl":"","text":"快递"},{"icon":"/uploads/stock/logistics_2.jpg","iconSrc":"","navUrl":"","text":"零担"},{"icon":"/uploads/stock/logistics_3.jpg","iconSrc":"","navUrl":"","text":"整车"},{"icon":"/uploads/stock/logistics_4.jpg","iconSrc":"","navUrl":"","text":"冷链"},{"icon":"/uploads/stock/logistics_5.jpg","iconSrc":"","navUrl":"","text":"仓储"},{"icon":"/uploads/stock/logistics_6.jpg","iconSrc":"","navUrl":"","text":"同城"},{"icon":"/uploads/stock/logistics_55.jpg","iconSrc":"","navUrl":"","text":"跨境"},{"icon":"/uploads/stock/logistics_56.jpg","iconSrc":"","navUrl":"","text":"包装"},{"icon":"/uploads/stock/logistics_57.jpg","iconSrc":"","navUrl":"","text":"跟踪"},{"icon":"/uploads/stock/logistics_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]}, promoPair_logistics_v01_home_07: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/logistics_40.jpg","imageSrc":"","navUrl":"","title":"当日达"},{"bgColor":"#fff3e0","image":"/uploads/stock/logistics_41.jpg","imageSrc":"","navUrl":"","title":"企业专线"}]}, promoPair_logistics_v01_home_08: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/logistics_42.jpg","imageSrc":"","navUrl":"","title":"会员折扣"},{"bgColor":"#fff3e0","image":"/uploads/stock/logistics_43.jpg","imageSrc":"","navUrl":"","title":"限时特惠"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_logistics_v01_home_11();
    await this._mpLoadProducts_products_logistics_v01_home_13()
  },
  async _mpLoadProducts_products_logistics_v01_home_11() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("logistics_v01_home_11");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_logistics_v01_home_11 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_logistics_v01_home_11: list });
    } catch (e) { this.mpDevWarn('product', "logistics_v01_home_11", e); }
  },

  async _mpLoadProducts_products_logistics_v01_home_13() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("logistics_v01_home_13");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_logistics_v01_home_13 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_logistics_v01_home_13: list });
    } catch (e) { this.mpDevWarn('product', "logistics_v01_home_13", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_logistics_v01_home_03()
  },
  async _mpLoadSwiper_swiper_logistics_v01_home_03() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("logistics_v01_home_03"));
      ...
      var cur = this.data.swiper_logistics_v01_home_03 || {};
      this.setData({
        swiper_logistics_v01_home_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "logistics_v01_home_03", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_logistics_v01_home_04()
  },
  async _mpLoadNotice_notice_logistics_v01_home_04() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("logistics_v01_home_04"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_logistics_v01_home_04: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "logistics_v01_home_04", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_logistics_v01_home_11, 'image'); if (list.length) this.setData({ products_logistics_v01_home_11: list }); }
    { var list = withSrc(this.data.products_logistics_v01_home_13, 'image'); if (list.length) this.setData({ products_logistics_v01_home_13: list }); }
    { var wgt = this.data.swiper_logistics_v01_home_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_logistics_v01_home_03: next }); } }
  },
onShow() {
