...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_logistics_v02_home_06: [{"id":1,"image":"/uploads/stock/logistics_10.jpg","imageSrc":"","name":"速达物流精选款A","price":39},{"id":2,"image":"/uploads/stock/logistics_11.jpg","imageSrc":"","name":"速达物流精选款B","price":88},{"id":3,"image":"/uploads/stock/logistics_12.jpg","imageSrc":"","name":"速达物流精选款C","price":137},{"id":4,"image":"/uploads/stock/logistics_13.jpg","imageSrc":"","name":"速达物流精选款D","price":186},{"id":5,"image":"/uploads/stock/logistics_14.jpg","imageSrc":"","name":"速达物流精选款E","price":235},{"id":6,"image":"/uploads/stock/logistics_15.jpg","imageSrc":"","name":"速达物流精选款F","price":284},{"id":7,"image":"/uploads/stock/logistics_16.jpg","imageSrc":"","name":"热销单品1","price":39},{"id":8,"image":"/uploads/stock/logistics_17.jpg","imageSrc":"","name":"热销单品2","price":88}], products_logistics_v02_home_07: [{"id":13,"image":"/uploads/stock/logistics_22.jpg","imageSrc":"","name":"新品推荐1","price":39},{"id":14,"image":"/uploads/stock/logistics_23.jpg","imageSrc":"","name":"新品推荐2","price":88},{"id":15,"image":"/uploads/stock/logistics_24.jpg","imageSrc":"","name":"新品推荐3","price":137}], productWidgets: [{"key":"products_logistics_v02_home_06","cid":"logistics_v02_home_06","limit":8},{"key":"products_logistics_v02_home_07","cid":"logistics_v02_home_07","limit":3}], swiper_logistics_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/logistics_8.jpg","imageSrc":"","link":"","title":"物流运输"},{"image":"/uploads/stock/logistics_9.jpg","imageSrc":"","link":"","title":"当日达"}] }, swiperWidgets: [{"key":"swiper_logistics_v02_home_02","cid":"logistics_v02_home_02","height":280,"interval":3000}], notice_logistics_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购物流运输好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_logistics_v02_home_03","cid":"logistics_v02_home_03"}], gridNav_logistics_v02_home_04: {"items":[{"icon":"/uploads/stock/logistics_1.jpg","iconSrc":"","navUrl":"","text":"快递"},{"icon":"/uploads/stock/logistics_2.jpg","iconSrc":"","navUrl":"","text":"零担"},{"icon":"/uploads/stock/logistics_3.jpg","iconSrc":"","navUrl":"","text":"整车"},{"icon":"/uploads/stock/logistics_4.jpg","iconSrc":"","navUrl":"","text":"冷链"},{"icon":"/uploads/stock/logistics_5.jpg","iconSrc":"","navUrl":"","text":"仓储"},{"icon":"/uploads/stock/logistics_6.jpg","iconSrc":"","navUrl":"","text":"同城"},{"icon":"/uploads/stock/logistics_55.jpg","iconSrc":"","navUrl":"","text":"跨境"},{"icon":"/uploads/stock/logistics_56.jpg","iconSrc":"","navUrl":"","text":"包装"},{"icon":"/uploads/stock/logistics_57.jpg","iconSrc":"","navUrl":"","text":"跟踪"},{"icon":"/uploads/stock/logistics_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_logistics_v02_home_06();
    await this._mpLoadProducts_products_logistics_v02_home_07()
  },
  async _mpLoadProducts_products_logistics_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("logistics_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_logistics_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_logistics_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "logistics_v02_home_06", e); }
  },

  async _mpLoadProducts_products_logistics_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("logistics_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_logistics_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_logistics_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "logistics_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_logistics_v02_home_02()
  },
  async _mpLoadSwiper_swiper_logistics_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("logistics_v02_home_02"));
      ...
      var cur = this.data.swiper_logistics_v02_home_02 || {};
      this.setData({
        swiper_logistics_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "logistics_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_logistics_v02_home_03()
  },
  async _mpLoadNotice_notice_logistics_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("logistics_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_logistics_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "logistics_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_logistics_v02_home_06, 'image'); if (list.length) this.setData({ products_logistics_v02_home_06: list }); }
    { var list = withSrc(this.data.products_logistics_v02_home_07, 'image'); if (list.length) this.setData({ products_logistics_v02_home_07: list }); }
    { var wgt = this.data.swiper_logistics_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_logistics_v02_home_02: next }); } }
  },
onShow() {
