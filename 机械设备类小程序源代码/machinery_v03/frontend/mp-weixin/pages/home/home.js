...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_machinery_v03_home_08: [{"id":1,"image":"/uploads/stock/machinery_10.jpg","imageSrc":"","name":"精工机械精选款A","price":39},{"id":2,"image":"/uploads/stock/machinery_11.jpg","imageSrc":"","name":"精工机械精选款B","price":88},{"id":3,"image":"/uploads/stock/machinery_12.jpg","imageSrc":"","name":"精工机械精选款C","price":137},{"id":4,"image":"/uploads/stock/machinery_13.jpg","imageSrc":"","name":"精工机械精选款D","price":186},{"id":5,"image":"/uploads/stock/machinery_14.jpg","imageSrc":"","name":"精工机械精选款E","price":235},{"id":6,"image":"/uploads/stock/machinery_15.jpg","imageSrc":"","name":"精工机械精选款F","price":284}], productWidgets: [{"key":"products_machinery_v03_home_08","cid":"machinery_v03_home_08","limit":6}], swiper_machinery_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/machinery_9.jpg","imageSrc":"","link":"","title":"机械设备"},{"image":"/uploads/stock/machinery_48.jpg","imageSrc":"","link":"","title":"厂家直销"},{"image":"/uploads/stock/machinery_49.jpg","imageSrc":"","link":"","title":"质保服务"}] }, swiperWidgets: [{"key":"swiper_machinery_v03_home_02","cid":"machinery_v03_home_02","height":340,"interval":3000}], promoPair_machinery_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/machinery_42.jpg","imageSrc":"","navUrl":"","title":"厂家直销"},{"bgColor":"#fff3e0","image":"/uploads/stock/machinery_43.jpg","imageSrc":"","navUrl":"","title":"质保服务"}]}, promoPair_machinery_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/machinery_44.jpg","imageSrc":"","navUrl":"","title":"配件齐全"},{"bgColor":"#fff3e0","image":"/uploads/stock/machinery_45.jpg","imageSrc":"","navUrl":"","title":"限时特惠"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_machinery_v03_home_08()
  },
  async _mpLoadProducts_products_machinery_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("machinery_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_machinery_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_machinery_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "machinery_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_machinery_v03_home_02()
  },
  async _mpLoadSwiper_swiper_machinery_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("machinery_v03_home_02"));
      ...
      var cur = this.data.swiper_machinery_v03_home_02 || {};
      this.setData({
        swiper_machinery_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "machinery_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_machinery_v03_home_08, 'image'); if (list.length) this.setData({ products_machinery_v03_home_08: list }); }
    { var wgt = this.data.swiper_machinery_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_machinery_v03_home_02: next }); } }
  },
onShow() {
