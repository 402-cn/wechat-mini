...
function demo_product_catalog(): array {
    return [
        [1, 1, '日常保洁2小时', './assets/images/home_service_10.jpg', 99.00],
        [2, 1, '深度保洁', './assets/images/home_service_11.jpg', 258.00],
        [3, 1, '开荒保洁', './assets/images/home_service_12.jpg', 417.00],
        [4, 1, '擦玻璃', './assets/images/home_service_13.jpg', 576.00],
        [5, 1, '厨房保洁', './assets/images/home_service_14.jpg', 735.00],
        [6, 1, '卫生间保洁', './assets/images/home_service_15.jpg', 894.00],
        [7, 2, '月嫂服务26天', './assets/images/home_service_16.jpg', 99.00],
        [8, 2, '育儿嫂', './assets/images/home_service_17.jpg', 258.00],
        [9, 2, '催乳师', './assets/images/home_service_18.jpg', 417.00],
        [10, 2, '产后康复', './assets/images/home_service_19.jpg', 576.00],
        [11, 2, '婴儿护理', './assets/images/home_service_20.jpg', 735.00],
        [12, 2, '住家保姆', './assets/images/home_service_21.jpg', 894.00],
        [13, 3, '水管维修', './assets/images/home_service_22.jpg', 99.00],
        [14, 3, '电路维修', './assets/images/home_service_23.jpg', 258.00],
        [15, 3, '家电维修', './assets/images/home_service_24.jpg', 417.00],
        [16, 3, '门锁更换', './assets/images/home_service_25.jpg', 576.00],
        [17, 3, '防水补漏', './assets/images/home_service_26.jpg', 735.00],
        [18, 3, '家具安装', './assets/images/home_service_27.jpg', 894.00],
        [19, 4, '同城搬家', './assets/images/home_service_28.jpg', 99.00],
        [20, 4, '长途搬家', './assets/images/home_service_29.jpg', 258.00],
        [21, 4, '小件搬运', './assets/images/home_service_30.jpg', 417.00],
        [22, 4, '钢琴搬运', './assets/images/home_service_31.jpg', 576.00],
        [23, 4, '打包服务', './assets/images/home_service_32.jpg', 735.00],
        [24, 4, '仓储服务', './assets/images/home_service_33.jpg', 894.00],
        [25, 5, '空调清洗', './assets/images/home_service_34.jpg', 99.00],
        [26, 5, '油烟机清洗', './assets/images/home_service_35.jpg', 258.00],
        [27, 5, '地毯清洗', './assets/images/home_service_36.jpg', 417.00],
        [28, 5, '沙发清洗', './assets/images/home_service_37.jpg', 576.00],
        [29, 5, '窗帘清洗', './assets/images/home_service_38.jpg', 735.00],
        [30, 5, '消杀除螨', './assets/images/home_service_39.jpg', 894.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'保洁',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'月嫂',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'维修',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'搬家',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'清洗',5,1)");
