...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_home_service_v05_home_04: [{"id":1,"image":"/uploads/stock/home_service_10.jpg","imageSrc":"","name":"日常保洁2小时","price":99},{"id":2,"image":"/uploads/stock/home_service_11.jpg","imageSrc":"","name":"深度保洁","price":258},{"id":3,"image":"/uploads/stock/home_service_12.jpg","imageSrc":"","name":"开荒保洁","price":417},{"id":4,"image":"/uploads/stock/home_service_13.jpg","imageSrc":"","name":"擦玻璃","price":576},{"id":5,"image":"/uploads/stock/home_service_14.jpg","imageSrc":"","name":"厨房保洁","price":735},{"id":6,"image":"/uploads/stock/home_service_15.jpg","imageSrc":"","name":"卫生间保洁","price":894},{"id":7,"image":"/uploads/stock/home_service_16.jpg","imageSrc":"","name":"月嫂服务26天","price":99},{"id":8,"image":"/uploads/stock/home_service_17.jpg","imageSrc":"","name":"育儿嫂","price":258}], products_home_service_v05_home_06: [{"id":9,"image":"/uploads/stock/home_service_18.jpg","imageSrc":"","name":"催乳师","price":417},{"id":10,"image":"/uploads/stock/home_service_19.jpg","imageSrc":"","name":"产后康复","price":576},{"id":11,"image":"/uploads/stock/home_service_20.jpg","imageSrc":"","name":"婴儿护理","price":735},{"id":12,"image":"/uploads/stock/home_service_21.jpg","imageSrc":"","name":"住家保姆","price":894}], productWidgets: [{"key":"products_home_service_v05_home_04","cid":"home_service_v05_home_04","limit":8},{"key":"products_home_service_v05_home_06","cid":"home_service_v05_home_06","limit":4}], swiper_home_service_v05_home_02: { height: 360, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/home_service_49.jpg","imageSrc":"","link":"","title":"家政服务"}] }, swiperWidgets: [{"key":"swiper_home_service_v05_home_02","cid":"home_service_v05_home_02","height":360,"interval":3000}], notice_home_service_v05_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购家政服务好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_home_service_v05_home_03","cid":"home_service_v05_home_03"}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_home_service_v05_home_04();
    await this._mpLoadProducts_products_home_service_v05_home_06()
  },
  async _mpLoadProducts_products_home_service_v05_home_04() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("home_service_v05_home_04");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_home_service_v05_home_04 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_home_service_v05_home_04: list });
    } catch (e) { this.mpDevWarn('product', "home_service_v05_home_04", e); }
  },

  async _mpLoadProducts_products_home_service_v05_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("home_service_v05_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_home_service_v05_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_home_service_v05_home_06: list });
    } catch (e) { this.mpDevWarn('product', "home_service_v05_home_06", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_home_service_v05_home_02()
  },
  async _mpLoadSwiper_swiper_home_service_v05_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("home_service_v05_home_02"));
      ...
      var cur = this.data.swiper_home_service_v05_home_02 || {};
      this.setData({
        swiper_home_service_v05_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "home_service_v05_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_home_service_v05_home_03()
  },
  async _mpLoadNotice_notice_home_service_v05_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("home_service_v05_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_home_service_v05_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "home_service_v05_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_home_service_v05_home_04, 'image'); if (list.length) this.setData({ products_home_service_v05_home_04: list }); }
    { var list = withSrc(this.data.products_home_service_v05_home_06, 'image'); if (list.length) this.setData({ products_home_service_v05_home_06: list }); }
    { var wgt = this.data.swiper_home_service_v05_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_home_service_v05_home_02: next }); } }
  },
onShow() {
