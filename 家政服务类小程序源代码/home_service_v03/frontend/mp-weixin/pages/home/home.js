...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_home_service_v03_home_08: [{"id":1,"image":"/uploads/stock/home_service_10.jpg","imageSrc":"","name":"日常保洁2小时","price":99},{"id":2,"image":"/uploads/stock/home_service_11.jpg","imageSrc":"","name":"深度保洁","price":258},{"id":3,"image":"/uploads/stock/home_service_12.jpg","imageSrc":"","name":"开荒保洁","price":417},{"id":4,"image":"/uploads/stock/home_service_13.jpg","imageSrc":"","name":"擦玻璃","price":576},{"id":5,"image":"/uploads/stock/home_service_14.jpg","imageSrc":"","name":"厨房保洁","price":735},{"id":6,"image":"/uploads/stock/home_service_15.jpg","imageSrc":"","name":"卫生间保洁","price":894}], productWidgets: [{"key":"products_home_service_v03_home_08","cid":"home_service_v03_home_08","limit":6}], swiper_home_service_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/home_service_9.jpg","imageSrc":"","link":"","title":"家政服务"},{"image":"/uploads/stock/home_service_48.jpg","imageSrc":"","link":"","title":"首单优惠"},{"image":"/uploads/stock/home_service_49.jpg","imageSrc":"","link":"","title":"套餐服务"}] }, swiperWidgets: [{"key":"swiper_home_service_v03_home_02","cid":"home_service_v03_home_02","height":340,"interval":3000}], promoPair_home_service_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/home_service_42.jpg","imageSrc":"","navUrl":"","title":"首单优惠"},{"bgColor":"#fff3e0","image":"/uploads/stock/home_service_43.jpg","imageSrc":"","navUrl":"","title":"套餐服务"}]}, promoPair_home_service_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/home_service_44.jpg","imageSrc":"","navUrl":"","title":"会员折扣"},{"bgColor":"#fff3e0","image":"/uploads/stock/home_service_45.jpg","imageSrc":"","navUrl":"","title":"限时特惠"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_home_service_v03_home_08()
  },
  async _mpLoadProducts_products_home_service_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("home_service_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_home_service_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_home_service_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "home_service_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_home_service_v03_home_02()
  },
  async _mpLoadSwiper_swiper_home_service_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("home_service_v03_home_02"));
      ...
      var cur = this.data.swiper_home_service_v03_home_02 || {};
      this.setData({
        swiper_home_service_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "home_service_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_home_service_v03_home_08, 'image'); if (list.length) this.setData({ products_home_service_v03_home_08: list }); }
    { var wgt = this.data.swiper_home_service_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_home_service_v03_home_02: next }); } }
  },
onShow() {
