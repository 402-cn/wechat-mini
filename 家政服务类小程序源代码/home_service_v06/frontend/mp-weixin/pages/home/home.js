...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_home_service_v06_home_05: [{"id":7,"image":"/uploads/stock/home_service_16.jpg","imageSrc":"","name":"月嫂服务26天","price":99},{"id":8,"image":"/uploads/stock/home_service_17.jpg","imageSrc":"","name":"育儿嫂","price":258},{"id":9,"image":"/uploads/stock/home_service_18.jpg","imageSrc":"","name":"催乳师","price":417},{"id":10,"image":"/uploads/stock/home_service_19.jpg","imageSrc":"","name":"产后康复","price":576}], productWidgets: [{"key":"products_home_service_v06_home_05","cid":"home_service_v06_home_05","limit":4}], swiper_home_service_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/home_service_50.jpg","imageSrc":"","link":"","title":"家政服务"},{"image":"/uploads/stock/home_service_51.jpg","imageSrc":"","link":"","title":"首单优惠"},{"image":"/uploads/stock/home_service_52.jpg","imageSrc":"","link":"","title":"套餐服务"}] }, swiperWidgets: [{"key":"swiper_home_service_v06_home_02","cid":"home_service_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_home_service_v06_home_05()
  },
  async _mpLoadProducts_products_home_service_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("home_service_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_home_service_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_home_service_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "home_service_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_home_service_v06_home_02()
  },
  async _mpLoadSwiper_swiper_home_service_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("home_service_v06_home_02"));
      ...
      var cur = this.data.swiper_home_service_v06_home_02 || {};
      this.setData({
        swiper_home_service_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "home_service_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_home_service_v06_home_05, 'image'); if (list.length) this.setData({ products_home_service_v06_home_05: list }); }
    { var wgt = this.data.swiper_home_service_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_home_service_v06_home_02: next }); } }
  },
onShow() {
