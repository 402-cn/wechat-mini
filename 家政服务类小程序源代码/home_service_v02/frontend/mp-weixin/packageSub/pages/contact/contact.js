...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, notice_home_service_v02_contact_02: {"bgColor":"#f0f9ff","content":"客服热线：400-000-0000（示例）  工作时间：9:00-21:00","duration":"6.29s","fontSize":26,"prefixTitle":"","scrollDirection":"left","scrollSpeed":35,"showIcon":true,"textColor":"#333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_home_service_v02_contact_02","cid":"home_service_v02_contact_02"}], showMpTabBar: true, mpActiveTab: '', mpTabPrimary: "#3498db", mpTabItems: [{"icon":"/assets/tab/home.png","iconActive":"/assets/tab/home_active.png","page_key":"home","text":"首页"},{"icon":"/assets/tab/category.png","iconActive":"/assets/tab/category_active.png","page_key":"category","text":"分类"},{"icon":"/assets/tab/cart.png","iconActive":"/assets/tab/cart_active.png","page_key":"cart","text":"购物车"},{"icon":"/assets/tab/mine.png","iconActive":"/assets/tab/mine_active.png","page_key":"mine","text":"我的"}] },
  onLoad(q) {
...
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_home_service_v02_contact_02()
  },
  async _mpLoadNotice_notice_home_service_v02_contact_02() {
    const { req } = require('../../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("home_service_v02_contact_02"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_home_service_v02_contact_02: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "home_service_v02_contact_02", e); }
  },
