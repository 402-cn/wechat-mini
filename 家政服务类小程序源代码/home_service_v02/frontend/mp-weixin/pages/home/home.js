...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_home_service_v02_home_06: [{"id":1,"image":"/uploads/stock/home_service_10.jpg","imageSrc":"","name":"日常保洁2小时","price":99},{"id":2,"image":"/uploads/stock/home_service_11.jpg","imageSrc":"","name":"深度保洁","price":258},{"id":3,"image":"/uploads/stock/home_service_12.jpg","imageSrc":"","name":"开荒保洁","price":417},{"id":4,"image":"/uploads/stock/home_service_13.jpg","imageSrc":"","name":"擦玻璃","price":576},{"id":5,"image":"/uploads/stock/home_service_14.jpg","imageSrc":"","name":"厨房保洁","price":735},{"id":6,"image":"/uploads/stock/home_service_15.jpg","imageSrc":"","name":"卫生间保洁","price":894},{"id":7,"image":"/uploads/stock/home_service_16.jpg","imageSrc":"","name":"月嫂服务26天","price":99},{"id":8,"image":"/uploads/stock/home_service_17.jpg","imageSrc":"","name":"育儿嫂","price":258}], products_home_service_v02_home_07: [{"id":13,"image":"/uploads/stock/home_service_22.jpg","imageSrc":"","name":"水管维修","price":99},{"id":14,"image":"/uploads/stock/home_service_23.jpg","imageSrc":"","name":"电路维修","price":258},{"id":15,"image":"/uploads/stock/home_service_24.jpg","imageSrc":"","name":"家电维修","price":417}], productWidgets: [{"key":"products_home_service_v02_home_06","cid":"home_service_v02_home_06","limit":8},{"key":"products_home_service_v02_home_07","cid":"home_service_v02_home_07","limit":3}], swiper_home_service_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/home_service_8.jpg","imageSrc":"","link":"","title":"家政服务"},{"image":"/uploads/stock/home_service_9.jpg","imageSrc":"","link":"","title":"首单优惠"}] }, swiperWidgets: [{"key":"swiper_home_service_v02_home_02","cid":"home_service_v02_home_02","height":280,"interval":3000}], notice_home_service_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购家政服务好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_home_service_v02_home_03","cid":"home_service_v02_home_03"}], gridNav_home_service_v02_home_04: {"items":[{"icon":"/uploads/stock/home_service_1.jpg","iconSrc":"","navUrl":"","text":"保洁"},{"icon":"/uploads/stock/home_service_2.jpg","iconSrc":"","navUrl":"","text":"月嫂"},{"icon":"/uploads/stock/home_service_3.jpg","iconSrc":"","navUrl":"","text":"育儿"},{"icon":"/uploads/stock/home_service_4.jpg","iconSrc":"","navUrl":"","text":"维修"},{"icon":"/uploads/stock/home_service_5.jpg","iconSrc":"","navUrl":"","text":"搬家"},{"icon":"/uploads/stock/home_service_6.jpg","iconSrc":"","navUrl":"","text":"开锁"},{"icon":"/uploads/stock/home_service_55.jpg","iconSrc":"","navUrl":"","text":"清洗"},{"icon":"/uploads/stock/home_service_56.jpg","iconSrc":"","navUrl":"","text":"保姆"},{"icon":"/uploads/stock/home_service_57.jpg","iconSrc":"","navUrl":"","text":"钟点"},{"icon":"/uploads/stock/home_service_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_home_service_v02_home_06();
    await this._mpLoadProducts_products_home_service_v02_home_07()
  },
  async _mpLoadProducts_products_home_service_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("home_service_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_home_service_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_home_service_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "home_service_v02_home_06", e); }
  },

  async _mpLoadProducts_products_home_service_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("home_service_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_home_service_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_home_service_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "home_service_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_home_service_v02_home_02()
  },
  async _mpLoadSwiper_swiper_home_service_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("home_service_v02_home_02"));
      ...
      var cur = this.data.swiper_home_service_v02_home_02 || {};
      this.setData({
        swiper_home_service_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "home_service_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_home_service_v02_home_03()
  },
  async _mpLoadNotice_notice_home_service_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("home_service_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_home_service_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "home_service_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_home_service_v02_home_06, 'image'); if (list.length) this.setData({ products_home_service_v02_home_06: list }); }
    { var list = withSrc(this.data.products_home_service_v02_home_07, 'image'); if (list.length) this.setData({ products_home_service_v02_home_07: list }); }
    { var wgt = this.data.swiper_home_service_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_home_service_v02_home_02: next }); } }
  },
onShow() {
