...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, articles_fresh_grocery_v01_article_02: [{"cover":"/uploads/stock/corporate_7.jpg","coverSrc":"","created_at":"2026-01-01","id":"demo_1","summary":"部署后可在后台编辑","title":"欢迎来到集团官网"},{"cover":"/uploads/stock/corporate_8.jpg","coverSrc":"","created_at":"2026-01-02","id":"demo_2","summary":"演示文章仅供参考","title":"集团官网新品发布"},{"cover":"/uploads/stock/corporate_9.jpg","coverSrc":"","created_at":"2026-01-03","id":"demo_3","summary":"演示数据","title":"会员权益说明"},{"cover":"/uploads/stock/corporate_48.jpg","coverSrc":"","created_at":"2026-01-04","id":"demo_4","summary":"演示数据","title":"服务与配送说明"},{"cover":"/uploads/stock/corporate_49.jpg","coverSrc":"","created_at":"2026-01-05","id":"demo_5","summary":"演示数据","title":"常见问题解答"}], articleWidgets: [{"key":"articles_fresh_grocery_v01_article_02","cid":"fresh_grocery_v01_article_02","limit":5}], swiper_fresh_grocery_v01_article_03: { height: 280, interval: 4000, autoplay: true, items: [{"image":"/uploads/stock/fresh_grocery_50.jpg","imageSrc":"","link":"","title":"资讯"}] }, swiperWidgets: [{"key":"swiper_fresh_grocery_v01_article_03","cid":"fresh_grocery_v01_article_03","height":280,"interval":4000}], showMpTabBar: true, mpActiveTab: '', mpTabPrimary: "#2ecc71", mpTabItems: [{"icon":"/assets/tab/home.png","iconActive":"/assets/tab/home_active.png","page_key":"home","text":"首页"},{"icon":"/assets/tab/category.png","iconActive":"/assets/tab/category_active.png","page_key":"category","text":"分类"},{"icon":"/assets/tab/cart.png","iconActive":"/assets/tab/cart_active.png","page_key":"cart","text":"购物车"},{"icon":"/assets/tab/mine.png","iconActive":"/assets/tab/mine_active.png","page_key":"mine","text":"我的"}] },
  onLoad(q) {
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_fresh_grocery_v01_article_03()
  },
  async _mpLoadSwiper_swiper_fresh_grocery_v01_article_03() {
    const { req, assetUrl } = require('../../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("fresh_grocery_v01_article_03"));
      ...
      var cur = this.data.swiper_fresh_grocery_v01_article_03 || {};
      this.setData({
        swiper_fresh_grocery_v01_article_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "fresh_grocery_v01_article_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.articles_fresh_grocery_v01_article_02, 'cover'); if (list.length) this.setData({ articles_fresh_grocery_v01_article_02: list }); }
    { var wgt = this.data.swiper_fresh_grocery_v01_article_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_fresh_grocery_v01_article_03: next }); } }
  },
goArticle(e) {
...
async loadArticles() {
    ...
    try {
      await this._mpLoadArticles_articles_fresh_grocery_v01_article_02()
    } finally {
      this._articleLoading = false;
    }
  },
  async _mpLoadArticles_articles_fresh_grocery_v01_article_02() {
    const { req, assetUrl } = require('../../../utils/api');
    var url = '/article/list.php?limit=5&component_id=' + encodeURIComponent("fresh_grocery_v01_article_02");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.articles_fresh_grocery_v01_article_02 || []).slice();
      }
      if (!list.length) return;
      this.setData({ articles_fresh_grocery_v01_article_02: list });
    } catch (e) {
      this.mpDevWarn('article', "fresh_grocery_v01_article_02", e);
      var cur = this.data.articles_fresh_grocery_v01_article_02;
      if (cur && cur.length) {
        try {
          ...
          this.setData({ articles_fresh_grocery_v01_article_02: patched });
        } catch (e2) {}
      }
    }
  },
