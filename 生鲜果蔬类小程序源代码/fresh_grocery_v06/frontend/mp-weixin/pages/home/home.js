...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_fresh_grocery_v06_home_05: [{"id":7,"image":"/uploads/stock/fresh_grocery_16.jpg","imageSrc":"","name":"有机番茄","price":5.8},{"id":8,"image":"/uploads/stock/fresh_grocery_17.jpg","imageSrc":"","name":"水果黄瓜","price":4.5},{"id":9,"image":"/uploads/stock/fresh_grocery_18.jpg","imageSrc":"","name":"奶油生菜","price":3.9},{"id":10,"image":"/uploads/stock/fresh_grocery_19.jpg","imageSrc":"","name":"新鲜胡萝卜","price":3.2}], productWidgets: [{"key":"products_fresh_grocery_v06_home_05","cid":"fresh_grocery_v06_home_05","limit":4}], swiper_fresh_grocery_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/fresh_grocery_50.jpg","imageSrc":"","link":"","title":"生鲜果蔬"},{"image":"/uploads/stock/fresh_grocery_51.jpg","imageSrc":"","link":"","title":"每日鲜选"},{"image":"/uploads/stock/fresh_grocery_52.jpg","imageSrc":"","link":"","title":"限时特惠"}] }, swiperWidgets: [{"key":"swiper_fresh_grocery_v06_home_02","cid":"fresh_grocery_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_fresh_grocery_v06_home_05()
  },
  async _mpLoadProducts_products_fresh_grocery_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("fresh_grocery_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_fresh_grocery_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_fresh_grocery_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "fresh_grocery_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_fresh_grocery_v06_home_02()
  },
  async _mpLoadSwiper_swiper_fresh_grocery_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("fresh_grocery_v06_home_02"));
      ...
      var cur = this.data.swiper_fresh_grocery_v06_home_02 || {};
      this.setData({
        swiper_fresh_grocery_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "fresh_grocery_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_fresh_grocery_v06_home_05, 'image'); if (list.length) this.setData({ products_fresh_grocery_v06_home_05: list }); }
    { var wgt = this.data.swiper_fresh_grocery_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_fresh_grocery_v06_home_02: next }); } }
  },
onShow() {
