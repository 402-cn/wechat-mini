...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_fresh_grocery_v02_home_06: [{"id":1,"image":"/uploads/stock/fresh_grocery_10.jpg","imageSrc":"","name":"红富士苹果","price":12.8},{"id":2,"image":"/uploads/stock/fresh_grocery_11.jpg","imageSrc":"","name":"进口香蕉","price":6.9},{"id":3,"image":"/uploads/stock/fresh_grocery_12.jpg","imageSrc":"","name":"新鲜荔枝","price":18.8},{"id":4,"image":"/uploads/stock/fresh_grocery_13.jpg","imageSrc":"","name":"赣南脐橙","price":9.9},{"id":5,"image":"/uploads/stock/fresh_grocery_14.jpg","imageSrc":"","name":"巨峰葡萄","price":15.8},{"id":6,"image":"/uploads/stock/fresh_grocery_15.jpg","imageSrc":"","name":"丹东草莓","price":22.8},{"id":7,"image":"/uploads/stock/fresh_grocery_16.jpg","imageSrc":"","name":"有机番茄","price":5.8},{"id":8,"image":"/uploads/stock/fresh_grocery_17.jpg","imageSrc":"","name":"水果黄瓜","price":4.5}], products_fresh_grocery_v02_home_07: [{"id":13,"image":"/uploads/stock/fresh_grocery_22.jpg","imageSrc":"","name":"散养土鸡","price":68},{"id":14,"image":"/uploads/stock/fresh_grocery_23.jpg","imageSrc":"","name":"精选牛腩","price":45.8},{"id":15,"image":"/uploads/stock/fresh_grocery_24.jpg","imageSrc":"","name":"农家土鸡蛋","price":16.8}], productWidgets: [{"key":"products_fresh_grocery_v02_home_06","cid":"fresh_grocery_v02_home_06","limit":8},{"key":"products_fresh_grocery_v02_home_07","cid":"fresh_grocery_v02_home_07","limit":3}], swiper_fresh_grocery_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/fresh_grocery_8.jpg","imageSrc":"","link":"","title":"生鲜果蔬"},{"image":"/uploads/stock/fresh_grocery_9.jpg","imageSrc":"","link":"","title":"每日鲜选"}] }, swiperWidgets: [{"key":"swiper_fresh_grocery_v02_home_02","cid":"fresh_grocery_v02_home_02","height":280,"interval":3000}], notice_fresh_grocery_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购生鲜果蔬好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_fresh_grocery_v02_home_03","cid":"fresh_grocery_v02_home_03"}], gridNav_fresh_grocery_v02_home_04: {"items":[{"icon":"/uploads/stock/fresh_grocery_1.jpg","iconSrc":"","navUrl":"","text":"蔬菜"},{"icon":"/uploads/stock/fresh_grocery_2.jpg","iconSrc":"","navUrl":"","text":"水果"},{"icon":"/uploads/stock/fresh_grocery_3.jpg","iconSrc":"","navUrl":"","text":"肉禽"},{"icon":"/uploads/stock/fresh_grocery_4.jpg","iconSrc":"","navUrl":"","text":"海鲜"},{"icon":"/uploads/stock/fresh_grocery_5.jpg","iconSrc":"","navUrl":"","text":"乳品"},{"icon":"/uploads/stock/fresh_grocery_6.jpg","iconSrc":"","navUrl":"","text":"速食"},{"icon":"/uploads/stock/fresh_grocery_55.jpg","iconSrc":"","navUrl":"","text":"粮油"},{"icon":"/uploads/stock/fresh_grocery_56.jpg","iconSrc":"","navUrl":"","text":"调味"},{"icon":"/uploads/stock/fresh_grocery_57.jpg","iconSrc":"","navUrl":"","text":"酒水"},{"icon":"/uploads/stock/fresh_grocery_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_fresh_grocery_v02_home_06();
    await this._mpLoadProducts_products_fresh_grocery_v02_home_07()
  },
  async _mpLoadProducts_products_fresh_grocery_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("fresh_grocery_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_fresh_grocery_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_fresh_grocery_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "fresh_grocery_v02_home_06", e); }
  },

  async _mpLoadProducts_products_fresh_grocery_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("fresh_grocery_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_fresh_grocery_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_fresh_grocery_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "fresh_grocery_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_fresh_grocery_v02_home_02()
  },
  async _mpLoadSwiper_swiper_fresh_grocery_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("fresh_grocery_v02_home_02"));
      ...
      var cur = this.data.swiper_fresh_grocery_v02_home_02 || {};
      this.setData({
        swiper_fresh_grocery_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "fresh_grocery_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_fresh_grocery_v02_home_03()
  },
  async _mpLoadNotice_notice_fresh_grocery_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("fresh_grocery_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_fresh_grocery_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "fresh_grocery_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_fresh_grocery_v02_home_06, 'image'); if (list.length) this.setData({ products_fresh_grocery_v02_home_06: list }); }
    { var list = withSrc(this.data.products_fresh_grocery_v02_home_07, 'image'); if (list.length) this.setData({ products_fresh_grocery_v02_home_07: list }); }
    { var wgt = this.data.swiper_fresh_grocery_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_fresh_grocery_v02_home_02: next }); } }
  },
onShow() {
