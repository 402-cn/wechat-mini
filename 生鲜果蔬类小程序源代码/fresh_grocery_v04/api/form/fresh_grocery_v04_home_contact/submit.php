...
try {
    $pdo = db();
    ensure_form_table_columns($pdo, 'fresh_grocery_v04_home_contact', array(
    ...
    $stmt = $pdo->prepare('INSERT INTO `fresh_grocery_v04_home_contact` (`name`, `phone`, `message`) VALUES (?, ?, ?)');
    $stmt->execute($values);
