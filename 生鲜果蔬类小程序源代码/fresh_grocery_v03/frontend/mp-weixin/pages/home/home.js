...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_fresh_grocery_v03_home_08: [{"id":1,"image":"/uploads/stock/fresh_grocery_10.jpg","imageSrc":"","name":"红富士苹果","price":12.8},{"id":2,"image":"/uploads/stock/fresh_grocery_11.jpg","imageSrc":"","name":"进口香蕉","price":6.9},{"id":3,"image":"/uploads/stock/fresh_grocery_12.jpg","imageSrc":"","name":"新鲜荔枝","price":18.8},{"id":4,"image":"/uploads/stock/fresh_grocery_13.jpg","imageSrc":"","name":"赣南脐橙","price":9.9},{"id":5,"image":"/uploads/stock/fresh_grocery_14.jpg","imageSrc":"","name":"巨峰葡萄","price":15.8},{"id":6,"image":"/uploads/stock/fresh_grocery_15.jpg","imageSrc":"","name":"丹东草莓","price":22.8}], productWidgets: [{"key":"products_fresh_grocery_v03_home_08","cid":"fresh_grocery_v03_home_08","limit":6}], swiper_fresh_grocery_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/fresh_grocery_9.jpg","imageSrc":"","link":"","title":"生鲜果蔬"},{"image":"/uploads/stock/fresh_grocery_48.jpg","imageSrc":"","link":"","title":"每日鲜选"},{"image":"/uploads/stock/fresh_grocery_49.jpg","imageSrc":"","link":"","title":"限时特惠"}] }, swiperWidgets: [{"key":"swiper_fresh_grocery_v03_home_02","cid":"fresh_grocery_v03_home_02","height":340,"interval":3000}], promoPair_fresh_grocery_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/fresh_grocery_42.jpg","imageSrc":"","navUrl":"","title":"每日鲜选"},{"bgColor":"#fff3e0","image":"/uploads/stock/fresh_grocery_43.jpg","imageSrc":"","navUrl":"","title":"限时特惠"}]}, promoPair_fresh_grocery_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/fresh_grocery_44.jpg","imageSrc":"","navUrl":"","title":"会员福利"},{"bgColor":"#fff3e0","image":"/uploads/stock/fresh_grocery_45.jpg","imageSrc":"","navUrl":"","title":"秒杀专区"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_fresh_grocery_v03_home_08()
  },
  async _mpLoadProducts_products_fresh_grocery_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("fresh_grocery_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_fresh_grocery_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_fresh_grocery_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "fresh_grocery_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_fresh_grocery_v03_home_02()
  },
  async _mpLoadSwiper_swiper_fresh_grocery_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("fresh_grocery_v03_home_02"));
      ...
      var cur = this.data.swiper_fresh_grocery_v03_home_02 || {};
      this.setData({
        swiper_fresh_grocery_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "fresh_grocery_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_fresh_grocery_v03_home_08, 'image'); if (list.length) this.setData({ products_fresh_grocery_v03_home_08: list }); }
    { var wgt = this.data.swiper_fresh_grocery_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_fresh_grocery_v03_home_02: next }); } }
  },
onShow() {
