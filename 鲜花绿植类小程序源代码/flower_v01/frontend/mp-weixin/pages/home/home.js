...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_flower_v01_home_11: [{"id":1,"image":"/uploads/stock/flower_10.jpg","imageSrc":"","name":"红玫瑰11枝","price":88},{"id":2,"image":"/uploads/stock/flower_11.jpg","imageSrc":"","name":"粉玫瑰19枝","price":216},{"id":3,"image":"/uploads/stock/flower_12.jpg","imageSrc":"","name":"香槟玫瑰","price":344}], products_flower_v01_home_13: [{"id":7,"image":"/uploads/stock/flower_16.jpg","imageSrc":"","name":"白色百合","price":88},{"id":8,"image":"/uploads/stock/flower_17.jpg","imageSrc":"","name":"粉色百合","price":216},{"id":9,"image":"/uploads/stock/flower_18.jpg","imageSrc":"","name":"香水百合","price":344},{"id":10,"image":"/uploads/stock/flower_19.jpg","imageSrc":"","name":"百合花束","price":472},{"id":11,"image":"/uploads/stock/flower_20.jpg","imageSrc":"","name":"百合盆栽","price":600},{"id":12,"image":"/uploads/stock/flower_21.jpg","imageSrc":"","name":"混搭百合","price":728}], productWidgets: [{"key":"products_flower_v01_home_11","cid":"flower_v01_home_11","limit":3},{"key":"products_flower_v01_home_13","cid":"flower_v01_home_13","limit":6}], swiper_flower_v01_home_03: { height: 320, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/flower_7.jpg","imageSrc":"","link":"","title":"鲜花绿植"},{"image":"/uploads/stock/flower_8.jpg","imageSrc":"","link":"","title":"每日鲜花"},{"image":"/uploads/stock/flower_9.jpg","imageSrc":"","link":"","title":"节日特供"}] }, swiperWidgets: [{"key":"swiper_flower_v01_home_03","cid":"flower_v01_home_03","height":320,"interval":3000}], notice_flower_v01_home_04: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购鲜花绿植好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_flower_v01_home_04","cid":"flower_v01_home_04"}], gridNav_flower_v01_home_02: {"items":[{"icon":"/uploads/stock/flower_1.jpg","iconSrc":"","navUrl":"","text":"再买一单"},{"icon":"/uploads/stock/flower_2.jpg","iconSrc":"","navUrl":"","text":"会员中心"},{"icon":"/uploads/stock/flower_3.jpg","iconSrc":"","navUrl":"","text":"优惠券"},{"icon":"/uploads/stock/flower_4.jpg","iconSrc":"","navUrl":"","text":"我的订单"}]}, gridNav_flower_v01_home_05: {"items":[{"icon":"/uploads/stock/flower_1.jpg","iconSrc":"","navUrl":"","text":"极速达"},{"icon":"/uploads/stock/flower_2.jpg","iconSrc":"","navUrl":"","text":"品质保障"},{"icon":"/uploads/stock/flower_3.jpg","iconSrc":"","navUrl":"","text":"售后无忧"}]}, gridNav_flower_v01_home_06: {"items":[{"icon":"/uploads/stock/flower_1.jpg","iconSrc":"","navUrl":"","text":"玫瑰"},{"icon":"/uploads/stock/flower_2.jpg","iconSrc":"","navUrl":"","text":"百合"},{"icon":"/uploads/stock/flower_3.jpg","iconSrc":"","navUrl":"","text":"康乃馨"},{"icon":"/uploads/stock/flower_4.jpg","iconSrc":"","navUrl":"","text":"多肉"},{"icon":"/uploads/stock/flower_5.jpg","iconSrc":"","navUrl":"","text":"绿植"},{"icon":"/uploads/stock/flower_6.jpg","iconSrc":"","navUrl":"","text":"盆栽"},{"icon":"/uploads/stock/flower_55.jpg","iconSrc":"","navUrl":"","text":"花束"},{"icon":"/uploads/stock/flower_56.jpg","iconSrc":"","navUrl":"","text":"礼盒"},{"icon":"/uploads/stock/flower_57.jpg","iconSrc":"","navUrl":"","text":"婚庆"},{"icon":"/uploads/stock/flower_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]}, promoPair_flower_v01_home_07: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/flower_40.jpg","imageSrc":"","navUrl":"","title":"每日鲜花"},{"bgColor":"#fff3e0","image":"/uploads/stock/flower_41.jpg","imageSrc":"","navUrl":"","title":"节日特供"}]}, promoPair_flower_v01_home_08: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/flower_42.jpg","imageSrc":"","navUrl":"","title":"会员优惠"},{"bgColor":"#fff3e0","image":"/uploads/stock/flower_43.jpg","imageSrc":"","navUrl":"","title":"限时折扣"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_flower_v01_home_11();
    await this._mpLoadProducts_products_flower_v01_home_13()
  },
  async _mpLoadProducts_products_flower_v01_home_11() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("flower_v01_home_11");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_flower_v01_home_11 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_flower_v01_home_11: list });
    } catch (e) { this.mpDevWarn('product', "flower_v01_home_11", e); }
  },

  async _mpLoadProducts_products_flower_v01_home_13() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("flower_v01_home_13");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_flower_v01_home_13 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_flower_v01_home_13: list });
    } catch (e) { this.mpDevWarn('product', "flower_v01_home_13", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_flower_v01_home_03()
  },
  async _mpLoadSwiper_swiper_flower_v01_home_03() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("flower_v01_home_03"));
      ...
      var cur = this.data.swiper_flower_v01_home_03 || {};
      this.setData({
        swiper_flower_v01_home_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "flower_v01_home_03", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_flower_v01_home_04()
  },
  async _mpLoadNotice_notice_flower_v01_home_04() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("flower_v01_home_04"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_flower_v01_home_04: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "flower_v01_home_04", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_flower_v01_home_11, 'image'); if (list.length) this.setData({ products_flower_v01_home_11: list }); }
    { var list = withSrc(this.data.products_flower_v01_home_13, 'image'); if (list.length) this.setData({ products_flower_v01_home_13: list }); }
    { var wgt = this.data.swiper_flower_v01_home_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_flower_v01_home_03: next }); } }
  },
onShow() {
