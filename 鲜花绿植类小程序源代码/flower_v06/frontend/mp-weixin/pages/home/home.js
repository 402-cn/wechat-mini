...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_flower_v06_home_05: [{"id":7,"image":"/uploads/stock/flower_16.jpg","imageSrc":"","name":"白色百合","price":88},{"id":8,"image":"/uploads/stock/flower_17.jpg","imageSrc":"","name":"粉色百合","price":216},{"id":9,"image":"/uploads/stock/flower_18.jpg","imageSrc":"","name":"香水百合","price":344},{"id":10,"image":"/uploads/stock/flower_19.jpg","imageSrc":"","name":"百合花束","price":472}], productWidgets: [{"key":"products_flower_v06_home_05","cid":"flower_v06_home_05","limit":4}], swiper_flower_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/flower_50.jpg","imageSrc":"","link":"","title":"鲜花绿植"},{"image":"/uploads/stock/flower_51.jpg","imageSrc":"","link":"","title":"每日鲜花"},{"image":"/uploads/stock/flower_52.jpg","imageSrc":"","link":"","title":"节日特供"}] }, swiperWidgets: [{"key":"swiper_flower_v06_home_02","cid":"flower_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_flower_v06_home_05()
  },
  async _mpLoadProducts_products_flower_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("flower_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_flower_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_flower_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "flower_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_flower_v06_home_02()
  },
  async _mpLoadSwiper_swiper_flower_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("flower_v06_home_02"));
      ...
      var cur = this.data.swiper_flower_v06_home_02 || {};
      this.setData({
        swiper_flower_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "flower_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_flower_v06_home_05, 'image'); if (list.length) this.setData({ products_flower_v06_home_05: list }); }
    { var wgt = this.data.swiper_flower_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_flower_v06_home_02: next }); } }
  },
onShow() {
