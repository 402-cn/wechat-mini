...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_flower_v02_home_06: [{"id":1,"image":"/uploads/stock/flower_10.jpg","imageSrc":"","name":"红玫瑰11枝","price":88},{"id":2,"image":"/uploads/stock/flower_11.jpg","imageSrc":"","name":"粉玫瑰19枝","price":216},{"id":3,"image":"/uploads/stock/flower_12.jpg","imageSrc":"","name":"香槟玫瑰","price":344},{"id":4,"image":"/uploads/stock/flower_13.jpg","imageSrc":"","name":"蓝色妖姬","price":472},{"id":5,"image":"/uploads/stock/flower_14.jpg","imageSrc":"","name":"多头玫瑰","price":600},{"id":6,"image":"/uploads/stock/flower_15.jpg","imageSrc":"","name":"玫瑰礼盒","price":728},{"id":7,"image":"/uploads/stock/flower_16.jpg","imageSrc":"","name":"白色百合","price":88},{"id":8,"image":"/uploads/stock/flower_17.jpg","imageSrc":"","name":"粉色百合","price":216}], products_flower_v02_home_07: [{"id":13,"image":"/uploads/stock/flower_22.jpg","imageSrc":"","name":"康乃馨花束","price":88},{"id":14,"image":"/uploads/stock/flower_23.jpg","imageSrc":"","name":"母亲节花束","price":216},{"id":15,"image":"/uploads/stock/flower_24.jpg","imageSrc":"","name":"康乃馨盆栽","price":344}], productWidgets: [{"key":"products_flower_v02_home_06","cid":"flower_v02_home_06","limit":8},{"key":"products_flower_v02_home_07","cid":"flower_v02_home_07","limit":3}], swiper_flower_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/flower_8.jpg","imageSrc":"","link":"","title":"鲜花绿植"},{"image":"/uploads/stock/flower_9.jpg","imageSrc":"","link":"","title":"每日鲜花"}] }, swiperWidgets: [{"key":"swiper_flower_v02_home_02","cid":"flower_v02_home_02","height":280,"interval":3000}], notice_flower_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购鲜花绿植好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_flower_v02_home_03","cid":"flower_v02_home_03"}], gridNav_flower_v02_home_04: {"items":[{"icon":"/uploads/stock/flower_1.jpg","iconSrc":"","navUrl":"","text":"玫瑰"},{"icon":"/uploads/stock/flower_2.jpg","iconSrc":"","navUrl":"","text":"百合"},{"icon":"/uploads/stock/flower_3.jpg","iconSrc":"","navUrl":"","text":"康乃馨"},{"icon":"/uploads/stock/flower_4.jpg","iconSrc":"","navUrl":"","text":"多肉"},{"icon":"/uploads/stock/flower_5.jpg","iconSrc":"","navUrl":"","text":"绿植"},{"icon":"/uploads/stock/flower_6.jpg","iconSrc":"","navUrl":"","text":"盆栽"},{"icon":"/uploads/stock/flower_55.jpg","iconSrc":"","navUrl":"","text":"花束"},{"icon":"/uploads/stock/flower_56.jpg","iconSrc":"","navUrl":"","text":"礼盒"},{"icon":"/uploads/stock/flower_57.jpg","iconSrc":"","navUrl":"","text":"婚庆"},{"icon":"/uploads/stock/flower_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_flower_v02_home_06();
    await this._mpLoadProducts_products_flower_v02_home_07()
  },
  async _mpLoadProducts_products_flower_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("flower_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_flower_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_flower_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "flower_v02_home_06", e); }
  },

  async _mpLoadProducts_products_flower_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("flower_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_flower_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_flower_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "flower_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_flower_v02_home_02()
  },
  async _mpLoadSwiper_swiper_flower_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("flower_v02_home_02"));
      ...
      var cur = this.data.swiper_flower_v02_home_02 || {};
      this.setData({
        swiper_flower_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "flower_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_flower_v02_home_03()
  },
  async _mpLoadNotice_notice_flower_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("flower_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_flower_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "flower_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_flower_v02_home_06, 'image'); if (list.length) this.setData({ products_flower_v02_home_06: list }); }
    { var list = withSrc(this.data.products_flower_v02_home_07, 'image'); if (list.length) this.setData({ products_flower_v02_home_07: list }); }
    { var wgt = this.data.swiper_flower_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_flower_v02_home_02: next }); } }
  },
onShow() {
