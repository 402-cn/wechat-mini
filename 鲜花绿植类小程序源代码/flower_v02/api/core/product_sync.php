...
function demo_product_catalog(): array {
    return [
        [1, 1, '红玫瑰11枝', './assets/images/flower_10.jpg', 88.00],
        [2, 1, '粉玫瑰19枝', './assets/images/flower_11.jpg', 216.00],
        [3, 1, '香槟玫瑰', './assets/images/flower_12.jpg', 344.00],
        [4, 1, '蓝色妖姬', './assets/images/flower_13.jpg', 472.00],
        [5, 1, '多头玫瑰', './assets/images/flower_14.jpg', 600.00],
        [6, 1, '玫瑰礼盒', './assets/images/flower_15.jpg', 728.00],
        [7, 2, '白色百合', './assets/images/flower_16.jpg', 88.00],
        [8, 2, '粉色百合', './assets/images/flower_17.jpg', 216.00],
        [9, 2, '香水百合', './assets/images/flower_18.jpg', 344.00],
        [10, 2, '百合花束', './assets/images/flower_19.jpg', 472.00],
        [11, 2, '百合盆栽', './assets/images/flower_20.jpg', 600.00],
        [12, 2, '混搭百合', './assets/images/flower_21.jpg', 728.00],
        [13, 3, '康乃馨花束', './assets/images/flower_22.jpg', 88.00],
        [14, 3, '母亲节花束', './assets/images/flower_23.jpg', 216.00],
        [15, 3, '康乃馨盆栽', './assets/images/flower_24.jpg', 344.00],
        [16, 3, '混色康乃馨', './assets/images/flower_25.jpg', 472.00],
        [17, 3, '永生康乃馨', './assets/images/flower_26.jpg', 600.00],
        [18, 3, '康乃馨礼盒', './assets/images/flower_27.jpg', 728.00],
        [19, 4, '绿萝', './assets/images/flower_28.jpg', 88.00],
        [20, 4, '多肉组合', './assets/images/flower_29.jpg', 216.00],
        [21, 4, '发财树', './assets/images/flower_30.jpg', 344.00],
        [22, 4, '龟背竹', './assets/images/flower_31.jpg', 472.00],
        [23, 4, '仙人掌', './assets/images/flower_32.jpg', 600.00],
        [24, 4, '吊兰', './assets/images/flower_33.jpg', 728.00],
        [25, 5, '生日花束', './assets/images/flower_34.jpg', 88.00],
        [26, 5, '告白花束', './assets/images/flower_35.jpg', 216.00],
        [27, 5, '开业花篮', './assets/images/flower_36.jpg', 344.00],
        [28, 5, '探望花束', './assets/images/flower_37.jpg', 472.00],
        [29, 5, '永生花盒', './assets/images/flower_38.jpg', 600.00],
        [30, 5, 'weekly鲜花', './assets/images/flower_39.jpg', 728.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'玫瑰',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'百合',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'康乃馨',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'绿植',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'礼盒',5,1)");
