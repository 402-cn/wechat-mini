...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_flower_v03_home_08: [{"id":1,"image":"/uploads/stock/flower_10.jpg","imageSrc":"","name":"红玫瑰11枝","price":88},{"id":2,"image":"/uploads/stock/flower_11.jpg","imageSrc":"","name":"粉玫瑰19枝","price":216},{"id":3,"image":"/uploads/stock/flower_12.jpg","imageSrc":"","name":"香槟玫瑰","price":344},{"id":4,"image":"/uploads/stock/flower_13.jpg","imageSrc":"","name":"蓝色妖姬","price":472},{"id":5,"image":"/uploads/stock/flower_14.jpg","imageSrc":"","name":"多头玫瑰","price":600},{"id":6,"image":"/uploads/stock/flower_15.jpg","imageSrc":"","name":"玫瑰礼盒","price":728}], productWidgets: [{"key":"products_flower_v03_home_08","cid":"flower_v03_home_08","limit":6}], swiper_flower_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/flower_9.jpg","imageSrc":"","link":"","title":"鲜花绿植"},{"image":"/uploads/stock/flower_48.jpg","imageSrc":"","link":"","title":"每日鲜花"},{"image":"/uploads/stock/flower_49.jpg","imageSrc":"","link":"","title":"节日特供"}] }, swiperWidgets: [{"key":"swiper_flower_v03_home_02","cid":"flower_v03_home_02","height":340,"interval":3000}], promoPair_flower_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/flower_42.jpg","imageSrc":"","navUrl":"","title":"每日鲜花"},{"bgColor":"#fff3e0","image":"/uploads/stock/flower_43.jpg","imageSrc":"","navUrl":"","title":"节日特供"}]}, promoPair_flower_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/flower_44.jpg","imageSrc":"","navUrl":"","title":"会员优惠"},{"bgColor":"#fff3e0","image":"/uploads/stock/flower_45.jpg","imageSrc":"","navUrl":"","title":"限时折扣"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_flower_v03_home_08()
  },
  async _mpLoadProducts_products_flower_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("flower_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_flower_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_flower_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "flower_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_flower_v03_home_02()
  },
  async _mpLoadSwiper_swiper_flower_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("flower_v03_home_02"));
      ...
      var cur = this.data.swiper_flower_v03_home_02 || {};
      this.setData({
        swiper_flower_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "flower_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_flower_v03_home_08, 'image'); if (list.length) this.setData({ products_flower_v03_home_08: list }); }
    { var wgt = this.data.swiper_flower_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_flower_v03_home_02: next }); } }
  },
onShow() {
