...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_beauty_v03_home_08: [{"id":1,"image":"/uploads/stock/beauty_10.jpg","imageSrc":"","name":"保湿精华","price":89},{"id":2,"image":"/uploads/stock/beauty_11.jpg","imageSrc":"","name":"修护面霜","price":218},{"id":3,"image":"/uploads/stock/beauty_12.jpg","imageSrc":"","name":"防晒霜","price":347},{"id":4,"image":"/uploads/stock/beauty_13.jpg","imageSrc":"","name":"洁面乳","price":476},{"id":5,"image":"/uploads/stock/beauty_14.jpg","imageSrc":"","name":"爽肤水","price":605},{"id":6,"image":"/uploads/stock/beauty_15.jpg","imageSrc":"","name":"眼霜","price":734}], productWidgets: [{"key":"products_beauty_v03_home_08","cid":"beauty_v03_home_08","limit":6}], swiper_beauty_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/beauty_9.jpg","imageSrc":"","link":"","title":"美妆护肤"},{"image":"/uploads/stock/beauty_48.jpg","imageSrc":"","link":"","title":"大牌补贴"},{"image":"/uploads/stock/beauty_49.jpg","imageSrc":"","link":"","title":"新品首发"}] }, swiperWidgets: [{"key":"swiper_beauty_v03_home_02","cid":"beauty_v03_home_02","height":340,"interval":3000}], promoPair_beauty_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/beauty_42.jpg","imageSrc":"","navUrl":"","title":"大牌补贴"},{"bgColor":"#fff3e0","image":"/uploads/stock/beauty_43.jpg","imageSrc":"","navUrl":"","title":"新品首发"}]}, promoPair_beauty_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/beauty_44.jpg","imageSrc":"","navUrl":"","title":"会员礼遇"},{"bgColor":"#fff3e0","image":"/uploads/stock/beauty_45.jpg","imageSrc":"","navUrl":"","title":"限时抢购"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_beauty_v03_home_08()
  },
  async _mpLoadProducts_products_beauty_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("beauty_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_beauty_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_beauty_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "beauty_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_beauty_v03_home_02()
  },
  async _mpLoadSwiper_swiper_beauty_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("beauty_v03_home_02"));
      ...
      var cur = this.data.swiper_beauty_v03_home_02 || {};
      this.setData({
        swiper_beauty_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "beauty_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_beauty_v03_home_08, 'image'); if (list.length) this.setData({ products_beauty_v03_home_08: list }); }
    { var wgt = this.data.swiper_beauty_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_beauty_v03_home_02: next }); } }
  },
onShow() {
