...
function demo_product_catalog(): array {
    return [
        [1, 1, '保湿精华', './assets/images/beauty_10.jpg', 89.00],
        [2, 1, '修护面霜', './assets/images/beauty_11.jpg', 218.00],
        [3, 1, '防晒霜', './assets/images/beauty_12.jpg', 347.00],
        [4, 1, '洁面乳', './assets/images/beauty_13.jpg', 476.00],
        [5, 1, '爽肤水', './assets/images/beauty_14.jpg', 605.00],
        [6, 1, '眼霜', './assets/images/beauty_15.jpg', 734.00],
        [7, 2, '哑光口红', './assets/images/beauty_16.jpg', 89.00],
        [8, 2, '气垫粉底', './assets/images/beauty_17.jpg', 218.00],
        [9, 2, '眉笔', './assets/images/beauty_18.jpg', 347.00],
        [10, 2, '睫毛膏', './assets/images/beauty_19.jpg', 476.00],
        [11, 2, '腮红', './assets/images/beauty_20.jpg', 605.00],
        [12, 2, '定妆喷雾', './assets/images/beauty_21.jpg', 734.00],
        [13, 3, '补水面膜', './assets/images/beauty_22.jpg', 89.00],
        [14, 3, '美白面膜', './assets/images/beauty_23.jpg', 218.00],
        [15, 3, '清洁面膜', './assets/images/beauty_24.jpg', 347.00],
        [16, 3, '睡眠面膜', './assets/images/beauty_25.jpg', 476.00],
        [17, 3, '眼膜', './assets/images/beauty_26.jpg', 605.00],
        [18, 3, '颈膜', './assets/images/beauty_27.jpg', 734.00],
        [19, 4, '女士淡香水', './assets/images/beauty_28.jpg', 89.00],
        [20, 4, '男士古龙', './assets/images/beauty_29.jpg', 218.00],
        [21, 4, '中性香氛', './assets/images/beauty_30.jpg', 347.00],
        [22, 4, '旅行装香水', './assets/images/beauty_31.jpg', 476.00],
        [23, 4, '身体喷雾', './assets/images/beauty_32.jpg', 605.00],
        [24, 4, '香氛礼盒', './assets/images/beauty_33.jpg', 734.00],
        [25, 5, '洗发水', './assets/images/beauty_34.jpg', 89.00],
        [26, 5, '护发素', './assets/images/beauty_35.jpg', 218.00],
        [27, 5, '沐浴露', './assets/images/beauty_36.jpg', 347.00],
        [28, 5, '身体乳', './assets/images/beauty_37.jpg', 476.00],
        [29, 5, '护手霜', './assets/images/beauty_38.jpg', 605.00],
        [30, 5, '发膜', './assets/images/beauty_39.jpg', 734.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'护肤',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'彩妆',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'面膜',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'香水',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'洗护',5,1)");
