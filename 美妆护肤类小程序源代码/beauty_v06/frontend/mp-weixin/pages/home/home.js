...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_beauty_v06_home_05: [{"id":7,"image":"/uploads/stock/beauty_16.jpg","imageSrc":"","name":"哑光口红","price":89},{"id":8,"image":"/uploads/stock/beauty_17.jpg","imageSrc":"","name":"气垫粉底","price":218},{"id":9,"image":"/uploads/stock/beauty_18.jpg","imageSrc":"","name":"眉笔","price":347},{"id":10,"image":"/uploads/stock/beauty_19.jpg","imageSrc":"","name":"睫毛膏","price":476}], productWidgets: [{"key":"products_beauty_v06_home_05","cid":"beauty_v06_home_05","limit":4}], swiper_beauty_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/beauty_50.jpg","imageSrc":"","link":"","title":"美妆护肤"},{"image":"/uploads/stock/beauty_51.jpg","imageSrc":"","link":"","title":"大牌补贴"},{"image":"/uploads/stock/beauty_52.jpg","imageSrc":"","link":"","title":"新品首发"}] }, swiperWidgets: [{"key":"swiper_beauty_v06_home_02","cid":"beauty_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_beauty_v06_home_05()
  },
  async _mpLoadProducts_products_beauty_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("beauty_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_beauty_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_beauty_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "beauty_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_beauty_v06_home_02()
  },
  async _mpLoadSwiper_swiper_beauty_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("beauty_v06_home_02"));
      ...
      var cur = this.data.swiper_beauty_v06_home_02 || {};
      this.setData({
        swiper_beauty_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "beauty_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_beauty_v06_home_05, 'image'); if (list.length) this.setData({ products_beauty_v06_home_05: list }); }
    { var wgt = this.data.swiper_beauty_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_beauty_v06_home_02: next }); } }
  },
onShow() {
