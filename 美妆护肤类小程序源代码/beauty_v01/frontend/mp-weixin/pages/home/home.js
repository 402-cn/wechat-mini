...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_beauty_v01_home_11: [{"id":1,"image":"/uploads/stock/beauty_10.jpg","imageSrc":"","name":"保湿精华","price":89},{"id":2,"image":"/uploads/stock/beauty_11.jpg","imageSrc":"","name":"修护面霜","price":218},{"id":3,"image":"/uploads/stock/beauty_12.jpg","imageSrc":"","name":"防晒霜","price":347}], products_beauty_v01_home_13: [{"id":7,"image":"/uploads/stock/beauty_16.jpg","imageSrc":"","name":"哑光口红","price":89},{"id":8,"image":"/uploads/stock/beauty_17.jpg","imageSrc":"","name":"气垫粉底","price":218},{"id":9,"image":"/uploads/stock/beauty_18.jpg","imageSrc":"","name":"眉笔","price":347},{"id":10,"image":"/uploads/stock/beauty_19.jpg","imageSrc":"","name":"睫毛膏","price":476},{"id":11,"image":"/uploads/stock/beauty_20.jpg","imageSrc":"","name":"腮红","price":605},{"id":12,"image":"/uploads/stock/beauty_21.jpg","imageSrc":"","name":"定妆喷雾","price":734}], productWidgets: [{"key":"products_beauty_v01_home_11","cid":"beauty_v01_home_11","limit":3},{"key":"products_beauty_v01_home_13","cid":"beauty_v01_home_13","limit":6}], swiper_beauty_v01_home_03: { height: 320, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/beauty_7.jpg","imageSrc":"","link":"","title":"美妆护肤"},{"image":"/uploads/stock/beauty_8.jpg","imageSrc":"","link":"","title":"大牌补贴"},{"image":"/uploads/stock/beauty_9.jpg","imageSrc":"","link":"","title":"新品首发"}] }, swiperWidgets: [{"key":"swiper_beauty_v01_home_03","cid":"beauty_v01_home_03","height":320,"interval":3000}], notice_beauty_v01_home_04: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购美妆护肤好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_beauty_v01_home_04","cid":"beauty_v01_home_04"}], gridNav_beauty_v01_home_02: {"items":[{"icon":"/uploads/stock/beauty_1.jpg","iconSrc":"","navUrl":"","text":"再买一单"},{"icon":"/uploads/stock/beauty_2.jpg","iconSrc":"","navUrl":"","text":"会员中心"},{"icon":"/uploads/stock/beauty_3.jpg","iconSrc":"","navUrl":"","text":"优惠券"},{"icon":"/uploads/stock/beauty_4.jpg","iconSrc":"","navUrl":"","text":"我的订单"}]}, gridNav_beauty_v01_home_05: {"items":[{"icon":"/uploads/stock/beauty_1.jpg","iconSrc":"","navUrl":"","text":"极速达"},{"icon":"/uploads/stock/beauty_2.jpg","iconSrc":"","navUrl":"","text":"品质保障"},{"icon":"/uploads/stock/beauty_3.jpg","iconSrc":"","navUrl":"","text":"售后无忧"}]}, gridNav_beauty_v01_home_06: {"items":[{"icon":"/uploads/stock/beauty_1.jpg","iconSrc":"","navUrl":"","text":"护肤"},{"icon":"/uploads/stock/beauty_2.jpg","iconSrc":"","navUrl":"","text":"彩妆"},{"icon":"/uploads/stock/beauty_3.jpg","iconSrc":"","navUrl":"","text":"面膜"},{"icon":"/uploads/stock/beauty_4.jpg","iconSrc":"","navUrl":"","text":"香水"},{"icon":"/uploads/stock/beauty_5.jpg","iconSrc":"","navUrl":"","text":"洗护"},{"icon":"/uploads/stock/beauty_6.jpg","iconSrc":"","navUrl":"","text":"工具"},{"icon":"/uploads/stock/beauty_55.jpg","iconSrc":"","navUrl":"","text":"男士"},{"icon":"/uploads/stock/beauty_56.jpg","iconSrc":"","navUrl":"","text":"礼盒"},{"icon":"/uploads/stock/beauty_57.jpg","iconSrc":"","navUrl":"","text":"大牌"},{"icon":"/uploads/stock/beauty_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]}, promoPair_beauty_v01_home_07: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/beauty_40.jpg","imageSrc":"","navUrl":"","title":"大牌补贴"},{"bgColor":"#fff3e0","image":"/uploads/stock/beauty_41.jpg","imageSrc":"","navUrl":"","title":"新品首发"}]}, promoPair_beauty_v01_home_08: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/beauty_42.jpg","imageSrc":"","navUrl":"","title":"会员礼遇"},{"bgColor":"#fff3e0","image":"/uploads/stock/beauty_43.jpg","imageSrc":"","navUrl":"","title":"限时抢购"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_beauty_v01_home_11();
    await this._mpLoadProducts_products_beauty_v01_home_13()
  },
  async _mpLoadProducts_products_beauty_v01_home_11() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("beauty_v01_home_11");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_beauty_v01_home_11 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_beauty_v01_home_11: list });
    } catch (e) { this.mpDevWarn('product', "beauty_v01_home_11", e); }
  },

  async _mpLoadProducts_products_beauty_v01_home_13() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("beauty_v01_home_13");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_beauty_v01_home_13 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_beauty_v01_home_13: list });
    } catch (e) { this.mpDevWarn('product', "beauty_v01_home_13", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_beauty_v01_home_03()
  },
  async _mpLoadSwiper_swiper_beauty_v01_home_03() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("beauty_v01_home_03"));
      ...
      var cur = this.data.swiper_beauty_v01_home_03 || {};
      this.setData({
        swiper_beauty_v01_home_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "beauty_v01_home_03", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_beauty_v01_home_04()
  },
  async _mpLoadNotice_notice_beauty_v01_home_04() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("beauty_v01_home_04"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_beauty_v01_home_04: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "beauty_v01_home_04", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_beauty_v01_home_11, 'image'); if (list.length) this.setData({ products_beauty_v01_home_11: list }); }
    { var list = withSrc(this.data.products_beauty_v01_home_13, 'image'); if (list.length) this.setData({ products_beauty_v01_home_13: list }); }
    { var wgt = this.data.swiper_beauty_v01_home_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_beauty_v01_home_03: next }); } }
  },
onShow() {
