...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_beauty_v02_home_06: [{"id":1,"image":"/uploads/stock/beauty_10.jpg","imageSrc":"","name":"保湿精华","price":89},{"id":2,"image":"/uploads/stock/beauty_11.jpg","imageSrc":"","name":"修护面霜","price":218},{"id":3,"image":"/uploads/stock/beauty_12.jpg","imageSrc":"","name":"防晒霜","price":347},{"id":4,"image":"/uploads/stock/beauty_13.jpg","imageSrc":"","name":"洁面乳","price":476},{"id":5,"image":"/uploads/stock/beauty_14.jpg","imageSrc":"","name":"爽肤水","price":605},{"id":6,"image":"/uploads/stock/beauty_15.jpg","imageSrc":"","name":"眼霜","price":734},{"id":7,"image":"/uploads/stock/beauty_16.jpg","imageSrc":"","name":"哑光口红","price":89},{"id":8,"image":"/uploads/stock/beauty_17.jpg","imageSrc":"","name":"气垫粉底","price":218}], products_beauty_v02_home_07: [{"id":13,"image":"/uploads/stock/beauty_22.jpg","imageSrc":"","name":"补水面膜","price":89},{"id":14,"image":"/uploads/stock/beauty_23.jpg","imageSrc":"","name":"美白面膜","price":218},{"id":15,"image":"/uploads/stock/beauty_24.jpg","imageSrc":"","name":"清洁面膜","price":347}], productWidgets: [{"key":"products_beauty_v02_home_06","cid":"beauty_v02_home_06","limit":8},{"key":"products_beauty_v02_home_07","cid":"beauty_v02_home_07","limit":3}], swiper_beauty_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/beauty_8.jpg","imageSrc":"","link":"","title":"美妆护肤"},{"image":"/uploads/stock/beauty_9.jpg","imageSrc":"","link":"","title":"大牌补贴"}] }, swiperWidgets: [{"key":"swiper_beauty_v02_home_02","cid":"beauty_v02_home_02","height":280,"interval":3000}], notice_beauty_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购美妆护肤好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_beauty_v02_home_03","cid":"beauty_v02_home_03"}], gridNav_beauty_v02_home_04: {"items":[{"icon":"/uploads/stock/beauty_1.jpg","iconSrc":"","navUrl":"","text":"护肤"},{"icon":"/uploads/stock/beauty_2.jpg","iconSrc":"","navUrl":"","text":"彩妆"},{"icon":"/uploads/stock/beauty_3.jpg","iconSrc":"","navUrl":"","text":"面膜"},{"icon":"/uploads/stock/beauty_4.jpg","iconSrc":"","navUrl":"","text":"香水"},{"icon":"/uploads/stock/beauty_5.jpg","iconSrc":"","navUrl":"","text":"洗护"},{"icon":"/uploads/stock/beauty_6.jpg","iconSrc":"","navUrl":"","text":"工具"},{"icon":"/uploads/stock/beauty_55.jpg","iconSrc":"","navUrl":"","text":"男士"},{"icon":"/uploads/stock/beauty_56.jpg","iconSrc":"","navUrl":"","text":"礼盒"},{"icon":"/uploads/stock/beauty_57.jpg","iconSrc":"","navUrl":"","text":"大牌"},{"icon":"/uploads/stock/beauty_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_beauty_v02_home_06();
    await this._mpLoadProducts_products_beauty_v02_home_07()
  },
  async _mpLoadProducts_products_beauty_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("beauty_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_beauty_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_beauty_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "beauty_v02_home_06", e); }
  },

  async _mpLoadProducts_products_beauty_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("beauty_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_beauty_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_beauty_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "beauty_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_beauty_v02_home_02()
  },
  async _mpLoadSwiper_swiper_beauty_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("beauty_v02_home_02"));
      ...
      var cur = this.data.swiper_beauty_v02_home_02 || {};
      this.setData({
        swiper_beauty_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "beauty_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_beauty_v02_home_03()
  },
  async _mpLoadNotice_notice_beauty_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("beauty_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_beauty_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "beauty_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_beauty_v02_home_06, 'image'); if (list.length) this.setData({ products_beauty_v02_home_06: list }); }
    { var list = withSrc(this.data.products_beauty_v02_home_07, 'image'); if (list.length) this.setData({ products_beauty_v02_home_07: list }); }
    { var wgt = this.data.swiper_beauty_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_beauty_v02_home_02: next }); } }
  },
onShow() {
