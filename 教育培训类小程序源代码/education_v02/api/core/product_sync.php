...
function demo_product_catalog(): array {
    return [
        [1, 1, '语文基础班', './assets/images/education_10.jpg', 99.00],
        [2, 1, '阅读写作班', './assets/images/education_11.jpg', 298.00],
        [3, 1, '作文提升', './assets/images/education_12.jpg', 497.00],
        [4, 1, '古诗词', './assets/images/education_13.jpg', 696.00],
        [5, 1, '拼音启蒙', './assets/images/education_14.jpg', 895.00],
        [6, 1, '文言文', './assets/images/education_15.jpg', 1094.00],
        [7, 2, '数学思维', './assets/images/education_16.jpg', 99.00],
        [8, 2, '奥数提高', './assets/images/education_17.jpg', 298.00],
        [9, 2, '口算训练', './assets/images/education_18.jpg', 497.00],
        [10, 2, '几何专题', './assets/images/education_19.jpg', 696.00],
        [11, 2, '应用题', './assets/images/education_20.jpg', 895.00],
        [12, 2, '中考冲刺', './assets/images/education_21.jpg', 1094.00],
        [13, 3, '英语口语', './assets/images/education_22.jpg', 99.00],
        [14, 3, '自然拼读', './assets/images/education_23.jpg', 298.00],
        [15, 3, '新概念英语', './assets/images/education_24.jpg', 497.00],
        [16, 3, '雅思入门', './assets/images/education_25.jpg', 696.00],
        [17, 3, '托福基础', './assets/images/education_26.jpg', 895.00],
        [18, 3, '少儿英语', './assets/images/education_27.jpg', 1094.00],
        [19, 4, 'Scratch编程', './assets/images/education_28.jpg', 99.00],
        [20, 4, 'Python入门', './assets/images/education_29.jpg', 298.00],
        [21, 4, 'C++竞赛', './assets/images/education_30.jpg', 497.00],
        [22, 4, '机器人', './assets/images/education_31.jpg', 696.00],
        [23, 4, 'AI启蒙', './assets/images/education_32.jpg', 895.00],
        [24, 4, '信息学', './assets/images/education_33.jpg', 1094.00],
        [25, 5, '美术绘画', './assets/images/education_34.jpg', 99.00],
        [26, 5, '书法', './assets/images/education_35.jpg', 298.00],
        [27, 5, '钢琴', './assets/images/education_36.jpg', 497.00],
        [28, 5, '舞蹈', './assets/images/education_37.jpg', 696.00],
        [29, 5, '声乐', './assets/images/education_38.jpg', 895.00],
        [30, 5, '围棋', './assets/images/education_39.jpg', 1094.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'语文',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'数学',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'英语',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'编程',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'艺术',5,1)");
