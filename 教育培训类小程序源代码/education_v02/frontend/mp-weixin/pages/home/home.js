...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_education_v02_home_06: [{"id":1,"image":"/uploads/stock/education_10.jpg","imageSrc":"","name":"语文基础班","price":99},{"id":2,"image":"/uploads/stock/education_11.jpg","imageSrc":"","name":"阅读写作班","price":298},{"id":3,"image":"/uploads/stock/education_12.jpg","imageSrc":"","name":"作文提升","price":497},{"id":4,"image":"/uploads/stock/education_13.jpg","imageSrc":"","name":"古诗词","price":696},{"id":5,"image":"/uploads/stock/education_14.jpg","imageSrc":"","name":"拼音启蒙","price":895},{"id":6,"image":"/uploads/stock/education_15.jpg","imageSrc":"","name":"文言文","price":1094},{"id":7,"image":"/uploads/stock/education_16.jpg","imageSrc":"","name":"数学思维","price":99},{"id":8,"image":"/uploads/stock/education_17.jpg","imageSrc":"","name":"奥数提高","price":298}], products_education_v02_home_07: [{"id":13,"image":"/uploads/stock/education_22.jpg","imageSrc":"","name":"英语口语","price":99},{"id":14,"image":"/uploads/stock/education_23.jpg","imageSrc":"","name":"自然拼读","price":298},{"id":15,"image":"/uploads/stock/education_24.jpg","imageSrc":"","name":"新概念英语","price":497}], productWidgets: [{"key":"products_education_v02_home_06","cid":"education_v02_home_06","limit":8},{"key":"products_education_v02_home_07","cid":"education_v02_home_07","limit":3}], swiper_education_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/education_8.jpg","imageSrc":"","link":"","title":"教育培训"},{"image":"/uploads/stock/education_9.jpg","imageSrc":"","link":"","title":"免费试听"}] }, swiperWidgets: [{"key":"swiper_education_v02_home_02","cid":"education_v02_home_02","height":280,"interval":3000}], notice_education_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购教育培训好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_education_v02_home_03","cid":"education_v02_home_03"}], gridNav_education_v02_home_04: {"items":[{"icon":"/uploads/stock/education_1.jpg","iconSrc":"","navUrl":"","text":"语文"},{"icon":"/uploads/stock/education_2.jpg","iconSrc":"","navUrl":"","text":"数学"},{"icon":"/uploads/stock/education_3.jpg","iconSrc":"","navUrl":"","text":"英语"},{"icon":"/uploads/stock/education_4.jpg","iconSrc":"","navUrl":"","text":"编程"},{"icon":"/uploads/stock/education_5.jpg","iconSrc":"","navUrl":"","text":"艺术"},{"icon":"/uploads/stock/education_6.jpg","iconSrc":"","navUrl":"","text":"体育"},{"icon":"/uploads/stock/education_55.jpg","iconSrc":"","navUrl":"","text":"考研"},{"icon":"/uploads/stock/education_56.jpg","iconSrc":"","navUrl":"","text":"考证"},{"icon":"/uploads/stock/education_57.jpg","iconSrc":"","navUrl":"","text":"少儿"},{"icon":"/uploads/stock/education_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_education_v02_home_06();
    await this._mpLoadProducts_products_education_v02_home_07()
  },
  async _mpLoadProducts_products_education_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("education_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_education_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_education_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "education_v02_home_06", e); }
  },

  async _mpLoadProducts_products_education_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("education_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_education_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_education_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "education_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_education_v02_home_02()
  },
  async _mpLoadSwiper_swiper_education_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("education_v02_home_02"));
      ...
      var cur = this.data.swiper_education_v02_home_02 || {};
      this.setData({
        swiper_education_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "education_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_education_v02_home_03()
  },
  async _mpLoadNotice_notice_education_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("education_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_education_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "education_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_education_v02_home_06, 'image'); if (list.length) this.setData({ products_education_v02_home_06: list }); }
    { var list = withSrc(this.data.products_education_v02_home_07, 'image'); if (list.length) this.setData({ products_education_v02_home_07: list }); }
    { var wgt = this.data.swiper_education_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_education_v02_home_02: next }); } }
  },
onShow() {
