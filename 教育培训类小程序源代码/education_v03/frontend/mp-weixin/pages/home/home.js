...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_education_v03_home_08: [{"id":1,"image":"/uploads/stock/education_10.jpg","imageSrc":"","name":"语文基础班","price":99},{"id":2,"image":"/uploads/stock/education_11.jpg","imageSrc":"","name":"阅读写作班","price":298},{"id":3,"image":"/uploads/stock/education_12.jpg","imageSrc":"","name":"作文提升","price":497},{"id":4,"image":"/uploads/stock/education_13.jpg","imageSrc":"","name":"古诗词","price":696},{"id":5,"image":"/uploads/stock/education_14.jpg","imageSrc":"","name":"拼音启蒙","price":895},{"id":6,"image":"/uploads/stock/education_15.jpg","imageSrc":"","name":"文言文","price":1094}], productWidgets: [{"key":"products_education_v03_home_08","cid":"education_v03_home_08","limit":6}], swiper_education_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/education_9.jpg","imageSrc":"","link":"","title":"教育培训"},{"image":"/uploads/stock/education_48.jpg","imageSrc":"","link":"","title":"免费试听"},{"image":"/uploads/stock/education_49.jpg","imageSrc":"","link":"","title":"限时优惠"}] }, swiperWidgets: [{"key":"swiper_education_v03_home_02","cid":"education_v03_home_02","height":340,"interval":3000}], promoPair_education_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/education_42.jpg","imageSrc":"","navUrl":"","title":"免费试听"},{"bgColor":"#fff3e0","image":"/uploads/stock/education_43.jpg","imageSrc":"","navUrl":"","title":"限时优惠"}]}, promoPair_education_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/education_44.jpg","imageSrc":"","navUrl":"","title":"会员课程"},{"bgColor":"#fff3e0","image":"/uploads/stock/education_45.jpg","imageSrc":"","navUrl":"","title":"热门推荐"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_education_v03_home_08()
  },
  async _mpLoadProducts_products_education_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("education_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_education_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_education_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "education_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_education_v03_home_02()
  },
  async _mpLoadSwiper_swiper_education_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("education_v03_home_02"));
      ...
      var cur = this.data.swiper_education_v03_home_02 || {};
      this.setData({
        swiper_education_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "education_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_education_v03_home_08, 'image'); if (list.length) this.setData({ products_education_v03_home_08: list }); }
    { var wgt = this.data.swiper_education_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_education_v03_home_02: next }); } }
  },
onShow() {
