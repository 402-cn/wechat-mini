...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_education_v01_home_11: [{"id":1,"image":"/uploads/stock/education_10.jpg","imageSrc":"","name":"语文基础班","price":99},{"id":2,"image":"/uploads/stock/education_11.jpg","imageSrc":"","name":"阅读写作班","price":298},{"id":3,"image":"/uploads/stock/education_12.jpg","imageSrc":"","name":"作文提升","price":497}], products_education_v01_home_13: [{"id":7,"image":"/uploads/stock/education_16.jpg","imageSrc":"","name":"数学思维","price":99},{"id":8,"image":"/uploads/stock/education_17.jpg","imageSrc":"","name":"奥数提高","price":298},{"id":9,"image":"/uploads/stock/education_18.jpg","imageSrc":"","name":"口算训练","price":497},{"id":10,"image":"/uploads/stock/education_19.jpg","imageSrc":"","name":"几何专题","price":696},{"id":11,"image":"/uploads/stock/education_20.jpg","imageSrc":"","name":"应用题","price":895},{"id":12,"image":"/uploads/stock/education_21.jpg","imageSrc":"","name":"中考冲刺","price":1094}], productWidgets: [{"key":"products_education_v01_home_11","cid":"education_v01_home_11","limit":3},{"key":"products_education_v01_home_13","cid":"education_v01_home_13","limit":6}], swiper_education_v01_home_03: { height: 320, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/education_7.jpg","imageSrc":"","link":"","title":"教育培训"},{"image":"/uploads/stock/education_8.jpg","imageSrc":"","link":"","title":"免费试听"},{"image":"/uploads/stock/education_9.jpg","imageSrc":"","link":"","title":"限时优惠"}] }, swiperWidgets: [{"key":"swiper_education_v01_home_03","cid":"education_v01_home_03","height":320,"interval":3000}], notice_education_v01_home_04: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购教育培训好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_education_v01_home_04","cid":"education_v01_home_04"}], gridNav_education_v01_home_02: {"items":[{"icon":"/uploads/stock/education_1.jpg","iconSrc":"","navUrl":"","text":"再买一单"},{"icon":"/uploads/stock/education_2.jpg","iconSrc":"","navUrl":"","text":"会员中心"},{"icon":"/uploads/stock/education_3.jpg","iconSrc":"","navUrl":"","text":"优惠券"},{"icon":"/uploads/stock/education_4.jpg","iconSrc":"","navUrl":"","text":"我的订单"}]}, gridNav_education_v01_home_05: {"items":[{"icon":"/uploads/stock/education_1.jpg","iconSrc":"","navUrl":"","text":"极速达"},{"icon":"/uploads/stock/education_2.jpg","iconSrc":"","navUrl":"","text":"品质保障"},{"icon":"/uploads/stock/education_3.jpg","iconSrc":"","navUrl":"","text":"售后无忧"}]}, gridNav_education_v01_home_06: {"items":[{"icon":"/uploads/stock/education_1.jpg","iconSrc":"","navUrl":"","text":"语文"},{"icon":"/uploads/stock/education_2.jpg","iconSrc":"","navUrl":"","text":"数学"},{"icon":"/uploads/stock/education_3.jpg","iconSrc":"","navUrl":"","text":"英语"},{"icon":"/uploads/stock/education_4.jpg","iconSrc":"","navUrl":"","text":"编程"},{"icon":"/uploads/stock/education_5.jpg","iconSrc":"","navUrl":"","text":"艺术"},{"icon":"/uploads/stock/education_6.jpg","iconSrc":"","navUrl":"","text":"体育"},{"icon":"/uploads/stock/education_55.jpg","iconSrc":"","navUrl":"","text":"考研"},{"icon":"/uploads/stock/education_56.jpg","iconSrc":"","navUrl":"","text":"考证"},{"icon":"/uploads/stock/education_57.jpg","iconSrc":"","navUrl":"","text":"少儿"},{"icon":"/uploads/stock/education_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]}, promoPair_education_v01_home_07: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/education_40.jpg","imageSrc":"","navUrl":"","title":"免费试听"},{"bgColor":"#fff3e0","image":"/uploads/stock/education_41.jpg","imageSrc":"","navUrl":"","title":"限时优惠"}]}, promoPair_education_v01_home_08: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/education_42.jpg","imageSrc":"","navUrl":"","title":"会员课程"},{"bgColor":"#fff3e0","image":"/uploads/stock/education_43.jpg","imageSrc":"","navUrl":"","title":"热门推荐"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_education_v01_home_11();
    await this._mpLoadProducts_products_education_v01_home_13()
  },
  async _mpLoadProducts_products_education_v01_home_11() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("education_v01_home_11");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_education_v01_home_11 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_education_v01_home_11: list });
    } catch (e) { this.mpDevWarn('product', "education_v01_home_11", e); }
  },

  async _mpLoadProducts_products_education_v01_home_13() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("education_v01_home_13");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_education_v01_home_13 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_education_v01_home_13: list });
    } catch (e) { this.mpDevWarn('product', "education_v01_home_13", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_education_v01_home_03()
  },
  async _mpLoadSwiper_swiper_education_v01_home_03() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("education_v01_home_03"));
      ...
      var cur = this.data.swiper_education_v01_home_03 || {};
      this.setData({
        swiper_education_v01_home_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "education_v01_home_03", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_education_v01_home_04()
  },
  async _mpLoadNotice_notice_education_v01_home_04() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("education_v01_home_04"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_education_v01_home_04: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "education_v01_home_04", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_education_v01_home_11, 'image'); if (list.length) this.setData({ products_education_v01_home_11: list }); }
    { var list = withSrc(this.data.products_education_v01_home_13, 'image'); if (list.length) this.setData({ products_education_v01_home_13: list }); }
    { var wgt = this.data.swiper_education_v01_home_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_education_v01_home_03: next }); } }
  },
onShow() {
