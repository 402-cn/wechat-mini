...
function demo_product_catalog(): array {
    return [
        [1, 1, '法务通精选款A', './assets/images/legal_service_10.jpg', 39.00],
        [2, 1, '法务通精选款B', './assets/images/legal_service_11.jpg', 88.00],
        [3, 1, '法务通精选款C', './assets/images/legal_service_12.jpg', 137.00],
        [4, 1, '法务通精选款D', './assets/images/legal_service_13.jpg', 186.00],
        [5, 1, '法务通精选款E', './assets/images/legal_service_14.jpg', 235.00],
        [6, 1, '法务通精选款F', './assets/images/legal_service_15.jpg', 284.00],
        [7, 2, '热销单品1', './assets/images/legal_service_16.jpg', 39.00],
        [8, 2, '热销单品2', './assets/images/legal_service_17.jpg', 88.00],
        [9, 2, '热销单品3', './assets/images/legal_service_18.jpg', 137.00],
        [10, 2, '热销单品4', './assets/images/legal_service_19.jpg', 186.00],
        [11, 2, '热销单品5', './assets/images/legal_service_20.jpg', 235.00],
        [12, 2, '热销单品6', './assets/images/legal_service_21.jpg', 284.00],
        [13, 3, '新品推荐1', './assets/images/legal_service_22.jpg', 39.00],
        [14, 3, '新品推荐2', './assets/images/legal_service_23.jpg', 88.00],
        [15, 3, '新品推荐3', './assets/images/legal_service_24.jpg', 137.00],
        [16, 3, '新品推荐4', './assets/images/legal_service_25.jpg', 186.00],
        [17, 3, '新品推荐5', './assets/images/legal_service_26.jpg', 235.00],
        [18, 3, '新品推荐6', './assets/images/legal_service_27.jpg', 284.00],
        [19, 4, '套餐服务1', './assets/images/legal_service_28.jpg', 39.00],
        [20, 4, '套餐服务2', './assets/images/legal_service_29.jpg', 88.00],
        [21, 4, '套餐服务3', './assets/images/legal_service_30.jpg', 137.00],
        [22, 4, '套餐服务4', './assets/images/legal_service_31.jpg', 186.00],
        [23, 4, '套餐服务5', './assets/images/legal_service_32.jpg', 235.00],
        [24, 4, '套餐服务6', './assets/images/legal_service_33.jpg', 284.00],
        [25, 5, '会员专享1', './assets/images/legal_service_34.jpg', 39.00],
        [26, 5, '会员专享2', './assets/images/legal_service_35.jpg', 88.00],
        [27, 5, '会员专享3', './assets/images/legal_service_36.jpg', 137.00],
        [28, 5, '会员专享4', './assets/images/legal_service_37.jpg', 186.00],
        [29, 5, '会员专享5', './assets/images/legal_service_38.jpg', 235.00],
        [30, 5, '会员专享6', './assets/images/legal_service_39.jpg', 284.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'咨询',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'合同',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'诉讼',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'知产',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'公司法',5,1)");
