...
try {
    $pdo = db();
    ensure_form_table_columns($pdo, 'legal_service_v04_home_contact', array(
    ...
    $stmt = $pdo->prepare('INSERT INTO `legal_service_v04_home_contact` (`name`, `phone`, `message`) VALUES (?, ?, ?)');
    $stmt->execute($values);
