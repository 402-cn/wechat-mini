...
function demo_product_catalog(): array {
    return [
        [1, 1, '婴儿配方奶粉1段', './assets/images/mother_baby_10.jpg', 49.00],
        [2, 1, '婴儿配方奶粉2段', './assets/images/mother_baby_11.jpg', 118.00],
        [3, 1, '有机奶粉', './assets/images/mother_baby_12.jpg', 187.00],
        [4, 1, '羊奶粉', './assets/images/mother_baby_13.jpg', 256.00],
        [5, 1, '特殊配方奶粉', './assets/images/mother_baby_14.jpg', 325.00],
        [6, 1, '试用装奶粉', './assets/images/mother_baby_15.jpg', 394.00],
        [7, 2, '纸尿裤S码', './assets/images/mother_baby_16.jpg', 49.00],
        [8, 2, '纸尿裤M码', './assets/images/mother_baby_17.jpg', 118.00],
        [9, 2, '纸尿裤L码', './assets/images/mother_baby_18.jpg', 187.00],
        [10, 2, '拉拉裤', './assets/images/mother_baby_19.jpg', 256.00],
        [11, 2, '湿巾', './assets/images/mother_baby_20.jpg', 325.00],
        [12, 2, '棉柔巾', './assets/images/mother_baby_21.jpg', 394.00],
        [13, 3, '婴儿米粉', './assets/images/mother_baby_22.jpg', 49.00],
        [14, 3, '果泥', './assets/images/mother_baby_23.jpg', 118.00],
        [15, 3, '磨牙棒', './assets/images/mother_baby_24.jpg', 187.00],
        [16, 3, '营养面', './assets/images/mother_baby_25.jpg', 256.00],
        [17, 3, '肉松', './assets/images/mother_baby_26.jpg', 325.00],
        [18, 3, '溶豆', './assets/images/mother_baby_27.jpg', 394.00],
        [19, 4, '积木玩具', './assets/images/mother_baby_28.jpg', 49.00],
        [20, 4, '安抚玩偶', './assets/images/mother_baby_29.jpg', 118.00],
        [21, 4, '早教机', './assets/images/mother_baby_30.jpg', 187.00],
        [22, 4, '绘本', './assets/images/mother_baby_31.jpg', 256.00],
        [23, 4, '滑板车', './assets/images/mother_baby_32.jpg', 325.00],
        [24, 4, '拼图', './assets/images/mother_baby_33.jpg', 394.00],
        [25, 5, '连体衣', './assets/images/mother_baby_34.jpg', 49.00],
        [26, 5, '爬服', './assets/images/mother_baby_35.jpg', 118.00],
        [27, 5, '外套', './assets/images/mother_baby_36.jpg', 187.00],
        [28, 5, '帽子', './assets/images/mother_baby_37.jpg', 256.00],
        [29, 5, '袜子', './assets/images/mother_baby_38.jpg', 325.00],
        [30, 5, '睡袋', './assets/images/mother_baby_39.jpg', 394.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'奶粉',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'尿裤',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'辅食',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'玩具',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'童装',5,1)");
