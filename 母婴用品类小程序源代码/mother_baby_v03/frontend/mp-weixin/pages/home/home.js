...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_mother_baby_v03_home_08: [{"id":1,"image":"/uploads/stock/mother_baby_10.jpg","imageSrc":"","name":"婴儿配方奶粉1段","price":49},{"id":2,"image":"/uploads/stock/mother_baby_11.jpg","imageSrc":"","name":"婴儿配方奶粉2段","price":118},{"id":3,"image":"/uploads/stock/mother_baby_12.jpg","imageSrc":"","name":"有机奶粉","price":187},{"id":4,"image":"/uploads/stock/mother_baby_13.jpg","imageSrc":"","name":"羊奶粉","price":256},{"id":5,"image":"/uploads/stock/mother_baby_14.jpg","imageSrc":"","name":"特殊配方奶粉","price":325},{"id":6,"image":"/uploads/stock/mother_baby_15.jpg","imageSrc":"","name":"试用装奶粉","price":394}], productWidgets: [{"key":"products_mother_baby_v03_home_08","cid":"mother_baby_v03_home_08","limit":6}], swiper_mother_baby_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/mother_baby_9.jpg","imageSrc":"","link":"","title":"母婴用品"},{"image":"/uploads/stock/mother_baby_48.jpg","imageSrc":"","link":"","title":"孕妈专享"},{"image":"/uploads/stock/mother_baby_49.jpg","imageSrc":"","link":"","title":"宝宝好物"}] }, swiperWidgets: [{"key":"swiper_mother_baby_v03_home_02","cid":"mother_baby_v03_home_02","height":340,"interval":3000}], promoPair_mother_baby_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/mother_baby_42.jpg","imageSrc":"","navUrl":"","title":"孕妈专享"},{"bgColor":"#fff3e0","image":"/uploads/stock/mother_baby_43.jpg","imageSrc":"","navUrl":"","title":"宝宝好物"}]}, promoPair_mother_baby_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/mother_baby_44.jpg","imageSrc":"","navUrl":"","title":"会员礼包"},{"bgColor":"#fff3e0","image":"/uploads/stock/mother_baby_45.jpg","imageSrc":"","navUrl":"","title":"限时特惠"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_mother_baby_v03_home_08()
  },
  async _mpLoadProducts_products_mother_baby_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("mother_baby_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_mother_baby_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_mother_baby_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "mother_baby_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_mother_baby_v03_home_02()
  },
  async _mpLoadSwiper_swiper_mother_baby_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("mother_baby_v03_home_02"));
      ...
      var cur = this.data.swiper_mother_baby_v03_home_02 || {};
      this.setData({
        swiper_mother_baby_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "mother_baby_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_mother_baby_v03_home_08, 'image'); if (list.length) this.setData({ products_mother_baby_v03_home_08: list }); }
    { var wgt = this.data.swiper_mother_baby_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_mother_baby_v03_home_02: next }); } }
  },
onShow() {
