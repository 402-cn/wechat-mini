...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_mother_baby_v02_home_06: [{"id":1,"image":"/uploads/stock/mother_baby_10.jpg","imageSrc":"","name":"婴儿配方奶粉1段","price":49},{"id":2,"image":"/uploads/stock/mother_baby_11.jpg","imageSrc":"","name":"婴儿配方奶粉2段","price":118},{"id":3,"image":"/uploads/stock/mother_baby_12.jpg","imageSrc":"","name":"有机奶粉","price":187},{"id":4,"image":"/uploads/stock/mother_baby_13.jpg","imageSrc":"","name":"羊奶粉","price":256},{"id":5,"image":"/uploads/stock/mother_baby_14.jpg","imageSrc":"","name":"特殊配方奶粉","price":325},{"id":6,"image":"/uploads/stock/mother_baby_15.jpg","imageSrc":"","name":"试用装奶粉","price":394},{"id":7,"image":"/uploads/stock/mother_baby_16.jpg","imageSrc":"","name":"纸尿裤S码","price":49},{"id":8,"image":"/uploads/stock/mother_baby_17.jpg","imageSrc":"","name":"纸尿裤M码","price":118}], products_mother_baby_v02_home_07: [{"id":13,"image":"/uploads/stock/mother_baby_22.jpg","imageSrc":"","name":"婴儿米粉","price":49},{"id":14,"image":"/uploads/stock/mother_baby_23.jpg","imageSrc":"","name":"果泥","price":118},{"id":15,"image":"/uploads/stock/mother_baby_24.jpg","imageSrc":"","name":"磨牙棒","price":187}], productWidgets: [{"key":"products_mother_baby_v02_home_06","cid":"mother_baby_v02_home_06","limit":8},{"key":"products_mother_baby_v02_home_07","cid":"mother_baby_v02_home_07","limit":3}], swiper_mother_baby_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/mother_baby_8.jpg","imageSrc":"","link":"","title":"母婴用品"},{"image":"/uploads/stock/mother_baby_9.jpg","imageSrc":"","link":"","title":"孕妈专享"}] }, swiperWidgets: [{"key":"swiper_mother_baby_v02_home_02","cid":"mother_baby_v02_home_02","height":280,"interval":3000}], notice_mother_baby_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购母婴用品好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_mother_baby_v02_home_03","cid":"mother_baby_v02_home_03"}], gridNav_mother_baby_v02_home_04: {"items":[{"icon":"/uploads/stock/mother_baby_1.jpg","iconSrc":"","navUrl":"","text":"奶粉"},{"icon":"/uploads/stock/mother_baby_2.jpg","iconSrc":"","navUrl":"","text":"尿裤"},{"icon":"/uploads/stock/mother_baby_3.jpg","iconSrc":"","navUrl":"","text":"辅食"},{"icon":"/uploads/stock/mother_baby_4.jpg","iconSrc":"","navUrl":"","text":"玩具"},{"icon":"/uploads/stock/mother_baby_5.jpg","iconSrc":"","navUrl":"","text":"童装"},{"icon":"/uploads/stock/mother_baby_6.jpg","iconSrc":"","navUrl":"","text":"推车"},{"icon":"/uploads/stock/mother_baby_55.jpg","iconSrc":"","navUrl":"","text":"洗护"},{"icon":"/uploads/stock/mother_baby_56.jpg","iconSrc":"","navUrl":"","text":"孕妈"},{"icon":"/uploads/stock/mother_baby_57.jpg","iconSrc":"","navUrl":"","text":"绘本"},{"icon":"/uploads/stock/mother_baby_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_mother_baby_v02_home_06();
    await this._mpLoadProducts_products_mother_baby_v02_home_07()
  },
  async _mpLoadProducts_products_mother_baby_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("mother_baby_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_mother_baby_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_mother_baby_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "mother_baby_v02_home_06", e); }
  },

  async _mpLoadProducts_products_mother_baby_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("mother_baby_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_mother_baby_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_mother_baby_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "mother_baby_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_mother_baby_v02_home_02()
  },
  async _mpLoadSwiper_swiper_mother_baby_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("mother_baby_v02_home_02"));
      ...
      var cur = this.data.swiper_mother_baby_v02_home_02 || {};
      this.setData({
        swiper_mother_baby_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "mother_baby_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_mother_baby_v02_home_03()
  },
  async _mpLoadNotice_notice_mother_baby_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("mother_baby_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_mother_baby_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "mother_baby_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_mother_baby_v02_home_06, 'image'); if (list.length) this.setData({ products_mother_baby_v02_home_06: list }); }
    { var list = withSrc(this.data.products_mother_baby_v02_home_07, 'image'); if (list.length) this.setData({ products_mother_baby_v02_home_07: list }); }
    { var wgt = this.data.swiper_mother_baby_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_mother_baby_v02_home_02: next }); } }
  },
onShow() {
