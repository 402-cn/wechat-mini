...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_wedding_v01_home_11: [{"id":1,"image":"/uploads/stock/wedding_10.jpg","imageSrc":"","name":"经典婚纱摄影套餐","price":3999},{"id":2,"image":"/uploads/stock/wedding_11.jpg","imageSrc":"","name":"轻奢外景婚纱照","price":5999},{"id":3,"image":"/uploads/stock/wedding_12.jpg","imageSrc":"","name":"室内韩式婚纱","price":4599}], products_wedding_v01_home_13: [{"id":7,"image":"/uploads/stock/wedding_16.jpg","imageSrc":"","name":"主纱租赁套餐","price":1999},{"id":8,"image":"/uploads/stock/wedding_17.jpg","imageSrc":"","name":"敬酒礼服套装","price":899},{"id":9,"image":"/uploads/stock/wedding_18.jpg","imageSrc":"","name":"中式秀禾服","price":1299},{"id":10,"image":"/uploads/stock/wedding_19.jpg","imageSrc":"","name":"伴娘礼服组","price":699},{"id":11,"image":"/uploads/stock/wedding_20.jpg","imageSrc":"","name":"新郎西装定制","price":1599},{"id":12,"image":"/uploads/stock/wedding_21.jpg","imageSrc":"","name":"妈妈礼服","price":799}], productWidgets: [{"key":"products_wedding_v01_home_11","cid":"wedding_v01_home_11","limit":3},{"key":"products_wedding_v01_home_13","cid":"wedding_v01_home_13","limit":6}], swiper_wedding_v01_home_03: { height: 320, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/wedding_7.jpg","imageSrc":"","link":"","title":"婚纱摄影"},{"image":"/uploads/stock/wedding_8.jpg","imageSrc":"","link":"","title":"婚纱摄影"},{"image":"/uploads/stock/wedding_9.jpg","imageSrc":"","link":"","title":"婚礼策划"}] }, swiperWidgets: [{"key":"swiper_wedding_v01_home_03","cid":"wedding_v01_home_03","height":320,"interval":3000}], notice_wedding_v01_home_04: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购婚纱摄影好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_wedding_v01_home_04","cid":"wedding_v01_home_04"}], gridNav_wedding_v01_home_02: {"items":[{"icon":"/uploads/stock/wedding_1.jpg","iconSrc":"","navUrl":"","text":"再买一单"},{"icon":"/uploads/stock/wedding_2.jpg","iconSrc":"","navUrl":"","text":"会员中心"},{"icon":"/uploads/stock/wedding_3.jpg","iconSrc":"","navUrl":"","text":"优惠券"},{"icon":"/uploads/stock/wedding_4.jpg","iconSrc":"","navUrl":"","text":"我的订单"}]}, gridNav_wedding_v01_home_05: {"items":[{"icon":"/uploads/stock/wedding_1.jpg","iconSrc":"","navUrl":"","text":"极速达"},{"icon":"/uploads/stock/wedding_2.jpg","iconSrc":"","navUrl":"","text":"品质保障"},{"icon":"/uploads/stock/wedding_3.jpg","iconSrc":"","navUrl":"","text":"售后无忧"}]}, gridNav_wedding_v01_home_06: {"items":[{"icon":"/uploads/stock/wedding_1.jpg","iconSrc":"","navUrl":"","text":"婚纱"},{"icon":"/uploads/stock/wedding_2.jpg","iconSrc":"","navUrl":"","text":"礼服"},{"icon":"/uploads/stock/wedding_3.jpg","iconSrc":"","navUrl":"","text":"跟妆"},{"icon":"/uploads/stock/wedding_4.jpg","iconSrc":"","navUrl":"","text":"摄影"},{"icon":"/uploads/stock/wedding_5.jpg","iconSrc":"","navUrl":"","text":"策划"},{"icon":"/uploads/stock/wedding_6.jpg","iconSrc":"","navUrl":"","text":"婚宴"},{"icon":"/uploads/stock/wedding_55.jpg","iconSrc":"","navUrl":"","text":"珠宝"},{"icon":"/uploads/stock/wedding_56.jpg","iconSrc":"","navUrl":"","text":"旅拍"},{"icon":"/uploads/stock/wedding_57.jpg","iconSrc":"","navUrl":"","text":"写真"},{"icon":"/uploads/stock/wedding_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]}, promoPair_wedding_v01_home_07: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/wedding_40.jpg","imageSrc":"","navUrl":"","title":"婚纱摄影"},{"bgColor":"#fff3e0","image":"/uploads/stock/wedding_41.jpg","imageSrc":"","navUrl":"","title":"婚礼策划"}]}, promoPair_wedding_v01_home_08: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/wedding_42.jpg","imageSrc":"","navUrl":"","title":"礼服租赁"},{"bgColor":"#fff3e0","image":"/uploads/stock/wedding_43.jpg","imageSrc":"","navUrl":"","title":"限时优惠"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_wedding_v01_home_11();
    await this._mpLoadProducts_products_wedding_v01_home_13()
  },
  async _mpLoadProducts_products_wedding_v01_home_11() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("wedding_v01_home_11");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_wedding_v01_home_11 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_wedding_v01_home_11: list });
    } catch (e) { this.mpDevWarn('product', "wedding_v01_home_11", e); }
  },

  async _mpLoadProducts_products_wedding_v01_home_13() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("wedding_v01_home_13");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_wedding_v01_home_13 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_wedding_v01_home_13: list });
    } catch (e) { this.mpDevWarn('product', "wedding_v01_home_13", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_wedding_v01_home_03()
  },
  async _mpLoadSwiper_swiper_wedding_v01_home_03() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("wedding_v01_home_03"));
      ...
      var cur = this.data.swiper_wedding_v01_home_03 || {};
      this.setData({
        swiper_wedding_v01_home_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "wedding_v01_home_03", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_wedding_v01_home_04()
  },
  async _mpLoadNotice_notice_wedding_v01_home_04() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("wedding_v01_home_04"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_wedding_v01_home_04: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "wedding_v01_home_04", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_wedding_v01_home_11, 'image'); if (list.length) this.setData({ products_wedding_v01_home_11: list }); }
    { var list = withSrc(this.data.products_wedding_v01_home_13, 'image'); if (list.length) this.setData({ products_wedding_v01_home_13: list }); }
    { var wgt = this.data.swiper_wedding_v01_home_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_wedding_v01_home_03: next }); } }
  },
onShow() {
