...
function demo_article_catalog(): array {
    return [
        ['婚纱摄影风格指南', '选片与拍摄小贴士', './assets/images/wedding_7.jpg', '<p><strong>本文为演示数据</strong>，安装后可在 PHP 后台「文章管理」中修改或删除。正式运营请替换为真实内容。</p><!--ADMIN_GUIDE_FOOTER-->', 128, 1],
        ['婚礼筹备时间表', '提前3个月开始准备', './assets/images/wedding_8.jpg', '<p>演示正文。部署后可在 PHP 后台「文章管理」中修改或删除。</p><!--ADMIN_GUIDE_FOOTER-->', 86, 1],
        ['礼服挑选攻略', '演示数据', './assets/images/wedding_9.jpg', '<p>演示正文。部署后可在 PHP 后台「文章管理」中修改或删除。</p><!--ADMIN_GUIDE_FOOTER-->', 203, 1],
        ['婚礼预算规划', '演示数据', './assets/images/wedding_48.jpg', '<p>演示正文。部署后可在 PHP 后台「文章管理」中修改或删除。</p><!--ADMIN_GUIDE_FOOTER-->', 57, 1],
        ['客片欣赏与案例', '演示数据', './assets/images/wedding_49.jpg', '<p>演示正文。部署后可在 PHP 后台「文章管理」中修改或删除。</p><!--ADMIN_GUIDE_FOOTER-->', 91, 1],
    ];
}
