...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_wedding_v03_home_08: [{"id":1,"image":"/uploads/stock/wedding_10.jpg","imageSrc":"","name":"经典婚纱摄影套餐","price":3999},{"id":2,"image":"/uploads/stock/wedding_11.jpg","imageSrc":"","name":"轻奢外景婚纱照","price":5999},{"id":3,"image":"/uploads/stock/wedding_12.jpg","imageSrc":"","name":"室内韩式婚纱","price":4599},{"id":4,"image":"/uploads/stock/wedding_13.jpg","imageSrc":"","name":"旅拍三亚套餐","price":8999},{"id":5,"image":"/uploads/stock/wedding_14.jpg","imageSrc":"","name":"复古胶片婚纱","price":5299},{"id":6,"image":"/uploads/stock/wedding_15.jpg","imageSrc":"","name":"森系小清新婚纱","price":4899}], productWidgets: [{"key":"products_wedding_v03_home_08","cid":"wedding_v03_home_08","limit":6}], swiper_wedding_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/wedding_9.jpg","imageSrc":"","link":"","title":"婚纱摄影"},{"image":"/uploads/stock/wedding_48.jpg","imageSrc":"","link":"","title":"婚纱摄影"},{"image":"/uploads/stock/wedding_49.jpg","imageSrc":"","link":"","title":"婚礼策划"}] }, swiperWidgets: [{"key":"swiper_wedding_v03_home_02","cid":"wedding_v03_home_02","height":340,"interval":3000}], promoPair_wedding_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/wedding_42.jpg","imageSrc":"","navUrl":"","title":"婚纱摄影"},{"bgColor":"#fff3e0","image":"/uploads/stock/wedding_43.jpg","imageSrc":"","navUrl":"","title":"婚礼策划"}]}, promoPair_wedding_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/wedding_44.jpg","imageSrc":"","navUrl":"","title":"礼服租赁"},{"bgColor":"#fff3e0","image":"/uploads/stock/wedding_45.jpg","imageSrc":"","navUrl":"","title":"限时优惠"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_wedding_v03_home_08()
  },
  async _mpLoadProducts_products_wedding_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("wedding_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_wedding_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_wedding_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "wedding_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_wedding_v03_home_02()
  },
  async _mpLoadSwiper_swiper_wedding_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("wedding_v03_home_02"));
      ...
      var cur = this.data.swiper_wedding_v03_home_02 || {};
      this.setData({
        swiper_wedding_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "wedding_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_wedding_v03_home_08, 'image'); if (list.length) this.setData({ products_wedding_v03_home_08: list }); }
    { var wgt = this.data.swiper_wedding_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_wedding_v03_home_02: next }); } }
  },
onShow() {
