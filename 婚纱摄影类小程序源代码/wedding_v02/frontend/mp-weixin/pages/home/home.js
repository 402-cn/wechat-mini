...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_wedding_v02_home_06: [{"id":1,"image":"/uploads/stock/wedding_10.jpg","imageSrc":"","name":"经典婚纱摄影套餐","price":3999},{"id":2,"image":"/uploads/stock/wedding_11.jpg","imageSrc":"","name":"轻奢外景婚纱照","price":5999},{"id":3,"image":"/uploads/stock/wedding_12.jpg","imageSrc":"","name":"室内韩式婚纱","price":4599},{"id":4,"image":"/uploads/stock/wedding_13.jpg","imageSrc":"","name":"旅拍三亚套餐","price":8999},{"id":5,"image":"/uploads/stock/wedding_14.jpg","imageSrc":"","name":"复古胶片婚纱","price":5299},{"id":6,"image":"/uploads/stock/wedding_15.jpg","imageSrc":"","name":"森系小清新婚纱","price":4899},{"id":7,"image":"/uploads/stock/wedding_16.jpg","imageSrc":"","name":"主纱租赁套餐","price":1999},{"id":8,"image":"/uploads/stock/wedding_17.jpg","imageSrc":"","name":"敬酒礼服套装","price":899}], products_wedding_v02_home_07: [{"id":13,"image":"/uploads/stock/wedding_22.jpg","imageSrc":"","name":"新娘全天跟妆","price":1280},{"id":14,"image":"/uploads/stock/wedding_23.jpg","imageSrc":"","name":"试妆体验套餐","price":299},{"id":15,"image":"/uploads/stock/wedding_24.jpg","imageSrc":"","name":"伴娘妆发套餐","price":599}], productWidgets: [{"key":"products_wedding_v02_home_06","cid":"wedding_v02_home_06","limit":8},{"key":"products_wedding_v02_home_07","cid":"wedding_v02_home_07","limit":3}], swiper_wedding_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/wedding_8.jpg","imageSrc":"","link":"","title":"婚纱摄影"},{"image":"/uploads/stock/wedding_9.jpg","imageSrc":"","link":"","title":"婚纱摄影"}] }, swiperWidgets: [{"key":"swiper_wedding_v02_home_02","cid":"wedding_v02_home_02","height":280,"interval":3000}], notice_wedding_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购婚纱摄影好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_wedding_v02_home_03","cid":"wedding_v02_home_03"}], gridNav_wedding_v02_home_04: {"items":[{"icon":"/uploads/stock/wedding_1.jpg","iconSrc":"","navUrl":"","text":"婚纱"},{"icon":"/uploads/stock/wedding_2.jpg","iconSrc":"","navUrl":"","text":"礼服"},{"icon":"/uploads/stock/wedding_3.jpg","iconSrc":"","navUrl":"","text":"跟妆"},{"icon":"/uploads/stock/wedding_4.jpg","iconSrc":"","navUrl":"","text":"摄影"},{"icon":"/uploads/stock/wedding_5.jpg","iconSrc":"","navUrl":"","text":"策划"},{"icon":"/uploads/stock/wedding_6.jpg","iconSrc":"","navUrl":"","text":"婚宴"},{"icon":"/uploads/stock/wedding_55.jpg","iconSrc":"","navUrl":"","text":"珠宝"},{"icon":"/uploads/stock/wedding_56.jpg","iconSrc":"","navUrl":"","text":"旅拍"},{"icon":"/uploads/stock/wedding_57.jpg","iconSrc":"","navUrl":"","text":"写真"},{"icon":"/uploads/stock/wedding_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_wedding_v02_home_06();
    await this._mpLoadProducts_products_wedding_v02_home_07()
  },
  async _mpLoadProducts_products_wedding_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("wedding_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_wedding_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_wedding_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "wedding_v02_home_06", e); }
  },

  async _mpLoadProducts_products_wedding_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("wedding_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_wedding_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_wedding_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "wedding_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_wedding_v02_home_02()
  },
  async _mpLoadSwiper_swiper_wedding_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("wedding_v02_home_02"));
      ...
      var cur = this.data.swiper_wedding_v02_home_02 || {};
      this.setData({
        swiper_wedding_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "wedding_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_wedding_v02_home_03()
  },
  async _mpLoadNotice_notice_wedding_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("wedding_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_wedding_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "wedding_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_wedding_v02_home_06, 'image'); if (list.length) this.setData({ products_wedding_v02_home_06: list }); }
    { var list = withSrc(this.data.products_wedding_v02_home_07, 'image'); if (list.length) this.setData({ products_wedding_v02_home_07: list }); }
    { var wgt = this.data.swiper_wedding_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_wedding_v02_home_02: next }); } }
  },
onShow() {
