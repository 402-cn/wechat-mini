...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_wedding_v06_home_05: [{"id":7,"image":"/uploads/stock/wedding_16.jpg","imageSrc":"","name":"主纱租赁套餐","price":1999},{"id":8,"image":"/uploads/stock/wedding_17.jpg","imageSrc":"","name":"敬酒礼服套装","price":899},{"id":9,"image":"/uploads/stock/wedding_18.jpg","imageSrc":"","name":"中式秀禾服","price":1299},{"id":10,"image":"/uploads/stock/wedding_19.jpg","imageSrc":"","name":"伴娘礼服组","price":699}], productWidgets: [{"key":"products_wedding_v06_home_05","cid":"wedding_v06_home_05","limit":4}], swiper_wedding_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/wedding_50.jpg","imageSrc":"","link":"","title":"婚纱摄影"},{"image":"/uploads/stock/wedding_51.jpg","imageSrc":"","link":"","title":"婚纱摄影"},{"image":"/uploads/stock/wedding_52.jpg","imageSrc":"","link":"","title":"婚礼策划"}] }, swiperWidgets: [{"key":"swiper_wedding_v06_home_02","cid":"wedding_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_wedding_v06_home_05()
  },
  async _mpLoadProducts_products_wedding_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("wedding_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_wedding_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_wedding_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "wedding_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_wedding_v06_home_02()
  },
  async _mpLoadSwiper_swiper_wedding_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("wedding_v06_home_02"));
      ...
      var cur = this.data.swiper_wedding_v06_home_02 || {};
      this.setData({
        swiper_wedding_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "wedding_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_wedding_v06_home_05, 'image'); if (list.length) this.setData({ products_wedding_v06_home_05: list }); }
    { var wgt = this.data.swiper_wedding_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_wedding_v06_home_02: next }); } }
  },
onShow() {
