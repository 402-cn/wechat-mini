...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_milk_tea_v03_home_08: [{"id":1,"image":"/uploads/stock/milk_tea_10.jpg","imageSrc":"","name":"珍珠奶茶","price":12},{"id":2,"image":"/uploads/stock/milk_tea_11.jpg","imageSrc":"","name":"芋泥波波","price":27},{"id":3,"image":"/uploads/stock/milk_tea_12.jpg","imageSrc":"","name":"黑糖鹿丸","price":42},{"id":4,"image":"/uploads/stock/milk_tea_13.jpg","imageSrc":"","name":"芝士奶盖","price":57},{"id":5,"image":"/uploads/stock/milk_tea_14.jpg","imageSrc":"","name":"燕麦奶茶","price":72},{"id":6,"image":"/uploads/stock/milk_tea_15.jpg","imageSrc":"","name":"红豆奶茶","price":87}], productWidgets: [{"key":"products_milk_tea_v03_home_08","cid":"milk_tea_v03_home_08","limit":6}], swiper_milk_tea_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/milk_tea_9.jpg","imageSrc":"","link":"","title":"奶茶饮品"},{"image":"/uploads/stock/milk_tea_48.jpg","imageSrc":"","link":"","title":"新品上市"},{"image":"/uploads/stock/milk_tea_49.jpg","imageSrc":"","link":"","title":"第二杯半价"}] }, swiperWidgets: [{"key":"swiper_milk_tea_v03_home_02","cid":"milk_tea_v03_home_02","height":340,"interval":3000}], promoPair_milk_tea_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/milk_tea_42.jpg","imageSrc":"","navUrl":"","title":"新品上市"},{"bgColor":"#fff3e0","image":"/uploads/stock/milk_tea_43.jpg","imageSrc":"","navUrl":"","title":"第二杯半价"}]}, promoPair_milk_tea_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/milk_tea_44.jpg","imageSrc":"","navUrl":"","title":"会员专享"},{"bgColor":"#fff3e0","image":"/uploads/stock/milk_tea_45.jpg","imageSrc":"","navUrl":"","title":"限时秒杀"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_milk_tea_v03_home_08()
  },
  async _mpLoadProducts_products_milk_tea_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("milk_tea_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_milk_tea_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_milk_tea_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "milk_tea_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_milk_tea_v03_home_02()
  },
  async _mpLoadSwiper_swiper_milk_tea_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("milk_tea_v03_home_02"));
      ...
      var cur = this.data.swiper_milk_tea_v03_home_02 || {};
      this.setData({
        swiper_milk_tea_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "milk_tea_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_milk_tea_v03_home_08, 'image'); if (list.length) this.setData({ products_milk_tea_v03_home_08: list }); }
    { var wgt = this.data.swiper_milk_tea_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_milk_tea_v03_home_02: next }); } }
  },
onShow() {
