...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_milk_tea_v05_home_04: [{"id":1,"image":"/uploads/stock/milk_tea_10.jpg","imageSrc":"","name":"珍珠奶茶","price":12},{"id":2,"image":"/uploads/stock/milk_tea_11.jpg","imageSrc":"","name":"芋泥波波","price":27},{"id":3,"image":"/uploads/stock/milk_tea_12.jpg","imageSrc":"","name":"黑糖鹿丸","price":42},{"id":4,"image":"/uploads/stock/milk_tea_13.jpg","imageSrc":"","name":"芝士奶盖","price":57},{"id":5,"image":"/uploads/stock/milk_tea_14.jpg","imageSrc":"","name":"燕麦奶茶","price":72},{"id":6,"image":"/uploads/stock/milk_tea_15.jpg","imageSrc":"","name":"红豆奶茶","price":87},{"id":7,"image":"/uploads/stock/milk_tea_16.jpg","imageSrc":"","name":"满杯红柚","price":12},{"id":8,"image":"/uploads/stock/milk_tea_17.jpg","imageSrc":"","name":"多肉葡萄","price":27}], products_milk_tea_v05_home_06: [{"id":9,"image":"/uploads/stock/milk_tea_18.jpg","imageSrc":"","name":"杨枝甘露","price":42},{"id":10,"image":"/uploads/stock/milk_tea_19.jpg","imageSrc":"","name":"柠檬绿茶","price":57},{"id":11,"image":"/uploads/stock/milk_tea_20.jpg","imageSrc":"","name":"蜜桃乌龙","price":72},{"id":12,"image":"/uploads/stock/milk_tea_21.jpg","imageSrc":"","name":"霸气橙子","price":87}], productWidgets: [{"key":"products_milk_tea_v05_home_04","cid":"milk_tea_v05_home_04","limit":8},{"key":"products_milk_tea_v05_home_06","cid":"milk_tea_v05_home_06","limit":4}], swiper_milk_tea_v05_home_02: { height: 360, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/milk_tea_49.jpg","imageSrc":"","link":"","title":"奶茶饮品"}] }, swiperWidgets: [{"key":"swiper_milk_tea_v05_home_02","cid":"milk_tea_v05_home_02","height":360,"interval":3000}], notice_milk_tea_v05_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购奶茶饮品好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_milk_tea_v05_home_03","cid":"milk_tea_v05_home_03"}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_milk_tea_v05_home_04();
    await this._mpLoadProducts_products_milk_tea_v05_home_06()
  },
  async _mpLoadProducts_products_milk_tea_v05_home_04() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("milk_tea_v05_home_04");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_milk_tea_v05_home_04 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_milk_tea_v05_home_04: list });
    } catch (e) { this.mpDevWarn('product', "milk_tea_v05_home_04", e); }
  },

  async _mpLoadProducts_products_milk_tea_v05_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("milk_tea_v05_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_milk_tea_v05_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_milk_tea_v05_home_06: list });
    } catch (e) { this.mpDevWarn('product', "milk_tea_v05_home_06", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_milk_tea_v05_home_02()
  },
  async _mpLoadSwiper_swiper_milk_tea_v05_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("milk_tea_v05_home_02"));
      ...
      var cur = this.data.swiper_milk_tea_v05_home_02 || {};
      this.setData({
        swiper_milk_tea_v05_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "milk_tea_v05_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_milk_tea_v05_home_03()
  },
  async _mpLoadNotice_notice_milk_tea_v05_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("milk_tea_v05_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_milk_tea_v05_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "milk_tea_v05_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_milk_tea_v05_home_04, 'image'); if (list.length) this.setData({ products_milk_tea_v05_home_04: list }); }
    { var list = withSrc(this.data.products_milk_tea_v05_home_06, 'image'); if (list.length) this.setData({ products_milk_tea_v05_home_06: list }); }
    { var wgt = this.data.swiper_milk_tea_v05_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_milk_tea_v05_home_02: next }); } }
  },
onShow() {
