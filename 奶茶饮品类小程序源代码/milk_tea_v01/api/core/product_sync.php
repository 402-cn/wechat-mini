...
function demo_product_catalog(): array {
    return [
        [1, 1, '珍珠奶茶', './assets/images/milk_tea_10.jpg', 12.00],
        [2, 1, '芋泥波波', './assets/images/milk_tea_11.jpg', 27.00],
        [3, 1, '黑糖鹿丸', './assets/images/milk_tea_12.jpg', 42.00],
        [4, 1, '芝士奶盖', './assets/images/milk_tea_13.jpg', 57.00],
        [5, 1, '燕麦奶茶', './assets/images/milk_tea_14.jpg', 72.00],
        [6, 1, '红豆奶茶', './assets/images/milk_tea_15.jpg', 87.00],
        [7, 2, '满杯红柚', './assets/images/milk_tea_16.jpg', 12.00],
        [8, 2, '多肉葡萄', './assets/images/milk_tea_17.jpg', 27.00],
        [9, 2, '杨枝甘露', './assets/images/milk_tea_18.jpg', 42.00],
        [10, 2, '柠檬绿茶', './assets/images/milk_tea_19.jpg', 57.00],
        [11, 2, '蜜桃乌龙', './assets/images/milk_tea_20.jpg', 72.00],
        [12, 2, '霸气橙子', './assets/images/milk_tea_21.jpg', 87.00],
        [13, 3, '美式咖啡', './assets/images/milk_tea_22.jpg', 12.00],
        [14, 3, '拿铁咖啡', './assets/images/milk_tea_23.jpg', 27.00],
        [15, 3, '生椰拿铁', './assets/images/milk_tea_24.jpg', 42.00],
        [16, 3, '摩卡咖啡', './assets/images/milk_tea_25.jpg', 57.00],
        [17, 3, '卡布奇诺', './assets/images/milk_tea_26.jpg', 72.00],
        [18, 3, '冷萃咖啡', './assets/images/milk_tea_27.jpg', 87.00],
        [19, 4, '椰果', './assets/images/milk_tea_28.jpg', 12.00],
        [20, 4, '布丁', './assets/images/milk_tea_29.jpg', 27.00],
        [21, 4, '芋圆', './assets/images/milk_tea_30.jpg', 42.00],
        [22, 4, '燕麦', './assets/images/milk_tea_31.jpg', 57.00],
        [23, 4, '芝士奶盖加料', './assets/images/milk_tea_32.jpg', 72.00],
        [24, 4, '双倍珍珠', './assets/images/milk_tea_33.jpg', 87.00],
        [25, 5, '提拉米苏', './assets/images/milk_tea_34.jpg', 12.00],
        [26, 5, '巴斯克蛋糕', './assets/images/milk_tea_35.jpg', 27.00],
        [27, 5, '欧包', './assets/images/milk_tea_36.jpg', 42.00],
        [28, 5, '三明治', './assets/images/milk_tea_37.jpg', 57.00],
        [29, 5, '酸奶杯', './assets/images/milk_tea_38.jpg', 72.00],
        [30, 5, '曲奇礼盒', './assets/images/milk_tea_39.jpg', 87.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'经典奶茶',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'果茶系列',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'咖啡',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'小料加料',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'甜品轻食',5,1)");
