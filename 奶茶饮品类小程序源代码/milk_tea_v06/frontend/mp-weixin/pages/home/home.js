...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_milk_tea_v06_home_05: [{"id":7,"image":"/uploads/stock/milk_tea_16.jpg","imageSrc":"","name":"满杯红柚","price":12},{"id":8,"image":"/uploads/stock/milk_tea_17.jpg","imageSrc":"","name":"多肉葡萄","price":27},{"id":9,"image":"/uploads/stock/milk_tea_18.jpg","imageSrc":"","name":"杨枝甘露","price":42},{"id":10,"image":"/uploads/stock/milk_tea_19.jpg","imageSrc":"","name":"柠檬绿茶","price":57}], productWidgets: [{"key":"products_milk_tea_v06_home_05","cid":"milk_tea_v06_home_05","limit":4}], swiper_milk_tea_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/milk_tea_50.jpg","imageSrc":"","link":"","title":"奶茶饮品"},{"image":"/uploads/stock/milk_tea_51.jpg","imageSrc":"","link":"","title":"新品上市"},{"image":"/uploads/stock/milk_tea_52.jpg","imageSrc":"","link":"","title":"第二杯半价"}] }, swiperWidgets: [{"key":"swiper_milk_tea_v06_home_02","cid":"milk_tea_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_milk_tea_v06_home_05()
  },
  async _mpLoadProducts_products_milk_tea_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("milk_tea_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_milk_tea_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_milk_tea_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "milk_tea_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_milk_tea_v06_home_02()
  },
  async _mpLoadSwiper_swiper_milk_tea_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("milk_tea_v06_home_02"));
      ...
      var cur = this.data.swiper_milk_tea_v06_home_02 || {};
      this.setData({
        swiper_milk_tea_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "milk_tea_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_milk_tea_v06_home_05, 'image'); if (list.length) this.setData({ products_milk_tea_v06_home_05: list }); }
    { var wgt = this.data.swiper_milk_tea_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_milk_tea_v06_home_02: next }); } }
  },
onShow() {
