...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_milk_tea_v02_home_06: [{"id":1,"image":"/uploads/stock/milk_tea_10.jpg","imageSrc":"","name":"珍珠奶茶","price":12},{"id":2,"image":"/uploads/stock/milk_tea_11.jpg","imageSrc":"","name":"芋泥波波","price":27},{"id":3,"image":"/uploads/stock/milk_tea_12.jpg","imageSrc":"","name":"黑糖鹿丸","price":42},{"id":4,"image":"/uploads/stock/milk_tea_13.jpg","imageSrc":"","name":"芝士奶盖","price":57},{"id":5,"image":"/uploads/stock/milk_tea_14.jpg","imageSrc":"","name":"燕麦奶茶","price":72},{"id":6,"image":"/uploads/stock/milk_tea_15.jpg","imageSrc":"","name":"红豆奶茶","price":87},{"id":7,"image":"/uploads/stock/milk_tea_16.jpg","imageSrc":"","name":"满杯红柚","price":12},{"id":8,"image":"/uploads/stock/milk_tea_17.jpg","imageSrc":"","name":"多肉葡萄","price":27}], products_milk_tea_v02_home_07: [{"id":13,"image":"/uploads/stock/milk_tea_22.jpg","imageSrc":"","name":"美式咖啡","price":12},{"id":14,"image":"/uploads/stock/milk_tea_23.jpg","imageSrc":"","name":"拿铁咖啡","price":27},{"id":15,"image":"/uploads/stock/milk_tea_24.jpg","imageSrc":"","name":"生椰拿铁","price":42}], productWidgets: [{"key":"products_milk_tea_v02_home_06","cid":"milk_tea_v02_home_06","limit":8},{"key":"products_milk_tea_v02_home_07","cid":"milk_tea_v02_home_07","limit":3}], swiper_milk_tea_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/milk_tea_8.jpg","imageSrc":"","link":"","title":"奶茶饮品"},{"image":"/uploads/stock/milk_tea_9.jpg","imageSrc":"","link":"","title":"新品上市"}] }, swiperWidgets: [{"key":"swiper_milk_tea_v02_home_02","cid":"milk_tea_v02_home_02","height":280,"interval":3000}], notice_milk_tea_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购奶茶饮品好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_milk_tea_v02_home_03","cid":"milk_tea_v02_home_03"}], gridNav_milk_tea_v02_home_04: {"items":[{"icon":"/uploads/stock/milk_tea_1.jpg","iconSrc":"","navUrl":"","text":"奶茶"},{"icon":"/uploads/stock/milk_tea_2.jpg","iconSrc":"","navUrl":"","text":"果茶"},{"icon":"/uploads/stock/milk_tea_3.jpg","iconSrc":"","navUrl":"","text":"咖啡"},{"icon":"/uploads/stock/milk_tea_4.jpg","iconSrc":"","navUrl":"","text":"小料"},{"icon":"/uploads/stock/milk_tea_5.jpg","iconSrc":"","navUrl":"","text":"甜品"},{"icon":"/uploads/stock/milk_tea_6.jpg","iconSrc":"","navUrl":"","text":"轻食"},{"icon":"/uploads/stock/milk_tea_55.jpg","iconSrc":"","navUrl":"","text":"套餐"},{"icon":"/uploads/stock/milk_tea_56.jpg","iconSrc":"","navUrl":"","text":"新品"},{"icon":"/uploads/stock/milk_tea_57.jpg","iconSrc":"","navUrl":"","text":"热销"},{"icon":"/uploads/stock/milk_tea_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_milk_tea_v02_home_06();
    await this._mpLoadProducts_products_milk_tea_v02_home_07()
  },
  async _mpLoadProducts_products_milk_tea_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("milk_tea_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_milk_tea_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_milk_tea_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "milk_tea_v02_home_06", e); }
  },

  async _mpLoadProducts_products_milk_tea_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("milk_tea_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_milk_tea_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_milk_tea_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "milk_tea_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_milk_tea_v02_home_02()
  },
  async _mpLoadSwiper_swiper_milk_tea_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("milk_tea_v02_home_02"));
      ...
      var cur = this.data.swiper_milk_tea_v02_home_02 || {};
      this.setData({
        swiper_milk_tea_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "milk_tea_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_milk_tea_v02_home_03()
  },
  async _mpLoadNotice_notice_milk_tea_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("milk_tea_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_milk_tea_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "milk_tea_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_milk_tea_v02_home_06, 'image'); if (list.length) this.setData({ products_milk_tea_v02_home_06: list }); }
    { var list = withSrc(this.data.products_milk_tea_v02_home_07, 'image'); if (list.length) this.setData({ products_milk_tea_v02_home_07: list }); }
    { var wgt = this.data.swiper_milk_tea_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_milk_tea_v02_home_02: next }); } }
  },
onShow() {
