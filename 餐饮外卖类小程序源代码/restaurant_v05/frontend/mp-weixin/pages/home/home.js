...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_restaurant_v05_home_04: [{"id":1,"image":"/uploads/stock/restaurant_10.jpg","imageSrc":"","name":"招牌红烧肉","price":28},{"id":2,"image":"/uploads/stock/restaurant_11.jpg","imageSrc":"","name":"宫保鸡丁","price":66},{"id":3,"image":"/uploads/stock/restaurant_12.jpg","imageSrc":"","name":"水煮牛肉","price":104},{"id":4,"image":"/uploads/stock/restaurant_13.jpg","imageSrc":"","name":"糖醋里脊","price":142},{"id":5,"image":"/uploads/stock/restaurant_14.jpg","imageSrc":"","name":"鱼香肉丝","price":180},{"id":6,"image":"/uploads/stock/restaurant_15.jpg","imageSrc":"","name":"回锅肉","price":218},{"id":7,"image":"/uploads/stock/restaurant_16.jpg","imageSrc":"","name":"凉拌黄瓜","price":28},{"id":8,"image":"/uploads/stock/restaurant_17.jpg","imageSrc":"","name":"口水鸡","price":66}], products_restaurant_v05_home_06: [{"id":9,"image":"/uploads/stock/restaurant_18.jpg","imageSrc":"","name":"皮蛋豆腐","price":104},{"id":10,"image":"/uploads/stock/restaurant_19.jpg","imageSrc":"","name":"夫妻肺片","price":142},{"id":11,"image":"/uploads/stock/restaurant_20.jpg","imageSrc":"","name":"拍黄瓜","price":180},{"id":12,"image":"/uploads/stock/restaurant_21.jpg","imageSrc":"","name":"凉拌木耳","price":218}], productWidgets: [{"key":"products_restaurant_v05_home_04","cid":"restaurant_v05_home_04","limit":8},{"key":"products_restaurant_v05_home_06","cid":"restaurant_v05_home_06","limit":4}], swiper_restaurant_v05_home_02: { height: 360, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/restaurant_49.jpg","imageSrc":"","link":"","title":"餐饮外卖"}] }, swiperWidgets: [{"key":"swiper_restaurant_v05_home_02","cid":"restaurant_v05_home_02","height":360,"interval":3000}], notice_restaurant_v05_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购餐饮外卖好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_restaurant_v05_home_03","cid":"restaurant_v05_home_03"}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_restaurant_v05_home_04();
    await this._mpLoadProducts_products_restaurant_v05_home_06()
  },
  async _mpLoadProducts_products_restaurant_v05_home_04() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("restaurant_v05_home_04");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_restaurant_v05_home_04 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_restaurant_v05_home_04: list });
    } catch (e) { this.mpDevWarn('product', "restaurant_v05_home_04", e); }
  },

  async _mpLoadProducts_products_restaurant_v05_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("restaurant_v05_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_restaurant_v05_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_restaurant_v05_home_06: list });
    } catch (e) { this.mpDevWarn('product', "restaurant_v05_home_06", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_restaurant_v05_home_02()
  },
  async _mpLoadSwiper_swiper_restaurant_v05_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("restaurant_v05_home_02"));
      ...
      var cur = this.data.swiper_restaurant_v05_home_02 || {};
      this.setData({
        swiper_restaurant_v05_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "restaurant_v05_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_restaurant_v05_home_03()
  },
  async _mpLoadNotice_notice_restaurant_v05_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("restaurant_v05_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_restaurant_v05_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "restaurant_v05_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_restaurant_v05_home_04, 'image'); if (list.length) this.setData({ products_restaurant_v05_home_04: list }); }
    { var list = withSrc(this.data.products_restaurant_v05_home_06, 'image'); if (list.length) this.setData({ products_restaurant_v05_home_06: list }); }
    { var wgt = this.data.swiper_restaurant_v05_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_restaurant_v05_home_02: next }); } }
  },
onShow() {
