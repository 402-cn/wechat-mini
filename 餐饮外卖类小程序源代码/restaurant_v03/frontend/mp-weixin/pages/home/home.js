...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_restaurant_v03_home_08: [{"id":1,"image":"/uploads/stock/restaurant_10.jpg","imageSrc":"","name":"招牌红烧肉","price":28},{"id":2,"image":"/uploads/stock/restaurant_11.jpg","imageSrc":"","name":"宫保鸡丁","price":66},{"id":3,"image":"/uploads/stock/restaurant_12.jpg","imageSrc":"","name":"水煮牛肉","price":104},{"id":4,"image":"/uploads/stock/restaurant_13.jpg","imageSrc":"","name":"糖醋里脊","price":142},{"id":5,"image":"/uploads/stock/restaurant_14.jpg","imageSrc":"","name":"鱼香肉丝","price":180},{"id":6,"image":"/uploads/stock/restaurant_15.jpg","imageSrc":"","name":"回锅肉","price":218}], productWidgets: [{"key":"products_restaurant_v03_home_08","cid":"restaurant_v03_home_08","limit":6}], swiper_restaurant_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/restaurant_9.jpg","imageSrc":"","link":"","title":"餐饮外卖"},{"image":"/uploads/stock/restaurant_48.jpg","imageSrc":"","link":"","title":"今日特价"},{"image":"/uploads/stock/restaurant_49.jpg","imageSrc":"","link":"","title":"满减优惠"}] }, swiperWidgets: [{"key":"swiper_restaurant_v03_home_02","cid":"restaurant_v03_home_02","height":340,"interval":3000}], promoPair_restaurant_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/restaurant_42.jpg","imageSrc":"","navUrl":"","title":"今日特价"},{"bgColor":"#fff3e0","image":"/uploads/stock/restaurant_43.jpg","imageSrc":"","navUrl":"","title":"满减优惠"}]}, promoPair_restaurant_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/restaurant_44.jpg","imageSrc":"","navUrl":"","title":"新客立减"},{"bgColor":"#fff3e0","image":"/uploads/stock/restaurant_45.jpg","imageSrc":"","navUrl":"","title":"外卖专享"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_restaurant_v03_home_08()
  },
  async _mpLoadProducts_products_restaurant_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("restaurant_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_restaurant_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_restaurant_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "restaurant_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_restaurant_v03_home_02()
  },
  async _mpLoadSwiper_swiper_restaurant_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("restaurant_v03_home_02"));
      ...
      var cur = this.data.swiper_restaurant_v03_home_02 || {};
      this.setData({
        swiper_restaurant_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "restaurant_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_restaurant_v03_home_08, 'image'); if (list.length) this.setData({ products_restaurant_v03_home_08: list }); }
    { var wgt = this.data.swiper_restaurant_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_restaurant_v03_home_02: next }); } }
  },
onShow() {
