...
function demo_product_catalog(): array {
    return [
        [1, 1, '招牌红烧肉', './assets/images/restaurant_10.jpg', 28.00],
        [2, 1, '宫保鸡丁', './assets/images/restaurant_11.jpg', 66.00],
        [3, 1, '水煮牛肉', './assets/images/restaurant_12.jpg', 104.00],
        [4, 1, '糖醋里脊', './assets/images/restaurant_13.jpg', 142.00],
        [5, 1, '鱼香肉丝', './assets/images/restaurant_14.jpg', 180.00],
        [6, 1, '回锅肉', './assets/images/restaurant_15.jpg', 218.00],
        [7, 2, '凉拌黄瓜', './assets/images/restaurant_16.jpg', 28.00],
        [8, 2, '口水鸡', './assets/images/restaurant_17.jpg', 66.00],
        [9, 2, '皮蛋豆腐', './assets/images/restaurant_18.jpg', 104.00],
        [10, 2, '夫妻肺片', './assets/images/restaurant_19.jpg', 142.00],
        [11, 2, '拍黄瓜', './assets/images/restaurant_20.jpg', 180.00],
        [12, 2, '凉拌木耳', './assets/images/restaurant_21.jpg', 218.00],
        [13, 3, '扬州炒饭', './assets/images/restaurant_22.jpg', 28.00],
        [14, 3, '牛肉拉面', './assets/images/restaurant_23.jpg', 66.00],
        [15, 3, '葱油拌面', './assets/images/restaurant_24.jpg', 104.00],
        [16, 3, '手工水饺', './assets/images/restaurant_25.jpg', 142.00],
        [17, 3, '小笼包', './assets/images/restaurant_26.jpg', 180.00],
        [18, 3, '蛋炒饭', './assets/images/restaurant_27.jpg', 218.00],
        [19, 4, '番茄蛋花汤', './assets/images/restaurant_28.jpg', 28.00],
        [20, 4, '酸辣汤', './assets/images/restaurant_29.jpg', 66.00],
        [21, 4, '排骨莲藕汤', './assets/images/restaurant_30.jpg', 104.00],
        [22, 4, '紫菜蛋汤', './assets/images/restaurant_31.jpg', 142.00],
        [23, 4, '菌菇汤', './assets/images/restaurant_32.jpg', 180.00],
        [24, 4, '玉米排骨汤', './assets/images/restaurant_33.jpg', 218.00],
        [25, 5, '炸鸡翅', './assets/images/restaurant_34.jpg', 28.00],
        [26, 5, '春卷', './assets/images/restaurant_35.jpg', 66.00],
        [27, 5, '锅贴', './assets/images/restaurant_36.jpg', 104.00],
        [28, 5, '薯条', './assets/images/restaurant_37.jpg', 142.00],
        [29, 5, '烤串', './assets/images/restaurant_38.jpg', 180.00],
        [30, 5, '红糖糍粑', './assets/images/restaurant_39.jpg', 218.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'热菜',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'凉菜',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'主食',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'汤品',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'小吃',5,1)");
