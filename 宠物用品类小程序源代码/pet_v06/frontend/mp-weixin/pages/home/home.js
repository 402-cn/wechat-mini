...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_pet_v06_home_05: [{"id":7,"image":"/uploads/stock/pet_16.jpg","imageSrc":"","name":"成犬狗粮","price":39},{"id":8,"image":"/uploads/stock/pet_17.jpg","imageSrc":"","name":"幼犬狗粮","price":98},{"id":9,"image":"/uploads/stock/pet_18.jpg","imageSrc":"","name":"犬用罐头","price":157},{"id":10,"image":"/uploads/stock/pet_19.jpg","imageSrc":"","name":"犬磨牙棒","price":216}], productWidgets: [{"key":"products_pet_v06_home_05","cid":"pet_v06_home_05","limit":4}], swiper_pet_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/pet_50.jpg","imageSrc":"","link":"","title":"宠物用品"},{"image":"/uploads/stock/pet_51.jpg","imageSrc":"","link":"","title":"萌宠特惠"},{"image":"/uploads/stock/pet_52.jpg","imageSrc":"","link":"","title":"新品上架"}] }, swiperWidgets: [{"key":"swiper_pet_v06_home_02","cid":"pet_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_pet_v06_home_05()
  },
  async _mpLoadProducts_products_pet_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("pet_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_pet_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_pet_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "pet_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_pet_v06_home_02()
  },
  async _mpLoadSwiper_swiper_pet_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("pet_v06_home_02"));
      ...
      var cur = this.data.swiper_pet_v06_home_02 || {};
      this.setData({
        swiper_pet_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "pet_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_pet_v06_home_05, 'image'); if (list.length) this.setData({ products_pet_v06_home_05: list }); }
    { var wgt = this.data.swiper_pet_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_pet_v06_home_02: next }); } }
  },
onShow() {
