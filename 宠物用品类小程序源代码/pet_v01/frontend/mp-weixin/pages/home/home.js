...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_pet_v01_home_11: [{"id":1,"image":"/uploads/stock/pet_10.jpg","imageSrc":"","name":"成猫猫粮","price":39},{"id":2,"image":"/uploads/stock/pet_11.jpg","imageSrc":"","name":"幼猫猫粮","price":98},{"id":3,"image":"/uploads/stock/pet_12.jpg","imageSrc":"","name":"冻干猫粮","price":157}], products_pet_v01_home_13: [{"id":7,"image":"/uploads/stock/pet_16.jpg","imageSrc":"","name":"成犬狗粮","price":39},{"id":8,"image":"/uploads/stock/pet_17.jpg","imageSrc":"","name":"幼犬狗粮","price":98},{"id":9,"image":"/uploads/stock/pet_18.jpg","imageSrc":"","name":"犬用罐头","price":157},{"id":10,"image":"/uploads/stock/pet_19.jpg","imageSrc":"","name":"犬磨牙棒","price":216},{"id":11,"image":"/uploads/stock/pet_20.jpg","imageSrc":"","name":"犬零食","price":275},{"id":12,"image":"/uploads/stock/pet_21.jpg","imageSrc":"","name":"营养膏","price":334}], productWidgets: [{"key":"products_pet_v01_home_11","cid":"pet_v01_home_11","limit":3},{"key":"products_pet_v01_home_13","cid":"pet_v01_home_13","limit":6}], swiper_pet_v01_home_03: { height: 320, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/pet_7.jpg","imageSrc":"","link":"","title":"宠物用品"},{"image":"/uploads/stock/pet_8.jpg","imageSrc":"","link":"","title":"萌宠特惠"},{"image":"/uploads/stock/pet_9.jpg","imageSrc":"","link":"","title":"新品上架"}] }, swiperWidgets: [{"key":"swiper_pet_v01_home_03","cid":"pet_v01_home_03","height":320,"interval":3000}], notice_pet_v01_home_04: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购宠物用品好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_pet_v01_home_04","cid":"pet_v01_home_04"}], gridNav_pet_v01_home_02: {"items":[{"icon":"/uploads/stock/pet_1.jpg","iconSrc":"","navUrl":"","text":"再买一单"},{"icon":"/uploads/stock/pet_2.jpg","iconSrc":"","navUrl":"","text":"会员中心"},{"icon":"/uploads/stock/pet_3.jpg","iconSrc":"","navUrl":"","text":"优惠券"},{"icon":"/uploads/stock/pet_4.jpg","iconSrc":"","navUrl":"","text":"我的订单"}]}, gridNav_pet_v01_home_05: {"items":[{"icon":"/uploads/stock/pet_1.jpg","iconSrc":"","navUrl":"","text":"极速达"},{"icon":"/uploads/stock/pet_2.jpg","iconSrc":"","navUrl":"","text":"品质保障"},{"icon":"/uploads/stock/pet_3.jpg","iconSrc":"","navUrl":"","text":"售后无忧"}]}, gridNav_pet_v01_home_06: {"items":[{"icon":"/uploads/stock/pet_1.jpg","iconSrc":"","navUrl":"","text":"猫粮"},{"icon":"/uploads/stock/pet_2.jpg","iconSrc":"","navUrl":"","text":"狗粮"},{"icon":"/uploads/stock/pet_3.jpg","iconSrc":"","navUrl":"","text":"零食"},{"icon":"/uploads/stock/pet_4.jpg","iconSrc":"","navUrl":"","text":"玩具"},{"icon":"/uploads/stock/pet_5.jpg","iconSrc":"","navUrl":"","text":"清洁"},{"icon":"/uploads/stock/pet_6.jpg","iconSrc":"","navUrl":"","text":"医疗"},{"icon":"/uploads/stock/pet_55.jpg","iconSrc":"","navUrl":"","text":"服饰"},{"icon":"/uploads/stock/pet_56.jpg","iconSrc":"","navUrl":"","text":"窝垫"},{"icon":"/uploads/stock/pet_57.jpg","iconSrc":"","navUrl":"","text":"出行"},{"icon":"/uploads/stock/pet_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]}, promoPair_pet_v01_home_07: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/pet_40.jpg","imageSrc":"","navUrl":"","title":"萌宠特惠"},{"bgColor":"#fff3e0","image":"/uploads/stock/pet_41.jpg","imageSrc":"","navUrl":"","title":"新品上架"}]}, promoPair_pet_v01_home_08: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/pet_42.jpg","imageSrc":"","navUrl":"","title":"会员日"},{"bgColor":"#fff3e0","image":"/uploads/stock/pet_43.jpg","imageSrc":"","navUrl":"","title":"限时秒杀"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_pet_v01_home_11();
    await this._mpLoadProducts_products_pet_v01_home_13()
  },
  async _mpLoadProducts_products_pet_v01_home_11() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("pet_v01_home_11");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_pet_v01_home_11 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_pet_v01_home_11: list });
    } catch (e) { this.mpDevWarn('product', "pet_v01_home_11", e); }
  },

  async _mpLoadProducts_products_pet_v01_home_13() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("pet_v01_home_13");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_pet_v01_home_13 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_pet_v01_home_13: list });
    } catch (e) { this.mpDevWarn('product', "pet_v01_home_13", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_pet_v01_home_03()
  },
  async _mpLoadSwiper_swiper_pet_v01_home_03() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("pet_v01_home_03"));
      ...
      var cur = this.data.swiper_pet_v01_home_03 || {};
      this.setData({
        swiper_pet_v01_home_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "pet_v01_home_03", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_pet_v01_home_04()
  },
  async _mpLoadNotice_notice_pet_v01_home_04() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("pet_v01_home_04"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_pet_v01_home_04: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "pet_v01_home_04", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_pet_v01_home_11, 'image'); if (list.length) this.setData({ products_pet_v01_home_11: list }); }
    { var list = withSrc(this.data.products_pet_v01_home_13, 'image'); if (list.length) this.setData({ products_pet_v01_home_13: list }); }
    { var wgt = this.data.swiper_pet_v01_home_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_pet_v01_home_03: next }); } }
  },
onShow() {
