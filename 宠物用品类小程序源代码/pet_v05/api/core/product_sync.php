...
function demo_product_catalog(): array {
    return [
        [1, 1, '成猫猫粮', './assets/images/pet_10.jpg', 39.00],
        [2, 1, '幼猫猫粮', './assets/images/pet_11.jpg', 98.00],
        [3, 1, '冻干猫粮', './assets/images/pet_12.jpg', 157.00],
        [4, 1, '猫罐头', './assets/images/pet_13.jpg', 216.00],
        [5, 1, '猫条', './assets/images/pet_14.jpg', 275.00],
        [6, 1, '化毛膏', './assets/images/pet_15.jpg', 334.00],
        [7, 2, '成犬狗粮', './assets/images/pet_16.jpg', 39.00],
        [8, 2, '幼犬狗粮', './assets/images/pet_17.jpg', 98.00],
        [9, 2, '犬用罐头', './assets/images/pet_18.jpg', 157.00],
        [10, 2, '犬磨牙棒', './assets/images/pet_19.jpg', 216.00],
        [11, 2, '犬零食', './assets/images/pet_20.jpg', 275.00],
        [12, 2, '营养膏', './assets/images/pet_21.jpg', 334.00],
        [13, 3, '冻干零食', './assets/images/pet_22.jpg', 39.00],
        [14, 3, '肉干', './assets/images/pet_23.jpg', 98.00],
        [15, 3, '洁齿棒', './assets/images/pet_24.jpg', 157.00],
        [16, 3, '猫薄荷', './assets/images/pet_25.jpg', 216.00],
        [17, 3, '小鱼干', './assets/images/pet_26.jpg', 275.00],
        [18, 3, '奶酪棒', './assets/images/pet_27.jpg', 334.00],
        [19, 4, '逗猫棒', './assets/images/pet_28.jpg', 39.00],
        [20, 4, '猫抓板', './assets/images/pet_29.jpg', 98.00],
        [21, 4, '犬飞盘', './assets/images/pet_30.jpg', 157.00],
        [22, 4, '益智玩具', './assets/images/pet_31.jpg', 216.00],
        [23, 4, '毛绒玩具', './assets/images/pet_32.jpg', 275.00],
        [24, 4, '球类玩具', './assets/images/pet_33.jpg', 334.00],
        [25, 5, '猫砂', './assets/images/pet_34.jpg', 39.00],
        [26, 5, '除臭喷雾', './assets/images/pet_35.jpg', 98.00],
        [27, 5, '沐浴露', './assets/images/pet_36.jpg', 157.00],
        [28, 5, '梳毛器', './assets/images/pet_37.jpg', 216.00],
        [29, 5, '尿垫', './assets/images/pet_38.jpg', 275.00],
        [30, 5, '拾便袋', './assets/images/pet_39.jpg', 334.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'猫粮',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'狗粮',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'零食',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'玩具',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'清洁',5,1)");
