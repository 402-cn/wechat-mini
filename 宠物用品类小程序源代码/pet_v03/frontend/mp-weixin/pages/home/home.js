...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_pet_v03_home_08: [{"id":1,"image":"/uploads/stock/pet_10.jpg","imageSrc":"","name":"成猫猫粮","price":39},{"id":2,"image":"/uploads/stock/pet_11.jpg","imageSrc":"","name":"幼猫猫粮","price":98},{"id":3,"image":"/uploads/stock/pet_12.jpg","imageSrc":"","name":"冻干猫粮","price":157},{"id":4,"image":"/uploads/stock/pet_13.jpg","imageSrc":"","name":"猫罐头","price":216},{"id":5,"image":"/uploads/stock/pet_14.jpg","imageSrc":"","name":"猫条","price":275},{"id":6,"image":"/uploads/stock/pet_15.jpg","imageSrc":"","name":"化毛膏","price":334}], productWidgets: [{"key":"products_pet_v03_home_08","cid":"pet_v03_home_08","limit":6}], swiper_pet_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/pet_9.jpg","imageSrc":"","link":"","title":"宠物用品"},{"image":"/uploads/stock/pet_48.jpg","imageSrc":"","link":"","title":"萌宠特惠"},{"image":"/uploads/stock/pet_49.jpg","imageSrc":"","link":"","title":"新品上架"}] }, swiperWidgets: [{"key":"swiper_pet_v03_home_02","cid":"pet_v03_home_02","height":340,"interval":3000}], promoPair_pet_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/pet_42.jpg","imageSrc":"","navUrl":"","title":"萌宠特惠"},{"bgColor":"#fff3e0","image":"/uploads/stock/pet_43.jpg","imageSrc":"","navUrl":"","title":"新品上架"}]}, promoPair_pet_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/pet_44.jpg","imageSrc":"","navUrl":"","title":"会员日"},{"bgColor":"#fff3e0","image":"/uploads/stock/pet_45.jpg","imageSrc":"","navUrl":"","title":"限时秒杀"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_pet_v03_home_08()
  },
  async _mpLoadProducts_products_pet_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("pet_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_pet_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_pet_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "pet_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_pet_v03_home_02()
  },
  async _mpLoadSwiper_swiper_pet_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("pet_v03_home_02"));
      ...
      var cur = this.data.swiper_pet_v03_home_02 || {};
      this.setData({
        swiper_pet_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "pet_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_pet_v03_home_08, 'image'); if (list.length) this.setData({ products_pet_v03_home_08: list }); }
    { var wgt = this.data.swiper_pet_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_pet_v03_home_02: next }); } }
  },
onShow() {
