...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_pet_v02_home_06: [{"id":1,"image":"/uploads/stock/pet_10.jpg","imageSrc":"","name":"成猫猫粮","price":39},{"id":2,"image":"/uploads/stock/pet_11.jpg","imageSrc":"","name":"幼猫猫粮","price":98},{"id":3,"image":"/uploads/stock/pet_12.jpg","imageSrc":"","name":"冻干猫粮","price":157},{"id":4,"image":"/uploads/stock/pet_13.jpg","imageSrc":"","name":"猫罐头","price":216},{"id":5,"image":"/uploads/stock/pet_14.jpg","imageSrc":"","name":"猫条","price":275},{"id":6,"image":"/uploads/stock/pet_15.jpg","imageSrc":"","name":"化毛膏","price":334},{"id":7,"image":"/uploads/stock/pet_16.jpg","imageSrc":"","name":"成犬狗粮","price":39},{"id":8,"image":"/uploads/stock/pet_17.jpg","imageSrc":"","name":"幼犬狗粮","price":98}], products_pet_v02_home_07: [{"id":13,"image":"/uploads/stock/pet_22.jpg","imageSrc":"","name":"冻干零食","price":39},{"id":14,"image":"/uploads/stock/pet_23.jpg","imageSrc":"","name":"肉干","price":98},{"id":15,"image":"/uploads/stock/pet_24.jpg","imageSrc":"","name":"洁齿棒","price":157}], productWidgets: [{"key":"products_pet_v02_home_06","cid":"pet_v02_home_06","limit":8},{"key":"products_pet_v02_home_07","cid":"pet_v02_home_07","limit":3}], swiper_pet_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/pet_8.jpg","imageSrc":"","link":"","title":"宠物用品"},{"image":"/uploads/stock/pet_9.jpg","imageSrc":"","link":"","title":"萌宠特惠"}] }, swiperWidgets: [{"key":"swiper_pet_v02_home_02","cid":"pet_v02_home_02","height":280,"interval":3000}], notice_pet_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购宠物用品好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_pet_v02_home_03","cid":"pet_v02_home_03"}], gridNav_pet_v02_home_04: {"items":[{"icon":"/uploads/stock/pet_1.jpg","iconSrc":"","navUrl":"","text":"猫粮"},{"icon":"/uploads/stock/pet_2.jpg","iconSrc":"","navUrl":"","text":"狗粮"},{"icon":"/uploads/stock/pet_3.jpg","iconSrc":"","navUrl":"","text":"零食"},{"icon":"/uploads/stock/pet_4.jpg","iconSrc":"","navUrl":"","text":"玩具"},{"icon":"/uploads/stock/pet_5.jpg","iconSrc":"","navUrl":"","text":"清洁"},{"icon":"/uploads/stock/pet_6.jpg","iconSrc":"","navUrl":"","text":"医疗"},{"icon":"/uploads/stock/pet_55.jpg","iconSrc":"","navUrl":"","text":"服饰"},{"icon":"/uploads/stock/pet_56.jpg","iconSrc":"","navUrl":"","text":"窝垫"},{"icon":"/uploads/stock/pet_57.jpg","iconSrc":"","navUrl":"","text":"出行"},{"icon":"/uploads/stock/pet_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_pet_v02_home_06();
    await this._mpLoadProducts_products_pet_v02_home_07()
  },
  async _mpLoadProducts_products_pet_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("pet_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_pet_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_pet_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "pet_v02_home_06", e); }
  },

  async _mpLoadProducts_products_pet_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("pet_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_pet_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_pet_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "pet_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_pet_v02_home_02()
  },
  async _mpLoadSwiper_swiper_pet_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("pet_v02_home_02"));
      ...
      var cur = this.data.swiper_pet_v02_home_02 || {};
      this.setData({
        swiper_pet_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "pet_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_pet_v02_home_03()
  },
  async _mpLoadNotice_notice_pet_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("pet_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_pet_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "pet_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_pet_v02_home_06, 'image'); if (list.length) this.setData({ products_pet_v02_home_06: list }); }
    { var list = withSrc(this.data.products_pet_v02_home_07, 'image'); if (list.length) this.setData({ products_pet_v02_home_07: list }); }
    { var wgt = this.data.swiper_pet_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_pet_v02_home_02: next }); } }
  },
onShow() {
