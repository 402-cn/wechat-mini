...
function demo_product_catalog(): array {
    return [
        [1, 1, '创媒文化精选款A', './assets/images/media_culture_10.jpg', 39.00],
        [2, 1, '创媒文化精选款B', './assets/images/media_culture_11.jpg', 88.00],
        [3, 1, '创媒文化精选款C', './assets/images/media_culture_12.jpg', 137.00],
        [4, 1, '创媒文化精选款D', './assets/images/media_culture_13.jpg', 186.00],
        [5, 1, '创媒文化精选款E', './assets/images/media_culture_14.jpg', 235.00],
        [6, 1, '创媒文化精选款F', './assets/images/media_culture_15.jpg', 284.00],
        [7, 2, '热销单品1', './assets/images/media_culture_16.jpg', 39.00],
        [8, 2, '热销单品2', './assets/images/media_culture_17.jpg', 88.00],
        [9, 2, '热销单品3', './assets/images/media_culture_18.jpg', 137.00],
        [10, 2, '热销单品4', './assets/images/media_culture_19.jpg', 186.00],
        [11, 2, '热销单品5', './assets/images/media_culture_20.jpg', 235.00],
        [12, 2, '热销单品6', './assets/images/media_culture_21.jpg', 284.00],
        [13, 3, '新品推荐1', './assets/images/media_culture_22.jpg', 39.00],
        [14, 3, '新品推荐2', './assets/images/media_culture_23.jpg', 88.00],
        [15, 3, '新品推荐3', './assets/images/media_culture_24.jpg', 137.00],
        [16, 3, '新品推荐4', './assets/images/media_culture_25.jpg', 186.00],
        [17, 3, '新品推荐5', './assets/images/media_culture_26.jpg', 235.00],
        [18, 3, '新品推荐6', './assets/images/media_culture_27.jpg', 284.00],
        [19, 4, '套餐服务1', './assets/images/media_culture_28.jpg', 39.00],
        [20, 4, '套餐服务2', './assets/images/media_culture_29.jpg', 88.00],
        [21, 4, '套餐服务3', './assets/images/media_culture_30.jpg', 137.00],
        [22, 4, '套餐服务4', './assets/images/media_culture_31.jpg', 186.00],
        [23, 4, '套餐服务5', './assets/images/media_culture_32.jpg', 235.00],
        [24, 4, '套餐服务6', './assets/images/media_culture_33.jpg', 284.00],
        [25, 5, '会员专享1', './assets/images/media_culture_34.jpg', 39.00],
        [26, 5, '会员专享2', './assets/images/media_culture_35.jpg', 88.00],
        [27, 5, '会员专享3', './assets/images/media_culture_36.jpg', 137.00],
        [28, 5, '会员专享4', './assets/images/media_culture_37.jpg', 186.00],
        [29, 5, '会员专享5', './assets/images/media_culture_38.jpg', 235.00],
        [30, 5, '会员专享6', './assets/images/media_culture_39.jpg', 284.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'策划',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'设计',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'拍摄',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'广告',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'活动',5,1)");
