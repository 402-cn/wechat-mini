...
try {
    $pdo = db();
    ensure_form_table_columns($pdo, 'media_culture_v07_home_contact', array(
    ...
    $stmt = $pdo->prepare('INSERT INTO `media_culture_v07_home_contact` (`name`, `phone`, `message`) VALUES (?, ?, ?)');
    $stmt->execute($values);
