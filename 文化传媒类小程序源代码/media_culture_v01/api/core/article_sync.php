...
function demo_article_catalog(): array {
    return [
        ['欢迎来到创媒文化', '部署后可在后台编辑', './assets/images/media_culture_7.jpg', '<p><strong>本文为演示数据</strong>，安装后可在 PHP 后台「文章管理」中修改或删除。正式运营请替换为真实内容。</p><!--ADMIN_GUIDE_FOOTER-->', 128, 1],
        ['创媒文化新品发布', '演示文章仅供参考', './assets/images/media_culture_8.jpg', '<p>演示正文。部署后可在 PHP 后台「文章管理」中修改或删除。</p><!--ADMIN_GUIDE_FOOTER-->', 86, 1],
        ['会员权益说明', '演示数据', './assets/images/media_culture_9.jpg', '<p>演示正文。部署后可在 PHP 后台「文章管理」中修改或删除。</p><!--ADMIN_GUIDE_FOOTER-->', 203, 1],
        ['服务与配送说明', '演示数据', './assets/images/media_culture_48.jpg', '<p>演示正文。部署后可在 PHP 后台「文章管理」中修改或删除。</p><!--ADMIN_GUIDE_FOOTER-->', 57, 1],
        ['常见问题解答', '演示数据', './assets/images/media_culture_49.jpg', '<p>演示正文。部署后可在 PHP 后台「文章管理」中修改或删除。</p><!--ADMIN_GUIDE_FOOTER-->', 91, 1],
    ];
}
