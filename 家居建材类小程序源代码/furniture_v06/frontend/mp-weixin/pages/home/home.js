...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_furniture_v06_home_05: [{"id":7,"image":"/uploads/stock/furniture_16.jpg","imageSrc":"","name":"1.8米床架","price":399},{"id":8,"image":"/uploads/stock/furniture_17.jpg","imageSrc":"","name":"1.5米床架","price":998},{"id":9,"image":"/uploads/stock/furniture_18.jpg","imageSrc":"","name":"床垫","price":1597},{"id":10,"image":"/uploads/stock/furniture_19.jpg","imageSrc":"","name":"床头柜","price":2196}], productWidgets: [{"key":"products_furniture_v06_home_05","cid":"furniture_v06_home_05","limit":4}], swiper_furniture_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/furniture_50.jpg","imageSrc":"","link":"","title":"家居建材"},{"image":"/uploads/stock/furniture_51.jpg","imageSrc":"","link":"","title":"家装节"},{"image":"/uploads/stock/furniture_52.jpg","imageSrc":"","link":"","title":"满减优惠"}] }, swiperWidgets: [{"key":"swiper_furniture_v06_home_02","cid":"furniture_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_furniture_v06_home_05()
  },
  async _mpLoadProducts_products_furniture_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("furniture_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_furniture_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_furniture_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "furniture_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_furniture_v06_home_02()
  },
  async _mpLoadSwiper_swiper_furniture_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("furniture_v06_home_02"));
      ...
      var cur = this.data.swiper_furniture_v06_home_02 || {};
      this.setData({
        swiper_furniture_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "furniture_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_furniture_v06_home_05, 'image'); if (list.length) this.setData({ products_furniture_v06_home_05: list }); }
    { var wgt = this.data.swiper_furniture_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_furniture_v06_home_02: next }); } }
  },
onShow() {
