...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_furniture_v02_home_06: [{"id":1,"image":"/uploads/stock/furniture_10.jpg","imageSrc":"","name":"三人布艺沙发","price":399},{"id":2,"image":"/uploads/stock/furniture_11.jpg","imageSrc":"","name":"真皮沙发","price":998},{"id":3,"image":"/uploads/stock/furniture_12.jpg","imageSrc":"","name":"单人沙发","price":1597},{"id":4,"image":"/uploads/stock/furniture_13.jpg","imageSrc":"","name":"沙发床","price":2196},{"id":5,"image":"/uploads/stock/furniture_14.jpg","imageSrc":"","name":"懒人沙发","price":2795},{"id":6,"image":"/uploads/stock/furniture_15.jpg","imageSrc":"","name":"转角沙发","price":3394},{"id":7,"image":"/uploads/stock/furniture_16.jpg","imageSrc":"","name":"1.8米床架","price":399},{"id":8,"image":"/uploads/stock/furniture_17.jpg","imageSrc":"","name":"1.5米床架","price":998}], products_furniture_v02_home_07: [{"id":13,"image":"/uploads/stock/furniture_22.jpg","imageSrc":"","name":"餐桌椅套装","price":399},{"id":14,"image":"/uploads/stock/furniture_23.jpg","imageSrc":"","name":"书桌","price":998},{"id":15,"image":"/uploads/stock/furniture_24.jpg","imageSrc":"","name":"办公椅","price":1597}], productWidgets: [{"key":"products_furniture_v02_home_06","cid":"furniture_v02_home_06","limit":8},{"key":"products_furniture_v02_home_07","cid":"furniture_v02_home_07","limit":3}], swiper_furniture_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/furniture_8.jpg","imageSrc":"","link":"","title":"家居建材"},{"image":"/uploads/stock/furniture_9.jpg","imageSrc":"","link":"","title":"家装节"}] }, swiperWidgets: [{"key":"swiper_furniture_v02_home_02","cid":"furniture_v02_home_02","height":280,"interval":3000}], notice_furniture_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购家居建材好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_furniture_v02_home_03","cid":"furniture_v02_home_03"}], gridNav_furniture_v02_home_04: {"items":[{"icon":"/uploads/stock/furniture_1.jpg","iconSrc":"","navUrl":"","text":"沙发"},{"icon":"/uploads/stock/furniture_2.jpg","iconSrc":"","navUrl":"","text":"床具"},{"icon":"/uploads/stock/furniture_3.jpg","iconSrc":"","navUrl":"","text":"桌椅"},{"icon":"/uploads/stock/furniture_4.jpg","iconSrc":"","navUrl":"","text":"灯具"},{"icon":"/uploads/stock/furniture_5.jpg","iconSrc":"","navUrl":"","text":"收纳"},{"icon":"/uploads/stock/furniture_6.jpg","iconSrc":"","navUrl":"","text":"厨具"},{"icon":"/uploads/stock/furniture_55.jpg","iconSrc":"","navUrl":"","text":"卫浴"},{"icon":"/uploads/stock/furniture_56.jpg","iconSrc":"","navUrl":"","text":"瓷砖"},{"icon":"/uploads/stock/furniture_57.jpg","iconSrc":"","navUrl":"","text":"涂料"},{"icon":"/uploads/stock/furniture_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_furniture_v02_home_06();
    await this._mpLoadProducts_products_furniture_v02_home_07()
  },
  async _mpLoadProducts_products_furniture_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("furniture_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_furniture_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_furniture_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "furniture_v02_home_06", e); }
  },

  async _mpLoadProducts_products_furniture_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("furniture_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_furniture_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_furniture_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "furniture_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_furniture_v02_home_02()
  },
  async _mpLoadSwiper_swiper_furniture_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("furniture_v02_home_02"));
      ...
      var cur = this.data.swiper_furniture_v02_home_02 || {};
      this.setData({
        swiper_furniture_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "furniture_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_furniture_v02_home_03()
  },
  async _mpLoadNotice_notice_furniture_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("furniture_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_furniture_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "furniture_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_furniture_v02_home_06, 'image'); if (list.length) this.setData({ products_furniture_v02_home_06: list }); }
    { var list = withSrc(this.data.products_furniture_v02_home_07, 'image'); if (list.length) this.setData({ products_furniture_v02_home_07: list }); }
    { var wgt = this.data.swiper_furniture_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_furniture_v02_home_02: next }); } }
  },
onShow() {
