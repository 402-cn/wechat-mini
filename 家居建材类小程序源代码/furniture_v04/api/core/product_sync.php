...
function demo_product_catalog(): array {
    return [
        [1, 1, '三人布艺沙发', './assets/images/furniture_10.jpg', 399.00],
        [2, 1, '真皮沙发', './assets/images/furniture_11.jpg', 998.00],
        [3, 1, '单人沙发', './assets/images/furniture_12.jpg', 1597.00],
        [4, 1, '沙发床', './assets/images/furniture_13.jpg', 2196.00],
        [5, 1, '懒人沙发', './assets/images/furniture_14.jpg', 2795.00],
        [6, 1, '转角沙发', './assets/images/furniture_15.jpg', 3394.00],
        [7, 2, '1.8米床架', './assets/images/furniture_16.jpg', 399.00],
        [8, 2, '1.5米床架', './assets/images/furniture_17.jpg', 998.00],
        [9, 2, '床垫', './assets/images/furniture_18.jpg', 1597.00],
        [10, 2, '床头柜', './assets/images/furniture_19.jpg', 2196.00],
        [11, 2, '儿童床', './assets/images/furniture_20.jpg', 2795.00],
        [12, 2, '上下床', './assets/images/furniture_21.jpg', 3394.00],
        [13, 3, '餐桌椅套装', './assets/images/furniture_22.jpg', 399.00],
        [14, 3, '书桌', './assets/images/furniture_23.jpg', 998.00],
        [15, 3, '办公椅', './assets/images/furniture_24.jpg', 1597.00],
        [16, 3, '茶几', './assets/images/furniture_25.jpg', 2196.00],
        [17, 3, '电视柜', './assets/images/furniture_26.jpg', 2795.00],
        [18, 3, '餐边柜', './assets/images/furniture_27.jpg', 3394.00],
        [19, 4, '吸顶灯', './assets/images/furniture_28.jpg', 399.00],
        [20, 4, '吊灯', './assets/images/furniture_29.jpg', 998.00],
        [21, 4, '台灯', './assets/images/furniture_30.jpg', 1597.00],
        [22, 4, '落地灯', './assets/images/furniture_31.jpg', 2196.00],
        [23, 4, '壁灯', './assets/images/furniture_32.jpg', 2795.00],
        [24, 4, '灯带', './assets/images/furniture_33.jpg', 3394.00],
        [25, 5, '衣柜', './assets/images/furniture_34.jpg', 399.00],
        [26, 5, '鞋柜', './assets/images/furniture_35.jpg', 998.00],
        [27, 5, '书架', './assets/images/furniture_36.jpg', 1597.00],
        [28, 5, '置物架', './assets/images/furniture_37.jpg', 2196.00],
        [29, 5, '收纳盒', './assets/images/furniture_38.jpg', 2795.00],
        [30, 5, '衣帽架', './assets/images/furniture_39.jpg', 3394.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'沙发',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'床具',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'桌椅',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'灯具',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'收纳',5,1)");
