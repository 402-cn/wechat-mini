...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_furniture_v01_home_11: [{"id":1,"image":"/uploads/stock/furniture_10.jpg","imageSrc":"","name":"三人布艺沙发","price":399},{"id":2,"image":"/uploads/stock/furniture_11.jpg","imageSrc":"","name":"真皮沙发","price":998},{"id":3,"image":"/uploads/stock/furniture_12.jpg","imageSrc":"","name":"单人沙发","price":1597}], products_furniture_v01_home_13: [{"id":7,"image":"/uploads/stock/furniture_16.jpg","imageSrc":"","name":"1.8米床架","price":399},{"id":8,"image":"/uploads/stock/furniture_17.jpg","imageSrc":"","name":"1.5米床架","price":998},{"id":9,"image":"/uploads/stock/furniture_18.jpg","imageSrc":"","name":"床垫","price":1597},{"id":10,"image":"/uploads/stock/furniture_19.jpg","imageSrc":"","name":"床头柜","price":2196},{"id":11,"image":"/uploads/stock/furniture_20.jpg","imageSrc":"","name":"儿童床","price":2795},{"id":12,"image":"/uploads/stock/furniture_21.jpg","imageSrc":"","name":"上下床","price":3394}], productWidgets: [{"key":"products_furniture_v01_home_11","cid":"furniture_v01_home_11","limit":3},{"key":"products_furniture_v01_home_13","cid":"furniture_v01_home_13","limit":6}], swiper_furniture_v01_home_03: { height: 320, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/furniture_7.jpg","imageSrc":"","link":"","title":"家居建材"},{"image":"/uploads/stock/furniture_8.jpg","imageSrc":"","link":"","title":"家装节"},{"image":"/uploads/stock/furniture_9.jpg","imageSrc":"","link":"","title":"满减优惠"}] }, swiperWidgets: [{"key":"swiper_furniture_v01_home_03","cid":"furniture_v01_home_03","height":320,"interval":3000}], notice_furniture_v01_home_04: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购家居建材好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_furniture_v01_home_04","cid":"furniture_v01_home_04"}], gridNav_furniture_v01_home_02: {"items":[{"icon":"/uploads/stock/furniture_1.jpg","iconSrc":"","navUrl":"","text":"再买一单"},{"icon":"/uploads/stock/furniture_2.jpg","iconSrc":"","navUrl":"","text":"会员中心"},{"icon":"/uploads/stock/furniture_3.jpg","iconSrc":"","navUrl":"","text":"优惠券"},{"icon":"/uploads/stock/furniture_4.jpg","iconSrc":"","navUrl":"","text":"我的订单"}]}, gridNav_furniture_v01_home_05: {"items":[{"icon":"/uploads/stock/furniture_1.jpg","iconSrc":"","navUrl":"","text":"极速达"},{"icon":"/uploads/stock/furniture_2.jpg","iconSrc":"","navUrl":"","text":"品质保障"},{"icon":"/uploads/stock/furniture_3.jpg","iconSrc":"","navUrl":"","text":"售后无忧"}]}, gridNav_furniture_v01_home_06: {"items":[{"icon":"/uploads/stock/furniture_1.jpg","iconSrc":"","navUrl":"","text":"沙发"},{"icon":"/uploads/stock/furniture_2.jpg","iconSrc":"","navUrl":"","text":"床具"},{"icon":"/uploads/stock/furniture_3.jpg","iconSrc":"","navUrl":"","text":"桌椅"},{"icon":"/uploads/stock/furniture_4.jpg","iconSrc":"","navUrl":"","text":"灯具"},{"icon":"/uploads/stock/furniture_5.jpg","iconSrc":"","navUrl":"","text":"收纳"},{"icon":"/uploads/stock/furniture_6.jpg","iconSrc":"","navUrl":"","text":"厨具"},{"icon":"/uploads/stock/furniture_55.jpg","iconSrc":"","navUrl":"","text":"卫浴"},{"icon":"/uploads/stock/furniture_56.jpg","iconSrc":"","navUrl":"","text":"瓷砖"},{"icon":"/uploads/stock/furniture_57.jpg","iconSrc":"","navUrl":"","text":"涂料"},{"icon":"/uploads/stock/furniture_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]}, promoPair_furniture_v01_home_07: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/furniture_40.jpg","imageSrc":"","navUrl":"","title":"家装节"},{"bgColor":"#fff3e0","image":"/uploads/stock/furniture_41.jpg","imageSrc":"","navUrl":"","title":"满减优惠"}]}, promoPair_furniture_v01_home_08: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/furniture_42.jpg","imageSrc":"","navUrl":"","title":"会员折扣"},{"bgColor":"#fff3e0","image":"/uploads/stock/furniture_43.jpg","imageSrc":"","navUrl":"","title":"限时秒杀"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_furniture_v01_home_11();
    await this._mpLoadProducts_products_furniture_v01_home_13()
  },
  async _mpLoadProducts_products_furniture_v01_home_11() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("furniture_v01_home_11");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_furniture_v01_home_11 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_furniture_v01_home_11: list });
    } catch (e) { this.mpDevWarn('product', "furniture_v01_home_11", e); }
  },

  async _mpLoadProducts_products_furniture_v01_home_13() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("furniture_v01_home_13");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_furniture_v01_home_13 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_furniture_v01_home_13: list });
    } catch (e) { this.mpDevWarn('product', "furniture_v01_home_13", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_furniture_v01_home_03()
  },
  async _mpLoadSwiper_swiper_furniture_v01_home_03() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("furniture_v01_home_03"));
      ...
      var cur = this.data.swiper_furniture_v01_home_03 || {};
      this.setData({
        swiper_furniture_v01_home_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "furniture_v01_home_03", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_furniture_v01_home_04()
  },
  async _mpLoadNotice_notice_furniture_v01_home_04() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("furniture_v01_home_04"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_furniture_v01_home_04: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "furniture_v01_home_04", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_furniture_v01_home_11, 'image'); if (list.length) this.setData({ products_furniture_v01_home_11: list }); }
    { var list = withSrc(this.data.products_furniture_v01_home_13, 'image'); if (list.length) this.setData({ products_furniture_v01_home_13: list }); }
    { var wgt = this.data.swiper_furniture_v01_home_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_furniture_v01_home_03: next }); } }
  },
onShow() {
