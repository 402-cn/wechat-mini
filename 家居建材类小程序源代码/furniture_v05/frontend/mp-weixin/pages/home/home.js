...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_furniture_v05_home_04: [{"id":1,"image":"/uploads/stock/furniture_10.jpg","imageSrc":"","name":"三人布艺沙发","price":399},{"id":2,"image":"/uploads/stock/furniture_11.jpg","imageSrc":"","name":"真皮沙发","price":998},{"id":3,"image":"/uploads/stock/furniture_12.jpg","imageSrc":"","name":"单人沙发","price":1597},{"id":4,"image":"/uploads/stock/furniture_13.jpg","imageSrc":"","name":"沙发床","price":2196},{"id":5,"image":"/uploads/stock/furniture_14.jpg","imageSrc":"","name":"懒人沙发","price":2795},{"id":6,"image":"/uploads/stock/furniture_15.jpg","imageSrc":"","name":"转角沙发","price":3394},{"id":7,"image":"/uploads/stock/furniture_16.jpg","imageSrc":"","name":"1.8米床架","price":399},{"id":8,"image":"/uploads/stock/furniture_17.jpg","imageSrc":"","name":"1.5米床架","price":998}], products_furniture_v05_home_06: [{"id":9,"image":"/uploads/stock/furniture_18.jpg","imageSrc":"","name":"床垫","price":1597},{"id":10,"image":"/uploads/stock/furniture_19.jpg","imageSrc":"","name":"床头柜","price":2196},{"id":11,"image":"/uploads/stock/furniture_20.jpg","imageSrc":"","name":"儿童床","price":2795},{"id":12,"image":"/uploads/stock/furniture_21.jpg","imageSrc":"","name":"上下床","price":3394}], productWidgets: [{"key":"products_furniture_v05_home_04","cid":"furniture_v05_home_04","limit":8},{"key":"products_furniture_v05_home_06","cid":"furniture_v05_home_06","limit":4}], swiper_furniture_v05_home_02: { height: 360, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/furniture_49.jpg","imageSrc":"","link":"","title":"家居建材"}] }, swiperWidgets: [{"key":"swiper_furniture_v05_home_02","cid":"furniture_v05_home_02","height":360,"interval":3000}], notice_furniture_v05_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购家居建材好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_furniture_v05_home_03","cid":"furniture_v05_home_03"}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_furniture_v05_home_04();
    await this._mpLoadProducts_products_furniture_v05_home_06()
  },
  async _mpLoadProducts_products_furniture_v05_home_04() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("furniture_v05_home_04");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_furniture_v05_home_04 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_furniture_v05_home_04: list });
    } catch (e) { this.mpDevWarn('product', "furniture_v05_home_04", e); }
  },

  async _mpLoadProducts_products_furniture_v05_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("furniture_v05_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_furniture_v05_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_furniture_v05_home_06: list });
    } catch (e) { this.mpDevWarn('product', "furniture_v05_home_06", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_furniture_v05_home_02()
  },
  async _mpLoadSwiper_swiper_furniture_v05_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("furniture_v05_home_02"));
      ...
      var cur = this.data.swiper_furniture_v05_home_02 || {};
      this.setData({
        swiper_furniture_v05_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "furniture_v05_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_furniture_v05_home_03()
  },
  async _mpLoadNotice_notice_furniture_v05_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("furniture_v05_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_furniture_v05_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "furniture_v05_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_furniture_v05_home_04, 'image'); if (list.length) this.setData({ products_furniture_v05_home_04: list }); }
    { var list = withSrc(this.data.products_furniture_v05_home_06, 'image'); if (list.length) this.setData({ products_furniture_v05_home_06: list }); }
    { var wgt = this.data.swiper_furniture_v05_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_furniture_v05_home_02: next }); } }
  },
onShow() {
