...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_furniture_v03_home_08: [{"id":1,"image":"/uploads/stock/furniture_10.jpg","imageSrc":"","name":"三人布艺沙发","price":399},{"id":2,"image":"/uploads/stock/furniture_11.jpg","imageSrc":"","name":"真皮沙发","price":998},{"id":3,"image":"/uploads/stock/furniture_12.jpg","imageSrc":"","name":"单人沙发","price":1597},{"id":4,"image":"/uploads/stock/furniture_13.jpg","imageSrc":"","name":"沙发床","price":2196},{"id":5,"image":"/uploads/stock/furniture_14.jpg","imageSrc":"","name":"懒人沙发","price":2795},{"id":6,"image":"/uploads/stock/furniture_15.jpg","imageSrc":"","name":"转角沙发","price":3394}], productWidgets: [{"key":"products_furniture_v03_home_08","cid":"furniture_v03_home_08","limit":6}], swiper_furniture_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/furniture_9.jpg","imageSrc":"","link":"","title":"家居建材"},{"image":"/uploads/stock/furniture_48.jpg","imageSrc":"","link":"","title":"家装节"},{"image":"/uploads/stock/furniture_49.jpg","imageSrc":"","link":"","title":"满减优惠"}] }, swiperWidgets: [{"key":"swiper_furniture_v03_home_02","cid":"furniture_v03_home_02","height":340,"interval":3000}], promoPair_furniture_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/furniture_42.jpg","imageSrc":"","navUrl":"","title":"家装节"},{"bgColor":"#fff3e0","image":"/uploads/stock/furniture_43.jpg","imageSrc":"","navUrl":"","title":"满减优惠"}]}, promoPair_furniture_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/furniture_44.jpg","imageSrc":"","navUrl":"","title":"会员折扣"},{"bgColor":"#fff3e0","image":"/uploads/stock/furniture_45.jpg","imageSrc":"","navUrl":"","title":"限时秒杀"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_furniture_v03_home_08()
  },
  async _mpLoadProducts_products_furniture_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("furniture_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_furniture_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_furniture_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "furniture_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_furniture_v03_home_02()
  },
  async _mpLoadSwiper_swiper_furniture_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("furniture_v03_home_02"));
      ...
      var cur = this.data.swiper_furniture_v03_home_02 || {};
      this.setData({
        swiper_furniture_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "furniture_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_furniture_v03_home_08, 'image'); if (list.length) this.setData({ products_furniture_v03_home_08: list }); }
    { var wgt = this.data.swiper_furniture_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_furniture_v03_home_02: next }); } }
  },
onShow() {
