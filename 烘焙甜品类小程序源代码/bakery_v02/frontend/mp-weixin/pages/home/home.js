...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_bakery_v02_home_06: [{"id":1,"image":"/uploads/stock/bakery_10.jpg","imageSrc":"","name":"生日蛋糕6寸","price":38},{"id":2,"image":"/uploads/stock/bakery_11.jpg","imageSrc":"","name":"生日蛋糕8寸","price":86},{"id":3,"image":"/uploads/stock/bakery_12.jpg","imageSrc":"","name":"慕斯蛋糕","price":134},{"id":4,"image":"/uploads/stock/bakery_13.jpg","imageSrc":"","name":"芝士蛋糕","price":182},{"id":5,"image":"/uploads/stock/bakery_14.jpg","imageSrc":"","name":"提拉米苏","price":230},{"id":6,"image":"/uploads/stock/bakery_15.jpg","imageSrc":"","name":"红丝绒蛋糕","price":278},{"id":7,"image":"/uploads/stock/bakery_16.jpg","imageSrc":"","name":"全麦吐司","price":38},{"id":8,"image":"/uploads/stock/bakery_17.jpg","imageSrc":"","name":"可颂面包","price":86}], products_bakery_v02_home_07: [{"id":13,"image":"/uploads/stock/bakery_22.jpg","imageSrc":"","name":"黄油曲奇","price":38},{"id":14,"image":"/uploads/stock/bakery_23.jpg","imageSrc":"","name":"巧克力曲奇","price":86},{"id":15,"image":"/uploads/stock/bakery_24.jpg","imageSrc":"","name":"蔓越莓曲奇","price":134}], productWidgets: [{"key":"products_bakery_v02_home_06","cid":"bakery_v02_home_06","limit":8},{"key":"products_bakery_v02_home_07","cid":"bakery_v02_home_07","limit":3}], swiper_bakery_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/bakery_8.jpg","imageSrc":"","link":"","title":"烘焙甜品"},{"image":"/uploads/stock/bakery_9.jpg","imageSrc":"","link":"","title":"生日蛋糕"}] }, swiperWidgets: [{"key":"swiper_bakery_v02_home_02","cid":"bakery_v02_home_02","height":280,"interval":3000}], notice_bakery_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购烘焙甜品好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_bakery_v02_home_03","cid":"bakery_v02_home_03"}], gridNav_bakery_v02_home_04: {"items":[{"icon":"/uploads/stock/bakery_1.jpg","iconSrc":"","navUrl":"","text":"蛋糕"},{"icon":"/uploads/stock/bakery_2.jpg","iconSrc":"","navUrl":"","text":"面包"},{"icon":"/uploads/stock/bakery_3.jpg","iconSrc":"","navUrl":"","text":"曲奇"},{"icon":"/uploads/stock/bakery_4.jpg","iconSrc":"","navUrl":"","text":"慕斯"},{"icon":"/uploads/stock/bakery_5.jpg","iconSrc":"","navUrl":"","text":"挞类"},{"icon":"/uploads/stock/bakery_6.jpg","iconSrc":"","navUrl":"","text":"礼盒"},{"icon":"/uploads/stock/bakery_55.jpg","iconSrc":"","navUrl":"","text":"定制"},{"icon":"/uploads/stock/bakery_56.jpg","iconSrc":"","navUrl":"","text":"早餐"},{"icon":"/uploads/stock/bakery_57.jpg","iconSrc":"","navUrl":"","text":"下午茶"},{"icon":"/uploads/stock/bakery_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_bakery_v02_home_06();
    await this._mpLoadProducts_products_bakery_v02_home_07()
  },
  async _mpLoadProducts_products_bakery_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("bakery_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_bakery_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_bakery_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "bakery_v02_home_06", e); }
  },

  async _mpLoadProducts_products_bakery_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("bakery_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_bakery_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_bakery_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "bakery_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_bakery_v02_home_02()
  },
  async _mpLoadSwiper_swiper_bakery_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("bakery_v02_home_02"));
      ...
      var cur = this.data.swiper_bakery_v02_home_02 || {};
      this.setData({
        swiper_bakery_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "bakery_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_bakery_v02_home_03()
  },
  async _mpLoadNotice_notice_bakery_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("bakery_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_bakery_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "bakery_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_bakery_v02_home_06, 'image'); if (list.length) this.setData({ products_bakery_v02_home_06: list }); }
    { var list = withSrc(this.data.products_bakery_v02_home_07, 'image'); if (list.length) this.setData({ products_bakery_v02_home_07: list }); }
    { var wgt = this.data.swiper_bakery_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_bakery_v02_home_02: next }); } }
  },
onShow() {
