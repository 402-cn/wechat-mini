...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_bakery_v03_home_08: [{"id":1,"image":"/uploads/stock/bakery_10.jpg","imageSrc":"","name":"生日蛋糕6寸","price":38},{"id":2,"image":"/uploads/stock/bakery_11.jpg","imageSrc":"","name":"生日蛋糕8寸","price":86},{"id":3,"image":"/uploads/stock/bakery_12.jpg","imageSrc":"","name":"慕斯蛋糕","price":134},{"id":4,"image":"/uploads/stock/bakery_13.jpg","imageSrc":"","name":"芝士蛋糕","price":182},{"id":5,"image":"/uploads/stock/bakery_14.jpg","imageSrc":"","name":"提拉米苏","price":230},{"id":6,"image":"/uploads/stock/bakery_15.jpg","imageSrc":"","name":"红丝绒蛋糕","price":278}], productWidgets: [{"key":"products_bakery_v03_home_08","cid":"bakery_v03_home_08","limit":6}], swiper_bakery_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/bakery_9.jpg","imageSrc":"","link":"","title":"烘焙甜品"},{"image":"/uploads/stock/bakery_48.jpg","imageSrc":"","link":"","title":"生日蛋糕"},{"image":"/uploads/stock/bakery_49.jpg","imageSrc":"","link":"","title":"限时折扣"}] }, swiperWidgets: [{"key":"swiper_bakery_v03_home_02","cid":"bakery_v03_home_02","height":340,"interval":3000}], promoPair_bakery_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/bakery_42.jpg","imageSrc":"","navUrl":"","title":"生日蛋糕"},{"bgColor":"#fff3e0","image":"/uploads/stock/bakery_43.jpg","imageSrc":"","navUrl":"","title":"限时折扣"}]}, promoPair_bakery_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/bakery_44.jpg","imageSrc":"","navUrl":"","title":"会员日"},{"bgColor":"#fff3e0","image":"/uploads/stock/bakery_45.jpg","imageSrc":"","navUrl":"","title":"新品试吃"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_bakery_v03_home_08()
  },
  async _mpLoadProducts_products_bakery_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("bakery_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_bakery_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_bakery_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "bakery_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_bakery_v03_home_02()
  },
  async _mpLoadSwiper_swiper_bakery_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("bakery_v03_home_02"));
      ...
      var cur = this.data.swiper_bakery_v03_home_02 || {};
      this.setData({
        swiper_bakery_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "bakery_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_bakery_v03_home_08, 'image'); if (list.length) this.setData({ products_bakery_v03_home_08: list }); }
    { var wgt = this.data.swiper_bakery_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_bakery_v03_home_02: next }); } }
  },
onShow() {
