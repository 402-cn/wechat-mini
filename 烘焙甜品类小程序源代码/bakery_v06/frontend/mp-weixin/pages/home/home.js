...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_bakery_v06_home_05: [{"id":7,"image":"/uploads/stock/bakery_16.jpg","imageSrc":"","name":"全麦吐司","price":38},{"id":8,"image":"/uploads/stock/bakery_17.jpg","imageSrc":"","name":"可颂面包","price":86},{"id":9,"image":"/uploads/stock/bakery_18.jpg","imageSrc":"","name":"法棍","price":134},{"id":10,"image":"/uploads/stock/bakery_19.jpg","imageSrc":"","name":"贝果","price":182}], productWidgets: [{"key":"products_bakery_v06_home_05","cid":"bakery_v06_home_05","limit":4}], swiper_bakery_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/bakery_50.jpg","imageSrc":"","link":"","title":"烘焙甜品"},{"image":"/uploads/stock/bakery_51.jpg","imageSrc":"","link":"","title":"生日蛋糕"},{"image":"/uploads/stock/bakery_52.jpg","imageSrc":"","link":"","title":"限时折扣"}] }, swiperWidgets: [{"key":"swiper_bakery_v06_home_02","cid":"bakery_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_bakery_v06_home_05()
  },
  async _mpLoadProducts_products_bakery_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("bakery_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_bakery_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_bakery_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "bakery_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_bakery_v06_home_02()
  },
  async _mpLoadSwiper_swiper_bakery_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("bakery_v06_home_02"));
      ...
      var cur = this.data.swiper_bakery_v06_home_02 || {};
      this.setData({
        swiper_bakery_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "bakery_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_bakery_v06_home_05, 'image'); if (list.length) this.setData({ products_bakery_v06_home_05: list }); }
    { var wgt = this.data.swiper_bakery_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_bakery_v06_home_02: next }); } }
  },
onShow() {
