...
function demo_product_catalog(): array {
    return [
        [1, 1, '生日蛋糕6寸', './assets/images/bakery_10.jpg', 38.00],
        [2, 1, '生日蛋糕8寸', './assets/images/bakery_11.jpg', 86.00],
        [3, 1, '慕斯蛋糕', './assets/images/bakery_12.jpg', 134.00],
        [4, 1, '芝士蛋糕', './assets/images/bakery_13.jpg', 182.00],
        [5, 1, '提拉米苏', './assets/images/bakery_14.jpg', 230.00],
        [6, 1, '红丝绒蛋糕', './assets/images/bakery_15.jpg', 278.00],
        [7, 2, '全麦吐司', './assets/images/bakery_16.jpg', 38.00],
        [8, 2, '可颂面包', './assets/images/bakery_17.jpg', 86.00],
        [9, 2, '法棍', './assets/images/bakery_18.jpg', 134.00],
        [10, 2, '贝果', './assets/images/bakery_19.jpg', 182.00],
        [11, 2, '丹麦酥', './assets/images/bakery_20.jpg', 230.00],
        [12, 2, '菠萝包', './assets/images/bakery_21.jpg', 278.00],
        [13, 3, '黄油曲奇', './assets/images/bakery_22.jpg', 38.00],
        [14, 3, '巧克力曲奇', './assets/images/bakery_23.jpg', 86.00],
        [15, 3, '蔓越莓曲奇', './assets/images/bakery_24.jpg', 134.00],
        [16, 3, '杏仁饼干', './assets/images/bakery_25.jpg', 182.00],
        [17, 3, '苏打饼干', './assets/images/bakery_26.jpg', 230.00],
        [18, 3, '海苔饼干', './assets/images/bakery_27.jpg', 278.00],
        [19, 4, '芒果慕斯', './assets/images/bakery_28.jpg', 38.00],
        [20, 4, '草莓慕斯', './assets/images/bakery_29.jpg', 86.00],
        [21, 4, '抹茶慕斯', './assets/images/bakery_30.jpg', 134.00],
        [22, 4, '榴莲千层', './assets/images/bakery_31.jpg', 182.00],
        [23, 4, '拿破仑', './assets/images/bakery_32.jpg', 230.00],
        [24, 4, '泡芙', './assets/images/bakery_33.jpg', 278.00],
        [25, 5, '节日礼盒A', './assets/images/bakery_34.jpg', 38.00],
        [26, 5, '节日礼盒B', './assets/images/bakery_35.jpg', 86.00],
        [27, 5, '伴手礼盒', './assets/images/bakery_36.jpg', 134.00],
        [28, 5, '企业定制盒', './assets/images/bakery_37.jpg', 182.00],
        [29, 5, '儿童礼盒', './assets/images/bakery_38.jpg', 230.00],
        [30, 5, '下午茶套餐', './assets/images/bakery_39.jpg', 278.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'蛋糕',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'面包',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'曲奇',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'慕斯',4,1)");
