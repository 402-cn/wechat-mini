...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_bakery_v01_home_11: [{"id":1,"image":"/uploads/stock/bakery_10.jpg","imageSrc":"","name":"生日蛋糕6寸","price":38},{"id":2,"image":"/uploads/stock/bakery_11.jpg","imageSrc":"","name":"生日蛋糕8寸","price":86},{"id":3,"image":"/uploads/stock/bakery_12.jpg","imageSrc":"","name":"慕斯蛋糕","price":134}], products_bakery_v01_home_13: [{"id":7,"image":"/uploads/stock/bakery_16.jpg","imageSrc":"","name":"全麦吐司","price":38},{"id":8,"image":"/uploads/stock/bakery_17.jpg","imageSrc":"","name":"可颂面包","price":86},{"id":9,"image":"/uploads/stock/bakery_18.jpg","imageSrc":"","name":"法棍","price":134},{"id":10,"image":"/uploads/stock/bakery_19.jpg","imageSrc":"","name":"贝果","price":182},{"id":11,"image":"/uploads/stock/bakery_20.jpg","imageSrc":"","name":"丹麦酥","price":230},{"id":12,"image":"/uploads/stock/bakery_21.jpg","imageSrc":"","name":"菠萝包","price":278}], productWidgets: [{"key":"products_bakery_v01_home_11","cid":"bakery_v01_home_11","limit":3},{"key":"products_bakery_v01_home_13","cid":"bakery_v01_home_13","limit":6}], swiper_bakery_v01_home_03: { height: 320, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/bakery_7.jpg","imageSrc":"","link":"","title":"烘焙甜品"},{"image":"/uploads/stock/bakery_8.jpg","imageSrc":"","link":"","title":"生日蛋糕"},{"image":"/uploads/stock/bakery_9.jpg","imageSrc":"","link":"","title":"限时折扣"}] }, swiperWidgets: [{"key":"swiper_bakery_v01_home_03","cid":"bakery_v01_home_03","height":320,"interval":3000}], notice_bakery_v01_home_04: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购烘焙甜品好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_bakery_v01_home_04","cid":"bakery_v01_home_04"}], gridNav_bakery_v01_home_02: {"items":[{"icon":"/uploads/stock/bakery_1.jpg","iconSrc":"","navUrl":"","text":"再买一单"},{"icon":"/uploads/stock/bakery_2.jpg","iconSrc":"","navUrl":"","text":"会员中心"},{"icon":"/uploads/stock/bakery_3.jpg","iconSrc":"","navUrl":"","text":"优惠券"},{"icon":"/uploads/stock/bakery_4.jpg","iconSrc":"","navUrl":"","text":"我的订单"}]}, gridNav_bakery_v01_home_05: {"items":[{"icon":"/uploads/stock/bakery_1.jpg","iconSrc":"","navUrl":"","text":"极速达"},{"icon":"/uploads/stock/bakery_2.jpg","iconSrc":"","navUrl":"","text":"品质保障"},{"icon":"/uploads/stock/bakery_3.jpg","iconSrc":"","navUrl":"","text":"售后无忧"}]}, gridNav_bakery_v01_home_06: {"items":[{"icon":"/uploads/stock/bakery_1.jpg","iconSrc":"","navUrl":"","text":"蛋糕"},{"icon":"/uploads/stock/bakery_2.jpg","iconSrc":"","navUrl":"","text":"面包"},{"icon":"/uploads/stock/bakery_3.jpg","iconSrc":"","navUrl":"","text":"曲奇"},{"icon":"/uploads/stock/bakery_4.jpg","iconSrc":"","navUrl":"","text":"慕斯"},{"icon":"/uploads/stock/bakery_5.jpg","iconSrc":"","navUrl":"","text":"挞类"},{"icon":"/uploads/stock/bakery_6.jpg","iconSrc":"","navUrl":"","text":"礼盒"},{"icon":"/uploads/stock/bakery_55.jpg","iconSrc":"","navUrl":"","text":"定制"},{"icon":"/uploads/stock/bakery_56.jpg","iconSrc":"","navUrl":"","text":"早餐"},{"icon":"/uploads/stock/bakery_57.jpg","iconSrc":"","navUrl":"","text":"下午茶"},{"icon":"/uploads/stock/bakery_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]}, promoPair_bakery_v01_home_07: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/bakery_40.jpg","imageSrc":"","navUrl":"","title":"生日蛋糕"},{"bgColor":"#fff3e0","image":"/uploads/stock/bakery_41.jpg","imageSrc":"","navUrl":"","title":"限时折扣"}]}, promoPair_bakery_v01_home_08: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/bakery_42.jpg","imageSrc":"","navUrl":"","title":"会员日"},{"bgColor":"#fff3e0","image":"/uploads/stock/bakery_43.jpg","imageSrc":"","navUrl":"","title":"新品试吃"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_bakery_v01_home_11();
    await this._mpLoadProducts_products_bakery_v01_home_13()
  },
  async _mpLoadProducts_products_bakery_v01_home_11() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("bakery_v01_home_11");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_bakery_v01_home_11 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_bakery_v01_home_11: list });
    } catch (e) { this.mpDevWarn('product', "bakery_v01_home_11", e); }
  },

  async _mpLoadProducts_products_bakery_v01_home_13() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("bakery_v01_home_13");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_bakery_v01_home_13 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_bakery_v01_home_13: list });
    } catch (e) { this.mpDevWarn('product', "bakery_v01_home_13", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_bakery_v01_home_03()
  },
  async _mpLoadSwiper_swiper_bakery_v01_home_03() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("bakery_v01_home_03"));
      ...
      var cur = this.data.swiper_bakery_v01_home_03 || {};
      this.setData({
        swiper_bakery_v01_home_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "bakery_v01_home_03", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_bakery_v01_home_04()
  },
  async _mpLoadNotice_notice_bakery_v01_home_04() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("bakery_v01_home_04"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_bakery_v01_home_04: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "bakery_v01_home_04", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_bakery_v01_home_11, 'image'); if (list.length) this.setData({ products_bakery_v01_home_11: list }); }
    { var list = withSrc(this.data.products_bakery_v01_home_13, 'image'); if (list.length) this.setData({ products_bakery_v01_home_13: list }); }
    { var wgt = this.data.swiper_bakery_v01_home_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_bakery_v01_home_03: next }); } }
  },
onShow() {
