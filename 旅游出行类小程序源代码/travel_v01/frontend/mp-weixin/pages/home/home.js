...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_travel_v01_home_11: [{"id":1,"image":"/uploads/stock/travel_10.jpg","imageSrc":"","name":"云南6日游","price":299},{"id":2,"image":"/uploads/stock/travel_11.jpg","imageSrc":"","name":"桂林5日游","price":898},{"id":3,"image":"/uploads/stock/travel_12.jpg","imageSrc":"","name":"西安4日游","price":1497}], products_travel_v01_home_13: [{"id":7,"image":"/uploads/stock/travel_16.jpg","imageSrc":"","name":"泰国6日游","price":299},{"id":8,"image":"/uploads/stock/travel_17.jpg","imageSrc":"","name":"日本7日游","price":898},{"id":9,"image":"/uploads/stock/travel_18.jpg","imageSrc":"","name":"新加坡5日游","price":1497},{"id":10,"image":"/uploads/stock/travel_19.jpg","imageSrc":"","name":"马尔代夫6日游","price":2096},{"id":11,"image":"/uploads/stock/travel_20.jpg","imageSrc":"","name":"欧洲10日游","price":2695},{"id":12,"image":"/uploads/stock/travel_21.jpg","imageSrc":"","name":"韩国5日游","price":3294}], productWidgets: [{"key":"products_travel_v01_home_11","cid":"travel_v01_home_11","limit":3},{"key":"products_travel_v01_home_13","cid":"travel_v01_home_13","limit":6}], swiper_travel_v01_home_03: { height: 320, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/travel_7.jpg","imageSrc":"","link":"","title":"旅游出行"},{"image":"/uploads/stock/travel_8.jpg","imageSrc":"","link":"","title":"特价线路"},{"image":"/uploads/stock/travel_9.jpg","imageSrc":"","link":"","title":"早鸟优惠"}] }, swiperWidgets: [{"key":"swiper_travel_v01_home_03","cid":"travel_v01_home_03","height":320,"interval":3000}], notice_travel_v01_home_04: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购旅游出行好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_travel_v01_home_04","cid":"travel_v01_home_04"}], gridNav_travel_v01_home_02: {"items":[{"icon":"/uploads/stock/travel_1.jpg","iconSrc":"","navUrl":"","text":"再买一单"},{"icon":"/uploads/stock/travel_2.jpg","iconSrc":"","navUrl":"","text":"会员中心"},{"icon":"/uploads/stock/travel_3.jpg","iconSrc":"","navUrl":"","text":"优惠券"},{"icon":"/uploads/stock/travel_4.jpg","iconSrc":"","navUrl":"","text":"我的订单"}]}, gridNav_travel_v01_home_05: {"items":[{"icon":"/uploads/stock/travel_1.jpg","iconSrc":"","navUrl":"","text":"极速达"},{"icon":"/uploads/stock/travel_2.jpg","iconSrc":"","navUrl":"","text":"品质保障"},{"icon":"/uploads/stock/travel_3.jpg","iconSrc":"","navUrl":"","text":"售后无忧"}]}, gridNav_travel_v01_home_06: {"items":[{"icon":"/uploads/stock/travel_1.jpg","iconSrc":"","navUrl":"","text":"国内"},{"icon":"/uploads/stock/travel_2.jpg","iconSrc":"","navUrl":"","text":"出境"},{"icon":"/uploads/stock/travel_3.jpg","iconSrc":"","navUrl":"","text":"周边"},{"icon":"/uploads/stock/travel_4.jpg","iconSrc":"","navUrl":"","text":"自驾"},{"icon":"/uploads/stock/travel_5.jpg","iconSrc":"","navUrl":"","text":"亲子"},{"icon":"/uploads/stock/travel_6.jpg","iconSrc":"","navUrl":"","text":"蜜月"},{"icon":"/uploads/stock/travel_55.jpg","iconSrc":"","navUrl":"","text":"团建"},{"icon":"/uploads/stock/travel_56.jpg","iconSrc":"","navUrl":"","text":"签证"},{"icon":"/uploads/stock/travel_57.jpg","iconSrc":"","navUrl":"","text":"门票"},{"icon":"/uploads/stock/travel_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]}, promoPair_travel_v01_home_07: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/travel_40.jpg","imageSrc":"","navUrl":"","title":"特价线路"},{"bgColor":"#fff3e0","image":"/uploads/stock/travel_41.jpg","imageSrc":"","navUrl":"","title":"早鸟优惠"}]}, promoPair_travel_v01_home_08: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/travel_42.jpg","imageSrc":"","navUrl":"","title":"会员专享"},{"bgColor":"#fff3e0","image":"/uploads/stock/travel_43.jpg","imageSrc":"","navUrl":"","title":"限时秒杀"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_travel_v01_home_11();
    await this._mpLoadProducts_products_travel_v01_home_13()
  },
  async _mpLoadProducts_products_travel_v01_home_11() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("travel_v01_home_11");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_travel_v01_home_11 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_travel_v01_home_11: list });
    } catch (e) { this.mpDevWarn('product', "travel_v01_home_11", e); }
  },

  async _mpLoadProducts_products_travel_v01_home_13() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("travel_v01_home_13");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_travel_v01_home_13 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_travel_v01_home_13: list });
    } catch (e) { this.mpDevWarn('product', "travel_v01_home_13", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_travel_v01_home_03()
  },
  async _mpLoadSwiper_swiper_travel_v01_home_03() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("travel_v01_home_03"));
      ...
      var cur = this.data.swiper_travel_v01_home_03 || {};
      this.setData({
        swiper_travel_v01_home_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "travel_v01_home_03", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_travel_v01_home_04()
  },
  async _mpLoadNotice_notice_travel_v01_home_04() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("travel_v01_home_04"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_travel_v01_home_04: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "travel_v01_home_04", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_travel_v01_home_11, 'image'); if (list.length) this.setData({ products_travel_v01_home_11: list }); }
    { var list = withSrc(this.data.products_travel_v01_home_13, 'image'); if (list.length) this.setData({ products_travel_v01_home_13: list }); }
    { var wgt = this.data.swiper_travel_v01_home_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_travel_v01_home_03: next }); } }
  },
onShow() {
