...
function demo_product_catalog(): array {
    return [
        [1, 1, '云南6日游', './assets/images/travel_10.jpg', 299.00],
        [2, 1, '桂林5日游', './assets/images/travel_11.jpg', 898.00],
        [3, 1, '西安4日游', './assets/images/travel_12.jpg', 1497.00],
        [4, 1, '成都3日游', './assets/images/travel_13.jpg', 2096.00],
        [5, 1, '海南5日游', './assets/images/travel_14.jpg', 2695.00],
        [6, 1, '张家界4日游', './assets/images/travel_15.jpg', 3294.00],
        [7, 2, '泰国6日游', './assets/images/travel_16.jpg', 299.00],
        [8, 2, '日本7日游', './assets/images/travel_17.jpg', 898.00],
        [9, 2, '新加坡5日游', './assets/images/travel_18.jpg', 1497.00],
        [10, 2, '马尔代夫6日游', './assets/images/travel_19.jpg', 2096.00],
        [11, 2, '欧洲10日游', './assets/images/travel_20.jpg', 2695.00],
        [12, 2, '韩国5日游', './assets/images/travel_21.jpg', 3294.00],
        [13, 3, '周边一日游', './assets/images/travel_22.jpg', 299.00],
        [14, 3, '温泉两日游', './assets/images/travel_23.jpg', 898.00],
        [15, 3, '古镇周末游', './assets/images/travel_24.jpg', 1497.00],
        [16, 3, '露营体验', './assets/images/travel_25.jpg', 2096.00],
        [17, 3, '骑行一日游', './assets/images/travel_26.jpg', 2695.00],
        [18, 3, '徒步两日游', './assets/images/travel_27.jpg', 3294.00],
        [19, 4, '川藏线自驾', './assets/images/travel_28.jpg', 299.00],
        [20, 4, '青甘大环线', './assets/images/travel_29.jpg', 898.00],
        [21, 4, '草原自驾', './assets/images/travel_30.jpg', 1497.00],
        [22, 4, '沿海公路', './assets/images/travel_31.jpg', 2096.00],
        [23, 4, 'RV房车', './assets/images/travel_32.jpg', 2695.00],
        [24, 4, '越野体验', './assets/images/travel_33.jpg', 3294.00],
        [25, 5, '主题乐园门票', './assets/images/travel_34.jpg', 299.00],
        [26, 5, '博物馆门票', './assets/images/travel_35.jpg', 898.00],
        [27, 5, '演出票', './assets/images/travel_36.jpg', 1497.00],
        [28, 5, '索道票', './assets/images/travel_37.jpg', 2096.00],
        [29, 5, '游船票', './assets/images/travel_38.jpg', 2695.00],
        [30, 5, '景区联票', './assets/images/travel_39.jpg', 3294.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'国内',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'出境',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'周边',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'自驾',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'门票',5,1)");
