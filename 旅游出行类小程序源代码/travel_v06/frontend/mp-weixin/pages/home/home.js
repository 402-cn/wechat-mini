...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_travel_v06_home_05: [{"id":7,"image":"/uploads/stock/travel_16.jpg","imageSrc":"","name":"泰国6日游","price":299},{"id":8,"image":"/uploads/stock/travel_17.jpg","imageSrc":"","name":"日本7日游","price":898},{"id":9,"image":"/uploads/stock/travel_18.jpg","imageSrc":"","name":"新加坡5日游","price":1497},{"id":10,"image":"/uploads/stock/travel_19.jpg","imageSrc":"","name":"马尔代夫6日游","price":2096}], productWidgets: [{"key":"products_travel_v06_home_05","cid":"travel_v06_home_05","limit":4}], swiper_travel_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/travel_50.jpg","imageSrc":"","link":"","title":"旅游出行"},{"image":"/uploads/stock/travel_51.jpg","imageSrc":"","link":"","title":"特价线路"},{"image":"/uploads/stock/travel_52.jpg","imageSrc":"","link":"","title":"早鸟优惠"}] }, swiperWidgets: [{"key":"swiper_travel_v06_home_02","cid":"travel_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_travel_v06_home_05()
  },
  async _mpLoadProducts_products_travel_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("travel_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_travel_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_travel_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "travel_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_travel_v06_home_02()
  },
  async _mpLoadSwiper_swiper_travel_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("travel_v06_home_02"));
      ...
      var cur = this.data.swiper_travel_v06_home_02 || {};
      this.setData({
        swiper_travel_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "travel_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_travel_v06_home_05, 'image'); if (list.length) this.setData({ products_travel_v06_home_05: list }); }
    { var wgt = this.data.swiper_travel_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_travel_v06_home_02: next }); } }
  },
onShow() {
