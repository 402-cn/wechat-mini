...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_travel_v02_home_06: [{"id":1,"image":"/uploads/stock/travel_10.jpg","imageSrc":"","name":"云南6日游","price":299},{"id":2,"image":"/uploads/stock/travel_11.jpg","imageSrc":"","name":"桂林5日游","price":898},{"id":3,"image":"/uploads/stock/travel_12.jpg","imageSrc":"","name":"西安4日游","price":1497},{"id":4,"image":"/uploads/stock/travel_13.jpg","imageSrc":"","name":"成都3日游","price":2096},{"id":5,"image":"/uploads/stock/travel_14.jpg","imageSrc":"","name":"海南5日游","price":2695},{"id":6,"image":"/uploads/stock/travel_15.jpg","imageSrc":"","name":"张家界4日游","price":3294},{"id":7,"image":"/uploads/stock/travel_16.jpg","imageSrc":"","name":"泰国6日游","price":299},{"id":8,"image":"/uploads/stock/travel_17.jpg","imageSrc":"","name":"日本7日游","price":898}], products_travel_v02_home_07: [{"id":13,"image":"/uploads/stock/travel_22.jpg","imageSrc":"","name":"周边一日游","price":299},{"id":14,"image":"/uploads/stock/travel_23.jpg","imageSrc":"","name":"温泉两日游","price":898},{"id":15,"image":"/uploads/stock/travel_24.jpg","imageSrc":"","name":"古镇周末游","price":1497}], productWidgets: [{"key":"products_travel_v02_home_06","cid":"travel_v02_home_06","limit":8},{"key":"products_travel_v02_home_07","cid":"travel_v02_home_07","limit":3}], swiper_travel_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/travel_8.jpg","imageSrc":"","link":"","title":"旅游出行"},{"image":"/uploads/stock/travel_9.jpg","imageSrc":"","link":"","title":"特价线路"}] }, swiperWidgets: [{"key":"swiper_travel_v02_home_02","cid":"travel_v02_home_02","height":280,"interval":3000}], notice_travel_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购旅游出行好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_travel_v02_home_03","cid":"travel_v02_home_03"}], gridNav_travel_v02_home_04: {"items":[{"icon":"/uploads/stock/travel_1.jpg","iconSrc":"","navUrl":"","text":"国内"},{"icon":"/uploads/stock/travel_2.jpg","iconSrc":"","navUrl":"","text":"出境"},{"icon":"/uploads/stock/travel_3.jpg","iconSrc":"","navUrl":"","text":"周边"},{"icon":"/uploads/stock/travel_4.jpg","iconSrc":"","navUrl":"","text":"自驾"},{"icon":"/uploads/stock/travel_5.jpg","iconSrc":"","navUrl":"","text":"亲子"},{"icon":"/uploads/stock/travel_6.jpg","iconSrc":"","navUrl":"","text":"蜜月"},{"icon":"/uploads/stock/travel_55.jpg","iconSrc":"","navUrl":"","text":"团建"},{"icon":"/uploads/stock/travel_56.jpg","iconSrc":"","navUrl":"","text":"签证"},{"icon":"/uploads/stock/travel_57.jpg","iconSrc":"","navUrl":"","text":"门票"},{"icon":"/uploads/stock/travel_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_travel_v02_home_06();
    await this._mpLoadProducts_products_travel_v02_home_07()
  },
  async _mpLoadProducts_products_travel_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("travel_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_travel_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_travel_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "travel_v02_home_06", e); }
  },

  async _mpLoadProducts_products_travel_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("travel_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_travel_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_travel_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "travel_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_travel_v02_home_02()
  },
  async _mpLoadSwiper_swiper_travel_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("travel_v02_home_02"));
      ...
      var cur = this.data.swiper_travel_v02_home_02 || {};
      this.setData({
        swiper_travel_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "travel_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_travel_v02_home_03()
  },
  async _mpLoadNotice_notice_travel_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("travel_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_travel_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "travel_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_travel_v02_home_06, 'image'); if (list.length) this.setData({ products_travel_v02_home_06: list }); }
    { var list = withSrc(this.data.products_travel_v02_home_07, 'image'); if (list.length) this.setData({ products_travel_v02_home_07: list }); }
    { var wgt = this.data.swiper_travel_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_travel_v02_home_02: next }); } }
  },
onShow() {
