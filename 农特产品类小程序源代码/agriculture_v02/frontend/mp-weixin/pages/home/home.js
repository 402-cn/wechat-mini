...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_agriculture_v02_home_06: [{"id":1,"image":"/uploads/stock/agriculture_10.jpg","imageSrc":"","name":"香菇干货","price":29},{"id":2,"image":"/uploads/stock/agriculture_11.jpg","imageSrc":"","name":"木耳","price":68},{"id":3,"image":"/uploads/stock/agriculture_12.jpg","imageSrc":"","name":"红枣","price":107},{"id":4,"image":"/uploads/stock/agriculture_13.jpg","imageSrc":"","name":"桂圆","price":146},{"id":5,"image":"/uploads/stock/agriculture_14.jpg","imageSrc":"","name":"枸杞","price":185},{"id":6,"image":"/uploads/stock/agriculture_15.jpg","imageSrc":"","name":"银耳","price":224},{"id":7,"image":"/uploads/stock/agriculture_16.jpg","imageSrc":"","name":"西湖龙井","price":29},{"id":8,"image":"/uploads/stock/agriculture_17.jpg","imageSrc":"","name":"铁观音","price":68}], products_agriculture_v02_home_07: [{"id":13,"image":"/uploads/stock/agriculture_22.jpg","imageSrc":"","name":"野生蜂蜜","price":29},{"id":14,"image":"/uploads/stock/agriculture_23.jpg","imageSrc":"","name":"蜂巢蜜","price":68},{"id":15,"image":"/uploads/stock/agriculture_24.jpg","imageSrc":"","name":"蜂王浆","price":107}], productWidgets: [{"key":"products_agriculture_v02_home_06","cid":"agriculture_v02_home_06","limit":8},{"key":"products_agriculture_v02_home_07","cid":"agriculture_v02_home_07","limit":3}], swiper_agriculture_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/agriculture_8.jpg","imageSrc":"","link":"","title":"农特产品"},{"image":"/uploads/stock/agriculture_9.jpg","imageSrc":"","link":"","title":"产地直供"}] }, swiperWidgets: [{"key":"swiper_agriculture_v02_home_02","cid":"agriculture_v02_home_02","height":280,"interval":3000}], notice_agriculture_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购农特产品好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_agriculture_v02_home_03","cid":"agriculture_v02_home_03"}], gridNav_agriculture_v02_home_04: {"items":[{"icon":"/uploads/stock/agriculture_1.jpg","iconSrc":"","navUrl":"","text":"干货"},{"icon":"/uploads/stock/agriculture_2.jpg","iconSrc":"","navUrl":"","text":"茶叶"},{"icon":"/uploads/stock/agriculture_3.jpg","iconSrc":"","navUrl":"","text":"蜂蜜"},{"icon":"/uploads/stock/agriculture_4.jpg","iconSrc":"","navUrl":"","text":"坚果"},{"icon":"/uploads/stock/agriculture_5.jpg","iconSrc":"","navUrl":"","text":"杂粮"},{"icon":"/uploads/stock/agriculture_6.jpg","iconSrc":"","navUrl":"","text":"腊味"},{"icon":"/uploads/stock/agriculture_55.jpg","iconSrc":"","navUrl":"","text":"水果"},{"icon":"/uploads/stock/agriculture_56.jpg","iconSrc":"","navUrl":"","text":"菌菇"},{"icon":"/uploads/stock/agriculture_57.jpg","iconSrc":"","navUrl":"","text":"特产"},{"icon":"/uploads/stock/agriculture_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_agriculture_v02_home_06();
    await this._mpLoadProducts_products_agriculture_v02_home_07()
  },
  async _mpLoadProducts_products_agriculture_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("agriculture_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_agriculture_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_agriculture_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "agriculture_v02_home_06", e); }
  },

  async _mpLoadProducts_products_agriculture_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("agriculture_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_agriculture_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_agriculture_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "agriculture_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_agriculture_v02_home_02()
  },
  async _mpLoadSwiper_swiper_agriculture_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("agriculture_v02_home_02"));
      ...
      var cur = this.data.swiper_agriculture_v02_home_02 || {};
      this.setData({
        swiper_agriculture_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "agriculture_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_agriculture_v02_home_03()
  },
  async _mpLoadNotice_notice_agriculture_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("agriculture_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_agriculture_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "agriculture_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_agriculture_v02_home_06, 'image'); if (list.length) this.setData({ products_agriculture_v02_home_06: list }); }
    { var list = withSrc(this.data.products_agriculture_v02_home_07, 'image'); if (list.length) this.setData({ products_agriculture_v02_home_07: list }); }
    { var wgt = this.data.swiper_agriculture_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_agriculture_v02_home_02: next }); } }
  },
onShow() {
