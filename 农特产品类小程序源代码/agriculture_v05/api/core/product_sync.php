...
function demo_product_catalog(): array {
    return [
        [1, 1, '香菇干货', './assets/images/agriculture_10.jpg', 29.00],
        [2, 1, '木耳', './assets/images/agriculture_11.jpg', 68.00],
        [3, 1, '红枣', './assets/images/agriculture_12.jpg', 107.00],
        [4, 1, '桂圆', './assets/images/agriculture_13.jpg', 146.00],
        [5, 1, '枸杞', './assets/images/agriculture_14.jpg', 185.00],
        [6, 1, '银耳', './assets/images/agriculture_15.jpg', 224.00],
        [7, 2, '西湖龙井', './assets/images/agriculture_16.jpg', 29.00],
        [8, 2, '铁观音', './assets/images/agriculture_17.jpg', 68.00],
        [9, 2, '普洱熟茶', './assets/images/agriculture_18.jpg', 107.00],
        [10, 2, '红茶', './assets/images/agriculture_19.jpg', 146.00],
        [11, 2, '白茶', './assets/images/agriculture_20.jpg', 185.00],
        [12, 2, '茉莉花茶', './assets/images/agriculture_21.jpg', 224.00],
        [13, 3, '野生蜂蜜', './assets/images/agriculture_22.jpg', 29.00],
        [14, 3, '蜂巢蜜', './assets/images/agriculture_23.jpg', 68.00],
        [15, 3, '蜂王浆', './assets/images/agriculture_24.jpg', 107.00],
        [16, 3, '花粉', './assets/images/agriculture_25.jpg', 146.00],
        [17, 3, '蜂胶', './assets/images/agriculture_26.jpg', 185.00],
        [18, 3, '礼盒蜂蜜', './assets/images/agriculture_27.jpg', 224.00],
        [19, 4, '核桃', './assets/images/agriculture_28.jpg', 29.00],
        [20, 4, '巴旦木', './assets/images/agriculture_29.jpg', 68.00],
        [21, 4, '腰果', './assets/images/agriculture_30.jpg', 107.00],
        [22, 4, '开心果', './assets/images/agriculture_31.jpg', 146.00],
        [23, 4, '夏威夷果', './assets/images/agriculture_32.jpg', 185.00],
        [24, 4, '混合坚果', './assets/images/agriculture_33.jpg', 224.00],
        [25, 5, '腊肉', './assets/images/agriculture_34.jpg', 29.00],
        [26, 5, '香肠', './assets/images/agriculture_35.jpg', 68.00],
        [27, 5, '霉干菜', './assets/images/agriculture_36.jpg', 107.00],
        [28, 5, '笋干', './assets/images/agriculture_37.jpg', 146.00],
        [29, 5, '地方特产礼盒', './assets/images/agriculture_38.jpg', 185.00],
        [30, 5, '杂粮礼包', './assets/images/agriculture_39.jpg', 224.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'干货',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'茶叶',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'蜂蜜',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'坚果',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'特产',5,1)");
