...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_agriculture_v05_home_04: [{"id":1,"image":"/uploads/stock/agriculture_10.jpg","imageSrc":"","name":"香菇干货","price":29},{"id":2,"image":"/uploads/stock/agriculture_11.jpg","imageSrc":"","name":"木耳","price":68},{"id":3,"image":"/uploads/stock/agriculture_12.jpg","imageSrc":"","name":"红枣","price":107},{"id":4,"image":"/uploads/stock/agriculture_13.jpg","imageSrc":"","name":"桂圆","price":146},{"id":5,"image":"/uploads/stock/agriculture_14.jpg","imageSrc":"","name":"枸杞","price":185},{"id":6,"image":"/uploads/stock/agriculture_15.jpg","imageSrc":"","name":"银耳","price":224},{"id":7,"image":"/uploads/stock/agriculture_16.jpg","imageSrc":"","name":"西湖龙井","price":29},{"id":8,"image":"/uploads/stock/agriculture_17.jpg","imageSrc":"","name":"铁观音","price":68}], products_agriculture_v05_home_06: [{"id":9,"image":"/uploads/stock/agriculture_18.jpg","imageSrc":"","name":"普洱熟茶","price":107},{"id":10,"image":"/uploads/stock/agriculture_19.jpg","imageSrc":"","name":"红茶","price":146},{"id":11,"image":"/uploads/stock/agriculture_20.jpg","imageSrc":"","name":"白茶","price":185},{"id":12,"image":"/uploads/stock/agriculture_21.jpg","imageSrc":"","name":"茉莉花茶","price":224}], productWidgets: [{"key":"products_agriculture_v05_home_04","cid":"agriculture_v05_home_04","limit":8},{"key":"products_agriculture_v05_home_06","cid":"agriculture_v05_home_06","limit":4}], swiper_agriculture_v05_home_02: { height: 360, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/agriculture_49.jpg","imageSrc":"","link":"","title":"农特产品"}] }, swiperWidgets: [{"key":"swiper_agriculture_v05_home_02","cid":"agriculture_v05_home_02","height":360,"interval":3000}], notice_agriculture_v05_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购农特产品好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_agriculture_v05_home_03","cid":"agriculture_v05_home_03"}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_agriculture_v05_home_04();
    await this._mpLoadProducts_products_agriculture_v05_home_06()
  },
  async _mpLoadProducts_products_agriculture_v05_home_04() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("agriculture_v05_home_04");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_agriculture_v05_home_04 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_agriculture_v05_home_04: list });
    } catch (e) { this.mpDevWarn('product', "agriculture_v05_home_04", e); }
  },

  async _mpLoadProducts_products_agriculture_v05_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("agriculture_v05_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_agriculture_v05_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_agriculture_v05_home_06: list });
    } catch (e) { this.mpDevWarn('product', "agriculture_v05_home_06", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_agriculture_v05_home_02()
  },
  async _mpLoadSwiper_swiper_agriculture_v05_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("agriculture_v05_home_02"));
      ...
      var cur = this.data.swiper_agriculture_v05_home_02 || {};
      this.setData({
        swiper_agriculture_v05_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "agriculture_v05_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_agriculture_v05_home_03()
  },
  async _mpLoadNotice_notice_agriculture_v05_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("agriculture_v05_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_agriculture_v05_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "agriculture_v05_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_agriculture_v05_home_04, 'image'); if (list.length) this.setData({ products_agriculture_v05_home_04: list }); }
    { var list = withSrc(this.data.products_agriculture_v05_home_06, 'image'); if (list.length) this.setData({ products_agriculture_v05_home_06: list }); }
    { var wgt = this.data.swiper_agriculture_v05_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_agriculture_v05_home_02: next }); } }
  },
onShow() {
