...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_agriculture_v03_home_08: [{"id":1,"image":"/uploads/stock/agriculture_10.jpg","imageSrc":"","name":"香菇干货","price":29},{"id":2,"image":"/uploads/stock/agriculture_11.jpg","imageSrc":"","name":"木耳","price":68},{"id":3,"image":"/uploads/stock/agriculture_12.jpg","imageSrc":"","name":"红枣","price":107},{"id":4,"image":"/uploads/stock/agriculture_13.jpg","imageSrc":"","name":"桂圆","price":146},{"id":5,"image":"/uploads/stock/agriculture_14.jpg","imageSrc":"","name":"枸杞","price":185},{"id":6,"image":"/uploads/stock/agriculture_15.jpg","imageSrc":"","name":"银耳","price":224}], productWidgets: [{"key":"products_agriculture_v03_home_08","cid":"agriculture_v03_home_08","limit":6}], swiper_agriculture_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/agriculture_9.jpg","imageSrc":"","link":"","title":"农特产品"},{"image":"/uploads/stock/agriculture_48.jpg","imageSrc":"","link":"","title":"产地直供"},{"image":"/uploads/stock/agriculture_49.jpg","imageSrc":"","link":"","title":"农家特惠"}] }, swiperWidgets: [{"key":"swiper_agriculture_v03_home_02","cid":"agriculture_v03_home_02","height":340,"interval":3000}], promoPair_agriculture_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/agriculture_42.jpg","imageSrc":"","navUrl":"","title":"产地直供"},{"bgColor":"#fff3e0","image":"/uploads/stock/agriculture_43.jpg","imageSrc":"","navUrl":"","title":"农家特惠"}]}, promoPair_agriculture_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/agriculture_44.jpg","imageSrc":"","navUrl":"","title":"会员专享"},{"bgColor":"#fff3e0","image":"/uploads/stock/agriculture_45.jpg","imageSrc":"","navUrl":"","title":"限时抢购"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_agriculture_v03_home_08()
  },
  async _mpLoadProducts_products_agriculture_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("agriculture_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_agriculture_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_agriculture_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "agriculture_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_agriculture_v03_home_02()
  },
  async _mpLoadSwiper_swiper_agriculture_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("agriculture_v03_home_02"));
      ...
      var cur = this.data.swiper_agriculture_v03_home_02 || {};
      this.setData({
        swiper_agriculture_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "agriculture_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_agriculture_v03_home_08, 'image'); if (list.length) this.setData({ products_agriculture_v03_home_08: list }); }
    { var wgt = this.data.swiper_agriculture_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_agriculture_v03_home_02: next }); } }
  },
onShow() {
