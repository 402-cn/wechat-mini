...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_agriculture_v06_home_05: [{"id":7,"image":"/uploads/stock/agriculture_16.jpg","imageSrc":"","name":"西湖龙井","price":29},{"id":8,"image":"/uploads/stock/agriculture_17.jpg","imageSrc":"","name":"铁观音","price":68},{"id":9,"image":"/uploads/stock/agriculture_18.jpg","imageSrc":"","name":"普洱熟茶","price":107},{"id":10,"image":"/uploads/stock/agriculture_19.jpg","imageSrc":"","name":"红茶","price":146}], productWidgets: [{"key":"products_agriculture_v06_home_05","cid":"agriculture_v06_home_05","limit":4}], swiper_agriculture_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/agriculture_50.jpg","imageSrc":"","link":"","title":"农特产品"},{"image":"/uploads/stock/agriculture_51.jpg","imageSrc":"","link":"","title":"产地直供"},{"image":"/uploads/stock/agriculture_52.jpg","imageSrc":"","link":"","title":"农家特惠"}] }, swiperWidgets: [{"key":"swiper_agriculture_v06_home_02","cid":"agriculture_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_agriculture_v06_home_05()
  },
  async _mpLoadProducts_products_agriculture_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("agriculture_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_agriculture_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_agriculture_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "agriculture_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_agriculture_v06_home_02()
  },
  async _mpLoadSwiper_swiper_agriculture_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("agriculture_v06_home_02"));
      ...
      var cur = this.data.swiper_agriculture_v06_home_02 || {};
      this.setData({
        swiper_agriculture_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "agriculture_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_agriculture_v06_home_05, 'image'); if (list.length) this.setData({ products_agriculture_v06_home_05: list }); }
    { var wgt = this.data.swiper_agriculture_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_agriculture_v06_home_02: next }); } }
  },
onShow() {
