...
function demo_product_catalog(): array {
    return [
        [1, 1, '户外探索精选款A', './assets/images/outdoor_10.jpg', 39.00],
        [2, 1, '户外探索精选款B', './assets/images/outdoor_11.jpg', 88.00],
        [3, 1, '户外探索精选款C', './assets/images/outdoor_12.jpg', 137.00],
        [4, 1, '户外探索精选款D', './assets/images/outdoor_13.jpg', 186.00],
        [5, 1, '户外探索精选款E', './assets/images/outdoor_14.jpg', 235.00],
        [6, 1, '户外探索精选款F', './assets/images/outdoor_15.jpg', 284.00],
        [7, 2, '热销单品1', './assets/images/outdoor_16.jpg', 39.00],
        [8, 2, '热销单品2', './assets/images/outdoor_17.jpg', 88.00],
        [9, 2, '热销单品3', './assets/images/outdoor_18.jpg', 137.00],
        [10, 2, '热销单品4', './assets/images/outdoor_19.jpg', 186.00],
        [11, 2, '热销单品5', './assets/images/outdoor_20.jpg', 235.00],
        [12, 2, '热销单品6', './assets/images/outdoor_21.jpg', 284.00],
        [13, 3, '新品推荐1', './assets/images/outdoor_22.jpg', 39.00],
        [14, 3, '新品推荐2', './assets/images/outdoor_23.jpg', 88.00],
        [15, 3, '新品推荐3', './assets/images/outdoor_24.jpg', 137.00],
        [16, 3, '新品推荐4', './assets/images/outdoor_25.jpg', 186.00],
        [17, 3, '新品推荐5', './assets/images/outdoor_26.jpg', 235.00],
        [18, 3, '新品推荐6', './assets/images/outdoor_27.jpg', 284.00],
        [19, 4, '套餐服务1', './assets/images/outdoor_28.jpg', 39.00],
        [20, 4, '套餐服务2', './assets/images/outdoor_29.jpg', 88.00],
        [21, 4, '套餐服务3', './assets/images/outdoor_30.jpg', 137.00],
        [22, 4, '套餐服务4', './assets/images/outdoor_31.jpg', 186.00],
        [23, 4, '套餐服务5', './assets/images/outdoor_32.jpg', 235.00],
        [24, 4, '套餐服务6', './assets/images/outdoor_33.jpg', 284.00],
        [25, 5, '会员专享1', './assets/images/outdoor_34.jpg', 39.00],
        [26, 5, '会员专享2', './assets/images/outdoor_35.jpg', 88.00],
        [27, 5, '会员专享3', './assets/images/outdoor_36.jpg', 137.00],
        [28, 5, '会员专享4', './assets/images/outdoor_37.jpg', 186.00],
        [29, 5, '会员专享5', './assets/images/outdoor_38.jpg', 235.00],
        [30, 5, '会员专享6', './assets/images/outdoor_39.jpg', 284.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'帐篷',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'背包',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'鞋服',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'露营',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'骑行',5,1)");
