...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_outdoor_v02_home_06: [{"id":1,"image":"/uploads/stock/outdoor_10.jpg","imageSrc":"","name":"户外探索精选款A","price":39},{"id":2,"image":"/uploads/stock/outdoor_11.jpg","imageSrc":"","name":"户外探索精选款B","price":88},{"id":3,"image":"/uploads/stock/outdoor_12.jpg","imageSrc":"","name":"户外探索精选款C","price":137},{"id":4,"image":"/uploads/stock/outdoor_13.jpg","imageSrc":"","name":"户外探索精选款D","price":186},{"id":5,"image":"/uploads/stock/outdoor_14.jpg","imageSrc":"","name":"户外探索精选款E","price":235},{"id":6,"image":"/uploads/stock/outdoor_15.jpg","imageSrc":"","name":"户外探索精选款F","price":284},{"id":7,"image":"/uploads/stock/outdoor_16.jpg","imageSrc":"","name":"热销单品1","price":39},{"id":8,"image":"/uploads/stock/outdoor_17.jpg","imageSrc":"","name":"热销单品2","price":88}], products_outdoor_v02_home_07: [{"id":13,"image":"/uploads/stock/outdoor_22.jpg","imageSrc":"","name":"新品推荐1","price":39},{"id":14,"image":"/uploads/stock/outdoor_23.jpg","imageSrc":"","name":"新品推荐2","price":88},{"id":15,"image":"/uploads/stock/outdoor_24.jpg","imageSrc":"","name":"新品推荐3","price":137}], productWidgets: [{"key":"products_outdoor_v02_home_06","cid":"outdoor_v02_home_06","limit":8},{"key":"products_outdoor_v02_home_07","cid":"outdoor_v02_home_07","limit":3}], swiper_outdoor_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/outdoor_8.jpg","imageSrc":"","link":"","title":"户外装备"},{"image":"/uploads/stock/outdoor_9.jpg","imageSrc":"","link":"","title":"露营季"}] }, swiperWidgets: [{"key":"swiper_outdoor_v02_home_02","cid":"outdoor_v02_home_02","height":280,"interval":3000}], notice_outdoor_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购户外装备好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_outdoor_v02_home_03","cid":"outdoor_v02_home_03"}], gridNav_outdoor_v02_home_04: {"items":[{"icon":"/uploads/stock/outdoor_1.jpg","iconSrc":"","navUrl":"","text":"帐篷"},{"icon":"/uploads/stock/outdoor_2.jpg","iconSrc":"","navUrl":"","text":"背包"},{"icon":"/uploads/stock/outdoor_3.jpg","iconSrc":"","navUrl":"","text":"鞋服"},{"icon":"/uploads/stock/outdoor_4.jpg","iconSrc":"","navUrl":"","text":"登山"},{"icon":"/uploads/stock/outdoor_5.jpg","iconSrc":"","navUrl":"","text":"露营"},{"icon":"/uploads/stock/outdoor_6.jpg","iconSrc":"","navUrl":"","text":"骑行"},{"icon":"/uploads/stock/outdoor_55.jpg","iconSrc":"","navUrl":"","text":"钓鱼"},{"icon":"/uploads/stock/outdoor_56.jpg","iconSrc":"","navUrl":"","text":"照明"},{"icon":"/uploads/stock/outdoor_57.jpg","iconSrc":"","navUrl":"","text":"配件"},{"icon":"/uploads/stock/outdoor_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_outdoor_v02_home_06();
    await this._mpLoadProducts_products_outdoor_v02_home_07()
  },
  async _mpLoadProducts_products_outdoor_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("outdoor_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_outdoor_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_outdoor_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "outdoor_v02_home_06", e); }
  },

  async _mpLoadProducts_products_outdoor_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("outdoor_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_outdoor_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_outdoor_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "outdoor_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_outdoor_v02_home_02()
  },
  async _mpLoadSwiper_swiper_outdoor_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("outdoor_v02_home_02"));
      ...
      var cur = this.data.swiper_outdoor_v02_home_02 || {};
      this.setData({
        swiper_outdoor_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "outdoor_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_outdoor_v02_home_03()
  },
  async _mpLoadNotice_notice_outdoor_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("outdoor_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_outdoor_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "outdoor_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_outdoor_v02_home_06, 'image'); if (list.length) this.setData({ products_outdoor_v02_home_06: list }); }
    { var list = withSrc(this.data.products_outdoor_v02_home_07, 'image'); if (list.length) this.setData({ products_outdoor_v02_home_07: list }); }
    { var wgt = this.data.swiper_outdoor_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_outdoor_v02_home_02: next }); } }
  },
onShow() {
