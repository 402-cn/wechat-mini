...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_medical_v03_home_08: [{"id":1,"image":"/uploads/stock/medical_10.jpg","imageSrc":"","name":"基础体检套餐","price":29},{"id":2,"image":"/uploads/stock/medical_11.jpg","imageSrc":"","name":"全面体检","price":88},{"id":3,"image":"/uploads/stock/medical_12.jpg","imageSrc":"","name":"入职体检","price":147},{"id":4,"image":"/uploads/stock/medical_13.jpg","imageSrc":"","name":"老年体检","price":206},{"id":5,"image":"/uploads/stock/medical_14.jpg","imageSrc":"","name":"女性专项","price":265},{"id":6,"image":"/uploads/stock/medical_15.jpg","imageSrc":"","name":"男性专项","price":324}], productWidgets: [{"key":"products_medical_v03_home_08","cid":"medical_v03_home_08","limit":6}], swiper_medical_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/medical_9.jpg","imageSrc":"","link":"","title":"医疗健康"},{"image":"/uploads/stock/medical_48.jpg","imageSrc":"","link":"","title":"体检优惠"},{"image":"/uploads/stock/medical_49.jpg","imageSrc":"","link":"","title":"在线问诊"}] }, swiperWidgets: [{"key":"swiper_medical_v03_home_02","cid":"medical_v03_home_02","height":340,"interval":3000}], promoPair_medical_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/medical_42.jpg","imageSrc":"","navUrl":"","title":"体检优惠"},{"bgColor":"#fff3e0","image":"/uploads/stock/medical_43.jpg","imageSrc":"","navUrl":"","title":"在线问诊"}]}, promoPair_medical_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/medical_44.jpg","imageSrc":"","navUrl":"","title":"健康礼包"},{"bgColor":"#fff3e0","image":"/uploads/stock/medical_45.jpg","imageSrc":"","navUrl":"","title":"限时活动"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_medical_v03_home_08()
  },
  async _mpLoadProducts_products_medical_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("medical_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_medical_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_medical_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "medical_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_medical_v03_home_02()
  },
  async _mpLoadSwiper_swiper_medical_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("medical_v03_home_02"));
      ...
      var cur = this.data.swiper_medical_v03_home_02 || {};
      this.setData({
        swiper_medical_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "medical_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_medical_v03_home_08, 'image'); if (list.length) this.setData({ products_medical_v03_home_08: list }); }
    { var wgt = this.data.swiper_medical_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_medical_v03_home_02: next }); } }
  },
onShow() {
