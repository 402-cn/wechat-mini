...
function demo_product_catalog(): array {
    return [
        [1, 1, '基础体检套餐', './assets/images/medical_10.jpg', 29.00],
        [2, 1, '全面体检', './assets/images/medical_11.jpg', 88.00],
        [3, 1, '入职体检', './assets/images/medical_12.jpg', 147.00],
        [4, 1, '老年体检', './assets/images/medical_13.jpg', 206.00],
        [5, 1, '女性专项', './assets/images/medical_14.jpg', 265.00],
        [6, 1, '男性专项', './assets/images/medical_15.jpg', 324.00],
        [7, 2, '在线问诊', './assets/images/medical_16.jpg', 29.00],
        [8, 2, '专家复诊', './assets/images/medical_17.jpg', 88.00],
        [9, 2, '图文咨询', './assets/images/medical_18.jpg', 147.00],
        [10, 2, '视频问诊', './assets/images/medical_19.jpg', 206.00],
        [11, 2, '慢病管理', './assets/images/medical_20.jpg', 265.00],
        [12, 2, '健康档案', './assets/images/medical_21.jpg', 324.00],
        [13, 3, '常用感冒药', './assets/images/medical_22.jpg', 29.00],
        [14, 3, '维生素C', './assets/images/medical_23.jpg', 88.00],
        [15, 3, '钙片', './assets/images/medical_24.jpg', 147.00],
        [16, 3, '创可贴', './assets/images/medical_25.jpg', 206.00],
        [17, 3, '体温计套装', './assets/images/medical_26.jpg', 265.00],
        [18, 3, '口罩', './assets/images/medical_27.jpg', 324.00],
        [19, 4, '血压计', './assets/images/medical_28.jpg', 29.00],
        [20, 4, '血糖仪', './assets/images/medical_29.jpg', 88.00],
        [21, 4, '雾化器', './assets/images/medical_30.jpg', 147.00],
        [22, 4, '轮椅', './assets/images/medical_31.jpg', 206.00],
        [23, 4, '护腰', './assets/images/medical_32.jpg', 265.00],
        [24, 4, '颈椎仪', './assets/images/medical_33.jpg', 324.00],
        [25, 5, '蛋白粉', './assets/images/medical_34.jpg', 29.00],
        [26, 5, '鱼油', './assets/images/medical_35.jpg', 88.00],
        [27, 5, '益生菌', './assets/images/medical_36.jpg', 147.00],
        [28, 5, '叶黄素', './assets/images/medical_37.jpg', 206.00],
        [29, 5, '胶原蛋白', './assets/images/medical_38.jpg', 265.00],
        [30, 5, '艾灸贴', './assets/images/medical_39.jpg', 324.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'体检',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'问诊',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'药品',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'器械',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'保健',5,1)");
