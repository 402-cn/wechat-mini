...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_medical_v01_home_11: [{"id":1,"image":"/uploads/stock/medical_10.jpg","imageSrc":"","name":"基础体检套餐","price":29},{"id":2,"image":"/uploads/stock/medical_11.jpg","imageSrc":"","name":"全面体检","price":88},{"id":3,"image":"/uploads/stock/medical_12.jpg","imageSrc":"","name":"入职体检","price":147}], products_medical_v01_home_13: [{"id":7,"image":"/uploads/stock/medical_16.jpg","imageSrc":"","name":"在线问诊","price":29},{"id":8,"image":"/uploads/stock/medical_17.jpg","imageSrc":"","name":"专家复诊","price":88},{"id":9,"image":"/uploads/stock/medical_18.jpg","imageSrc":"","name":"图文咨询","price":147},{"id":10,"image":"/uploads/stock/medical_19.jpg","imageSrc":"","name":"视频问诊","price":206},{"id":11,"image":"/uploads/stock/medical_20.jpg","imageSrc":"","name":"慢病管理","price":265},{"id":12,"image":"/uploads/stock/medical_21.jpg","imageSrc":"","name":"健康档案","price":324}], productWidgets: [{"key":"products_medical_v01_home_11","cid":"medical_v01_home_11","limit":3},{"key":"products_medical_v01_home_13","cid":"medical_v01_home_13","limit":6}], swiper_medical_v01_home_03: { height: 320, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/medical_7.jpg","imageSrc":"","link":"","title":"医疗健康"},{"image":"/uploads/stock/medical_8.jpg","imageSrc":"","link":"","title":"体检优惠"},{"image":"/uploads/stock/medical_9.jpg","imageSrc":"","link":"","title":"在线问诊"}] }, swiperWidgets: [{"key":"swiper_medical_v01_home_03","cid":"medical_v01_home_03","height":320,"interval":3000}], notice_medical_v01_home_04: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购医疗健康好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_medical_v01_home_04","cid":"medical_v01_home_04"}], gridNav_medical_v01_home_02: {"items":[{"icon":"/uploads/stock/medical_1.jpg","iconSrc":"","navUrl":"","text":"再买一单"},{"icon":"/uploads/stock/medical_2.jpg","iconSrc":"","navUrl":"","text":"会员中心"},{"icon":"/uploads/stock/medical_3.jpg","iconSrc":"","navUrl":"","text":"优惠券"},{"icon":"/uploads/stock/medical_4.jpg","iconSrc":"","navUrl":"","text":"我的订单"}]}, gridNav_medical_v01_home_05: {"items":[{"icon":"/uploads/stock/medical_1.jpg","iconSrc":"","navUrl":"","text":"极速达"},{"icon":"/uploads/stock/medical_2.jpg","iconSrc":"","navUrl":"","text":"品质保障"},{"icon":"/uploads/stock/medical_3.jpg","iconSrc":"","navUrl":"","text":"售后无忧"}]}, gridNav_medical_v01_home_06: {"items":[{"icon":"/uploads/stock/medical_1.jpg","iconSrc":"","navUrl":"","text":"体检"},{"icon":"/uploads/stock/medical_2.jpg","iconSrc":"","navUrl":"","text":"问诊"},{"icon":"/uploads/stock/medical_3.jpg","iconSrc":"","navUrl":"","text":"药品"},{"icon":"/uploads/stock/medical_4.jpg","iconSrc":"","navUrl":"","text":"器械"},{"icon":"/uploads/stock/medical_5.jpg","iconSrc":"","navUrl":"","text":"保健"},{"icon":"/uploads/stock/medical_6.jpg","iconSrc":"","navUrl":"","text":"中医"},{"icon":"/uploads/stock/medical_55.jpg","iconSrc":"","navUrl":"","text":"口腔"},{"icon":"/uploads/stock/medical_56.jpg","iconSrc":"","navUrl":"","text":"眼科"},{"icon":"/uploads/stock/medical_57.jpg","iconSrc":"","navUrl":"","text":"康复"},{"icon":"/uploads/stock/medical_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]}, promoPair_medical_v01_home_07: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/medical_40.jpg","imageSrc":"","navUrl":"","title":"体检优惠"},{"bgColor":"#fff3e0","image":"/uploads/stock/medical_41.jpg","imageSrc":"","navUrl":"","title":"在线问诊"}]}, promoPair_medical_v01_home_08: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/medical_42.jpg","imageSrc":"","navUrl":"","title":"健康礼包"},{"bgColor":"#fff3e0","image":"/uploads/stock/medical_43.jpg","imageSrc":"","navUrl":"","title":"限时活动"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_medical_v01_home_11();
    await this._mpLoadProducts_products_medical_v01_home_13()
  },
  async _mpLoadProducts_products_medical_v01_home_11() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("medical_v01_home_11");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_medical_v01_home_11 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_medical_v01_home_11: list });
    } catch (e) { this.mpDevWarn('product', "medical_v01_home_11", e); }
  },

  async _mpLoadProducts_products_medical_v01_home_13() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("medical_v01_home_13");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_medical_v01_home_13 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_medical_v01_home_13: list });
    } catch (e) { this.mpDevWarn('product', "medical_v01_home_13", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_medical_v01_home_03()
  },
  async _mpLoadSwiper_swiper_medical_v01_home_03() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("medical_v01_home_03"));
      ...
      var cur = this.data.swiper_medical_v01_home_03 || {};
      this.setData({
        swiper_medical_v01_home_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "medical_v01_home_03", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_medical_v01_home_04()
  },
  async _mpLoadNotice_notice_medical_v01_home_04() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("medical_v01_home_04"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_medical_v01_home_04: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "medical_v01_home_04", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_medical_v01_home_11, 'image'); if (list.length) this.setData({ products_medical_v01_home_11: list }); }
    { var list = withSrc(this.data.products_medical_v01_home_13, 'image'); if (list.length) this.setData({ products_medical_v01_home_13: list }); }
    { var wgt = this.data.swiper_medical_v01_home_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_medical_v01_home_03: next }); } }
  },
onShow() {
