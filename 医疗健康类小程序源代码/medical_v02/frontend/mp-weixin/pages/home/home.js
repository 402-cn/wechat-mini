...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_medical_v02_home_06: [{"id":1,"image":"/uploads/stock/medical_10.jpg","imageSrc":"","name":"基础体检套餐","price":29},{"id":2,"image":"/uploads/stock/medical_11.jpg","imageSrc":"","name":"全面体检","price":88},{"id":3,"image":"/uploads/stock/medical_12.jpg","imageSrc":"","name":"入职体检","price":147},{"id":4,"image":"/uploads/stock/medical_13.jpg","imageSrc":"","name":"老年体检","price":206},{"id":5,"image":"/uploads/stock/medical_14.jpg","imageSrc":"","name":"女性专项","price":265},{"id":6,"image":"/uploads/stock/medical_15.jpg","imageSrc":"","name":"男性专项","price":324},{"id":7,"image":"/uploads/stock/medical_16.jpg","imageSrc":"","name":"在线问诊","price":29},{"id":8,"image":"/uploads/stock/medical_17.jpg","imageSrc":"","name":"专家复诊","price":88}], products_medical_v02_home_07: [{"id":13,"image":"/uploads/stock/medical_22.jpg","imageSrc":"","name":"常用感冒药","price":29},{"id":14,"image":"/uploads/stock/medical_23.jpg","imageSrc":"","name":"维生素C","price":88},{"id":15,"image":"/uploads/stock/medical_24.jpg","imageSrc":"","name":"钙片","price":147}], productWidgets: [{"key":"products_medical_v02_home_06","cid":"medical_v02_home_06","limit":8},{"key":"products_medical_v02_home_07","cid":"medical_v02_home_07","limit":3}], swiper_medical_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/medical_8.jpg","imageSrc":"","link":"","title":"医疗健康"},{"image":"/uploads/stock/medical_9.jpg","imageSrc":"","link":"","title":"体检优惠"}] }, swiperWidgets: [{"key":"swiper_medical_v02_home_02","cid":"medical_v02_home_02","height":280,"interval":3000}], notice_medical_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购医疗健康好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_medical_v02_home_03","cid":"medical_v02_home_03"}], gridNav_medical_v02_home_04: {"items":[{"icon":"/uploads/stock/medical_1.jpg","iconSrc":"","navUrl":"","text":"体检"},{"icon":"/uploads/stock/medical_2.jpg","iconSrc":"","navUrl":"","text":"问诊"},{"icon":"/uploads/stock/medical_3.jpg","iconSrc":"","navUrl":"","text":"药品"},{"icon":"/uploads/stock/medical_4.jpg","iconSrc":"","navUrl":"","text":"器械"},{"icon":"/uploads/stock/medical_5.jpg","iconSrc":"","navUrl":"","text":"保健"},{"icon":"/uploads/stock/medical_6.jpg","iconSrc":"","navUrl":"","text":"中医"},{"icon":"/uploads/stock/medical_55.jpg","iconSrc":"","navUrl":"","text":"口腔"},{"icon":"/uploads/stock/medical_56.jpg","iconSrc":"","navUrl":"","text":"眼科"},{"icon":"/uploads/stock/medical_57.jpg","iconSrc":"","navUrl":"","text":"康复"},{"icon":"/uploads/stock/medical_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_medical_v02_home_06();
    await this._mpLoadProducts_products_medical_v02_home_07()
  },
  async _mpLoadProducts_products_medical_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("medical_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_medical_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_medical_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "medical_v02_home_06", e); }
  },

  async _mpLoadProducts_products_medical_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("medical_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_medical_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_medical_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "medical_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_medical_v02_home_02()
  },
  async _mpLoadSwiper_swiper_medical_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("medical_v02_home_02"));
      ...
      var cur = this.data.swiper_medical_v02_home_02 || {};
      this.setData({
        swiper_medical_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "medical_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_medical_v02_home_03()
  },
  async _mpLoadNotice_notice_medical_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("medical_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_medical_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "medical_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_medical_v02_home_06, 'image'); if (list.length) this.setData({ products_medical_v02_home_06: list }); }
    { var list = withSrc(this.data.products_medical_v02_home_07, 'image'); if (list.length) this.setData({ products_medical_v02_home_07: list }); }
    { var wgt = this.data.swiper_medical_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_medical_v02_home_02: next }); } }
  },
onShow() {
