...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_medical_v06_home_05: [{"id":7,"image":"/uploads/stock/medical_16.jpg","imageSrc":"","name":"在线问诊","price":29},{"id":8,"image":"/uploads/stock/medical_17.jpg","imageSrc":"","name":"专家复诊","price":88},{"id":9,"image":"/uploads/stock/medical_18.jpg","imageSrc":"","name":"图文咨询","price":147},{"id":10,"image":"/uploads/stock/medical_19.jpg","imageSrc":"","name":"视频问诊","price":206}], productWidgets: [{"key":"products_medical_v06_home_05","cid":"medical_v06_home_05","limit":4}], swiper_medical_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/medical_50.jpg","imageSrc":"","link":"","title":"医疗健康"},{"image":"/uploads/stock/medical_51.jpg","imageSrc":"","link":"","title":"体检优惠"},{"image":"/uploads/stock/medical_52.jpg","imageSrc":"","link":"","title":"在线问诊"}] }, swiperWidgets: [{"key":"swiper_medical_v06_home_02","cid":"medical_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_medical_v06_home_05()
  },
  async _mpLoadProducts_products_medical_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("medical_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_medical_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_medical_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "medical_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_medical_v06_home_02()
  },
  async _mpLoadSwiper_swiper_medical_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("medical_v06_home_02"));
      ...
      var cur = this.data.swiper_medical_v06_home_02 || {};
      this.setData({
        swiper_medical_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "medical_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_medical_v06_home_05, 'image'); if (list.length) this.setData({ products_medical_v06_home_05: list }); }
    { var wgt = this.data.swiper_medical_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_medical_v06_home_02: next }); } }
  },
onShow() {
