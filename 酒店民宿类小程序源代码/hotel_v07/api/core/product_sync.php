...
function demo_product_catalog(): array {
    return [
        [1, 1, '标准大床房', './assets/images/hotel_10.jpg', 168.00],
        [2, 1, '标准双床房', './assets/images/hotel_11.jpg', 396.00],
        [3, 1, '无窗特惠房', './assets/images/hotel_12.jpg', 624.00],
        [4, 1, '钟点房', './assets/images/hotel_13.jpg', 852.00],
        [5, 1, '商务单间', './assets/images/hotel_14.jpg', 1080.00],
        [6, 1, '家庭房', './assets/images/hotel_15.jpg', 1308.00],
