...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_hotel_v02_home_06: [{"id":1,"image":"/uploads/stock/hotel_10.jpg","imageSrc":"","name":"标准大床房","price":168},{"id":2,"image":"/uploads/stock/hotel_11.jpg","imageSrc":"","name":"标准双床房","price":396},{"id":3,"image":"/uploads/stock/hotel_12.jpg","imageSrc":"","name":"无窗特惠房","price":624},{"id":4,"image":"/uploads/stock/hotel_13.jpg","imageSrc":"","name":"钟点房","price":852},{"id":5,"image":"/uploads/stock/hotel_14.jpg","imageSrc":"","name":"商务单间","price":1080},{"id":6,"image":"/uploads/stock/hotel_15.jpg","imageSrc":"","name":"家庭房","price":1308},{"id":7,"image":"/uploads/stock/hotel_16.jpg","imageSrc":"","name":"豪华大床","price":168},{"id":8,"image":"/uploads/stock/hotel_17.jpg","imageSrc":"","name":"行政房","price":396}], products_hotel_v02_home_07: [{"id":13,"image":"/uploads/stock/hotel_22.jpg","imageSrc":"","name":"总统套房","price":168},{"id":14,"image":"/uploads/stock/hotel_23.jpg","imageSrc":"","name":"泳池别墅","price":396},{"id":15,"image":"/uploads/stock/hotel_24.jpg","imageSrc":"","name":"海景房","price":624}], productWidgets: [{"key":"products_hotel_v02_home_06","cid":"hotel_v02_home_06","limit":8},{"key":"products_hotel_v02_home_07","cid":"hotel_v02_home_07","limit":3}], swiper_hotel_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/hotel_8.jpg","imageSrc":"","link":"","title":"酒店民宿"},{"image":"/uploads/stock/hotel_9.jpg","imageSrc":"","link":"","title":"今日特价"}] }, swiperWidgets: [{"key":"swiper_hotel_v02_home_02","cid":"hotel_v02_home_02","height":280,"interval":3000}], notice_hotel_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购酒店民宿好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_hotel_v02_home_03","cid":"hotel_v02_home_03"}], gridNav_hotel_v02_home_04: {"items":[{"icon":"/uploads/stock/hotel_1.jpg","iconSrc":"","navUrl":"","text":"经济"},{"icon":"/uploads/stock/hotel_2.jpg","iconSrc":"","navUrl":"","text":"舒适"},{"icon":"/uploads/stock/hotel_3.jpg","iconSrc":"","navUrl":"","text":"高档"},{"icon":"/uploads/stock/hotel_4.jpg","iconSrc":"","navUrl":"","text":"民宿"},{"icon":"/uploads/stock/hotel_5.jpg","iconSrc":"","navUrl":"","text":"公寓"},{"icon":"/uploads/stock/hotel_6.jpg","iconSrc":"","navUrl":"","text":"温泉"},{"icon":"/uploads/stock/hotel_55.jpg","iconSrc":"","navUrl":"","text":"海景"},{"icon":"/uploads/stock/hotel_56.jpg","iconSrc":"","navUrl":"","text":"亲子"},{"icon":"/uploads/stock/hotel_57.jpg","iconSrc":"","navUrl":"","text":"商务"},{"icon":"/uploads/stock/hotel_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_hotel_v02_home_06();
    await this._mpLoadProducts_products_hotel_v02_home_07()
  },
  async _mpLoadProducts_products_hotel_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("hotel_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_hotel_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_hotel_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "hotel_v02_home_06", e); }
  },

  async _mpLoadProducts_products_hotel_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("hotel_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_hotel_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_hotel_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "hotel_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_hotel_v02_home_02()
  },
  async _mpLoadSwiper_swiper_hotel_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("hotel_v02_home_02"));
      ...
      var cur = this.data.swiper_hotel_v02_home_02 || {};
      this.setData({
        swiper_hotel_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "hotel_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_hotel_v02_home_03()
  },
  async _mpLoadNotice_notice_hotel_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("hotel_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_hotel_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "hotel_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_hotel_v02_home_06, 'image'); if (list.length) this.setData({ products_hotel_v02_home_06: list }); }
    { var list = withSrc(this.data.products_hotel_v02_home_07, 'image'); if (list.length) this.setData({ products_hotel_v02_home_07: list }); }
    { var wgt = this.data.swiper_hotel_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_hotel_v02_home_02: next }); } }
  },
onShow() {
