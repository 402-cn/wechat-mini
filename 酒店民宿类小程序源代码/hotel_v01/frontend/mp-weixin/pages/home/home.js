...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_hotel_v01_home_11: [{"id":1,"image":"/uploads/stock/hotel_10.jpg","imageSrc":"","name":"标准大床房","price":168},{"id":2,"image":"/uploads/stock/hotel_11.jpg","imageSrc":"","name":"标准双床房","price":396},{"id":3,"image":"/uploads/stock/hotel_12.jpg","imageSrc":"","name":"无窗特惠房","price":624}], products_hotel_v01_home_13: [{"id":7,"image":"/uploads/stock/hotel_16.jpg","imageSrc":"","name":"豪华大床","price":168},{"id":8,"image":"/uploads/stock/hotel_17.jpg","imageSrc":"","name":"行政房","price":396},{"id":9,"image":"/uploads/stock/hotel_18.jpg","imageSrc":"","name":"景观房","price":624},{"id":10,"image":"/uploads/stock/hotel_19.jpg","imageSrc":"","name":"亲子房","price":852},{"id":11,"image":"/uploads/stock/hotel_20.jpg","imageSrc":"","name":"套房","price":1080},{"id":12,"image":"/uploads/stock/hotel_21.jpg","imageSrc":"","name":"连通房","price":1308}], productWidgets: [{"key":"products_hotel_v01_home_11","cid":"hotel_v01_home_11","limit":3},{"key":"products_hotel_v01_home_13","cid":"hotel_v01_home_13","limit":6}], swiper_hotel_v01_home_03: { height: 320, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/hotel_7.jpg","imageSrc":"","link":"","title":"酒店民宿"},{"image":"/uploads/stock/hotel_8.jpg","imageSrc":"","link":"","title":"今日特价"},{"image":"/uploads/stock/hotel_9.jpg","imageSrc":"","link":"","title":"连住优惠"}] }, swiperWidgets: [{"key":"swiper_hotel_v01_home_03","cid":"hotel_v01_home_03","height":320,"interval":3000}], notice_hotel_v01_home_04: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购酒店民宿好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_hotel_v01_home_04","cid":"hotel_v01_home_04"}], gridNav_hotel_v01_home_02: {"items":[{"icon":"/uploads/stock/hotel_1.jpg","iconSrc":"","navUrl":"","text":"再买一单"},{"icon":"/uploads/stock/hotel_2.jpg","iconSrc":"","navUrl":"","text":"会员中心"},{"icon":"/uploads/stock/hotel_3.jpg","iconSrc":"","navUrl":"","text":"优惠券"},{"icon":"/uploads/stock/hotel_4.jpg","iconSrc":"","navUrl":"","text":"我的订单"}]}, gridNav_hotel_v01_home_05: {"items":[{"icon":"/uploads/stock/hotel_1.jpg","iconSrc":"","navUrl":"","text":"极速达"},{"icon":"/uploads/stock/hotel_2.jpg","iconSrc":"","navUrl":"","text":"品质保障"},{"icon":"/uploads/stock/hotel_3.jpg","iconSrc":"","navUrl":"","text":"售后无忧"}]}, gridNav_hotel_v01_home_06: {"items":[{"icon":"/uploads/stock/hotel_1.jpg","iconSrc":"","navUrl":"","text":"经济"},{"icon":"/uploads/stock/hotel_2.jpg","iconSrc":"","navUrl":"","text":"舒适"},{"icon":"/uploads/stock/hotel_3.jpg","iconSrc":"","navUrl":"","text":"高档"},{"icon":"/uploads/stock/hotel_4.jpg","iconSrc":"","navUrl":"","text":"民宿"},{"icon":"/uploads/stock/hotel_5.jpg","iconSrc":"","navUrl":"","text":"公寓"},{"icon":"/uploads/stock/hotel_6.jpg","iconSrc":"","navUrl":"","text":"温泉"},{"icon":"/uploads/stock/hotel_55.jpg","iconSrc":"","navUrl":"","text":"海景"},{"icon":"/uploads/stock/hotel_56.jpg","iconSrc":"","navUrl":"","text":"亲子"},{"icon":"/uploads/stock/hotel_57.jpg","iconSrc":"","navUrl":"","text":"商务"},{"icon":"/uploads/stock/hotel_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]}, promoPair_hotel_v01_home_07: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/hotel_40.jpg","imageSrc":"","navUrl":"","title":"今日特价"},{"bgColor":"#fff3e0","image":"/uploads/stock/hotel_41.jpg","imageSrc":"","navUrl":"","title":"连住优惠"}]}, promoPair_hotel_v01_home_08: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/hotel_42.jpg","imageSrc":"","navUrl":"","title":"会员价"},{"bgColor":"#fff3e0","image":"/uploads/stock/hotel_43.jpg","imageSrc":"","navUrl":"","title":"限时抢购"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_hotel_v01_home_11();
    await this._mpLoadProducts_products_hotel_v01_home_13()
  },
  async _mpLoadProducts_products_hotel_v01_home_11() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("hotel_v01_home_11");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_hotel_v01_home_11 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_hotel_v01_home_11: list });
    } catch (e) { this.mpDevWarn('product', "hotel_v01_home_11", e); }
  },

  async _mpLoadProducts_products_hotel_v01_home_13() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("hotel_v01_home_13");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_hotel_v01_home_13 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_hotel_v01_home_13: list });
    } catch (e) { this.mpDevWarn('product', "hotel_v01_home_13", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_hotel_v01_home_03()
  },
  async _mpLoadSwiper_swiper_hotel_v01_home_03() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("hotel_v01_home_03"));
      ...
      var cur = this.data.swiper_hotel_v01_home_03 || {};
      this.setData({
        swiper_hotel_v01_home_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "hotel_v01_home_03", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_hotel_v01_home_04()
  },
  async _mpLoadNotice_notice_hotel_v01_home_04() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("hotel_v01_home_04"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_hotel_v01_home_04: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "hotel_v01_home_04", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_hotel_v01_home_11, 'image'); if (list.length) this.setData({ products_hotel_v01_home_11: list }); }
    { var list = withSrc(this.data.products_hotel_v01_home_13, 'image'); if (list.length) this.setData({ products_hotel_v01_home_13: list }); }
    { var wgt = this.data.swiper_hotel_v01_home_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_hotel_v01_home_03: next }); } }
  },
onShow() {
