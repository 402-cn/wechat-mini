...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_hotel_v05_home_04: [{"id":1,"image":"/uploads/stock/hotel_10.jpg","imageSrc":"","name":"标准大床房","price":168},{"id":2,"image":"/uploads/stock/hotel_11.jpg","imageSrc":"","name":"标准双床房","price":396},{"id":3,"image":"/uploads/stock/hotel_12.jpg","imageSrc":"","name":"无窗特惠房","price":624},{"id":4,"image":"/uploads/stock/hotel_13.jpg","imageSrc":"","name":"钟点房","price":852},{"id":5,"image":"/uploads/stock/hotel_14.jpg","imageSrc":"","name":"商务单间","price":1080},{"id":6,"image":"/uploads/stock/hotel_15.jpg","imageSrc":"","name":"家庭房","price":1308},{"id":7,"image":"/uploads/stock/hotel_16.jpg","imageSrc":"","name":"豪华大床","price":168},{"id":8,"image":"/uploads/stock/hotel_17.jpg","imageSrc":"","name":"行政房","price":396}], products_hotel_v05_home_06: [{"id":9,"image":"/uploads/stock/hotel_18.jpg","imageSrc":"","name":"景观房","price":624},{"id":10,"image":"/uploads/stock/hotel_19.jpg","imageSrc":"","name":"亲子房","price":852},{"id":11,"image":"/uploads/stock/hotel_20.jpg","imageSrc":"","name":"套房","price":1080},{"id":12,"image":"/uploads/stock/hotel_21.jpg","imageSrc":"","name":"连通房","price":1308}], productWidgets: [{"key":"products_hotel_v05_home_04","cid":"hotel_v05_home_04","limit":8},{"key":"products_hotel_v05_home_06","cid":"hotel_v05_home_06","limit":4}], swiper_hotel_v05_home_02: { height: 360, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/hotel_49.jpg","imageSrc":"","link":"","title":"酒店民宿"}] }, swiperWidgets: [{"key":"swiper_hotel_v05_home_02","cid":"hotel_v05_home_02","height":360,"interval":3000}], notice_hotel_v05_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购酒店民宿好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_hotel_v05_home_03","cid":"hotel_v05_home_03"}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_hotel_v05_home_04();
    await this._mpLoadProducts_products_hotel_v05_home_06()
  },
  async _mpLoadProducts_products_hotel_v05_home_04() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("hotel_v05_home_04");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_hotel_v05_home_04 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_hotel_v05_home_04: list });
    } catch (e) { this.mpDevWarn('product', "hotel_v05_home_04", e); }
  },

  async _mpLoadProducts_products_hotel_v05_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("hotel_v05_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_hotel_v05_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_hotel_v05_home_06: list });
    } catch (e) { this.mpDevWarn('product', "hotel_v05_home_06", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_hotel_v05_home_02()
  },
  async _mpLoadSwiper_swiper_hotel_v05_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("hotel_v05_home_02"));
      ...
      var cur = this.data.swiper_hotel_v05_home_02 || {};
      this.setData({
        swiper_hotel_v05_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "hotel_v05_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_hotel_v05_home_03()
  },
  async _mpLoadNotice_notice_hotel_v05_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("hotel_v05_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_hotel_v05_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "hotel_v05_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_hotel_v05_home_04, 'image'); if (list.length) this.setData({ products_hotel_v05_home_04: list }); }
    { var list = withSrc(this.data.products_hotel_v05_home_06, 'image'); if (list.length) this.setData({ products_hotel_v05_home_06: list }); }
    { var wgt = this.data.swiper_hotel_v05_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_hotel_v05_home_02: next }); } }
  },
onShow() {
