...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_hotel_v03_home_08: [{"id":1,"image":"/uploads/stock/hotel_10.jpg","imageSrc":"","name":"标准大床房","price":168},{"id":2,"image":"/uploads/stock/hotel_11.jpg","imageSrc":"","name":"标准双床房","price":396},{"id":3,"image":"/uploads/stock/hotel_12.jpg","imageSrc":"","name":"无窗特惠房","price":624},{"id":4,"image":"/uploads/stock/hotel_13.jpg","imageSrc":"","name":"钟点房","price":852},{"id":5,"image":"/uploads/stock/hotel_14.jpg","imageSrc":"","name":"商务单间","price":1080},{"id":6,"image":"/uploads/stock/hotel_15.jpg","imageSrc":"","name":"家庭房","price":1308}], productWidgets: [{"key":"products_hotel_v03_home_08","cid":"hotel_v03_home_08","limit":6}], swiper_hotel_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/hotel_9.jpg","imageSrc":"","link":"","title":"酒店民宿"},{"image":"/uploads/stock/hotel_48.jpg","imageSrc":"","link":"","title":"今日特价"},{"image":"/uploads/stock/hotel_49.jpg","imageSrc":"","link":"","title":"连住优惠"}] }, swiperWidgets: [{"key":"swiper_hotel_v03_home_02","cid":"hotel_v03_home_02","height":340,"interval":3000}], promoPair_hotel_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/hotel_42.jpg","imageSrc":"","navUrl":"","title":"今日特价"},{"bgColor":"#fff3e0","image":"/uploads/stock/hotel_43.jpg","imageSrc":"","navUrl":"","title":"连住优惠"}]}, promoPair_hotel_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/hotel_44.jpg","imageSrc":"","navUrl":"","title":"会员价"},{"bgColor":"#fff3e0","image":"/uploads/stock/hotel_45.jpg","imageSrc":"","navUrl":"","title":"限时抢购"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_hotel_v03_home_08()
  },
  async _mpLoadProducts_products_hotel_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("hotel_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_hotel_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_hotel_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "hotel_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_hotel_v03_home_02()
  },
  async _mpLoadSwiper_swiper_hotel_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("hotel_v03_home_02"));
      ...
      var cur = this.data.swiper_hotel_v03_home_02 || {};
      this.setData({
        swiper_hotel_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "hotel_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_hotel_v03_home_08, 'image'); if (list.length) this.setData({ products_hotel_v03_home_08: list }); }
    { var wgt = this.data.swiper_hotel_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_hotel_v03_home_02: next }); } }
  },
onShow() {
