...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_hotel_v06_home_05: [{"id":7,"image":"/uploads/stock/hotel_16.jpg","imageSrc":"","name":"豪华大床","price":168},{"id":8,"image":"/uploads/stock/hotel_17.jpg","imageSrc":"","name":"行政房","price":396},{"id":9,"image":"/uploads/stock/hotel_18.jpg","imageSrc":"","name":"景观房","price":624},{"id":10,"image":"/uploads/stock/hotel_19.jpg","imageSrc":"","name":"亲子房","price":852}], productWidgets: [{"key":"products_hotel_v06_home_05","cid":"hotel_v06_home_05","limit":4}], swiper_hotel_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/hotel_50.jpg","imageSrc":"","link":"","title":"酒店民宿"},{"image":"/uploads/stock/hotel_51.jpg","imageSrc":"","link":"","title":"今日特价"},{"image":"/uploads/stock/hotel_52.jpg","imageSrc":"","link":"","title":"连住优惠"}] }, swiperWidgets: [{"key":"swiper_hotel_v06_home_02","cid":"hotel_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_hotel_v06_home_05()
  },
  async _mpLoadProducts_products_hotel_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("hotel_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_hotel_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_hotel_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "hotel_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_hotel_v06_home_02()
  },
  async _mpLoadSwiper_swiper_hotel_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("hotel_v06_home_02"));
      ...
      var cur = this.data.swiper_hotel_v06_home_02 || {};
      this.setData({
        swiper_hotel_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "hotel_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_hotel_v06_home_05, 'image'); if (list.length) this.setData({ products_hotel_v06_home_05: list }); }
    { var wgt = this.data.swiper_hotel_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_hotel_v06_home_02: next }); } }
  },
onShow() {
