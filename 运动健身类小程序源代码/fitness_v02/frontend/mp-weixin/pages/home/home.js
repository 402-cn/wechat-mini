...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_fitness_v02_home_06: [{"id":1,"image":"/uploads/stock/fitness_10.jpg","imageSrc":"","name":"哑铃套装","price":49},{"id":2,"image":"/uploads/stock/fitness_11.jpg","imageSrc":"","name":"弹力带","price":138},{"id":3,"image":"/uploads/stock/fitness_12.jpg","imageSrc":"","name":"壶铃","price":227},{"id":4,"image":"/uploads/stock/fitness_13.jpg","imageSrc":"","name":"跳绳","price":316},{"id":5,"image":"/uploads/stock/fitness_14.jpg","imageSrc":"","name":"俯卧撑架","price":405},{"id":6,"image":"/uploads/stock/fitness_15.jpg","imageSrc":"","name":"引体向上器","price":494},{"id":7,"image":"/uploads/stock/fitness_16.jpg","imageSrc":"","name":"瑜伽垫","price":49},{"id":8,"image":"/uploads/stock/fitness_17.jpg","imageSrc":"","name":"瑜伽球","price":138}], products_fitness_v02_home_07: [{"id":13,"image":"/uploads/stock/fitness_22.jpg","imageSrc":"","name":"跑步机","price":49},{"id":14,"image":"/uploads/stock/fitness_23.jpg","imageSrc":"","name":"动感单车","price":138},{"id":15,"image":"/uploads/stock/fitness_24.jpg","imageSrc":"","name":"椭圆机","price":227}], productWidgets: [{"key":"products_fitness_v02_home_06","cid":"fitness_v02_home_06","limit":8},{"key":"products_fitness_v02_home_07","cid":"fitness_v02_home_07","limit":3}], swiper_fitness_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/fitness_8.jpg","imageSrc":"","link":"","title":"运动健身"},{"image":"/uploads/stock/fitness_9.jpg","imageSrc":"","link":"","title":"新人体验"}] }, swiperWidgets: [{"key":"swiper_fitness_v02_home_02","cid":"fitness_v02_home_02","height":280,"interval":3000}], notice_fitness_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购运动健身好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_fitness_v02_home_03","cid":"fitness_v02_home_03"}], gridNav_fitness_v02_home_04: {"items":[{"icon":"/uploads/stock/fitness_1.jpg","iconSrc":"","navUrl":"","text":"器械"},{"icon":"/uploads/stock/fitness_2.jpg","iconSrc":"","navUrl":"","text":"瑜伽"},{"icon":"/uploads/stock/fitness_3.jpg","iconSrc":"","navUrl":"","text":"跑步"},{"icon":"/uploads/stock/fitness_4.jpg","iconSrc":"","navUrl":"","text":"球类"},{"icon":"/uploads/stock/fitness_5.jpg","iconSrc":"","navUrl":"","text":"户外"},{"icon":"/uploads/stock/fitness_6.jpg","iconSrc":"","navUrl":"","text":"游泳"},{"icon":"/uploads/stock/fitness_55.jpg","iconSrc":"","navUrl":"","text":"营养"},{"icon":"/uploads/stock/fitness_56.jpg","iconSrc":"","navUrl":"","text":"服饰"},{"icon":"/uploads/stock/fitness_57.jpg","iconSrc":"","navUrl":"","text":"私教"},{"icon":"/uploads/stock/fitness_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_fitness_v02_home_06();
    await this._mpLoadProducts_products_fitness_v02_home_07()
  },
  async _mpLoadProducts_products_fitness_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("fitness_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_fitness_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_fitness_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "fitness_v02_home_06", e); }
  },

  async _mpLoadProducts_products_fitness_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("fitness_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_fitness_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_fitness_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "fitness_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_fitness_v02_home_02()
  },
  async _mpLoadSwiper_swiper_fitness_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("fitness_v02_home_02"));
      ...
      var cur = this.data.swiper_fitness_v02_home_02 || {};
      this.setData({
        swiper_fitness_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "fitness_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_fitness_v02_home_03()
  },
  async _mpLoadNotice_notice_fitness_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("fitness_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_fitness_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "fitness_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_fitness_v02_home_06, 'image'); if (list.length) this.setData({ products_fitness_v02_home_06: list }); }
    { var list = withSrc(this.data.products_fitness_v02_home_07, 'image'); if (list.length) this.setData({ products_fitness_v02_home_07: list }); }
    { var wgt = this.data.swiper_fitness_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_fitness_v02_home_02: next }); } }
  },
onShow() {
