...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_fitness_v03_home_08: [{"id":1,"image":"/uploads/stock/fitness_10.jpg","imageSrc":"","name":"哑铃套装","price":49},{"id":2,"image":"/uploads/stock/fitness_11.jpg","imageSrc":"","name":"弹力带","price":138},{"id":3,"image":"/uploads/stock/fitness_12.jpg","imageSrc":"","name":"壶铃","price":227},{"id":4,"image":"/uploads/stock/fitness_13.jpg","imageSrc":"","name":"跳绳","price":316},{"id":5,"image":"/uploads/stock/fitness_14.jpg","imageSrc":"","name":"俯卧撑架","price":405},{"id":6,"image":"/uploads/stock/fitness_15.jpg","imageSrc":"","name":"引体向上器","price":494}], productWidgets: [{"key":"products_fitness_v03_home_08","cid":"fitness_v03_home_08","limit":6}], swiper_fitness_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/fitness_9.jpg","imageSrc":"","link":"","title":"运动健身"},{"image":"/uploads/stock/fitness_48.jpg","imageSrc":"","link":"","title":"新人体验"},{"image":"/uploads/stock/fitness_49.jpg","imageSrc":"","link":"","title":"课程优惠"}] }, swiperWidgets: [{"key":"swiper_fitness_v03_home_02","cid":"fitness_v03_home_02","height":340,"interval":3000}], promoPair_fitness_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/fitness_42.jpg","imageSrc":"","navUrl":"","title":"新人体验"},{"bgColor":"#fff3e0","image":"/uploads/stock/fitness_43.jpg","imageSrc":"","navUrl":"","title":"课程优惠"}]}, promoPair_fitness_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/fitness_44.jpg","imageSrc":"","navUrl":"","title":"会员特权"},{"bgColor":"#fff3e0","image":"/uploads/stock/fitness_45.jpg","imageSrc":"","navUrl":"","title":"限时活动"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_fitness_v03_home_08()
  },
  async _mpLoadProducts_products_fitness_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("fitness_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_fitness_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_fitness_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "fitness_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_fitness_v03_home_02()
  },
  async _mpLoadSwiper_swiper_fitness_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("fitness_v03_home_02"));
      ...
      var cur = this.data.swiper_fitness_v03_home_02 || {};
      this.setData({
        swiper_fitness_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "fitness_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_fitness_v03_home_08, 'image'); if (list.length) this.setData({ products_fitness_v03_home_08: list }); }
    { var wgt = this.data.swiper_fitness_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_fitness_v03_home_02: next }); } }
  },
onShow() {
