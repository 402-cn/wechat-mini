...
function demo_product_catalog(): array {
    return [
        [1, 1, '哑铃套装', './assets/images/fitness_10.jpg', 49.00],
        [2, 1, '弹力带', './assets/images/fitness_11.jpg', 138.00],
        [3, 1, '壶铃', './assets/images/fitness_12.jpg', 227.00],
        [4, 1, '跳绳', './assets/images/fitness_13.jpg', 316.00],
        [5, 1, '俯卧撑架', './assets/images/fitness_14.jpg', 405.00],
        [6, 1, '引体向上器', './assets/images/fitness_15.jpg', 494.00],
        [7, 2, '瑜伽垫', './assets/images/fitness_16.jpg', 49.00],
        [8, 2, '瑜伽球', './assets/images/fitness_17.jpg', 138.00],
        [9, 2, '瑜伽砖', './assets/images/fitness_18.jpg', 227.00],
        [10, 2, '拉力带', './assets/images/fitness_19.jpg', 316.00],
        [11, 2, '泡沫轴', './assets/images/fitness_20.jpg', 405.00],
        [12, 2, '瑜伽服', './assets/images/fitness_21.jpg', 494.00],
        [13, 3, '跑步机', './assets/images/fitness_22.jpg', 49.00],
        [14, 3, '动感单车', './assets/images/fitness_23.jpg', 138.00],
        [15, 3, '椭圆机', './assets/images/fitness_24.jpg', 227.00],
        [16, 3, '运动手环', './assets/images/fitness_25.jpg', 316.00],
        [17, 3, '跑步鞋', './assets/images/fitness_26.jpg', 405.00],
        [18, 3, '运动水壶', './assets/images/fitness_27.jpg', 494.00],
        [19, 4, '蛋白粉', './assets/images/fitness_28.jpg', 49.00],
        [20, 4, '能量棒', './assets/images/fitness_29.jpg', 138.00],
        [21, 4, '电解质饮料', './assets/images/fitness_30.jpg', 227.00],
        [22, 4, '左旋肉碱', './assets/images/fitness_31.jpg', 316.00],
        [23, 4, '维生素', './assets/images/fitness_32.jpg', 405.00],
        [24, 4, '代餐奶昔', './assets/images/fitness_33.jpg', 494.00],
        [25, 5, '运动T恤', './assets/images/fitness_34.jpg', 49.00],
        [26, 5, '运动裤', './assets/images/fitness_35.jpg', 138.00],
        [27, 5, '运动内衣', './assets/images/fitness_36.jpg', 227.00],
        [28, 5, '护膝', './assets/images/fitness_37.jpg', 316.00],
        [29, 5, '运动袜', './assets/images/fitness_38.jpg', 405.00],
        [30, 5, '健身手套', './assets/images/fitness_39.jpg', 494.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'器械',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'瑜伽',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'跑步',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'营养',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'服饰',5,1)");
