...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_fitness_v06_home_05: [{"id":7,"image":"/uploads/stock/fitness_16.jpg","imageSrc":"","name":"瑜伽垫","price":49},{"id":8,"image":"/uploads/stock/fitness_17.jpg","imageSrc":"","name":"瑜伽球","price":138},{"id":9,"image":"/uploads/stock/fitness_18.jpg","imageSrc":"","name":"瑜伽砖","price":227},{"id":10,"image":"/uploads/stock/fitness_19.jpg","imageSrc":"","name":"拉力带","price":316}], productWidgets: [{"key":"products_fitness_v06_home_05","cid":"fitness_v06_home_05","limit":4}], swiper_fitness_v06_home_02: { height: 400, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/fitness_50.jpg","imageSrc":"","link":"","title":"运动健身"},{"image":"/uploads/stock/fitness_51.jpg","imageSrc":"","link":"","title":"新人体验"},{"image":"/uploads/stock/fitness_52.jpg","imageSrc":"","link":"","title":"课程优惠"}] }, swiperWidgets: [{"key":"swiper_fitness_v06_home_02","cid":"fitness_v06_home_02","height":400,"interval":3000}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_fitness_v06_home_05()
  },
  async _mpLoadProducts_products_fitness_v06_home_05() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("fitness_v06_home_05");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_fitness_v06_home_05 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_fitness_v06_home_05: list });
    } catch (e) { this.mpDevWarn('product', "fitness_v06_home_05", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_fitness_v06_home_02()
  },
  async _mpLoadSwiper_swiper_fitness_v06_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("fitness_v06_home_02"));
      ...
      var cur = this.data.swiper_fitness_v06_home_02 || {};
      this.setData({
        swiper_fitness_v06_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "fitness_v06_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_fitness_v06_home_05, 'image'); if (list.length) this.setData({ products_fitness_v06_home_05: list }); }
    { var wgt = this.data.swiper_fitness_v06_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_fitness_v06_home_02: next }); } }
  },
onShow() {
