...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_fitness_v01_home_11: [{"id":1,"image":"/uploads/stock/fitness_10.jpg","imageSrc":"","name":"哑铃套装","price":49},{"id":2,"image":"/uploads/stock/fitness_11.jpg","imageSrc":"","name":"弹力带","price":138},{"id":3,"image":"/uploads/stock/fitness_12.jpg","imageSrc":"","name":"壶铃","price":227}], products_fitness_v01_home_13: [{"id":7,"image":"/uploads/stock/fitness_16.jpg","imageSrc":"","name":"瑜伽垫","price":49},{"id":8,"image":"/uploads/stock/fitness_17.jpg","imageSrc":"","name":"瑜伽球","price":138},{"id":9,"image":"/uploads/stock/fitness_18.jpg","imageSrc":"","name":"瑜伽砖","price":227},{"id":10,"image":"/uploads/stock/fitness_19.jpg","imageSrc":"","name":"拉力带","price":316},{"id":11,"image":"/uploads/stock/fitness_20.jpg","imageSrc":"","name":"泡沫轴","price":405},{"id":12,"image":"/uploads/stock/fitness_21.jpg","imageSrc":"","name":"瑜伽服","price":494}], productWidgets: [{"key":"products_fitness_v01_home_11","cid":"fitness_v01_home_11","limit":3},{"key":"products_fitness_v01_home_13","cid":"fitness_v01_home_13","limit":6}], swiper_fitness_v01_home_03: { height: 320, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/fitness_7.jpg","imageSrc":"","link":"","title":"运动健身"},{"image":"/uploads/stock/fitness_8.jpg","imageSrc":"","link":"","title":"新人体验"},{"image":"/uploads/stock/fitness_9.jpg","imageSrc":"","link":"","title":"课程优惠"}] }, swiperWidgets: [{"key":"swiper_fitness_v01_home_03","cid":"fitness_v01_home_03","height":320,"interval":3000}], notice_fitness_v01_home_04: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购运动健身好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_fitness_v01_home_04","cid":"fitness_v01_home_04"}], gridNav_fitness_v01_home_02: {"items":[{"icon":"/uploads/stock/fitness_1.jpg","iconSrc":"","navUrl":"","text":"再买一单"},{"icon":"/uploads/stock/fitness_2.jpg","iconSrc":"","navUrl":"","text":"会员中心"},{"icon":"/uploads/stock/fitness_3.jpg","iconSrc":"","navUrl":"","text":"优惠券"},{"icon":"/uploads/stock/fitness_4.jpg","iconSrc":"","navUrl":"","text":"我的订单"}]}, gridNav_fitness_v01_home_05: {"items":[{"icon":"/uploads/stock/fitness_1.jpg","iconSrc":"","navUrl":"","text":"极速达"},{"icon":"/uploads/stock/fitness_2.jpg","iconSrc":"","navUrl":"","text":"品质保障"},{"icon":"/uploads/stock/fitness_3.jpg","iconSrc":"","navUrl":"","text":"售后无忧"}]}, gridNav_fitness_v01_home_06: {"items":[{"icon":"/uploads/stock/fitness_1.jpg","iconSrc":"","navUrl":"","text":"器械"},{"icon":"/uploads/stock/fitness_2.jpg","iconSrc":"","navUrl":"","text":"瑜伽"},{"icon":"/uploads/stock/fitness_3.jpg","iconSrc":"","navUrl":"","text":"跑步"},{"icon":"/uploads/stock/fitness_4.jpg","iconSrc":"","navUrl":"","text":"球类"},{"icon":"/uploads/stock/fitness_5.jpg","iconSrc":"","navUrl":"","text":"户外"},{"icon":"/uploads/stock/fitness_6.jpg","iconSrc":"","navUrl":"","text":"游泳"},{"icon":"/uploads/stock/fitness_55.jpg","iconSrc":"","navUrl":"","text":"营养"},{"icon":"/uploads/stock/fitness_56.jpg","iconSrc":"","navUrl":"","text":"服饰"},{"icon":"/uploads/stock/fitness_57.jpg","iconSrc":"","navUrl":"","text":"私教"},{"icon":"/uploads/stock/fitness_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]}, promoPair_fitness_v01_home_07: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/fitness_40.jpg","imageSrc":"","navUrl":"","title":"新人体验"},{"bgColor":"#fff3e0","image":"/uploads/stock/fitness_41.jpg","imageSrc":"","navUrl":"","title":"课程优惠"}]}, promoPair_fitness_v01_home_08: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/fitness_42.jpg","imageSrc":"","navUrl":"","title":"会员特权"},{"bgColor":"#fff3e0","image":"/uploads/stock/fitness_43.jpg","imageSrc":"","navUrl":"","title":"限时活动"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_fitness_v01_home_11();
    await this._mpLoadProducts_products_fitness_v01_home_13()
  },
  async _mpLoadProducts_products_fitness_v01_home_11() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("fitness_v01_home_11");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_fitness_v01_home_11 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_fitness_v01_home_11: list });
    } catch (e) { this.mpDevWarn('product', "fitness_v01_home_11", e); }
  },

  async _mpLoadProducts_products_fitness_v01_home_13() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("fitness_v01_home_13");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_fitness_v01_home_13 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_fitness_v01_home_13: list });
    } catch (e) { this.mpDevWarn('product', "fitness_v01_home_13", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_fitness_v01_home_03()
  },
  async _mpLoadSwiper_swiper_fitness_v01_home_03() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("fitness_v01_home_03"));
      ...
      var cur = this.data.swiper_fitness_v01_home_03 || {};
      this.setData({
        swiper_fitness_v01_home_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "fitness_v01_home_03", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_fitness_v01_home_04()
  },
  async _mpLoadNotice_notice_fitness_v01_home_04() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("fitness_v01_home_04"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_fitness_v01_home_04: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "fitness_v01_home_04", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_fitness_v01_home_11, 'image'); if (list.length) this.setData({ products_fitness_v01_home_11: list }); }
    { var list = withSrc(this.data.products_fitness_v01_home_13, 'image'); if (list.length) this.setData({ products_fitness_v01_home_13: list }); }
    { var wgt = this.data.swiper_fitness_v01_home_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_fitness_v01_home_03: next }); } }
  },
onShow() {
