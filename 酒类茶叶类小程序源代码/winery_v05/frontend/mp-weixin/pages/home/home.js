...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_winery_v05_home_04: [{"id":1,"image":"/uploads/stock/winery_10.jpg","imageSrc":"","name":"茅台镇酱香白酒","price":89},{"id":2,"image":"/uploads/stock/winery_11.jpg","imageSrc":"","name":"五粮液普五","price":218},{"id":3,"image":"/uploads/stock/winery_12.jpg","imageSrc":"","name":"剑南春","price":347},{"id":4,"image":"/uploads/stock/winery_13.jpg","imageSrc":"","name":"泸州老窖特曲","price":476},{"id":5,"image":"/uploads/stock/winery_14.jpg","imageSrc":"","name":"青花汾酒","price":605},{"id":6,"image":"/uploads/stock/winery_15.jpg","imageSrc":"","name":"西凤酒","price":734},{"id":7,"image":"/uploads/stock/winery_16.jpg","imageSrc":"","name":"波尔多干红葡萄酒","price":89},{"id":8,"image":"/uploads/stock/winery_17.jpg","imageSrc":"","name":"勃艮第黑皮诺","price":218}], products_winery_v05_home_06: [{"id":9,"image":"/uploads/stock/winery_18.jpg","imageSrc":"","name":"智利赤霞珠","price":347},{"id":10,"image":"/uploads/stock/winery_19.jpg","imageSrc":"","name":"澳洲西拉","price":476},{"id":11,"image":"/uploads/stock/winery_20.jpg","imageSrc":"","name":"起泡香槟","price":605},{"id":12,"image":"/uploads/stock/winery_21.jpg","imageSrc":"","name":"葡萄酒双支礼盒","price":734}], productWidgets: [{"key":"products_winery_v05_home_04","cid":"winery_v05_home_04","limit":8},{"key":"products_winery_v05_home_06","cid":"winery_v05_home_06","limit":4}], swiper_winery_v05_home_02: { height: 360, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/winery_49.jpg","imageSrc":"","link":"","title":"酒类茶叶"}] }, swiperWidgets: [{"key":"swiper_winery_v05_home_02","cid":"winery_v05_home_02","height":360,"interval":3000}], notice_winery_v05_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购酒类茶叶好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_winery_v05_home_03","cid":"winery_v05_home_03"}] },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_winery_v05_home_04();
    await this._mpLoadProducts_products_winery_v05_home_06()
  },
  async _mpLoadProducts_products_winery_v05_home_04() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("winery_v05_home_04");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_winery_v05_home_04 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_winery_v05_home_04: list });
    } catch (e) { this.mpDevWarn('product', "winery_v05_home_04", e); }
  },

  async _mpLoadProducts_products_winery_v05_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=4&component_id=' + encodeURIComponent("winery_v05_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_winery_v05_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_winery_v05_home_06: list });
    } catch (e) { this.mpDevWarn('product', "winery_v05_home_06", e); }
  },
async loadSwipers() {
    await this._mpLoadSwiper_swiper_winery_v05_home_02()
  },
  async _mpLoadSwiper_swiper_winery_v05_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("winery_v05_home_02"));
      ...
      var cur = this.data.swiper_winery_v05_home_02 || {};
      this.setData({
        swiper_winery_v05_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "winery_v05_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_winery_v05_home_03()
  },
  async _mpLoadNotice_notice_winery_v05_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("winery_v05_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_winery_v05_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "winery_v05_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_winery_v05_home_04, 'image'); if (list.length) this.setData({ products_winery_v05_home_04: list }); }
    { var list = withSrc(this.data.products_winery_v05_home_06, 'image'); if (list.length) this.setData({ products_winery_v05_home_06: list }); }
    { var wgt = this.data.swiper_winery_v05_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_winery_v05_home_02: next }); } }
  },
onShow() {
