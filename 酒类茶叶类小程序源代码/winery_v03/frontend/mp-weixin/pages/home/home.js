...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_winery_v03_home_08: [{"id":1,"image":"/uploads/stock/winery_10.jpg","imageSrc":"","name":"茅台镇酱香白酒","price":89},{"id":2,"image":"/uploads/stock/winery_11.jpg","imageSrc":"","name":"五粮液普五","price":218},{"id":3,"image":"/uploads/stock/winery_12.jpg","imageSrc":"","name":"剑南春","price":347},{"id":4,"image":"/uploads/stock/winery_13.jpg","imageSrc":"","name":"泸州老窖特曲","price":476},{"id":5,"image":"/uploads/stock/winery_14.jpg","imageSrc":"","name":"青花汾酒","price":605},{"id":6,"image":"/uploads/stock/winery_15.jpg","imageSrc":"","name":"西凤酒","price":734}], productWidgets: [{"key":"products_winery_v03_home_08","cid":"winery_v03_home_08","limit":6}], swiper_winery_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/winery_9.jpg","imageSrc":"","link":"","title":"酒类茶叶"},{"image":"/uploads/stock/winery_48.jpg","imageSrc":"","link":"","title":"名酒特惠"},{"image":"/uploads/stock/winery_49.jpg","imageSrc":"","link":"","title":"新茶上市"}] }, swiperWidgets: [{"key":"swiper_winery_v03_home_02","cid":"winery_v03_home_02","height":340,"interval":3000}], promoPair_winery_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/winery_42.jpg","imageSrc":"","navUrl":"","title":"名酒特惠"},{"bgColor":"#fff3e0","image":"/uploads/stock/winery_43.jpg","imageSrc":"","navUrl":"","title":"新茶上市"}]}, promoPair_winery_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/winery_44.jpg","imageSrc":"","navUrl":"","title":"礼盒推荐"},{"bgColor":"#fff3e0","image":"/uploads/stock/winery_45.jpg","imageSrc":"","navUrl":"","title":"会员专享"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_winery_v03_home_08()
  },
  async _mpLoadProducts_products_winery_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("winery_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_winery_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_winery_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "winery_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_winery_v03_home_02()
  },
  async _mpLoadSwiper_swiper_winery_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("winery_v03_home_02"));
      ...
      var cur = this.data.swiper_winery_v03_home_02 || {};
      this.setData({
        swiper_winery_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "winery_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_winery_v03_home_08, 'image'); if (list.length) this.setData({ products_winery_v03_home_08: list }); }
    { var wgt = this.data.swiper_winery_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_winery_v03_home_02: next }); } }
  },
onShow() {
