...
function demo_product_catalog(): array {
    return [
        [1, 1, '茅台镇酱香白酒', './assets/images/winery_10.jpg', 89.00],
        [2, 1, '五粮液普五', './assets/images/winery_11.jpg', 218.00],
        [3, 1, '剑南春', './assets/images/winery_12.jpg', 347.00],
        [4, 1, '泸州老窖特曲', './assets/images/winery_13.jpg', 476.00],
        [5, 1, '青花汾酒', './assets/images/winery_14.jpg', 605.00],
        [6, 1, '西凤酒', './assets/images/winery_15.jpg', 734.00],
        [7, 2, '波尔多干红葡萄酒', './assets/images/winery_16.jpg', 89.00],
        [8, 2, '勃艮第黑皮诺', './assets/images/winery_17.jpg', 218.00],
        [9, 2, '智利赤霞珠', './assets/images/winery_18.jpg', 347.00],
        [10, 2, '澳洲西拉', './assets/images/winery_19.jpg', 476.00],
        [11, 2, '起泡香槟', './assets/images/winery_20.jpg', 605.00],
        [12, 2, '葡萄酒双支礼盒', './assets/images/winery_21.jpg', 734.00],
        [13, 3, '西湖龙井', './assets/images/winery_22.jpg', 89.00],
        [14, 3, '铁观音', './assets/images/winery_23.jpg', 218.00],
        [15, 3, '普洱熟茶', './assets/images/winery_24.jpg', 347.00],
        [16, 3, '金骏眉红茶', './assets/images/winery_25.jpg', 476.00],
        [17, 3, '白毫银针', './assets/images/winery_26.jpg', 605.00],
        [18, 3, '茉莉花茶', './assets/images/winery_27.jpg', 734.00],
        [19, 4, '茶酒双节礼盒', './assets/images/winery_28.jpg', 89.00],
        [20, 4, '茶叶礼盒装', './assets/images/winery_29.jpg', 218.00],
        [21, 4, '红酒礼盒', './assets/images/winery_30.jpg', 347.00],
        [22, 4, '白酒礼盒', './assets/images/winery_31.jpg', 476.00],
        [23, 4, '茶酒组合礼盒', './assets/images/winery_32.jpg', 605.00],
        [24, 4, '企业定制礼盒', './assets/images/winery_33.jpg', 734.00],
        [25, 5, '紫砂茶具套装', './assets/images/winery_34.jpg', 89.00],
        [26, 5, '玻璃茶壶', './assets/images/winery_35.jpg', 218.00],
        [27, 5, '红酒醒酒器', './assets/images/winery_36.jpg', 347.00],
        [28, 5, '开瓶器套装', './assets/images/winery_37.jpg', 476.00],
        [29, 5, '陶瓷酒具', './assets/images/winery_38.jpg', 605.00],
        [30, 5, '便携旅行茶具', './assets/images/winery_39.jpg', 734.00],
    ];
}
...
function ensure_demo_products(PDO $pdo, bool $allowSeed = false): array {
    ...
    if (!$allowSeed) {
        ...
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (1,'白酒',1,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (2,'红酒',2,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (3,'茶叶',3,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (4,'礼盒',4,1)");
        $pdo->exec("INSERT IGNORE INTO product_categories (id,name,sort_order,status) VALUES (5,'酒具',5,1)");
