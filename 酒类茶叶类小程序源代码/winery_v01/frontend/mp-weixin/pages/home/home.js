...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_winery_v01_home_11: [{"id":1,"image":"/uploads/stock/winery_10.jpg","imageSrc":"","name":"茅台镇酱香白酒","price":89},{"id":2,"image":"/uploads/stock/winery_11.jpg","imageSrc":"","name":"五粮液普五","price":218},{"id":3,"image":"/uploads/stock/winery_12.jpg","imageSrc":"","name":"剑南春","price":347}], products_winery_v01_home_13: [{"id":7,"image":"/uploads/stock/winery_16.jpg","imageSrc":"","name":"波尔多干红葡萄酒","price":89},{"id":8,"image":"/uploads/stock/winery_17.jpg","imageSrc":"","name":"勃艮第黑皮诺","price":218},{"id":9,"image":"/uploads/stock/winery_18.jpg","imageSrc":"","name":"智利赤霞珠","price":347},{"id":10,"image":"/uploads/stock/winery_19.jpg","imageSrc":"","name":"澳洲西拉","price":476},{"id":11,"image":"/uploads/stock/winery_20.jpg","imageSrc":"","name":"起泡香槟","price":605},{"id":12,"image":"/uploads/stock/winery_21.jpg","imageSrc":"","name":"葡萄酒双支礼盒","price":734}], productWidgets: [{"key":"products_winery_v01_home_11","cid":"winery_v01_home_11","limit":3},{"key":"products_winery_v01_home_13","cid":"winery_v01_home_13","limit":6}], swiper_winery_v01_home_03: { height: 320, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/winery_7.jpg","imageSrc":"","link":"","title":"酒类茶叶"},{"image":"/uploads/stock/winery_8.jpg","imageSrc":"","link":"","title":"名酒特惠"},{"image":"/uploads/stock/winery_9.jpg","imageSrc":"","link":"","title":"新茶上市"}] }, swiperWidgets: [{"key":"swiper_winery_v01_home_03","cid":"winery_v01_home_03","height":320,"interval":3000}], notice_winery_v01_home_04: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购酒类茶叶好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_winery_v01_home_04","cid":"winery_v01_home_04"}], gridNav_winery_v01_home_02: {"items":[{"icon":"/uploads/stock/winery_1.jpg","iconSrc":"","navUrl":"","text":"再买一单"},{"icon":"/uploads/stock/winery_2.jpg","iconSrc":"","navUrl":"","text":"会员中心"},{"icon":"/uploads/stock/winery_3.jpg","iconSrc":"","navUrl":"","text":"优惠券"},{"icon":"/uploads/stock/winery_4.jpg","iconSrc":"","navUrl":"","text":"我的订单"}]}, gridNav_winery_v01_home_05: {"items":[{"icon":"/uploads/stock/winery_1.jpg","iconSrc":"","navUrl":"","text":"极速达"},{"icon":"/uploads/stock/winery_2.jpg","iconSrc":"","navUrl":"","text":"品质保障"},{"icon":"/uploads/stock/winery_3.jpg","iconSrc":"","navUrl":"","text":"售后无忧"}]}, gridNav_winery_v01_home_06: {"items":[{"icon":"/uploads/stock/winery_1.jpg","iconSrc":"","navUrl":"","text":"白酒"},{"icon":"/uploads/stock/winery_2.jpg","iconSrc":"","navUrl":"","text":"红酒"},{"icon":"/uploads/stock/winery_3.jpg","iconSrc":"","navUrl":"","text":"啤酒"},{"icon":"/uploads/stock/winery_4.jpg","iconSrc":"","navUrl":"","text":"茶叶"},{"icon":"/uploads/stock/winery_5.jpg","iconSrc":"","navUrl":"","text":"礼盒"},{"icon":"/uploads/stock/winery_6.jpg","iconSrc":"","navUrl":"","text":"茶具"},{"icon":"/uploads/stock/winery_55.jpg","iconSrc":"","navUrl":"","text":"酒具"},{"icon":"/uploads/stock/winery_56.jpg","iconSrc":"","navUrl":"","text":"特产"},{"icon":"/uploads/stock/winery_57.jpg","iconSrc":"","navUrl":"","text":"新品"},{"icon":"/uploads/stock/winery_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]}, promoPair_winery_v01_home_07: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/winery_40.jpg","imageSrc":"","navUrl":"","title":"名酒特惠"},{"bgColor":"#fff3e0","image":"/uploads/stock/winery_41.jpg","imageSrc":"","navUrl":"","title":"新茶上市"}]}, promoPair_winery_v01_home_08: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/winery_42.jpg","imageSrc":"","navUrl":"","title":"礼盒推荐"},{"bgColor":"#fff3e0","image":"/uploads/stock/winery_43.jpg","imageSrc":"","navUrl":"","title":"会员专享"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_winery_v01_home_11();
    await this._mpLoadProducts_products_winery_v01_home_13()
  },
  async _mpLoadProducts_products_winery_v01_home_11() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("winery_v01_home_11");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_winery_v01_home_11 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_winery_v01_home_11: list });
    } catch (e) { this.mpDevWarn('product', "winery_v01_home_11", e); }
  },

  async _mpLoadProducts_products_winery_v01_home_13() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("winery_v01_home_13");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_winery_v01_home_13 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_winery_v01_home_13: list });
    } catch (e) { this.mpDevWarn('product', "winery_v01_home_13", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_winery_v01_home_03()
  },
  async _mpLoadSwiper_swiper_winery_v01_home_03() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("winery_v01_home_03"));
      ...
      var cur = this.data.swiper_winery_v01_home_03 || {};
      this.setData({
        swiper_winery_v01_home_03: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "winery_v01_home_03", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_winery_v01_home_04()
  },
  async _mpLoadNotice_notice_winery_v01_home_04() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("winery_v01_home_04"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_winery_v01_home_04: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "winery_v01_home_04", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_winery_v01_home_11, 'image'); if (list.length) this.setData({ products_winery_v01_home_11: list }); }
    { var list = withSrc(this.data.products_winery_v01_home_13, 'image'); if (list.length) this.setData({ products_winery_v01_home_13: list }); }
    { var wgt = this.data.swiper_winery_v01_home_03; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_winery_v01_home_03: next }); } }
  },
onShow() {
