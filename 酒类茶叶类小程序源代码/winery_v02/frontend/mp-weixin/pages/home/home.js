...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_winery_v02_home_06: [{"id":1,"image":"/uploads/stock/winery_10.jpg","imageSrc":"","name":"茅台镇酱香白酒","price":89},{"id":2,"image":"/uploads/stock/winery_11.jpg","imageSrc":"","name":"五粮液普五","price":218},{"id":3,"image":"/uploads/stock/winery_12.jpg","imageSrc":"","name":"剑南春","price":347},{"id":4,"image":"/uploads/stock/winery_13.jpg","imageSrc":"","name":"泸州老窖特曲","price":476},{"id":5,"image":"/uploads/stock/winery_14.jpg","imageSrc":"","name":"青花汾酒","price":605},{"id":6,"image":"/uploads/stock/winery_15.jpg","imageSrc":"","name":"西凤酒","price":734},{"id":7,"image":"/uploads/stock/winery_16.jpg","imageSrc":"","name":"波尔多干红葡萄酒","price":89},{"id":8,"image":"/uploads/stock/winery_17.jpg","imageSrc":"","name":"勃艮第黑皮诺","price":218}], products_winery_v02_home_07: [{"id":13,"image":"/uploads/stock/winery_22.jpg","imageSrc":"","name":"西湖龙井","price":89},{"id":14,"image":"/uploads/stock/winery_23.jpg","imageSrc":"","name":"铁观音","price":218},{"id":15,"image":"/uploads/stock/winery_24.jpg","imageSrc":"","name":"普洱熟茶","price":347}], productWidgets: [{"key":"products_winery_v02_home_06","cid":"winery_v02_home_06","limit":8},{"key":"products_winery_v02_home_07","cid":"winery_v02_home_07","limit":3}], swiper_winery_v02_home_02: { height: 280, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/winery_8.jpg","imageSrc":"","link":"","title":"酒类茶叶"},{"image":"/uploads/stock/winery_9.jpg","imageSrc":"","link":"","title":"名酒特惠"}] }, swiperWidgets: [{"key":"swiper_winery_v02_home_02","cid":"winery_v02_home_02","height":280,"interval":3000}], notice_winery_v02_home_03: {"bgColor":"#ffffff","content":"新用户专享优惠，欢迎选购酒类茶叶好物！","duration":"4.40s","fontSize":28,"prefixTitle":"","scrollDirection":"left","scrollSpeed":50,"showIcon":true,"textColor":"#333333","trackClass":"to-left"}, noticeWidgets: [{"key":"notice_winery_v02_home_03","cid":"winery_v02_home_03"}], gridNav_winery_v02_home_04: {"items":[{"icon":"/uploads/stock/winery_1.jpg","iconSrc":"","navUrl":"","text":"白酒"},{"icon":"/uploads/stock/winery_2.jpg","iconSrc":"","navUrl":"","text":"红酒"},{"icon":"/uploads/stock/winery_3.jpg","iconSrc":"","navUrl":"","text":"啤酒"},{"icon":"/uploads/stock/winery_4.jpg","iconSrc":"","navUrl":"","text":"茶叶"},{"icon":"/uploads/stock/winery_5.jpg","iconSrc":"","navUrl":"","text":"礼盒"},{"icon":"/uploads/stock/winery_6.jpg","iconSrc":"","navUrl":"","text":"茶具"},{"icon":"/uploads/stock/winery_55.jpg","iconSrc":"","navUrl":"","text":"酒具"},{"icon":"/uploads/stock/winery_56.jpg","iconSrc":"","navUrl":"","text":"特产"},{"icon":"/uploads/stock/winery_57.jpg","iconSrc":"","navUrl":"","text":"新品"},{"icon":"/uploads/stock/winery_58.jpg","iconSrc":"","navUrl":"","text":"更多"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_winery_v02_home_06();
    await this._mpLoadProducts_products_winery_v02_home_07()
  },
  async _mpLoadProducts_products_winery_v02_home_06() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=8&component_id=' + encodeURIComponent("winery_v02_home_06");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_winery_v02_home_06 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_winery_v02_home_06: list });
    } catch (e) { this.mpDevWarn('product', "winery_v02_home_06", e); }
  },

  async _mpLoadProducts_products_winery_v02_home_07() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=3&component_id=' + encodeURIComponent("winery_v02_home_07");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_winery_v02_home_07 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_winery_v02_home_07: list });
    } catch (e) { this.mpDevWarn('product', "winery_v02_home_07", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_winery_v02_home_02()
  },
  async _mpLoadSwiper_swiper_winery_v02_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("winery_v02_home_02"));
      ...
      var cur = this.data.swiper_winery_v02_home_02 || {};
      this.setData({
        swiper_winery_v02_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "winery_v02_home_02", e); }
  },
noticeDuration(speed) {
  ...
  async loadNotices() {
    await this._mpLoadNotice_notice_winery_v02_home_03()
  },
  async _mpLoadNotice_notice_winery_v02_home_03() {
    const { req } = require('../../utils/api');
    try {
      var j = await req('/notice/get.php?id=' + encodeURIComponent("winery_v02_home_03"));
      if (!j || j.code !== 0 || !j.data || !j.data.content) return;
      var d = j.data;
      var speed = d.scrollSpeed || 50;
      var dir = d.scrollDirection || 'left';
      this.setData({
        notice_winery_v02_home_03: {
          content: d.content || '',
    ...
    } catch (e) { this.mpDevWarn('notice', "winery_v02_home_03", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_winery_v02_home_06, 'image'); if (list.length) this.setData({ products_winery_v02_home_06: list }); }
    { var list = withSrc(this.data.products_winery_v02_home_07, 'image'); if (list.length) this.setData({ products_winery_v02_home_07: list }); }
    { var wgt = this.data.swiper_winery_v02_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_winery_v02_home_02: next }); } }
  },
onShow() {
