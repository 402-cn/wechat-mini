...
Page({
  data: { appModalShow: false, appModalTitle: '提示', appModalContent: '',  siteRoot: __mpSiteRoot, assetRoot: __mpAssetRoot, products_stationery_v03_home_08: [{"id":1,"image":"/uploads/stock/stationery_10.jpg","imageSrc":"","name":"文具优选精选款A","price":39},{"id":2,"image":"/uploads/stock/stationery_11.jpg","imageSrc":"","name":"文具优选精选款B","price":88},{"id":3,"image":"/uploads/stock/stationery_12.jpg","imageSrc":"","name":"文具优选精选款C","price":137},{"id":4,"image":"/uploads/stock/stationery_13.jpg","imageSrc":"","name":"文具优选精选款D","price":186},{"id":5,"image":"/uploads/stock/stationery_14.jpg","imageSrc":"","name":"文具优选精选款E","price":235},{"id":6,"image":"/uploads/stock/stationery_15.jpg","imageSrc":"","name":"文具优选精选款F","price":284}], productWidgets: [{"key":"products_stationery_v03_home_08","cid":"stationery_v03_home_08","limit":6}], swiper_stationery_v03_home_02: { height: 340, interval: 3000, autoplay: true, items: [{"image":"/uploads/stock/stationery_9.jpg","imageSrc":"","link":"","title":"文具百货"},{"image":"/uploads/stock/stationery_48.jpg","imageSrc":"","link":"","title":"开学季"},{"image":"/uploads/stock/stationery_49.jpg","imageSrc":"","link":"","title":"满减优惠"}] }, swiperWidgets: [{"key":"swiper_stationery_v03_home_02","cid":"stationery_v03_home_02","height":340,"interval":3000}], promoPair_stationery_v03_home_05: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/stationery_42.jpg","imageSrc":"","navUrl":"","title":"开学季"},{"bgColor":"#fff3e0","image":"/uploads/stock/stationery_43.jpg","imageSrc":"","navUrl":"","title":"满减优惠"}]}, promoPair_stationery_v03_home_06: {"items":[{"bgColor":"#e8f8f0","image":"/uploads/stock/stationery_44.jpg","imageSrc":"","navUrl":"","title":"新品上架"},{"bgColor":"#fff3e0","image":"/uploads/stock/stationery_45.jpg","imageSrc":"","navUrl":"","title":"限时秒杀"}]} },
  onLoad(q) {
...
async loadProducts() {
    await this._mpLoadProducts_products_stationery_v03_home_08()
  },
  async _mpLoadProducts_products_stationery_v03_home_08() {
    const { req, assetUrl } = require('../../utils/api');
    var url = '/product/list.php?limit=6&component_id=' + encodeURIComponent("stationery_v03_home_08");
    try {
      var j = await req(url);
      var list = [];
      if (j && j.code === 0 && j.data && j.data.list && j.data.list.length) {
        ...
        list = (this.data.products_stationery_v03_home_08 || []).slice();
      }
      if (!list.length) return;
      this.setData({ products_stationery_v03_home_08: list });
    } catch (e) { this.mpDevWarn('product', "stationery_v03_home_08", e); }
  },
...
async loadSwipers() {
    await this._mpLoadSwiper_swiper_stationery_v03_home_02()
  },
  async _mpLoadSwiper_swiper_stationery_v03_home_02() {
    const { req, assetUrl } = require('../../utils/api');
    try {
      var j = await req('/swiper/list.php?id=' + encodeURIComponent("stationery_v03_home_02"));
      ...
      var cur = this.data.swiper_stationery_v03_home_02 || {};
      this.setData({
        swiper_stationery_v03_home_02: {
    ...
    } catch (e) { this.mpDevWarn('swiper', "stationery_v03_home_02", e); }
  },
...
seedDemoImages() {
    ...
    { var list = withSrc(this.data.products_stationery_v03_home_08, 'image'); if (list.length) this.setData({ products_stationery_v03_home_08: list }); }
    { var wgt = this.data.swiper_stationery_v03_home_02; if (wgt && wgt.items && wgt.items.length) { var next = Object.assign({}, wgt, { items: withSrc(wgt.items, 'image') }); this.setData({ swiper_stationery_v03_home_02: next }); } }
  },
onShow() {
